function __function_selector__() public {
    ...
    0x8: v8(0x8f2) = CONST 
    0xb: vb = CODESIZE 
    0xc: vc = SUB vb, v8(0x8f2)
    0xe: ve(0x8f2) = CONST 
    0x12: CODECOPY v7, ve(0x8f2), vc
    0x15: v15 = ADD vc, v7
    0x16: v16(0x40) = CONST 
    ...
    0x1d0: v1d0(0x3c4) = CONST 
    0x1d3: v1d3(0x25b000003c4) = OR v1d0(0x3c4), v1cf(0x25b00000000)
    0x1d4: v1d4(0x20) = CONST 
    0x1d6: v1d6(0x25b) = SHR v1d4(0x20), v1d3(0x25b000003c4)
    ...
    0x1fe: v1fe(0x8bc) = CONST 
    0x201: v201(0x36) = CONST 
    0x204: CODECOPY v1fc, v1fe(0x8bc), v201(0x36)
    ...
    prev=[0x1ba], succ=[]
    =================================
    0x262: v262(0x64c) = CONST 
    0x266: v266(0x270) = CONST 
    0x269: v269(0x0) = CONST 
    0x26b: CODECOPY v269(0x0), v266(0x270), v262(0x64c)
    0x26c: v26c(0x0) = CONST 
    0x26e: RETURN v26c(0x0), v262(0x64c)
