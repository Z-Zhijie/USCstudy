function __function_selector__() public {
    ...
    0x16: v16(0x19eb) = CONST 
    0x1a: v1a = CODESIZE 
    0x1b: v1b = SUB v1a, v16(0x19eb)
    0x1d: v1d(0x19eb) = CONST 
    0x22: CODECOPY v15, v1d(0x19eb), v1b
    ...
    0x56b: v56b(0x39) = CONST 
    0x56e: MSTORE v565, v56b(0x39)
    0x56f: v56f(0x20) = CONST 
    0x571: v571 = ADD v56f(0x20), v565
    0x573: v573(0x19b2) = CONST 
    0x577: v577(0x39) = CONST 
    0x57a: CODECOPY v571, v573(0x19b2), v577(0x39)
    ...
    Begin block 0x61e
    prev=[0x5cb, 0x628], succ=[0x638, 0x628]
    =================================
    0x61e_0x0: v61e_0 = PHI v61c(0x0), v632
    0x621: v621 = LT v61e_0, v5fe
    ...
    Begin block 0x6f00x0
    prev=[0x666], succ=[0x7140x0]
    =================================
    0x6f10x0: v06f1(0x12) = CONST 
    0x6f30x0: v06f3 = SLOAD v06f1(0x12)
    0x6f40x0: v06f4(0x60) = CONST 
    0x6f70x0: v06f7(0x714) = CONST 
    0x6fc0x0: v06fc(0x1) = CONST 
    0x6fe0x0: v06fe(0x1) = CONST 
    0x7000x0: v0700(0xa0) = CONST 
    0x7020x0: v0702(0x10000000000000000000000000000000000000000) = SHL v0700(0xa0), v06fe(0x1)
    0x7030x0: v0703(0xffffffffffffffffffffffffffffffffffffffff) = SUB v0702(0x10000000000000000000000000000000000000000), v06fc(0x1)
    0x7040x0: v0704 = AND v0703(0xffffffffffffffffffffffffffffffffffffffff), v06f3
    0x7060x0: v0706(0x1) = CONST 
    0x7080x0: v0708(0x1) = CONST 
    0x70a0x0: v070a(0xe0) = CONST 
    0x70c0x0: v070c(0x100000000000000000000000000000000000000000000000000000000) = SHL v070a(0xe0), v0708(0x1)
    0x70d0x0: v070d(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) = SUB v070c(0x100000000000000000000000000000000000000000000000000000000), v0706(0x1)
    0x70e0x0: v070e(0x472) = CONST 
    0x7120x0: v0712(0x472) = AND v070e(0x472), v070d(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff)
    0x7130x0: v0713_0 = CALLPRIVATE v0712(0x472), v66b, v0704, v06f7(0x714)

    Begin block 0x7140x0
    prev=[0x6f00x0], succ=[0x6a1]
    =================================
    0x7190x0: JUMP v604(0x6a1)

    Begin block 0x6a1
    prev=[0x7140x0], succ=[0x43c]
    =================================
    ...
    0x6b4: v6b4 = AND v602, v6b1(0xffffffffffffffffffffffffffffffffffffffff)
    ...
    0x44d: v44d = AND v1c3, v44a(0xffffffffffffffffffffffffffffffffffffffff)
    ...
    prev=[0x43c], succ=[]
    =================================
    0x71b: v71b(0x1288) = CONST 
    0x71f: v71f(0x72a) = CONST 
    0x723: v723(0x0) = CONST 
    0x725: CODECOPY v723(0x0), v71f(0x72a), v71b(0x1288)
    0x726: v726(0x0) = CONST 
    0x728: RETURN v726(0x0), v71b(0x1288)
    ...
    =================================
    0x628_0x0: v628_0 = PHI v61c(0x0), v632
    0x62a: v62a = ADD v628_0, v617
    0x62b: v62b = MLOAD v62a
    0x62e: v62e = ADD v628_0, v613
