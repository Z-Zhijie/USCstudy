function __function_selector__() public {
    ...
    0x8: v8(0x956) = CONST 
    0xb: vb = CODESIZE 
    0xc: vc = SUB vb, v8(0x956)
    0xe: ve(0x956) = CONST 
    0x12: CODECOPY v7, ve(0x956), vc
    0x15: v15 = ADD vc, v7
    0x16: v16(0x40) = CONST 
    ...
    0x129: v129 = EQ v128, vbba(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc)
    0x12c: v12c(0x131) = CONST 
    0x12f: JUMPI v12c(0x131), v129
    0xbba: vbba(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc) = CONST 
    ...
    Begin block 0x265
    prev=[0x131], succ=[0x2d7B0x265]
    =================================
    0x266: v266(0x278) = CONST 
    0x26a: v26a(0x2d7) = CONST 
    0x26d: v26d(0x20) = CONST 
    0x26f: v26f(0x2d700000000) = SHL v26d(0x20), v26a(0x2d7)
    0x270: v270(0x4dd) = CONST 
    0x273: v273(0x2d7000004dd) = OR v270(0x4dd), v26f(0x2d700000000)
    0x274: v274(0x20) = CONST 
    0x276: v276(0x2d7) = SHR v274(0x20), v273(0x2d7000004dd)
    0x277: JUMP v276(0x2d7)

    Begin block 0x2d7B0x265
    prev=[0x265], succ=[0x30bB0x265, 0x307B0x265]
    =================================
    0x2d8S0x265: v2d8V265(0x0) = CONST 
    0x2dbS0x265: v2dbV265 = EXTCODEHASH v28
    0x2dcS0x265: v2dcV265(0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470) = CONST 
    0x2ffS0x265: v2ffV265 = EQ v2dcV265(0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470), v2dbV265
    0x301S0x265: v301V265 = ISZERO v2ffV265
    0x303S0x265: v303V265(0x30b) = CONST 
    0x306S0x265: JUMPI v303V265(0x30b), v2ffV265

    Begin block 0x30bB0x265
    prev=[0x2d7B0x265, 0x307B0x265], succ=[0x278]
    =================================
    0x30b_0x0S0x265: v30b_0V265 = PHI v301V265, v30aV265
    0x312S0x265: JUMP v266(0x278)

    Begin block 0x278
    prev=[0x30bB0x265], succ=[0x27d, 0x2b3]
    =================================
    0x279: v279(0x2b3) = CONST 
    0x27c: JUMPI v279(0x2b3), v30b_0V265
    ...
    0x296: v296(0x36) = CONST 
    0x299: MSTORE v290, v296(0x36)
    0x29a: v29a(0x20) = CONST 
    0x29c: v29c = ADD v29a(0x20), v290
    0x29e: v29e(0x920) = CONST 
    0x2a1: v2a1(0x36) = CONST 
    0x2a4: CODECOPY v29c, v29e(0x920), v2a1(0x36)
    ...
    0x2ba: v2ba(0x900) = CONST 
    0x2c2: MSTORE v2b4(0x0), v2b7
    0x2c3: SSTORE vbc4(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc), v28
    0x2c4: JUMP v132(0x143)
    0xbc4: vbc4(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc) = CONST 
    ...
    0x245: v245 = EQ v244, vbbf(0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103)
    0x246: v246(0x24b) = CONST 
    0x249: JUMPI v246(0x24b), v245
    0xbbf: vbbf(0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103) = CONST 
    ...
    0x2cc: v2cc(0x8e0) = CONST 
    0x2d4: MSTORE v2c6(0x0), v2c9
    0x2d5: SSTORE vbc9(0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103), v2d
    0x2d6: JUMP v24c(0x25d)
    0xbc9: vbc9(0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103) = CONST 

    Begin block 0x25d
    prev=[0x2c5], succ=[0x313]
    =================================
    0x261: v261(0x313) = CONST 
    0x264: JUMP v261(0x313)

    Begin block 0x313
    prev=[0x25d], succ=[]
    =================================
    0x314: v314(0x5be) = CONST 
    0x318: v318(0x322) = CONST 
    0x31b: v31b(0x0) = CONST 
    0x31d: CODECOPY v31b(0x0), v318(0x322), v314(0x5be)
    0x31e: v31e(0x0) = CONST 
    0x320: RETURN v31e(0x0), v314(0x5be)
    ...
    Begin block 0x307B0x265
    prev=[0x2d7B0x265], succ=[0x30bB0x265]
    =================================
    0x309S0x265: v309V265 = ISZERO v2dbV265
    0x30aS0x265: v30aV265 = ISZERO v309V265
