function __function_selector__() public {
    ...
    0x16: v16(0x1c29) = CONST 
    0x1a: v1a = CODESIZE 
    0x1b: v1b = SUB v1a, v16(0x1c29)
    0x1d: v1d(0x1c29) = CONST 
    0x22: CODECOPY v15, v1d(0x1c29), v1b
    ...
    0x4f1: v4f1(0x34) = CONST 
    0x4f4: MSTORE v4eb, v4f1(0x34)
    0x4f5: v4f5(0x20) = CONST 
    0x4f7: v4f7 = ADD v4f5(0x20), v4eb
    0x4f9: v4f9(0x1bf5) = CONST 
    0x4fd: v4fd(0x34) = CONST 
    0x500: CODECOPY v4f7, v4f9(0x1bf5), v4fd(0x34)
    ...
    =================================
    0x677S0x517: v677V517(0xc) = CONST 
    0x679S0x517: v679V517 = SLOAD v677V517(0xc)
    ...
    0x552: v552(0xc) = CONST 
    0x555: v555 = SLOAD v552(0xc)
    ...
    =================================
    0x6770x0: v0677(0xc) = CONST 
    0x6790x0: v0679 = SLOAD v0677(0xc)
    ...
    =================================
    0x629: v629(0xc) = CONST 
    0x62b: v62b = SLOAD v629(0xc)
    ...
    prev=[0x3ec], succ=[]
    =================================
    0x6a1: v6a1(0x1545) = CONST 
    0x6a5: v6a5(0x6b0) = CONST 
    0x6a9: v6a9(0x0) = CONST 
    0x6ab: CODECOPY v6a9(0x0), v6a5(0x6b0), v6a1(0x1545)
    0x6ac: v6ac(0x0) = CONST 
    0x6ae: RETURN v6ac(0x0), v6a1(0x1545)
