function __function_selector__() public {
    ...
    0x1b: v1b(0x2b84) = CONST 
    0x1f: v1f = CODESIZE 
    0x20: v20 = SUB v1f, v1b(0x2b84)
    0x22: v22(0x2b84) = CONST 
    0x27: CODECOPY v1a, v22(0x2b84), v20
    ...
    0x2b0S0x1b0: v2b0V1b0(0x2ce3) = CONST 
    ...
    prev=[0x2cbB0x2aeB0x1b0, 0x2c0B0x2aeB0x1b0], succ=[0x2cbB0x2aeB0x1b0, 0x2d06B0x2aeB0x1b0]
    =================================
    ...
    0x2c6S0x2aeS0x1b0: v2c6V2aeV1b0(0x2d06) = CONST 
    0x2caS0x2aeS0x1b0: JUMPI v2c6V2aeV1b0(0x2d06), v2c5V2aeV1b0
    ...
    Begin block 0x2d06B0x2aeB0x1b0
    prev=[0x2c1B0x2aeB0x1b0], succ=[0x2ce3B0x1b0]
    =================================
    0x2d09S0x2aeS0x1b0: JUMP v2b0V1b0(0x2ce3)

    Begin block 0x2ce3B0x1b0
    prev=[0x2d06B0x2aeB0x1b0], succ=[0x1da]
    =================================
    0x2ce6S0x1b0: JUMP v1ca(0x1da)

    Begin block 0x1da
    prev=[0x2ce3B0x1b0], succ=[0x23bB0x1da]
    =================================
    ...
    0x2b0S0x1da: v2b0V1da(0x2ce3) = CONST 
    ...
    prev=[0x2cbB0x2aeB0x1da, 0x2c0B0x2aeB0x1da], succ=[0x2cbB0x2aeB0x1da, 0x2d06B0x2aeB0x1da]
    =================================
    ...
    0x2c6S0x2aeS0x1da: v2c6V2aeV1da(0x2d06) = CONST 
    0x2caS0x2aeS0x1da: JUMPI v2c6V2aeV1da(0x2d06), v2c5V2aeV1da
    ...
    Begin block 0x2d06B0x2aeB0x1da
    prev=[0x2c1B0x2aeB0x1da], succ=[0x2ce3B0x1da]
    =================================
    0x2d09S0x2aeS0x1da: JUMP v2b0V1da(0x2ce3)

    Begin block 0x2ce3B0x1da
    prev=[0x2d06B0x2aeB0x1da], succ=[0x1f0]
    =================================
    0x2ce6S0x1da: JUMP v1de(0x1f0)

    Begin block 0x1f0
    prev=[0x2ce3B0x1da], succ=[0x2d7]
    =================================
    ...
    0x2f0: v2f0(0x27fd) = CONST 
    0x2f3: v2f3(0x387) = CONST 
    0x2f7: v2f7(0x0) = CONST 
    0x2f9: CODECOPY v2f7(0x0), v2f3(0x387), v2f0(0x27fd)
    0x2fb: v2fb(0x7c6) = CONST 
    0x2fe: MSTORE v2fb(0x7c6), v2ef
    0x300: v300(0x9ce) = CONST 
    0x303: MSTORE v300(0x9ce), v2ef
    0x305: v305(0xdc0) = CONST 
    0x308: MSTORE v305(0xdc0), v2ef
    0x30a: v30a(0xea3) = CONST 
    0x30d: MSTORE v30a(0xea3), v2ef
    0x30f: v30f(0xf6b) = CONST 
    0x312: MSTORE v30f(0xf6b), v2ef
    0x314: v314(0xfac) = CONST 
    0x317: MSTORE v314(0xfac), v2ef
    0x319: v319(0x1520) = CONST 
    0x31c: MSTORE v319(0x1520), v2ef
    0x31e: v31e(0x172b) = CONST 
    0x321: MSTORE v31e(0x172b), v2ef
    0x323: v323(0x1e78) = CONST 
    0x326: MSTORE v323(0x1e78), v2ef
    0x328: v328(0x1fd4) = CONST 
    0x32b: MSTORE v328(0x1fd4), v2ef
    0x32e: v32e(0x105d) = CONST 
    0x331: MSTORE v32e(0x105d), v2e9
    0x333: v333(0x109e) = CONST 
    0x336: MSTORE v333(0x109e), v2e9
    0x338: v338(0x10f4) = CONST 
    0x33b: MSTORE v338(0x10f4), v2e9
    0x33d: v33d(0x126a) = CONST 
    0x340: MSTORE v33d(0x126a), v2e9
    0x343: v343(0x9fd) = CONST 
    0x346: MSTORE v343(0x9fd), v2e3
    0x348: v348(0xe6f) = CONST 
    0x34b: MSTORE v348(0xe6f), v2e3
    0x34d: v34d(0xed2) = CONST 
    0x350: MSTORE v34d(0xed2), v2e3
    0x352: v352(0x128e) = CONST 
    0x355: MSTORE v352(0x128e), v2e3
    0x357: v357(0x164e) = CONST 
    0x35a: MSTORE v357(0x164e), v2e3
    0x35c: v35c(0x1ea7) = CONST 
    0x35f: MSTORE v35c(0x1ea7), v2e3
    0x361: v361(0x1f85) = CONST 
    0x364: MSTORE v361(0x1f85), v2e3
    0x367: v367(0x1ae9) = CONST 
    0x36a: MSTORE v367(0x1ae9), v2dd
    0x36c: v36c(0x1b10) = CONST 
    0x36f: MSTORE v36c(0x1b10), v2dd
    0x371: v371(0x23bf) = CONST 
    0x374: MSTORE v371(0x23bf), v2dd
    0x376: v376(0x23ed) = CONST 
    0x379: MSTORE v376(0x23ed), v2dd
    0x37b: v37b(0x249d) = CONST 
    0x37e: MSTORE v37b(0x249d), v2dd
    0x380: v380(0x27fd) = CONST 
    0x383: v383(0x0) = CONST 
    0x385: RETURN v383(0x0), v380(0x27fd)
