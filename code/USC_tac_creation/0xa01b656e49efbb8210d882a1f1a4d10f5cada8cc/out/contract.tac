function __function_selector__() public {
    ...
    0x8: v8(0xc93) = CONST 
    0xb: vb = CODESIZE 
    0xc: vc = SUB vb, v8(0xc93)
    0xe: ve(0xc93) = CONST 
    0x12: CODECOPY v7, ve(0xc93), vc
    0x15: v15 = ADD vc, v7
    0x16: v16(0x40) = CONST 
    ...
    prev=[0xd5], succ=[]
    =================================
    0xd34: vd34(0xee) = CONST 
    0xd35: CALLPRIVATE vd34(0xee), vce, veb, v3a, v7, v28, v43, v36, v2c
...
function upgradeToAndCall(address,bytes)(0xeearg0x0, 0xeearg0x1, 0xeearg0x2, 0xeearg0x3, 0xeearg0x4, 0xeearg0x5, 0xeearg0x6, 0xeearg0x7) public {
    Begin block 0xee
    prev=[], succ=[0x14b, 0x14c]
    =================================
    0xf0: vf0(0x40) = CONST 
    0xf2: MSTORE vf0(0x40), veearg1
    0xf8: vf8(0x1) = CONST 
    ...
    0x2a0: v2a0(0x5c4) = CONST 
    0x2a3: v2a3(0x35b000005c4) = OR v2a0(0x5c4), v29f(0x35b00000000)
    0x2a4: v2a4(0x20) = CONST 
    0x2a6: v2a6(0x35b) = SHR v2a4(0x20), v2a3(0x35b000005c4)
    ...
    0x360: v360 = EXTCODESIZE veearg7
    ...
    0x2e8: v2e8(0xc58) = CONST 
    0x2eb: v2eb(0x3b) = CONST 
    0x2ee: CODECOPY v2e6, v2e8(0xc58), v2eb(0x3b)
    ...
    0x328: SSTORE v323(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc), veearg7
    ...
    0x17e: v17e = AND v169(0xffffffffffffffffffffffffffffffffffffffff), veearg7
    0x180: v180(0x40) = CONST 
    0x182: v182 = MLOAD v180(0x40)
    0x186: v186 = MLOAD veearg5
    0x188: v188(0x20) = CONST 
    0x18a: v18a = ADD v188(0x20), veearg5
    ...
    0x357: SSTORE v352(0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103), veearg6
    ...
    prev=[0x28d], succ=[]
    =================================
    0x36f: v36f(0x8db) = CONST 
    0x373: v373(0x37d) = CONST 
    0x376: v376(0x0) = CONST 
    0x378: CODECOPY v376(0x0), v373(0x37d), v36f(0x8db)
    0x379: v379(0x0) = CONST 
    0x37b: RETURN v379(0x0), v36f(0x8db)
