function __function_selector__() public {
    ...
    0x83: v83(0x1) = EQ vcee(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc), v3ec(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc)
    0x84: v84(0x9e) = CONST 
    ...
    0x174: SSTORE vcf3(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc), v326V354V11
    0x175: JUMP v9f(0xa9)
    ...
    0x179S0xb2: v179Vb2(0xcbd) = CONST 
    ...
    prev=[0x2e6B0x2c6B0x176B0xb2], succ=[0xce3B0x2c6B0x176B0xb2]
    =================================
    0x2f2S0x2c6S0x176S0xb2: v2f2V2c6V176Vb2(0xce3) = CONST 
    0x2f6S0x2c6S0x176S0xb2: JUMP v2f2V2c6V176Vb2(0xce3)

    Begin block 0xce3B0x2c6B0x176B0xb2
    prev=[0x2f0B0x2c6B0x176B0xb2], succ=[0x2d9B0x176B0xb2]
    =================================
    0xce9S0x2c6S0x176S0xb2: JUMP v2cdV176Vb2(0x2d9)

    Begin block 0x2d9B0x176B0xb2
    prev=[0xce3B0x2c6B0x176B0xb2], succ=[0xcbdB0xb2]
    =================================
    0x2e2S0x176S0xb2: JUMP v179Vb2(0xcbd)

    Begin block 0xcbdB0xb2
    prev=[0x2d9B0x176B0xb2], succ=[0xc8]
    =================================
    0xcc3S0xb2: JUMP vb2(0xc8)

    Begin block 0xc8
    prev=[0xcbdB0xb2], succ=[0xca]
    =================================
