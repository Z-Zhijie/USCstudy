function __function_selector__() public {
    ...
    0x8: v8(0x8dc) = CONST 
    0xb: vb = CODESIZE 
    0xc: vc = SUB vb, v8(0x8dc)
    0xe: ve(0x8dc) = CONST 
    0x12: CODECOPY v7, ve(0x8dc), vc
    0x15: v15 = ADD vc, v7
    0x16: v16(0x40) = CONST 
    ...
    0x1ca: v1ca(0x3b4) = CONST 
    0x1cd: v1cd(0x255000003b4) = OR v1ca(0x3b4), v1c9(0x25500000000)
    0x1ce: v1ce(0x20) = CONST 
    0x1d0: v1d0(0x255) = SHR v1ce(0x20), v1cd(0x255000003b4)
    0x1d1: JUMP v1d0(0x255)

    Begin block 0x255
    prev=[0x1bf], succ=[0x1d2]
    =================================
    0x256: v256 = EXTCODESIZE v28
    ...
    0x1f0: v1f0(0x36) = CONST 
    0x1f3: MSTORE v1ea, v1f0(0x36)
    0x1f4: v1f4(0x20) = CONST 
    0x1f6: v1f6 = ADD v1f4(0x20), v1ea
    0x1f8: v1f8(0x8a6) = CONST 
    0x1fb: v1fb(0x36) = CONST 
    0x1fe: CODECOPY v1f6, v1f8(0x8a6), v1fb(0x36)
    ...
    0x22f: SSTORE v20e(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc), v28
    0x230: JUMP ve6(0xee)
    ...
    0x101: v101 = AND v100(0xffffffffffffffffffffffffffffffffffffffff), v28
    ...
    0x253: SSTORE v232(0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103), v2d
    ...
    prev=[0x1b7], succ=[]
    =================================
    0x25c: v25c(0x63c) = CONST 
    0x260: v260(0x26a) = CONST 
    0x263: v263(0x0) = CONST 
    0x265: CODECOPY v263(0x0), v260(0x26a), v25c(0x63c)
    0x266: v266(0x0) = CONST 
    0x268: RETURN v266(0x0), v25c(0x63c)
