function __function_selector__() public {
    ...
    0x8: v8(0xcb7) = CONST 
    0xb: vb = CODESIZE 
    0xc: vc = SUB vb, v8(0xcb7)
    0xe: ve(0xcb7) = CONST 
    0x12: CODECOPY v7, ve(0xcb7), vc
    0x15: v15 = ADD vc, v7
    0x16: v16(0x40) = CONST 
    ...
    Begin block 0x385
    prev=[0x2bf], succ=[0x2d2]
    =================================
    0x386: v386(0x0) = CONST 
    0x38a: v38a = EXTCODESIZE v2c
    0x38d: v38d(0x0) = CONST 
    0x390: v390 = GT v38a, v38d(0x0)
    0x397: JUMP v2c0(0x2d2)

    Begin block 0x2d2
    prev=[0x385], succ=[0x2d7, 0x327]
    =================================
    0x2d3: v2d3(0x327) = CONST 
    0x2d6: JUMPI v2d3(0x327), v390
    ...
    0x312: v312(0xc7c) = CONST 
    0x315: v315(0x3b) = CONST 
    0x318: CODECOPY v310, v312(0xc7c), v315(0x3b)
    ...
    =================================
    0x2bb: v2bb(0x398) = CONST 
    0x2be: JUMP v2bb(0x398)

    Begin block 0x398
    prev=[0x2b7], succ=[]
    =================================
    0x399: v399(0x8d5) = CONST 
    0x39d: v39d(0x3a7) = CONST 
    0x3a0: v3a0(0x0) = CONST 
    0x3a2: CODECOPY v3a0(0x0), v39d(0x3a7), v399(0x8d5)
    0x3a3: v3a3(0x0) = CONST 
    0x3a5: RETURN v3a3(0x0), v399(0x8d5)
