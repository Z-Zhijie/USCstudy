function __function_selector__() public {
    ...
    0x16: v16(0x647e) = CONST 
    0x1a: v1a = CODESIZE 
    0x1b: v1b = SUB v1a, v16(0x647e)
    0x1d: v1d(0x647e) = CONST 
    0x22: CODECOPY v15, v1d(0x647e), v1b
    ...
    0x2beS0x11: v2beV11(0x65c1) = CONST 
    0x2c3S0x11: v2c3V11(0x23a) = CONST 
    0x2c7S0x11: JUMP v2c3V11(0x23a), v2baV11, v2beV11(0x65c1)
    ...
    prev=[0x23aB0x2b5B0x11], succ=[0x65c1B0x11]
    =================================
    0x251S0x2b5S0x11: JUMP v2beV11(0x65c1)

    Begin block 0x65c1B0x11
    prev=[0x24fB0x2b5B0x11], succ=[0x34]
    =================================
    0x65ceS0x11: JUMP v2a(0x34)

    Begin block 0x34
    prev=[0x65c1B0x11], succ=[0x4f, 0x67]
    =================================
    ...
    0x359: v359(0x5fff) = CONST 
    0x35c: v35c(0x47f) = CONST 
    0x360: v360(0x0) = CONST 
    0x361: CODECOPY v360(0x0), v35c(0x47f), v359(0x5fff)
    0x362: v362(0x0) = CONST 
    0x365: v365(0x2047) = CONST 
    0x368: v368(0x2047) = ADD v365(0x2047), v362(0x0)
    0x369: MSTORE v368(0x2047), v358
    0x36c: v36c(0x21af) = CONST 
    0x36f: v36f(0x21af) = ADD v36c(0x21af), v362(0x0)
    0x370: MSTORE v36f(0x21af), v358
    0x373: v373(0x2471) = CONST 
    0x376: v376(0x2471) = ADD v373(0x2471), v362(0x0)
    0x377: MSTORE v376(0x2471), v358
    0x378: v378(0x2825) = CONST 
    0x37b: v37b(0x2825) = ADD v378(0x2825), v362(0x0)
    0x37c: MSTORE v37b(0x2825), v358
    ...
    0x395: v395(0xfc8) = CONST 
    0x398: v398(0xfc8) = ADD v395(0xfc8), v37d(0x0)
    0x399: MSTORE v398(0xfc8), v354
    0x39c: v39c(0x1052) = CONST 
    0x39f: v39f(0x1052) = ADD v39c(0x1052), v37d(0x0)
    0x3a0: MSTORE v39f(0x1052), v354
    0x3a3: v3a3(0x14d6) = CONST 
    0x3a6: v3a6(0x14d6) = ADD v3a3(0x14d6), v37d(0x0)
    0x3a7: MSTORE v3a6(0x14d6), v354
    0x3aa: v3aa(0x309e) = CONST 
    0x3ad: v3ad(0x309e) = ADD v3aa(0x309e), v37d(0x0)
    0x3ae: MSTORE v3ad(0x309e), v354
    0x3b1: v3b1(0x3198) = CONST 
    0x3b4: v3b4(0x3198) = ADD v3b1(0x3198), v37d(0x0)
    0x3b5: MSTORE v3b4(0x3198), v354
    0x3b8: v3b8(0x3489) = CONST 
    0x3bb: v3bb(0x3489) = ADD v3b8(0x3489), v37d(0x0)
    0x3bc: MSTORE v3bb(0x3489), v354
    0x3bf: v3bf(0x34c5) = CONST 
    0x3c2: v3c2(0x34c5) = ADD v3bf(0x34c5), v37d(0x0)
    0x3c3: MSTORE v3c2(0x34c5), v354
    0x3c6: v3c6(0x3588) = CONST 
    0x3c9: v3c9(0x3588) = ADD v3c6(0x3588), v37d(0x0)
    0x3ca: MSTORE v3c9(0x3588), v354
    0x3cd: v3cd(0x3633) = CONST 
    0x3d0: v3d0(0x3633) = ADD v3cd(0x3633), v37d(0x0)
    0x3d1: MSTORE v3d0(0x3633), v354
    0x3d4: v3d4(0x3f88) = CONST 
    0x3d7: v3d7(0x3f88) = ADD v3d4(0x3f88), v37d(0x0)
    0x3d8: MSTORE v3d7(0x3f88), v354
    0x3db: v3db(0x407c) = CONST 
    0x3de: v3de(0x407c) = ADD v3db(0x407c), v37d(0x0)
    0x3df: MSTORE v3de(0x407c), v354
    0x3e2: v3e2(0x4106) = CONST 
    0x3e5: v3e5(0x4106) = ADD v3e2(0x4106), v37d(0x0)
    0x3e6: MSTORE v3e5(0x4106), v354
    0x3e9: v3e9(0x427b) = CONST 
    0x3ec: v3ec(0x427b) = ADD v3e9(0x427b), v37d(0x0)
    0x3ed: MSTORE v3ec(0x427b), v354
    0x3ee: v3ee(0x4429) = CONST 
    0x3f1: v3f1(0x4429) = ADD v3ee(0x4429), v37d(0x0)
    0x3f2: MSTORE v3f1(0x4429), v354
    0x3f3: v3f3(0x0) = CONST 
    0x3f6: v3f6(0x2f5) = CONST 
    0x3f9: v3f9(0x2f5) = ADD v3f6(0x2f5), v3f3(0x0)
    0x3fa: MSTORE v3f9(0x2f5), v350
    0x3fb: v3fb(0x2335) = CONST 
    0x3fe: v3fe(0x2335) = ADD v3fb(0x2335), v3f3(0x0)
    0x3ff: MSTORE v3fe(0x2335), v350
    0x400: v400(0x0) = CONST 
    0x401: v401(0x228b) = CONST 
    0x404: v404(0x228b) = ADD v401(0x228b), v400(0x0)
    0x405: MSTORE v404(0x228b), v34c(0x1f4)
    0x406: v406(0x0) = CONST 
    0x407: v407(0x22b4) = CONST 
    0x40a: v40a(0x22b4) = ADD v407(0x22b4), v406(0x0)
    0x40b: MSTORE v40a(0x22b4), v348
    ...
    0x41d: v41d(0x1aa2) = CONST 
    0x420: v420(0x1aa2) = ADD v41d(0x1aa2), v40c(0x0)
    0x421: MSTORE v420(0x1aa2), v345
    0x424: v424(0x1bb0) = CONST 
    0x427: v427(0x1bb0) = ADD v424(0x1bb0), v40c(0x0)
    0x428: MSTORE v427(0x1bb0), v345
    0x42b: v42b(0x1c79) = CONST 
    0x42e: v42e(0x1c79) = ADD v42b(0x1c79), v40c(0x0)
    0x42f: MSTORE v42e(0x1c79), v345
    0x432: v432(0x26ee) = CONST 
    0x435: v435(0x26ee) = ADD v432(0x26ee), v40c(0x0)
    0x436: MSTORE v435(0x26ee), v345
    0x439: v439(0x2c63) = CONST 
    0x43c: v43c(0x2c63) = ADD v439(0x2c63), v40c(0x0)
    0x43d: MSTORE v43c(0x2c63), v345
    0x440: v440(0x3cbc) = CONST 
    0x443: v443(0x3cbc) = ADD v440(0x3cbc), v40c(0x0)
    0x444: MSTORE v443(0x3cbc), v345
    0x447: v447(0x3d90) = CONST 
    0x44a: v44a(0x3d90) = ADD v447(0x3d90), v40c(0x0)
    0x44b: MSTORE v44a(0x3d90), v345
    0x44e: v44e(0x3e3d) = CONST 
    0x451: v451(0x3e3d) = ADD v44e(0x3e3d), v40c(0x0)
    0x452: MSTORE v451(0x3e3d), v345
    0x453: v453(0x4b94) = CONST 
    0x456: v456(0x4b94) = ADD v453(0x4b94), v40c(0x0)
    0x457: MSTORE v456(0x4b94), v345
    0x458: v458(0x0) = CONST 
    0x45b: v45b(0x5fe) = CONST 
    0x45e: v45e(0x5fe) = ADD v45b(0x5fe), v458(0x0)
    0x45f: MSTORE v45e(0x5fe), v342
    0x460: v460(0x3f04) = CONST 
    0x463: v463(0x3f04) = ADD v460(0x3f04), v458(0x0)
    0x464: MSTORE v463(0x3f04), v342
    0x465: v465(0x0) = CONST 
    0x468: v468(0x933) = CONST 
    0x46b: v46b(0x933) = ADD v468(0x933), v465(0x0)
    0x46c: MSTORE v46b(0x933), v33f
    0x46f: v46f(0x3cf5) = CONST 
    0x472: v472(0x3cf5) = ADD v46f(0x3cf5), v465(0x0)
    0x473: MSTORE v472(0x3cf5), v33f
    0x474: v474(0x5191) = CONST 
    0x477: v477(0x5191) = ADD v474(0x5191), v465(0x0)
    0x478: MSTORE v477(0x5191), v33f
    0x479: v479(0x5fff) = CONST 
    0x47c: v47c(0x0) = CONST 
    0x47d: RETURN v47c(0x0), v479(0x5fff)
    ...
    prev=[0xfb], succ=[0x317B0xfb, 0x65eeB0xfb]
    =================================
    ...
    0x312S0xfb: v312Vfb(0x65ee) = CONST 
    0x316S0xfb: JUMPI v312Vfb(0x65ee), v311Vfb

    Begin block 0x317B0xfb
    prev=[0x30aB0xfb], succ=[0x655bB0xfb]
    =================================
    0x317S0xfb: v317Vfb(0x6613) = CONST 
    0x31bS0xfb: v31bVfb(0x655b) = CONST 
    0x31fS0xfb: JUMP v31bVfb(0x655b)

    Begin block 0x655bB0xfb
    prev=[0x317B0xfb], succ=[]
    =================================
    0x655cS0xfb: v655cVfb(0x4e487b71) = CONST 
    0x6561S0xfb: v6561Vfb(0xe0) = CONST 
    0x6563S0xfb: v6563Vfb(0x4e487b7100000000000000000000000000000000000000000000000000000000) = SHL v6561Vfb(0xe0), v655cVfb(0x4e487b71)
    0x6564S0xfb: v6564Vfb(0x0) = CONST 
    0x6565S0xfb: MSTORE v6564Vfb(0x0), v6563Vfb(0x4e487b7100000000000000000000000000000000000000000000000000000000)
    0x6566S0xfb: v6566Vfb(0x11) = CONST 
    0x6568S0xfb: v6568Vfb(0x4) = CONST 
    0x656aS0xfb: MSTORE v6568Vfb(0x4), v6566Vfb(0x11)
    0x656bS0xfb: v656bVfb(0x24) = CONST 
    0x656dS0xfb: v656dVfb(0x0) = CONST 
    0x656eS0xfb: REVERT v656dVfb(0x0), v656bVfb(0x24)

    Begin block 0x65eeB0xfb
    prev=[0x30aB0xfb], succ=[0x10b]
    =================================
    0x65f3S0xfb: JUMP vfc(0x10b)

    Begin block 0x10b
    prev=[0x65eeB0xfb], succ=[0x2eaB0x10b]
    =================================
    ...
    prev=[0x129], succ=[0x333B0x129, 0x6638B0x129]
    =================================
    ...
    0x32eS0x129: v32eV129(0x6638) = CONST 
    0x332S0x129: JUMPI v32eV129(0x6638), v32dV129

    Begin block 0x333B0x129
    prev=[0x326B0x129], succ=[0x658eB0x129]
    =================================
    0x333S0x129: v333V129(0x665d) = CONST 
    0x337S0x129: v337V129(0x658e) = CONST 
    0x33bS0x129: JUMP v337V129(0x658e)

    Begin block 0x658eB0x129
    prev=[0x333B0x129], succ=[]
    =================================
    0x658fS0x129: v658fV129(0x4e487b71) = CONST 
    0x6594S0x129: v6594V129(0xe0) = CONST 
    0x6596S0x129: v6596V129(0x4e487b7100000000000000000000000000000000000000000000000000000000) = SHL v6594V129(0xe0), v658fV129(0x4e487b71)
    0x6597S0x129: v6597V129(0x0) = CONST 
    0x6598S0x129: MSTORE v6597V129(0x0), v6596V129(0x4e487b7100000000000000000000000000000000000000000000000000000000)
    0x6599S0x129: v6599V129(0x11) = CONST 
    0x659bS0x129: v659bV129(0x4) = CONST 
    0x659dS0x129: MSTORE v659bV129(0x4), v6599V129(0x11)
    0x659eS0x129: v659eV129(0x24) = CONST 
    0x65a0S0x129: v65a0V129(0x0) = CONST 
    0x65a1S0x129: REVERT v65a0V129(0x0), v659eV129(0x24)

    Begin block 0x6638B0x129
    prev=[0x326B0x129], succ=[0x139]
    =================================
    0x663dS0x129: JUMP v12a(0x139)

    Begin block 0x139
    prev=[0x6638B0x129], succ=[0x13c]
    =================================
