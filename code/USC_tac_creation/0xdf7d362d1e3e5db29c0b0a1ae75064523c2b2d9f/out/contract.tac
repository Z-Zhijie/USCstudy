function __function_selector__() public {
    ...
    0x8: v8(0x8ad) = CONST 
    0xb: vb = CODESIZE 
    0xc: vc = SUB vb, v8(0x8ad)
    0xe: ve(0x8ad) = CONST 
    0x12: CODECOPY v7, ve(0x8ad), vc
    0x15: v15 = ADD vc, v7
    0x16: v16(0x40) = CONST 
    ...
    0x1ca: v1ca(0x421) = CONST 
    0x1cd: v1cd(0x25500000421) = OR v1ca(0x421), v1c9(0x25500000000)
    0x1ce: v1ce(0x20) = CONST 
    0x1d0: v1d0(0x255) = SHR v1ce(0x20), v1cd(0x25500000421)
    ...
    0x1f8: v1f8(0x872) = CONST 
    0x1fb: v1fb(0x3b) = CONST 
    0x1fe: CODECOPY v1f6, v1f8(0x872), v1fb(0x3b)
    ...
    prev=[0x1b7], succ=[]
    =================================
    0x25c: v25c(0x608) = CONST 
    0x260: v260(0x26a) = CONST 
    0x263: v263(0x0) = CONST 
    0x265: CODECOPY v263(0x0), v260(0x26a), v25c(0x608)
    0x266: v266(0x0) = CONST 
    0x268: RETURN v266(0x0), v25c(0x608)
