function __function_selector__() public {
    ...
    0x15: v15(0xa1c) = CONST 
    0x18: v18 = CODESIZE 
    0x19: v19 = SUB v18, v15(0xa1c)
    0x1b: v1b(0xa1c) = CONST 
    0x1f: CODECOPY v14, v1b(0xa1c), v19
    ...
    0x104: v104(0x2cd) = CONST 
    0x107: v107(0x197000002cd) = OR v104(0x2cd), v103(0x19700000000)
    0x108: v108(0x20) = CONST 
    0x10a: v10a(0x197) = SHR v108(0x20), v107(0x197000002cd)
    ...
    0x132: v132(0x9c0) = CONST 
    0x135: v135(0x36) = CONST 
    0x138: CODECOPY v130, v132(0x9c0), v135(0x36)
    ...
    0xe7: ve7(0x2a1) = CONST 
    0xea: vea(0x16b000002a1) = OR ve7(0x2a1), ve6(0x16b00000000)
    0xeb: veb(0x20) = CONST 
    0xed: ved(0x16b) = SHR veb(0x20), vea(0x16b000002a1)
    0xee: JUMP ved(0x16b)
    ...
    0x16eS0xdc: v16eVdc(0xa57) = CONST 
    ...
    0x185S0xdc: v185Vdc(0x999) = CONST 
    0x188S0xdc: v188Vdc(0x27) = CONST 
    0x18bS0xdc: CODECOPY v184Vdc, v185Vdc(0x999), v188Vdc(0x27)
    ...
    0x1ceS0x16bS0xdc: v1ceV16bVdc(0x9f6) = CONST 
    0x1d1S0x16bS0xdc: v1d1V16bVdc(0x26) = CONST 
    0x1d4S0x16bS0xdc: CODECOPY v1ccV16bVdc, v1ceV16bVdc(0x9f6), v1d1V16bVdc(0x26)
    ...
    prev=[0x2a1B0x286B0x16bB0xdc], succ=[0xa7dB0x286B0x16bB0xdc]
    =================================
    0x2acS0x286S0x16bS0xdc: v2acV286V16bVdc(0xa7d) = CONST 
    0x2afS0x286S0x16bS0xdc: JUMP v2acV286V16bVdc(0xa7d)

    Begin block 0xa7dB0x286B0x16bB0xdc
    prev=[0x2aaB0x286B0x16bB0xdc], succ=[0x297B0x16bB0xdc]
    =================================
    0xa83S0x286S0x16bS0xdc: JUMP v28dV16bVdc(0x297)

    Begin block 0x297B0x16bB0xdc
    prev=[0xa7dB0x286B0x16bB0xdc], succ=[0xa57B0xdc]
    =================================
    0x2a0S0x16bS0xdc: JUMP v16eVdc(0xa57)

    Begin block 0xa57B0xdc
    prev=[0x297B0x16bB0xdc], succ=[0xef]
    =================================
    0xa5dS0xdc: JUMP vdc(0xef)

    Begin block 0xef
    prev=[0xa57B0xdc], succ=[0xf1]
    =================================
    ...
    prev=[0xf1], succ=[]
    =================================
    0x346: v346(0x645) = CONST 
    0x34a: v34a(0x354) = CONST 
    0x34d: v34d(0x0) = CONST 
    0x34f: CODECOPY v34d(0x0), v34a(0x354), v346(0x645)
    0x350: v350(0x0) = CONST 
    0x352: RETURN v350(0x0), v346(0x645)
