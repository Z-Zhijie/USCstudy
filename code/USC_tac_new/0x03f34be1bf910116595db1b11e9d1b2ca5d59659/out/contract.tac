function __function_selector__() public {
    ...
    Begin block 0x1e
    prev=[0xd], succ=[0x8ad, 0x29]
    =================================
    0x1f: v1f(0x5c60da1b) = CONST 
    0x24: v24 = EQ v1f(0x5c60da1b), v12
    0x89a: v89a(0x8ad) = CONST 
    0x89b: JUMPI v89a(0x8ad), v24

    Begin block 0x8ad
    prev=[0x1e], succ=[]
    =================================
    0x8ae: v8ae(0x128) = CONST 
    0x8af: CALLPRIVATE v8ae(0x128)

    Begin block 0x29
    prev=[0x1e], succ=[0x8b0, 0x34]
    =================================
    0x2a: v2a(0x8f283970) = CONST 
    0x2f: v2f = EQ v2a(0x8f283970), v12
    0x89c: v89c(0x8b0) = CONST 
    0x89d: JUMPI v89c(0x8b0), v2f

    Begin block 0x8b0
    prev=[0x29], succ=[]
    =================================
    0x8b1: v8b1(0x159) = CONST 
    0x8b2: CALLPRIVATE v8b1(0x159)

    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0x8b3]
    =================================
    0x35: v35(0xf851a440) = CONST 
    0x3a: v3a = EQ v35(0xf851a440), v12
    0x89e: v89e(0x8b3) = CONST 
    0x89f: JUMPI v89e(0x8b3), v3a
    ...
    prev=[0x34], succ=[]
    =================================
    0x8b4: v8b4(0x18c) = CONST 
    0x8b5: CALLPRIVATE v8b4(0x18c)

    Begin block 0x5e
    prev=[0x0], succ=[0x8a4, 0x6d]
    =================================
    ...
    prev=[0x5e], succ=[]
    =================================
    0x8a4: v8a4(0x8a6) = CONST 
    0x8a5: CALLPRIVATE v8a4(0x8a6)
...
function implementation()() public {
    ...
    Begin block 0x134
    prev=[0x128], succ=[0x6ef]
    =================================
    0x136: v136(0x6ef) = CONST 
    0x139: v139(0x2a2) = CONST 
    0x13c: v13c_0 = CALLPRIVATE v139(0x2a2), v136(0x6ef)
    ...
    0x6fe: v6fe = AND v13c_0, v6fb(0xffffffffffffffffffffffffffffffffffffffff)
    0x700: MSTORE v6f3, v6fe
    0x701: v701 = MLOAD v6f0(0x40)
    0x705: v705(0x0) = SUB v6f3, v701
    0x706: v706(0x20) = CONST 
    0x708: v708(0x20) = ADD v706(0x20), v705(0x0)
    0x70a: RETURN v701, v708(0x20)
...
function changeAdmin(address)() public {
    ...
    prev=[0x4d8], succ=[0x7a70x159]
    =================================
    0x1e60x159: v1591e6(0x7a7) = CONST 
    0x1e90x159: JUMP v1591e6(0x7a7)

    Begin block 0x7a70x159
    prev=[0x1e50x159], succ=[0x72a]
    =================================
    0x7a90x159: JUMP v167(0x72a)

    Begin block 0x72a
    prev=[0x7a70x159], succ=[]
    =================================
    0x72b: STOP 
    ...
    =================================
    0x1eb0x159: v1591eb(0x7c9) = CONST 
    ...
    =================================
    0x1aa0x159: v1591aa(0x786) = CONST 
...
function admin()() public {
    ...
    Begin block 0x198
    prev=[0x18c], succ=[0x74b]
    =================================
    0x19a: v19a(0x74b) = CONST 
    0x19d: v19d(0x399) = CONST 
    0x1a0: v1a0_0 = CALLPRIVATE v19d(0x399), v19a(0x74b)
    ...
    0x75a: v75a = AND v1a0_0, v757(0xffffffffffffffffffffffffffffffffffffffff)
...
function 0x2a2(0x2a2arg0x0) private {
    ...
    prev=[0x42aB0x2c6], succ=[0x8330x2a2]
    =================================
    0x2d00x2a2: v2a22d0(0x833) = CONST 
    0x2d30x2a2: JUMP v2a22d0(0x833)

    Begin block 0x8330x2a2
    prev=[0x2cd0x2a2], succ=[]
    =================================
    0x8350x2a2: RETURNPRIVATE v2a2arg0, v44cV2c6

    Begin block 0x2d40x2a2
    prev=[0x2ac], succ=[0x1a10x2a2]
    =================================
    0x2d50x2a2: v2a22d5(0x855) = CONST 
    ...
    =================================
    0x1aa0x2a2: v2a21aa(0x786) = CONST 
...
function 0x399(0x399arg0x0) private {
    ...
    prev=[0x473B0x3bd], succ=[0x8330x399]
    =================================
    0x2d00x399: v3992d0(0x833) = CONST 
    0x2d30x399: JUMP v3992d0(0x833)

    Begin block 0x8330x399
    prev=[0x2cd0x399], succ=[]
    =================================
    0x8350x399: RETURNPRIVATE v399arg0, v495V3bd

    Begin block 0x2d40x399
    prev=[0x3a3], succ=[0x1a10x399]
    =================================
    0x2d50x399: v3992d5(0x855) = CONST 
    ...
    =================================
    0x1aa0x399: v3991aa(0x786) = CONST 
...
function 0x3ca(0x3caarg0x0) private {
    ...
    Begin block 0x422
    prev=[0x3d2], succ=[0x898B0x422]
    =================================
    0x423: v423(0x877) = CONST 
    0x426: v426(0x898) = CONST 
    0x429: JUMP v426(0x898), v423(0x877)

    Begin block 0x898B0x422
    prev=[0x422], succ=[0x877]
    =================================
    0x899S0x422: JUMP v423(0x877)

    Begin block 0x877
    prev=[0x898B0x422], succ=[]
    =================================
    0x878: RETURNPRIVATE v3caarg0
...
function upgradeTo(address)() public {
    ...
    prev=[0x1dd], succ=[0x7a70x75]
    =================================
    0x1e60x75: v751e6(0x7a7) = CONST 
    0x1e90x75: JUMP v751e6(0x7a7)

    Begin block 0x7a70x75
    prev=[0x1e50x75], succ=[0x6ad]
    =================================
    0x7a90x75: JUMP v83(0x6ad)
...
function fallback()() public {
    Begin block 0x8a6
    prev=[], succ=[0x1a10x8a6]
    =================================
    0x64: v64(0x66b) = CONST 
    0x67: v67(0x1a1) = CONST 
    0x6a: JUMP v67(0x1a1)

    Begin block 0x1a10x8a6
    prev=[0x8a6], succ=[0x1a90x8a6]
    =================================
    0x1a20x8a6: v8a61a2(0x1a9) = CONST 
    0x1a50x8a6: v8a61a5(0x3ca) = CONST 
    0x1a80x8a6: CALLPRIVATE v8a61a5(0x3ca), v8a61a2(0x1a9)

    Begin block 0x1a90x8a6
    prev=[0x1a10x8a6], succ=[0x42aB0x1a90x8a6]
    =================================
    0x1aa0x8a6: v8a61aa(0x786) = CONST 
    0x1ad0x8a6: v8a61ad(0x1b4) = CONST 
    0x1b00x8a6: v8a61b0(0x42a) = CONST 
    0x1b30x8a6: JUMP v8a61b0(0x42a)

    Begin block 0x42aB0x1a90x8a6
    prev=[0x1a90x8a6], succ=[0x1b40x8a6]
    =================================
    0x42bS0x1a90x8a6: v42bV1a98a6(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc) = CONST 
    0x44cS0x1a90x8a6: v44cV1a98a6 = SLOAD v42bV1a98a6(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc)
    0x44eS0x1a90x8a6: JUMP v8a61ad(0x1b4)

    Begin block 0x1b40x8a6
    prev=[0x42aB0x1a90x8a6], succ=[0x44f0x8a6]
    =================================
    0x1b50x8a6: v8a61b5(0x44f) = CONST 
    0x1b80x8a6: JUMP v8a61b5(0x44f)

    Begin block 0x44f0x8a6
    prev=[0x1b40x8a6], succ=[0x46a0x8a6, 0x46e0x8a6]
    =================================
    0x4500x8a6: v8a6450 = CALLDATASIZE 
    0x4510x8a6: v8a6451(0x0) = CONST 
    0x4540x8a6: CALLDATACOPY v8a6451(0x0), v8a6451(0x0), v8a6450
    0x4550x8a6: v8a6455(0x0) = CONST 
    0x4580x8a6: v8a6458 = CALLDATASIZE 
    0x4590x8a6: v8a6459(0x0) = CONST 
    0x45c0x8a6: v8a645c = GAS 
    0x45d0x8a6: v8a645d = DELEGATECALL v8a645c, v44cV1a98a6, v8a6459(0x0), v8a6458, v8a6455(0x0), v8a6455(0x0)
    0x45e0x8a6: v8a645e = RETURNDATASIZE 
    0x45f0x8a6: v8a645f(0x0) = CONST 
    0x4620x8a6: RETURNDATACOPY v8a645f(0x0), v8a645f(0x0), v8a645e
    0x4650x8a6: v8a6465 = ISZERO v8a645d
    0x4660x8a6: v8a6466(0x46e) = CONST 
    0x4690x8a6: JUMPI v8a6466(0x46e), v8a6465

    Begin block 0x46a0x8a6
    prev=[0x44f0x8a6], succ=[]
    =================================
    0x46a0x8a6: v8a646a = RETURNDATASIZE 
    0x46b0x8a6: v8a646b(0x0) = CONST 
    0x46d0x8a6: RETURN v8a646b(0x0), v8a646a

    Begin block 0x46e0x8a6
    prev=[0x44f0x8a6], succ=[]
    =================================
    0x46f0x8a6: v8a646f = RETURNDATASIZE 
    0x4700x8a6: v8a6470(0x0) = CONST 
    0x4720x8a6: REVERT v8a6470(0x0), v8a646f
...
function upgradeToAndCall(address,bytes)() public {
    ...
    Begin block 0x28f
    prev=[0x281], succ=[0x7eb]
    =================================
    0x291: v291(0x7eb) = CONST 
    0x294: JUMP v291(0x7eb)

    Begin block 0x7eb
    prev=[0x28f], succ=[0x6ce]
    =================================
    0x7ef: JUMP va9(0x6ce)
