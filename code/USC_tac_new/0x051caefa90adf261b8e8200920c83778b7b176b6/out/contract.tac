function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0xd49: vd49(0xd5d) = CONST 
    0xd4a: JUMPI vd49(0xd5d), v8
    ...
    Begin block 0x59
    prev=[0xd], succ=[0xd60, 0x65]
    =================================
    0x5b: v5b(0xc340a24) = CONST 
    0x60: v60 = EQ v5b(0xc340a24), v12
    0xd55: vd55(0xd60) = CONST 
    0xd56: JUMPI vd55(0xd60), v60

    Begin block 0xd60
    prev=[0x59], succ=[]
    =================================
    0xd61: vd61(0x90) = CONST 
    0xd62: CALLPRIVATE vd61(0x90)

    Begin block 0x65
    prev=[0x59], succ=[0xd63, 0x70]
    =================================
    0x66: v66(0x3659cfe6) = CONST 
    0x6b: v6b = EQ v66(0x3659cfe6), v12
    0xd57: vd57(0xd63) = CONST 
    0xd58: JUMPI vd57(0xd63), v6b

    Begin block 0xd63
    prev=[0x65], succ=[]
    =================================
    0xd64: vd64(0xe7) = CONST 
    0xd65: CALLPRIVATE vd64(0xe7)

    Begin block 0x70
    prev=[0x65], succ=[0xd66, 0x7b]
    =================================
    0x71: v71(0x4f1ef286) = CONST 
    0x76: v76 = EQ v71(0x4f1ef286), v12
    0xd59: vd59(0xd66) = CONST 
    0xd5a: JUMPI vd59(0xd66), v76

    Begin block 0xd66
    prev=[0x70], succ=[]
    =================================
    0xd67: vd67(0x138) = CONST 
    0xd68: CALLPRIVATE vd67(0x138)

    Begin block 0x7b
    prev=[0x70], succ=[0xd5d, 0xd69]
    =================================
    0x7c: v7c(0x5c60da1b) = CONST 
    0x81: v81 = EQ v7c(0x5c60da1b), v12
    0xd5b: vd5b(0xd69) = CONST 
    0xd5c: JUMPI vd5b(0xd69), v81

    Begin block 0xd5d
    prev=[0x0, 0x7b], succ=[]
    =================================
    0xd5e: vd5e(0x86) = CONST 
    0xd5f: CALLPRIVATE vd5e(0x86)

    Begin block 0xd69
    prev=[0x7b], succ=[]
    =================================
    0xd6a: vd6a(0x1d1) = CONST 
    0xd6b: CALLPRIVATE vd6a(0x1d1)

    Begin block 0x1e
    prev=[0xd], succ=[0xd6c, 0x29]
    =================================
    0x1f: v1f(0x5d36b190) = CONST 
    0x24: v24 = EQ v1f(0x5d36b190), v12
    0xd4b: vd4b(0xd6c) = CONST 
    0xd4c: JUMPI vd4b(0xd6c), v24

    Begin block 0xd6c
    prev=[0x1e], succ=[]
    =================================
    0xd6d: vd6d(0x228) = CONST 
    0xd6e: CALLPRIVATE vd6d(0x228)

    Begin block 0x29
    prev=[0x1e], succ=[0xd6f, 0x34]
    =================================
    0x2a: v2a(0xc7af3352) = CONST 
    0x2f: v2f = EQ v2a(0xc7af3352), v12
    0xd4d: vd4d(0xd6f) = CONST 
    0xd4e: JUMPI vd4d(0xd6f), v2f

    Begin block 0xd6f
    prev=[0x29], succ=[]
    =================================
    0xd70: vd70(0x23f) = CONST 
    0xd71: CALLPRIVATE vd70(0x23f)

    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0xd72]
    =================================
    0x35: v35(0xcf7a1d77) = CONST 
    0x3a: v3a = EQ v35(0xcf7a1d77), v12
    0xd4f: vd4f(0xd72) = CONST 
    0xd50: JUMPI vd4f(0xd72), v3a

    Begin block 0x3f
    prev=[0x34], succ=[0xd75, 0x4a]
    =================================
    0x40: v40(0xd38bfff4) = CONST 
    0x45: v45 = EQ v40(0xd38bfff4), v12
    0xd51: vd51(0xd75) = CONST 
    0xd52: JUMPI vd51(0xd75), v45

    Begin block 0xd75
    prev=[0x3f], succ=[]
    =================================
    0xd76: vd76(0x369) = CONST 
    0xd77: CALLPRIVATE vd76(0x369)

    Begin block 0x4a
    prev=[0x3f], succ=[0x55, 0xd78]
    =================================
    0x4b: v4b(0xf851a440) = CONST 
    0x50: v50 = EQ v4b(0xf851a440), v12
    0xd53: vd53(0xd78) = CONST 
    0xd54: JUMPI vd53(0xd78), v50
    ...
    prev=[0x4a], succ=[]
    =================================
    0xd79: vd79(0x3ba) = CONST 
    0xd7a: CALLPRIVATE vd79(0x3ba)

    Begin block 0xd72
    prev=[0x34], succ=[]
    =================================
    0xd73: vd73(0x26e) = CONST 
    0xd74: CALLPRIVATE vd73(0x26e)
