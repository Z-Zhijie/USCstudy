function __function_selector__() public {
    ...
    0xa39: va39(0xa48) = CONST 
    0xa3a: JUMPI va39(0xa48), v19

    Begin block 0xa48
    prev=[0xd], succ=[]
    =================================
    0xa49: va49(0x72) = CONST 
    0xa4a: CALLPRIVATE va49(0x72)

    Begin block 0x1e
    prev=[0xd], succ=[0xa4b, 0x29]
    =================================
    0x1f: v1f(0x5fe48394) = CONST 
    0x24: v24 = EQ v1f(0x5fe48394), v12
    0xa3b: va3b(0xa4b) = CONST 
    0xa3c: JUMPI va3b(0xa4b), v24

    Begin block 0xa4b
    prev=[0x1e], succ=[]
    =================================
    0xa4c: va4c(0x89) = CONST 
    0xa4d: CALLPRIVATE va4c(0x89)

    Begin block 0x29
    prev=[0x1e], succ=[0xa4e, 0x34]
    =================================
    0x2a: v2a(0x88b4b861) = CONST 
    0x2f: v2f = EQ v2a(0x88b4b861), v12
    0xa3d: va3d(0xa4e) = CONST 
    0xa3e: JUMPI va3d(0xa4e), v2f

    Begin block 0xa4e
    prev=[0x29], succ=[]
    =================================
    0xa4f: va4f(0x122) = CONST 
    0xa50: CALLPRIVATE va4f(0x122)

    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0xa51]
    =================================
    0x35: v35(0x8f283970) = CONST 
    0x3a: v3a = EQ v35(0x8f283970), v12
    0xa3f: va3f(0xa51) = CONST 
    0xa40: JUMPI va3f(0xa51), v3a

    Begin block 0x3f
    prev=[0x34], succ=[0xa54, 0x4a]
    =================================
    0x40: v40(0xd55ec697) = CONST 
    0x45: v45 = EQ v40(0xd55ec697), v12
    0xa41: va41(0xa54) = CONST 
    0xa42: JUMPI va41(0xa54), v45

    Begin block 0xa54
    prev=[0x3f], succ=[]
    =================================
    0xa55: va55(0x1c4) = CONST 
    0xa56: CALLPRIVATE va55(0x1c4)

    Begin block 0x4a
    prev=[0x3f], succ=[0x55, 0xa57]
    =================================
    0x4b: v4b(0xfddb1a23) = CONST 
    0x50: v50 = EQ v4b(0xfddb1a23), v12
    0xa43: va43(0xa57) = CONST 
    0xa44: JUMPI va43(0xa57), v50
    ...
    prev=[0x4a], succ=[]
    =================================
    0xa58: va58(0x1db) = CONST 
    0xa59: CALLPRIVATE va58(0x1db)

    Begin block 0xa51
    prev=[0x34], succ=[]
    =================================
    0xa52: va52(0x173) = CONST 
    0xa53: CALLPRIVATE va52(0x173)

    Begin block 0x59
    prev=[0x0], succ=[0xa45, 0x68]
    =================================
    ...
    prev=[0x59], succ=[]
    =================================
    0xa45: va45(0xa47) = CONST 
    0xa46: CALLPRIVATE va45(0xa47)
...
function fallback()() public {
    Begin block 0xa47
    prev=[], succ=[0x2160xa47]
    =================================
    0x5f: v5f(0x66) = CONST 
    0x62: v62(0x216) = CONST 
    0x65: JUMP v62(0x216)

    Begin block 0x2160xa47
    prev=[0xa47], succ=[0x7fcB0x2160xa47]
    =================================
    0x2170xa47: va47217(0x21e) = CONST 
    0x21a0xa47: va4721a(0x7fc) = CONST 
    0x21d0xa47: JUMP va4721a(0x7fc)

    Begin block 0x7fcB0x2160xa47
    prev=[0x2160xa47], succ=[0x21e0xa47]
    =================================
    0x7fdS0x2160xa47: v7fdV216a47(0x0) = CONST 
    0x7ffS0x2160xa47: v7ffV216a47(0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103) = CONST 
    0x820S0x2160xa47: v820V216a47 = SLOAD v7ffV216a47(0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103)
    0x824S0x2160xa47: JUMP va47217(0x21e)

    Begin block 0x21e0xa47
    prev=[0x7fcB0x2160xa47], succ=[0x2520xa47, 0x2560xa47]
    =================================
    0x21f0xa47: va4721f(0xffffffffffffffffffffffffffffffffffffffff) = CONST 
    0x2340xa47: va47234 = AND va4721f(0xffffffffffffffffffffffffffffffffffffffff), v820V216a47
    0x2350xa47: va47235 = CALLER 
    0x2360xa47: va47236(0xffffffffffffffffffffffffffffffffffffffff) = CONST 
    0x24b0xa47: va4724b = AND va47236(0xffffffffffffffffffffffffffffffffffffffff), va47235
    0x24c0xa47: va4724c = EQ va4724b, va47234
    0x24d0xa47: va4724d = ISZERO va4724c
    0x24e0xa47: va4724e(0x256) = CONST 
    0x2510xa47: JUMPI va4724e(0x256), va4724d

    Begin block 0x2520xa47
    prev=[0x21e0xa47], succ=[]
    =================================
    0x2520xa47: va47252(0x0) = CONST 
    0x2550xa47: REVERT va47252(0x0), va47252(0x0)

    Begin block 0x2560xa47
    prev=[0x21e0xa47], succ=[0x825B0x2560xa47]
    =================================
    0x2570xa47: va47257(0x266) = CONST 
    0x25a0xa47: va4725a(0x261) = CONST 
    0x25d0xa47: va4725d(0x825) = CONST 
    0x2600xa47: JUMP va4725d(0x825)

    Begin block 0x825B0x2560xa47
    prev=[0x2560xa47], succ=[0x2610xa47]
    =================================
    0x826S0x2560xa47: v826V256a47(0x0) = CONST 
    0x828S0x2560xa47: v828V256a47(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc) = CONST 
    0x849S0x2560xa47: v849V256a47 = SLOAD v828V256a47(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc)
    0x84dS0x2560xa47: JUMP va4725a(0x261)

    Begin block 0x2610xa47
    prev=[0x825B0x2560xa47], succ=[0x84e0xa47]
    =================================
    0x2620xa47: va47262(0x84e) = CONST 
    0x2650xa47: JUMP va47262(0x84e)

    Begin block 0x84e0xa47
    prev=[0x2610xa47], succ=[0x86b0xa47, 0x86f0xa47]
    =================================
    0x84f0xa47: va4784f = CALLDATASIZE 
    0x8500xa47: va47850(0x0) = CONST 
    0x8530xa47: CALLDATACOPY va47850(0x0), va47850(0x0), va4784f
    0x8540xa47: va47854(0x0) = CONST 
    0x8570xa47: va47857 = CALLDATASIZE 
    0x8580xa47: va47858(0x0) = CONST 
    0x85b0xa47: va4785b = GAS 
    0x85c0xa47: va4785c = DELEGATECALL va4785b, v849V256a47, va47858(0x0), va47857, va47854(0x0), va47854(0x0)
    0x85d0xa47: va4785d = RETURNDATASIZE 
    0x85e0xa47: va4785e(0x0) = CONST 
    0x8610xa47: RETURNDATACOPY va4785e(0x0), va4785e(0x0), va4785d
    0x8630xa47: va47863(0x0) = CONST 
    0x8660xa47: va47866 = EQ va4785c, va47863(0x0)
    0x8670xa47: va47867(0x86f) = CONST 
    0x86a0xa47: JUMPI va47867(0x86f), va47866

    Begin block 0x86b0xa47
    prev=[0x84e0xa47], succ=[]
    =================================
    0x86b0xa47: va4786b = RETURNDATASIZE 
    0x86c0xa47: va4786c(0x0) = CONST 
    0x86e0xa47: RETURN va4786c(0x0), va4786b

    Begin block 0x86f0xa47
    prev=[0x84e0xa47], succ=[]
    =================================
    0x8700xa47: va47870 = RETURNDATASIZE 
    0x8710xa47: va47871(0x0) = CONST 
    0x8730xa47: REVERT va47871(0x0), va47870
