function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0xd52: vd52(0xd66) = CONST 
    0xd53: JUMPI vd52(0xd66), v8
    ...
    Begin block 0x59
    prev=[0xd], succ=[0xd69, 0x65]
    =================================
    0x5b: v5b(0xc340a24) = CONST 
    0x60: v60 = EQ v5b(0xc340a24), v12
    0xd5e: vd5e(0xd69) = CONST 
    0xd5f: JUMPI vd5e(0xd69), v60

    Begin block 0xd69
    prev=[0x59], succ=[]
    =================================
    0xd6a: vd6a(0x90) = CONST 
    0xd6b: CALLPRIVATE vd6a(0x90)

    Begin block 0x65
    prev=[0x59], succ=[0xd6c, 0x70]
    =================================
    0x66: v66(0x3659cfe6) = CONST 
    0x6b: v6b = EQ v66(0x3659cfe6), v12
    0xd60: vd60(0xd6c) = CONST 
    0xd61: JUMPI vd60(0xd6c), v6b

    Begin block 0xd6c
    prev=[0x65], succ=[]
    =================================
    0xd6d: vd6d(0xe7) = CONST 
    0xd6e: CALLPRIVATE vd6d(0xe7)

    Begin block 0x70
    prev=[0x65], succ=[0xd6f, 0x7b]
    =================================
    0x71: v71(0x4f1ef286) = CONST 
    0x76: v76 = EQ v71(0x4f1ef286), v12
    0xd62: vd62(0xd6f) = CONST 
    0xd63: JUMPI vd62(0xd6f), v76

    Begin block 0xd6f
    prev=[0x70], succ=[]
    =================================
    0xd70: vd70(0x138) = CONST 
    0xd71: CALLPRIVATE vd70(0x138)

    Begin block 0x7b
    prev=[0x70], succ=[0xd66, 0xd72]
    =================================
    0x7c: v7c(0x5c60da1b) = CONST 
    0x81: v81 = EQ v7c(0x5c60da1b), v12
    0xd64: vd64(0xd72) = CONST 
    0xd65: JUMPI vd64(0xd72), v81

    Begin block 0xd66
    prev=[0x0, 0x7b], succ=[]
    =================================
    0xd67: vd67(0x86) = CONST 
    0xd68: CALLPRIVATE vd67(0x86)

    Begin block 0xd72
    prev=[0x7b], succ=[]
    =================================
    0xd73: vd73(0x1d1) = CONST 
    0xd74: CALLPRIVATE vd73(0x1d1)

    Begin block 0x1e
    prev=[0xd], succ=[0xd75, 0x29]
    =================================
    0x1f: v1f(0x5d36b190) = CONST 
    0x24: v24 = EQ v1f(0x5d36b190), v12
    0xd54: vd54(0xd75) = CONST 
    0xd55: JUMPI vd54(0xd75), v24

    Begin block 0xd75
    prev=[0x1e], succ=[]
    =================================
    0xd76: vd76(0x228) = CONST 
    0xd77: CALLPRIVATE vd76(0x228)

    Begin block 0x29
    prev=[0x1e], succ=[0xd78, 0x34]
    =================================
    0x2a: v2a(0xc7af3352) = CONST 
    0x2f: v2f = EQ v2a(0xc7af3352), v12
    0xd56: vd56(0xd78) = CONST 
    0xd57: JUMPI vd56(0xd78), v2f

    Begin block 0xd78
    prev=[0x29], succ=[]
    =================================
    0xd79: vd79(0x23f) = CONST 
    0xd7a: CALLPRIVATE vd79(0x23f)

    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0xd7b]
    =================================
    0x35: v35(0xcf7a1d77) = CONST 
    0x3a: v3a = EQ v35(0xcf7a1d77), v12
    0xd58: vd58(0xd7b) = CONST 
    0xd59: JUMPI vd58(0xd7b), v3a

    Begin block 0x3f
    prev=[0x34], succ=[0xd7e, 0x4a]
    =================================
    0x40: v40(0xd38bfff4) = CONST 
    0x45: v45 = EQ v40(0xd38bfff4), v12
    0xd5a: vd5a(0xd7e) = CONST 
    0xd5b: JUMPI vd5a(0xd7e), v45

    Begin block 0xd7e
    prev=[0x3f], succ=[]
    =================================
    0xd7f: vd7f(0x369) = CONST 
    0xd80: CALLPRIVATE vd7f(0x369)

    Begin block 0x4a
    prev=[0x3f], succ=[0x55, 0xd81]
    =================================
    0x4b: v4b(0xf851a440) = CONST 
    0x50: v50 = EQ v4b(0xf851a440), v12
    0xd5c: vd5c(0xd81) = CONST 
    0xd5d: JUMPI vd5c(0xd81), v50
    ...
    prev=[0x4a], succ=[]
    =================================
    0xd82: vd82(0x3ba) = CONST 
    0xd83: CALLPRIVATE vd82(0x3ba)

    Begin block 0xd7b
    prev=[0x34], succ=[]
    =================================
    0xd7c: vd7c(0x26e) = CONST 
    0xd7d: CALLPRIVATE vd7c(0x26e)
