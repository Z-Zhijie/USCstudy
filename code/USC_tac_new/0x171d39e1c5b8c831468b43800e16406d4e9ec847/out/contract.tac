function __function_selector__() public {
    ...
    0x8ff: JUMPI v8fe(0x90a), v8

    Begin block 0xd
    prev=[0x0], succ=[0x90d, 0x41]
    =================================
    0xd: vd(0x0) = CONST 
    ...
    0x900: v900(0x90d) = CONST 
    0x901: JUMPI v900(0x90d), v3c

    Begin block 0x90d
    prev=[0xd], succ=[]
    =================================
    0x90e: v90e(0x77) = CONST 
    0x90f: CALLPRIVATE v90e(0x77)

    Begin block 0x41
    prev=[0xd], succ=[0x910, 0x4c]
    =================================
    0x42: v42(0x4f1ef286) = CONST 
    0x47: v47 = EQ v42(0x4f1ef286), v35
    0x902: v902(0x910) = CONST 
    0x903: JUMPI v902(0x910), v47

    Begin block 0x910
    prev=[0x41], succ=[]
    =================================
    0x911: v911(0xc8) = CONST 
    0x912: CALLPRIVATE v911(0xc8)

    Begin block 0x4c
    prev=[0x41], succ=[0x913, 0x57]
    =================================
    0x4d: v4d(0x5c60da1b) = CONST 
    0x52: v52 = EQ v4d(0x5c60da1b), v35
    0x904: v904(0x913) = CONST 
    0x905: JUMPI v904(0x913), v52

    Begin block 0x913
    prev=[0x4c], succ=[]
    =================================
    0x914: v914(0x161) = CONST 
    0x915: CALLPRIVATE v914(0x161)

    Begin block 0x57
    prev=[0x4c], succ=[0x916, 0x62]
    =================================
    0x58: v58(0x8f283970) = CONST 
    0x5d: v5d = EQ v58(0x8f283970), v35
    0x906: v906(0x916) = CONST 
    0x907: JUMPI v906(0x916), v5d

    Begin block 0x916
    prev=[0x57], succ=[]
    =================================
    0x917: v917(0x1b8) = CONST 
    0x918: CALLPRIVATE v917(0x1b8)

    Begin block 0x62
    prev=[0x57], succ=[0x90a, 0x919]
    =================================
    0x63: v63(0xf851a440) = CONST 
    0x68: v68 = EQ v63(0xf851a440), v35
    0x908: v908(0x919) = CONST 
    0x909: JUMPI v908(0x919), v68

    Begin block 0x90a
    prev=[0x0, 0x62], succ=[]
    =================================
    0x90b: v90b(0x6d) = CONST 
    0x90c: CALLPRIVATE v90b(0x6d)

    Begin block 0x919
    prev=[0x62], succ=[]
    =================================
    0x91a: v91a(0x209) = CONST 
    0x91b: CALLPRIVATE v91a(0x209)
