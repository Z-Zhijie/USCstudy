function __function_selector__() public {
    ...
    0xacd: vacd(0xada) = CONST 
    0xace: JUMPI vacd(0xada), v19

    Begin block 0xada
    prev=[0xd], succ=[]
    =================================
    0xadb: vadb(0x65) = CONST 
    0xadc: CALLPRIVATE vadb(0x65)

    Begin block 0x1e
    prev=[0xd], succ=[0xadd, 0x29]
    =================================
    0x1f: v1f(0x2e1997b6) = CONST 
    0x24: v24 = EQ v1f(0x2e1997b6), v12
    0xacf: vacf(0xadd) = CONST 
    0xad0: JUMPI vacf(0xadd), v24

    Begin block 0xadd
    prev=[0x1e], succ=[]
    =================================
    0xade: vade(0x85) = CONST 
    0xadf: CALLPRIVATE vade(0x85)

    Begin block 0x29
    prev=[0x1e], succ=[0xae0, 0x34]
    =================================
    0x2a: v2a(0x5c60da1b) = CONST 
    0x2f: v2f = EQ v2a(0x5c60da1b), v12
    0xad1: vad1(0xae0) = CONST 
    0xad2: JUMPI vad1(0xae0), v2f

    Begin block 0xae0
    prev=[0x29], succ=[]
    =================================
    0xae1: vae1(0xaf) = CONST 
    0xae2: CALLPRIVATE vae1(0xaf)

    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0xae3]
    =================================
    0x35: v35(0x621f6309) = CONST 
    0x3a: v3a = EQ v35(0x621f6309), v12
    0xad3: vad3(0xae3) = CONST 
    0xad4: JUMPI vad3(0xae3), v3a

    Begin block 0x3f
    prev=[0x34], succ=[0x4a, 0xae6]
    =================================
    0x40: v40(0xabe5e587) = CONST 
    0x45: v45 = EQ v40(0xabe5e587), v12
    0xad5: vad5(0xae6) = CONST 
    0xad6: JUMPI vad5(0xae6), v45
    ...
    prev=[0x3f], succ=[]
    =================================
    0xae7: vae7(0xfc) = CONST 
    0xae8: CALLPRIVATE vae7(0xfc)

    Begin block 0xae3
    prev=[0x34], succ=[]
    =================================
    0xae4: vae4(0xdc) = CONST 
    0xae5: CALLPRIVATE vae4(0xdc)

    Begin block 0x4e
    prev=[0x0], succ=[0xad7, 0x5d]
    =================================
    ...
    prev=[0x4e], succ=[]
    =================================
    0xad7: vad7(0xad9) = CONST 
    0xad8: CALLPRIVATE vad7(0xad9)
...
function proxy_changeAdmin(address)() public {
    ...
    =================================
    0x63cS0x71: v63cV71(0xac6) = CONST 
    ...
    prev=[0x60eB0x63bB0x71], succ=[0xac6B0x71]
    =================================
    0x629S0x63bS0x71: JUMP v63cV71(0xac6)

    Begin block 0xac6B0x71
    prev=[0x625B0x63bB0x71], succ=[0x80]
    =================================
    0xaccS0x71: JUMP v76(0x80)

    Begin block 0x80
    prev=[0xac6B0x71], succ=[0x143]
    =================================
    ...
    0x1e6: v1e6(0x80e) = CONST 
    0x1e9: JUMP v1e6(0x80e)
    ...
    0x814: v814(0x64) = SUB v1e5, v811
    0x816: REVERT v811, v814(0x64)

    Begin block 0x1ea
    prev=[0x19c], succ=[0x982]
    =================================
...
function fallback()() public {
    Begin block 0xad9
    prev=[], succ=[0x1110xad9]
    =================================
    0x54: v54(0x940) = CONST 
    0x57: v57(0x111) = CONST 
    0x5a: JUMP v57(0x111)

    Begin block 0x1110xad9
    prev=[0xad9], succ=[0x13c0xad9]
    =================================
    0x1120xad9: vad9112(0x141) = CONST 
    0x1150xad9: vad9115(0x13c) = CONST 
    0x1180xad9: vad9118(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc) = CONST 
    0x1390xad9: vad9139 = SLOAD vad9118(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc)
    0x13b0xad9: JUMP vad9115(0x13c)

    Begin block 0x13c0xad9
    prev=[0x1110xad9], succ=[0x3e20xad9]
    =================================
    0x13d0xad9: vad913d(0x3e2) = CONST 
    0x1400xad9: JUMP vad913d(0x3e2)

    Begin block 0x3e20xad9
    prev=[0x13c0xad9], succ=[0x3fd0xad9, 0x4010xad9]
    =================================
    0x3e30xad9: vad93e3 = CALLDATASIZE 
    0x3e40xad9: vad93e4(0x0) = CONST 
    0x3e70xad9: CALLDATACOPY vad93e4(0x0), vad93e4(0x0), vad93e3
    0x3e80xad9: vad93e8(0x0) = CONST 
    0x3eb0xad9: vad93eb = CALLDATASIZE 
    0x3ec0xad9: vad93ec(0x0) = CONST 
    0x3ef0xad9: vad93ef = GAS 
    0x3f00xad9: vad93f0 = DELEGATECALL vad93ef, vad9139, vad93ec(0x0), vad93eb, vad93e8(0x0), vad93e8(0x0)
    0x3f10xad9: vad93f1 = RETURNDATASIZE 
    0x3f20xad9: vad93f2(0x0) = CONST 
    0x3f50xad9: RETURNDATACOPY vad93f2(0x0), vad93f2(0x0), vad93f1
    0x3f80xad9: vad93f8 = ISZERO vad93f0
    0x3f90xad9: vad93f9(0x401) = CONST 
    0x3fc0xad9: JUMPI vad93f9(0x401), vad93f8

    Begin block 0x3fd0xad9
    prev=[0x3e20xad9], succ=[]
    =================================
    0x3fd0xad9: vad93fd = RETURNDATASIZE 
    0x3fe0xad9: vad93fe(0x0) = CONST 
    0x4000xad9: RETURN vad93fe(0x0), vad93fd

    Begin block 0x4010xad9
    prev=[0x3e20xad9], succ=[]
    =================================
    0x4020xad9: vad9402 = RETURNDATASIZE 
    0x4030xad9: vad9403(0x0) = CONST 
    0x4050xad9: REVERT vad9403(0x0), vad9402
...
function implementation()() public {
    ...
    =================================
    0xbd: vbd(0x9a3) = CONST 
    0xc0: vc0(0x285) = CONST 
    0xc3: JUMP vc0(0x285)

    Begin block 0x285B0xbb
    prev=[0xbb], succ=[0xa32B0xbb]
    =================================
    0x286S0xbb: v286Vbb(0x0) = CONST 
    0x288S0xbb: v288Vbb(0xa32) = CONST 
    ...
    0x2aeS0xbb: JUMP v288Vbb(0xa32)

    Begin block 0xa32B0xbb
    prev=[0x285B0xbb], succ=[0x9a3]
    =================================
    0xa36S0xbb: JUMP vbd(0x9a3)

    Begin block 0x9a3
    prev=[0xa32B0xbb], succ=[0xa60xaf]
    =================================
    ...
    0x9b1: v9b1 = AND v2acVbb, v9ae(0xffffffffffffffffffffffffffffffffffffffff)
    0x9b3: MSTORE v9a6, v9b1
    0x9b4: v9b4(0x20) = CONST 
    0x9b6: v9b6 = ADD v9b4(0x20), v9a6
    0x9b7: v9b7(0xa6) = CONST 
    0x9ba: JUMP v9b7(0xa6)
    ...
    0xac0xaf: vafac(0x20) = SUB v9b6, vafa9
...
function proxy_upgradeTo(address,bytes)() public {
    ...
    Begin block 0x699
    prev=[0x68e], succ=[0x8d6]
    =================================
    0x699: v699(0x6a0) = CONST 
    0x69c: v69c(0x8d6) = CONST 
    0x69f: JUMP v69c(0x8d6)

    Begin block 0x8d6
    prev=[0x699], succ=[]
    =================================
    0x8d7: v8d7(0x4e487b71) = CONST 
    0x8dc: v8dc(0xe0) = CONST 
    0x8de: v8de(0x4e487b7100000000000000000000000000000000000000000000000000000000) = SHL v8dc(0xe0), v8d7(0x4e487b71)
    0x8df: v8df(0x0) = CONST 
    0x8e1: MSTORE v8df(0x0), v8de(0x4e487b7100000000000000000000000000000000000000000000000000000000)
    0x8e2: v8e2(0x41) = CONST 
    0x8e4: v8e4(0x4) = CONST 
    0x8e6: MSTORE v8e4(0x4), v8e2(0x41)
    0x8e7: v8e7(0x24) = CONST 
    0x8e9: v8e9(0x0) = CONST 
    0x8eb: REVERT v8e9(0x0), v8e7(0x24)
    ...
    Begin block 0x6c1
    prev=[0x6a0], succ=[0x90b]
    =================================
    0x6c1: v6c1(0x6c8) = CONST 
    0x6c4: v6c4(0x90b) = CONST 
    0x6c7: JUMP v6c4(0x90b)

    Begin block 0x90b
    prev=[0x6c1], succ=[]
    =================================
    0x90c: v90c(0x4e487b71) = CONST 
    0x911: v911(0xe0) = CONST 
    0x913: v913(0x4e487b7100000000000000000000000000000000000000000000000000000000) = SHL v911(0xe0), v90c(0x4e487b71)
    0x914: v914(0x0) = CONST 
    0x916: MSTORE v914(0x0), v913(0x4e487b7100000000000000000000000000000000000000000000000000000000)
    0x917: v917(0x41) = CONST 
    0x919: v919(0x4) = CONST 
    0x91b: MSTORE v919(0x4), v917(0x41)
    0x91c: v91c(0x24) = CONST 
    0x91e: v91e(0x0) = CONST 
    0x920: REVERT v91e(0x0), v91c(0x24)
    ...
    0xfb: JUMP vf8(0x2b4), v6a3, v610V656, vea(0x9da)
    ...
    prev=[0x2beB0xf7], succ=[0x836B0xf7]
    =================================
    ...
    0x304S0xf7: v304Vf7(0x836) = CONST 
    0x307S0xf7: JUMP v304Vf7(0x836)

    Begin block 0x836B0xf7
    prev=[0x2cfB0xf7], succ=[]
    =================================
    0x837S0xf7: v837Vf7(0x40) = CONST 
    0x839S0xf7: v839Vf7 = MLOAD v837Vf7(0x40)
    0x83cS0xf7: v83cVf7(0x64) = SUB v303Vf7, v839Vf7
    0x83eS0xf7: REVERT v839Vf7, v83cVf7(0x64)
    ...
    prev=[0x308B0xf7], succ=[0x85eB0xf7]
    =================================
    ...
    0x352S0xf7: v352Vf7(0x85e) = CONST 
    0x355S0xf7: JUMP v352Vf7(0x85e)

    Begin block 0x85eB0xf7
    prev=[0x319B0xf7], succ=[]
    =================================
    0x85fS0xf7: v85fVf7(0x40) = CONST 
    0x861S0xf7: v861Vf7 = MLOAD v85fVf7(0x40)
    0x864S0xf7: v864Vf7(0x64) = SUB v351Vf7, v861Vf7
    0x866S0xf7: REVERT v861Vf7, v864Vf7(0x64)
    ...
    prev=[0x548B0xf7], succ=[0x8aeB0xf7]
    =================================
    ...
    0x5adS0xf7: v5adVf7(0x8ae) = CONST 
    0x5b0S0xf7: JUMP v5adVf7(0x8ae)

    Begin block 0x8aeB0xf7
    prev=[0x54fB0xf7], succ=[]
    =================================
    0x8afS0xf7: v8afVf7(0x40) = CONST 
    0x8b1S0xf7: v8b1Vf7 = MLOAD v8afVf7(0x40)
    0x8b4S0xf7: v8b4Vf7(0x84) = SUB v5acVf7, v8b1Vf7
    0x8b6S0xf7: REVERT v8b1Vf7, v8b4Vf7(0x84)
    ...
    prev=[0x474B0x367B0xf7], succ=[0x886B0x367B0xf7]
    =================================
    ...
    0x4cfS0x367S0xf7: v4cfV367Vf7(0x886) = CONST 
    0x4d2S0x367S0xf7: JUMP v4cfV367Vf7(0x886)

    Begin block 0x886B0x367B0xf7
    prev=[0x47dB0x367B0xf7], succ=[]
    =================================
    0x887S0x367S0xf7: v887V367Vf7(0x40) = CONST 
    0x889S0x367S0xf7: v889V367Vf7 = MLOAD v887V367Vf7(0x40)
    0x88cS0x367S0xf7: v88cV367Vf7(0x84) = SUB v4ceV367Vf7, v889V367Vf7
    0x88eS0x367S0xf7: REVERT v889V367Vf7, v88cV367Vf7(0x84)
    ...
    prev=[0x5d5B0x52eB0x367B0xf7], succ=[0xaa0B0x52eB0x367B0xf7]
    =================================
    0x5e0S0x52eS0x367S0xf7: v5e0V52eV367Vf7(0xaa0) = CONST 
    0x5e3S0x52eS0x367S0xf7: JUMP v5e0V52eV367Vf7(0xaa0)

    Begin block 0xaa0B0x52eB0x367B0xf7
    prev=[0x5deB0x52eB0x367B0xf7], succ=[0x53eB0x367B0xf7]
    =================================
    0xaa6S0x52eS0x367S0xf7: JUMP v534V367Vf7(0x53e)

    Begin block 0x53eB0x367B0xf7
    prev=[0xaa0B0x52eB0x367B0xf7], succ=[0x39c0x2b4B0xf7]
    =================================
    ...
    prev=[0x35fB0xf7, 0x39c0x2b4B0xf7], succ=[0x9da]
    =================================
    0x3a20x2b4S0xf7: JUMP vea(0x9da)
...
function proxy_getAdmin()() public {
    ...
    0x433S0x3a3S0x108: JUMP v3a6V108(0xa56)

    Begin block 0xa56B0x108
    prev=[0x406B0x3a3B0x108], succ=[0x9fb]
    =================================
    0xa5aS0x108: JUMP v10a(0x9fb)

    Begin block 0x9fb
    prev=[0xa56B0x108], succ=[0xa60xfc]
    =================================
    ...
    0xa09: va09 = AND v431V3a3V108, va06(0xffffffffffffffffffffffffffffffffffffffff)
    0xa0b: MSTORE v9fe, va09
    0xa0c: va0c(0x20) = CONST 
    0xa0e: va0e = ADD va0c(0x20), v9fe
    0xa0f: va0f(0xa6) = CONST 
    0xa12: JUMP va0f(0xa6)
    ...
    0xac0xfc: vfcac(0x20) = SUB va0e, vfca9
