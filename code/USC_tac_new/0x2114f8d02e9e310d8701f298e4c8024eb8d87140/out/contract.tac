function __function_selector__() public {
    ...
    Begin block 0x10
    prev=[0x0], succ=[0x1a, 0x4728]
    =================================
    0x12: v12(0x4) = CONST 
    0x14: v14 = CALLDATASIZE 
    0x15: v15 = LT v14, v12(0x4)
    0x4672: v4672(0x4728) = CONST 
    0x4673: JUMPI v4672(0x4728), v15
    ...
    Begin block 0x1ef
    prev=[0x1a8], succ=[0x46bc, 0x1fa]
    =================================
    0x1f1: v1f1(0xfdd58e) = CONST 
    0x1f5: v1f5 = EQ v1f1(0xfdd58e), v1f
    0x46b4: v46b4(0x46bc) = CONST 
    0x46b5: JUMPI v46b4(0x46bc), v1f5

    Begin block 0x46bc
    prev=[0x1ef], succ=[]
    =================================
    0x46bd: v46bd(0x220) = CONST 
    0x46be: CALLPRIVATE v46bd(0x220)

    Begin block 0x1fa
    prev=[0x1ef], succ=[0x46bf, 0x205]
    =================================
    0x1fb: v1fb(0x1ffc9a7) = CONST 
    0x200: v200 = EQ v1fb(0x1ffc9a7), v1f
    0x46b6: v46b6(0x46bf) = CONST 
    0x46b7: JUMPI v46b6(0x46bf), v200

    Begin block 0x46bf
    prev=[0x1fa], succ=[]
    =================================
    0x46c0: v46c0(0x25e) = CONST 
    0x46c1: CALLPRIVATE v46c0(0x25e)

    Begin block 0x205
    prev=[0x1fa], succ=[0x46c2, 0x210]
    =================================
    0x206: v206(0x2fe5305) = CONST 
    0x20b: v20b = EQ v206(0x2fe5305), v1f
    0x46b8: v46b8(0x46c2) = CONST 
    0x46b9: JUMPI v46b8(0x46c2), v20b

    Begin block 0x46c2
    prev=[0x205], succ=[]
    =================================
    0x46c3: v46c3(0x299) = CONST 
    0x46c4: CALLPRIVATE v46c3(0x299)

    Begin block 0x210
    prev=[0x205], succ=[0x46c5, 0x21b]
    =================================
    0x211: v211(0xe89341c) = CONST 
    0x216: v216 = EQ v211(0xe89341c), v1f
    0x46ba: v46ba(0x46c5) = CONST 
    0x46bb: JUMPI v46ba(0x46c5), v216

    Begin block 0x46c5
    prev=[0x210], succ=[]
    =================================
    0x46c6: v46c6(0x33f) = CONST 
    0x46c7: CALLPRIVATE v46c6(0x33f)
    ...
    Begin block 0x1b4
    prev=[0x1a8], succ=[0x46c8, 0x1bf]
    =================================
    0x1b5: v1b5(0x158ef93e) = CONST 
    0x1ba: v1ba = EQ v1b5(0x158ef93e), v1f
    0x46aa: v46aa(0x46c8) = CONST 
    0x46ab: JUMPI v46aa(0x46c8), v1ba

    Begin block 0x46c8
    prev=[0x1b4], succ=[]
    =================================
    0x46c9: v46c9(0x3d1) = CONST 
    0x46ca: CALLPRIVATE v46c9(0x3d1)

    Begin block 0x1bf
    prev=[0x1b4], succ=[0x46cb, 0x1ca]
    =================================
    0x1c0: v1c0(0x2de041f9) = CONST 
    0x1c5: v1c5 = EQ v1c0(0x2de041f9), v1f
    0x46ac: v46ac(0x46cb) = CONST 
    0x46ad: JUMPI v46ac(0x46cb), v1c5

    Begin block 0x46cb
    prev=[0x1bf], succ=[]
    =================================
    0x46cc: v46cc(0x3d9) = CONST 
    0x46cd: CALLPRIVATE v46cc(0x3d9)

    Begin block 0x1ca
    prev=[0x1bf], succ=[0x46ce, 0x1d5]
    =================================
    0x1cb: v1cb(0x2eb2c2d6) = CONST 
    0x1d0: v1d0 = EQ v1cb(0x2eb2c2d6), v1f
    0x46ae: v46ae(0x46ce) = CONST 
    0x46af: JUMPI v46ae(0x46ce), v1d0

    Begin block 0x46ce
    prev=[0x1ca], succ=[]
    =================================
    0x46cf: v46cf(0x41b) = CONST 
    0x46d0: CALLPRIVATE v46cf(0x41b)

    Begin block 0x1d5
    prev=[0x1ca], succ=[0x46d1, 0x1e0]
    =================================
    0x1d6: v1d6(0x3092afd5) = CONST 
    0x1db: v1db = EQ v1d6(0x3092afd5), v1f
    0x46b0: v46b0(0x46d1) = CONST 
    0x46b1: JUMPI v46b0(0x46d1), v1db

    Begin block 0x46d1
    prev=[0x1d5], succ=[]
    =================================
    0x46d2: v46d2(0x5dc) = CONST 
    0x46d3: CALLPRIVATE v46d2(0x5dc)

    Begin block 0x1e0
    prev=[0x1d5], succ=[0x1eb, 0x46d4]
    =================================
    0x1e1: v1e1(0x40c10f19) = CONST 
    0x1e6: v1e6 = EQ v1e1(0x40c10f19), v1f
    0x46b2: v46b2(0x46d4) = CONST 
    0x46b3: JUMPI v46b2(0x46d4), v1e6

    Begin block 0x1eb
    prev=[0x1e0], succ=[0x3d72]
    =================================
    0x1eb: v1eb(0x3d72) = CONST 
    0x1ee: JUMP v1eb(0x3d72)

    Begin block 0x3d72
    prev=[0x1eb], succ=[]
    =================================
    0x3d73: v3d73(0x0) = CONST 
    0x3d76: REVERT v3d73(0x0), v3d73(0x0)

    Begin block 0x46d4
    prev=[0x1e0], succ=[]
    =================================
    0x46d5: v46d5(0x602) = CONST 
    0x46d6: CALLPRIVATE v46d5(0x602)
    ...
    Begin block 0x177
    prev=[0x131], succ=[0x46d7, 0x183]
    =================================
    0x179: v179(0x485cc955) = CONST 
    0x17e: v17e = EQ v179(0x485cc955), v1f
    0x46a2: v46a2(0x46d7) = CONST 
    0x46a3: JUMPI v46a2(0x46d7), v17e

    Begin block 0x46d7
    prev=[0x177], succ=[]
    =================================
    0x46d8: v46d8(0x62e) = CONST 
    0x46d9: CALLPRIVATE v46d8(0x62e)

    Begin block 0x183
    prev=[0x177], succ=[0x46da, 0x18e]
    =================================
    0x184: v184(0x4e1273f4) = CONST 
    0x189: v189 = EQ v184(0x4e1273f4), v1f
    0x46a4: v46a4(0x46da) = CONST 
    0x46a5: JUMPI v46a4(0x46da), v189

    Begin block 0x46da
    prev=[0x183], succ=[]
    =================================
    0x46db: v46db(0x65c) = CONST 
    0x46dc: CALLPRIVATE v46db(0x65c)

    Begin block 0x18e
    prev=[0x183], succ=[0x46dd, 0x199]
    =================================
    0x18f: v18f(0x4fb2e45d) = CONST 
    0x194: v194 = EQ v18f(0x4fb2e45d), v1f
    0x46a6: v46a6(0x46dd) = CONST 
    0x46a7: JUMPI v46a6(0x46dd), v194

    Begin block 0x46dd
    prev=[0x18e], succ=[]
    =================================
    0x46de: v46de(0x7cf) = CONST 
    0x46df: CALLPRIVATE v46de(0x7cf)

    Begin block 0x199
    prev=[0x18e], succ=[0x1a4, 0x46e0]
    =================================
    0x19a: v19a(0x540865fe) = CONST 
    0x19f: v19f = EQ v19a(0x540865fe), v1f
    0x46a8: v46a8(0x46e0) = CONST 
    0x46a9: JUMPI v46a8(0x46e0), v19f

    Begin block 0x1a4
    prev=[0x199], succ=[0x3d4e]
    =================================
    0x1a4: v1a4(0x3d4e) = CONST 
    0x1a7: JUMP v1a4(0x3d4e)
    ...
    prev=[0x199], succ=[]
    =================================
    0x46e1: v46e1(0x7f5) = CONST 
    0x46e2: CALLPRIVATE v46e1(0x7f5)

    Begin block 0x13c
    prev=[0x131], succ=[0x46e3, 0x147]
    =================================
    0x13d: v13d(0x6c0360eb) = CONST 
    0x142: v142 = EQ v13d(0x6c0360eb), v1f
    0x4698: v4698(0x46e3) = CONST 
    0x4699: JUMPI v4698(0x46e3), v142

    Begin block 0x46e3
    prev=[0x13c], succ=[]
    =================================
    0x46e4: v46e4(0x821) = CONST 
    0x46e5: CALLPRIVATE v46e4(0x821)

    Begin block 0x147
    prev=[0x13c], succ=[0x46e6, 0x152]
    =================================
    0x148: v148(0x6d70f7ae) = CONST 
    0x14d: v14d = EQ v148(0x6d70f7ae), v1f
    0x469a: v469a(0x46e6) = CONST 
    0x469b: JUMPI v469a(0x46e6), v14d

    Begin block 0x46e6
    prev=[0x147], succ=[]
    =================================
    0x46e7: v46e7(0x829) = CONST 
    0x46e8: CALLPRIVATE v46e7(0x829)

    Begin block 0x152
    prev=[0x147], succ=[0x46e9, 0x15d]
    =================================
    0x153: v153(0x70c2f239) = CONST 
    0x158: v158 = EQ v153(0x70c2f239), v1f
    0x469c: v469c(0x46e9) = CONST 
    0x469d: JUMPI v469c(0x46e9), v158

    Begin block 0x46e9
    prev=[0x152], succ=[]
    =================================
    0x46ea: v46ea(0x84f) = CONST 
    0x46eb: CALLPRIVATE v46ea(0x84f)

    Begin block 0x15d
    prev=[0x152], succ=[0x46ec, 0x168]
    =================================
    0x15e: v15e(0x7a2a4b32) = CONST 
    0x163: v163 = EQ v15e(0x7a2a4b32), v1f
    0x469e: v469e(0x46ec) = CONST 
    0x469f: JUMPI v469e(0x46ec), v163

    Begin block 0x46ec
    prev=[0x15d], succ=[]
    =================================
    0x46ed: v46ed(0x8d2) = CONST 
    0x46ee: CALLPRIVATE v46ed(0x8d2)

    Begin block 0x168
    prev=[0x15d], succ=[0x173, 0x46ef]
    =================================
    0x169: v169(0x8a89bb14) = CONST 
    0x16e: v16e = EQ v169(0x8a89bb14), v1f
    0x46a0: v46a0(0x46ef) = CONST 
    0x46a1: JUMPI v46a0(0x46ef), v16e

    Begin block 0x173
    prev=[0x168], succ=[0x3d2a]
    =================================
    0x173: v173(0x3d2a) = CONST 
    0x176: JUMP v173(0x3d2a)

    Begin block 0x3d2a
    prev=[0x173], succ=[]
    =================================
    0x3d2b: v3d2b(0x0) = CONST 
    0x3d2e: REVERT v3d2b(0x0), v3d2b(0x0)

    Begin block 0x46ef
    prev=[0x168], succ=[]
    =================================
    0x46f0: v46f0(0x99f) = CONST 
    0x46f1: CALLPRIVATE v46f0(0x99f)
    ...
    Begin block 0xf4
    prev=[0xad], succ=[0x100, 0x46f2]
    =================================
    0xf6: vf6(0x9204aac6) = CONST 
    0xfb: vfb = EQ vf6(0x9204aac6), v1f
    0x4690: v4690(0x46f2) = CONST 
    0x4691: JUMPI v4690(0x46f2), vfb

    Begin block 0x100
    prev=[0xf4], succ=[0x46f5, 0x10b]
    =================================
    0x101: v101(0x983b2d56) = CONST 
    0x106: v106 = EQ v101(0x983b2d56), v1f
    0x4692: v4692(0x46f5) = CONST 
    0x4693: JUMPI v4692(0x46f5), v106

    Begin block 0x46f5
    prev=[0x100], succ=[]
    =================================
    0x46f6: v46f6(0x9f5) = CONST 
    0x46f7: CALLPRIVATE v46f6(0x9f5)

    Begin block 0x10b
    prev=[0x100], succ=[0x46f8, 0x116]
    =================================
    0x10c: v10c(0x9870d7fe) = CONST 
    0x111: v111 = EQ v10c(0x9870d7fe), v1f
    0x4694: v4694(0x46f8) = CONST 
    0x4695: JUMPI v4694(0x46f8), v111

    Begin block 0x46f8
    prev=[0x10b], succ=[]
    =================================
    0x46f9: v46f9(0xa1b) = CONST 
    0x46fa: CALLPRIVATE v46f9(0xa1b)

    Begin block 0x116
    prev=[0x10b], succ=[0x121, 0x46fb]
    =================================
    0x117: v117(0x9dc29fac) = CONST 
    0x11c: v11c = EQ v117(0x9dc29fac), v1f
    0x4696: v4696(0x46fb) = CONST 
    0x4697: JUMPI v4696(0x46fb), v11c

    Begin block 0x121
    prev=[0x116], succ=[0x3d06]
    =================================
    0x121: v121(0x3d06) = CONST 
    0x124: JUMP v121(0x3d06)

    Begin block 0x3d06
    prev=[0x121], succ=[]
    =================================
    0x3d07: v3d07(0x0) = CONST 
    0x3d0a: REVERT v3d07(0x0), v3d07(0x0)

    Begin block 0x46fb
    prev=[0x116], succ=[]
    =================================
    0x46fc: v46fc(0xa41) = CONST 
    0x46fd: CALLPRIVATE v46fc(0xa41)

    Begin block 0x46f2
    prev=[0xf4], succ=[]
    =================================
    0x46f3: v46f3(0x9d1) = CONST 
    0x46f4: CALLPRIVATE v46f3(0x9d1)

    Begin block 0xb9
    prev=[0xad], succ=[0x46fe, 0xc4]
    =================================
    0xba: vba(0xa22cb465) = CONST 
    0xbf: vbf = EQ vba(0xa22cb465), v1f
    0x4686: v4686(0x46fe) = CONST 
    0x4687: JUMPI v4686(0x46fe), vbf

    Begin block 0x46fe
    prev=[0xb9], succ=[]
    =================================
    0x46ff: v46ff(0xa6d) = CONST 
    0x4700: CALLPRIVATE v46ff(0xa6d)

    Begin block 0xc4
    prev=[0xb9], succ=[0x4701, 0xcf]
    =================================
    0xc5: vc5(0xa36dc62c) = CONST 
    0xca: vca = EQ vc5(0xa36dc62c), v1f
    0x4688: v4688(0x4701) = CONST 
    0x4689: JUMPI v4688(0x4701), vca

    Begin block 0x4701
    prev=[0xc4], succ=[]
    =================================
    0x4702: v4702(0xa9b) = CONST 
    0x4703: CALLPRIVATE v4702(0xa9b)

    Begin block 0xcf
    prev=[0xc4], succ=[0x4704, 0xda]
    =================================
    0xd0: vd0(0xa4a87571) = CONST 
    0xd5: vd5 = EQ vd0(0xa4a87571), v1f
    0x468a: v468a(0x4704) = CONST 
    0x468b: JUMPI v468a(0x4704), vd5

    Begin block 0x4704
    prev=[0xcf], succ=[]
    =================================
    0x4705: v4705(0xb75) = CONST 
    0x4706: CALLPRIVATE v4705(0xb75)

    Begin block 0xda
    prev=[0xcf], succ=[0xe5, 0x4707]
    =================================
    0xdb: vdb(0xaa271e1a) = CONST 
    0xe0: ve0 = EQ vdb(0xaa271e1a), v1f
    0x468c: v468c(0x4707) = CONST 
    0x468d: JUMPI v468c(0x4707), ve0

    Begin block 0xe5
    prev=[0xda], succ=[0xf0, 0x470a]
    =================================
    0xe6: ve6(0xaa936a0d) = CONST 
    0xeb: veb = EQ ve6(0xaa936a0d), v1f
    0x468e: v468e(0x470a) = CONST 
    0x468f: JUMPI v468e(0x470a), veb

    Begin block 0xf0
    prev=[0xe5], succ=[0x3ce2]
    =================================
    0xf0: vf0(0x3ce2) = CONST 
    0xf3: JUMP vf0(0x3ce2)

    Begin block 0x3ce2
    prev=[0xf0], succ=[]
    =================================
    0x3ce3: v3ce3(0x0) = CONST 
    0x3ce6: REVERT v3ce3(0x0), v3ce3(0x0)

    Begin block 0x470a
    prev=[0xe5], succ=[]
    =================================
    0x470b: v470b(0xbf0) = CONST 
    0x470c: CALLPRIVATE v470b(0xbf0)

    Begin block 0x4707
    prev=[0xda], succ=[]
    =================================
    0x4708: v4708(0xbca) = CONST 
    0x4709: CALLPRIVATE v4708(0xbca)
    ...
    Begin block 0x7c
    prev=[0x36], succ=[0x470d, 0x88]
    =================================
    0x7e: v7e(0xac8a584a) = CONST 
    0x83: v83 = EQ v7e(0xac8a584a), v1f
    0x467e: v467e(0x470d) = CONST 
    0x467f: JUMPI v467e(0x470d), v83

    Begin block 0x470d
    prev=[0x7c], succ=[]
    =================================
    0x470e: v470e(0xc16) = CONST 
    0x470f: CALLPRIVATE v470e(0xc16)

    Begin block 0x88
    prev=[0x7c], succ=[0x4710, 0x93]
    =================================
    0x89: v89(0xb2dc5dc3) = CONST 
    0x8e: v8e = EQ v89(0xb2dc5dc3), v1f
    0x4680: v4680(0x4710) = CONST 
    0x4681: JUMPI v4680(0x4710), v8e

    Begin block 0x4710
    prev=[0x88], succ=[]
    =================================
    0x4711: v4711(0xc3c) = CONST 
    0x4712: CALLPRIVATE v4711(0xc3c)

    Begin block 0x93
    prev=[0x88], succ=[0x4713, 0x9e]
    =================================
    0x94: v94(0xb738592d) = CONST 
    0x99: v99 = EQ v94(0xb738592d), v1f
    0x4682: v4682(0x4713) = CONST 
    0x4683: JUMPI v4682(0x4713), v99

    Begin block 0x4713
    prev=[0x93], succ=[]
    =================================
    0x4714: v4714(0xcba) = CONST 
    0x4715: CALLPRIVATE v4714(0xcba)

    Begin block 0x9e
    prev=[0x93], succ=[0xa9, 0x4716]
    =================================
    0x9f: v9f(0xb774b2b1) = CONST 
    0xa4: va4 = EQ v9f(0xb774b2b1), v1f
    0x4684: v4684(0x4716) = CONST 
    0x4685: JUMPI v4684(0x4716), va4

    Begin block 0xa9
    prev=[0x9e], succ=[0x3cbe]
    =================================
    0xa9: va9(0x3cbe) = CONST 
    0xac: JUMP va9(0x3cbe)

    Begin block 0x3cbe
    prev=[0xa9], succ=[]
    =================================
    0x3cbf: v3cbf(0x0) = CONST 
    0x3cc2: REVERT v3cbf(0x0), v3cbf(0x0)

    Begin block 0x4716
    prev=[0x9e], succ=[]
    =================================
    0x4717: v4717(0xcc2) = CONST 
    0x4718: CALLPRIVATE v4717(0xcc2)

    Begin block 0x41
    prev=[0x36], succ=[0x4719, 0x4c]
    =================================
    0x42: v42(0xc46d0771) = CONST 
    0x47: v47 = EQ v42(0xc46d0771), v1f
    0x4674: v4674(0x4719) = CONST 
    0x4675: JUMPI v4674(0x4719), v47

    Begin block 0x4719
    prev=[0x41], succ=[]
    =================================
    0x471a: v471a(0xd12) = CONST 
    0x471b: CALLPRIVATE v471a(0xd12)

    Begin block 0x4c
    prev=[0x41], succ=[0x471c, 0x57]
    =================================
    0x4d: v4d(0xc5b8f772) = CONST 
    0x52: v52 = EQ v4d(0xc5b8f772), v1f
    0x4676: v4676(0x471c) = CONST 
    0x4677: JUMPI v4676(0x471c), v52

    Begin block 0x471c
    prev=[0x4c], succ=[]
    =================================
    0x471d: v471d(0xd3e) = CONST 
    0x471e: CALLPRIVATE v471d(0xd3e)

    Begin block 0x57
    prev=[0x4c], succ=[0x62, 0x471f]
    =================================
    0x58: v58(0xe985e9c5) = CONST 
    0x5d: v5d = EQ v58(0xe985e9c5), v1f
    0x4678: v4678(0x471f) = CONST 
    0x4679: JUMPI v4678(0x471f), v5d

    Begin block 0x62
    prev=[0x57], succ=[0x4722, 0x6d]
    =================================
    0x63: v63(0xf242432a) = CONST 
    0x68: v68 = EQ v63(0xf242432a), v1f
    0x467a: v467a(0x4722) = CONST 
    0x467b: JUMPI v467a(0x4722), v68

    Begin block 0x4722
    prev=[0x62], succ=[]
    =================================
    0x4723: v4723(0xd98) = CONST 
    0x4724: CALLPRIVATE v4723(0xd98)

    Begin block 0x6d
    prev=[0x62], succ=[0x78, 0x4725]
    =================================
    0x6e: v6e(0xf2ebbc3d) = CONST 
    0x73: v73 = EQ v6e(0xf2ebbc3d), v1f
    0x467c: v467c(0x4725) = CONST 
    0x467d: JUMPI v467c(0x4725), v73

    Begin block 0x78
    prev=[0x6d], succ=[0x3c9a]
    =================================
    0x78: v78(0x3c9a) = CONST 
    0x7b: JUMP v78(0x3c9a)
    ...
    prev=[0x6d], succ=[]
    =================================
    0x4726: v4726(0xe61) = CONST 
    0x4727: CALLPRIVATE v4726(0xe61)

    Begin block 0x471f
    prev=[0x57], succ=[]
    =================================
    0x4720: v4720(0xd6a) = CONST 
    0x4721: CALLPRIVATE v4720(0xd6a)

    Begin block 0x4728
    prev=[0x10], succ=[]
    =================================
    0x4729: v4729(0x3c76) = CONST 
    0x472a: CALLPRIVATE v4729(0x3c76)

}

function 0x184b(0x184barg0x0) private {
    Begin block 0x184b
    prev=[], succ=[0x4342, 0x188e]
    =================================
    ...
    0x188a: v188a(0x4342) = CONST 
    0x188d: JUMPI v188a(0x4342), v1889

    Begin block 0x4342
    prev=[0x184b], succ=[]
    =================================
    0x434b: RETURNPRIVATE v184barg0, v1853
    ...
    0x18a5: v18a5(0x436b) = CONST 
    0x18a8: JUMP v18a5(0x436b)

    Begin block 0x436b
    prev=[0x1896], succ=[]
    =================================
    0x4374: RETURNPRIVATE v184barg0, v1853
...
function balanceOf(address,uint256)() public {
    ...
    prev=[0xe750x220], succ=[0x42430x220]
    =================================
    0xe7c0x220: v220e7c(0x1) = CONST 
    0xe7e0x220: v220e7e(0x4243) = CONST 
    0xe810x220: JUMP v220e7e(0x4243)

    Begin block 0x42430x220
    prev=[0xe7b0x220], succ=[0x3d96]
    =================================
    0x42480x220: JUMP v221(0x3d96)

    Begin block 0x3d96
    prev=[0xe860x220, 0x42430x220], succ=[]
    =================================
    0x3d96_0x0: v3d96_0 = PHI v220e84(0x0), v220e7c(0x1)
    0x3d97: v3d97(0x40) = CONST 
    0x3d9a: v3d9a = MLOAD v3d97(0x40)
    0x3d9d: MSTORE v3d9a, v3d96_0
    0x3d9e: v3d9e = MLOAD v3d97(0x40)
    0x3da2: v3da2(0x0) = SUB v3d9a, v3d9e
    0x3da3: v3da3(0x20) = CONST 
    0x3da5: v3da5(0x20) = ADD v3da3(0x20), v3da2(0x0)
    0x3da7: RETURN v3d9e, v3da5(0x20)
    ...
    prev=[0xe820x220], succ=[0x3d96]
    =================================
    0xe8b0x220: JUMP v221(0x3d96)
...
function 0x24b9(0x24b9arg0x0, 0x24b9arg0x1, 0x24b9arg0x2) private {
    ...
    0x24f00x24b9: v24b924f0(0x4427) = CONST 
    0x24f30x24b9: JUMP v24b924f0(0x4427)

    Begin block 0x44270x24b9
    prev=[0x24d10x24b9], succ=[]
    =================================
    0x442c0x24b9: RETURNPRIVATE v24b9arg2, v24b924ef

    Begin block 0x24ca0x24b9
    prev=[0x24b9], succ=[0x44020x24b9]
    =================================
    0x24cb0x24b9: v24b924cb(0x0) = CONST 
    0x24cd0x24b9: v24b924cd(0x4402) = CONST 
    0x24d00x24b9: JUMP v24b924cd(0x4402)

    Begin block 0x44020x24b9
    prev=[0x24ca0x24b9], succ=[]
    =================================
    0x44070x24b9: RETURNPRIVATE v24b9arg2, v24b924cb(0x0)
...
function supportsInterface(bytes4)() public {
    ...
    Begin block 0xeaa
    prev=[0xe8c], succ=[0x3dc7]
    =================================
    0xeae: JUMP v25f(0x3dc7)

    Begin block 0x3dc7
    prev=[0xeaa], succ=[]
    =================================
    0x3dc8: v3dc8(0x40) = CONST 
    0x3dcb: v3dcb = MLOAD v3dc8(0x40)
    0x3dcd: v3dcd = ISZERO vea9
    0x3dce: v3dce = ISZERO v3dcd
    0x3dd0: MSTORE v3dcb, v3dce
    0x3dd1: v3dd1 = MLOAD v3dc8(0x40)
    0x3dd5: v3dd5(0x0) = SUB v3dcb, v3dd1
...
function 0x26d0(0x26d0arg0x0, 0x26d0arg0x1) private {
    ...
    0x26f1: v26f1(0x4472) = CONST 
    0x26f4: JUMP v26f1(0x4472)

    Begin block 0x4472
    prev=[0x26d8], succ=[]
    =================================
    0x4476: RETURNPRIVATE v26d0arg1, v26dc
...
function 0x281f(0x281farg0x0, 0x281farg0x1, 0x281farg0x2, 0x281farg0x3, 0x281farg0x4, 0x281farg0x5, 0x281farg0x6) private {
    ...
    Begin block 0x2831
    prev=[0x36a6B0x281f], succ=[0x4496, 0x2837]
    =================================
    0x2832: v2832 = ISZERO v36a9V281f
    0x2833: v2833(0x4496) = CONST 
    0x2836: JUMPI v2833(0x4496), v2832

    Begin block 0x4496
    prev=[0x2831], succ=[]
    =================================
    0x449d: RETURNPRIVATE v281farg6
...
function setURI(string)() public {
    ...
    0x38b30x3835S0xf09: v383538b3Vf09(0x45a1) = CONST 
    ...
    prev=[0x397aB0x38b10x3835B0xf09, 0x3970B0x38b10x3835B0xf09], succ=[0x397aB0x38b10x3835B0xf09, 0x45c4B0x38b10x3835B0xf09]
    =================================
    ...
    0x3976S0x38b10x3835S0xf09: v3976V38b13835Vf09(0x45c4) = CONST 
    0x3979S0x38b10x3835S0xf09: JUMPI v3976V38b13835Vf09(0x45c4), v3975V38b13835Vf09
    ...
    Begin block 0x45c4B0x38b10x3835B0xf09
    prev=[0x3971B0x38b10x3835B0xf09], succ=[0x45a10x3835B0xf09]
    =================================
    0x45c7S0x38b10x3835S0xf09: JUMP v383538b3Vf09(0x45a1)

    Begin block 0x45a10x3835B0xf09
    prev=[0x45c4B0x38b10x3835B0xf09], succ=[0x4268]
    =================================
    0x45a40x3835S0xf09: JUMP vf0c(0x4268)

    Begin block 0x4268
    prev=[0x45a10x3835B0xf09], succ=[0x3dfa]
    =================================
    0x426b: JUMP v29a(0x3dfa)
...
function 0x2af3(0x2af3arg0x0, 0x2af3arg0x1, 0x2af3arg0x2) private {
    ...
    0x2c4a: CALLPRIVATE v2c47(0x351f), v2c39, v2c35(0x1), v2b59, v2af3arg1, v2c31(0x0), v2c30, v2c2d(0x44bd)

    Begin block 0x44bd
    prev=[0x2b50], succ=[]
    =================================
    0x44c3: RETURNPRIVATE v2af3arg2, v2b59
...
function uri(uint256)() public {
    ...
    0x1082: v1082(0x42af) = CONST 
    0x1085: JUMP v1082(0x42af)

    Begin block 0x42af
    prev=[0x103a], succ=[0x35c0x33f]
    =================================
    0x42b3: JUMP v340(0x35c)

    Begin block 0x35c0x33f
    prev=[0x428b, 0x42af], succ=[0x37e0x33f]
    =================================
    ...
    0xfa1: vfa1(0x428b) = CONST 
    0xfa4: JUMP vfa1(0x428b)

    Begin block 0x428b
    prev=[0xf91], succ=[0x35c0x33f]
    =================================
    0x428f: JUMP v340(0x35c)
...
function 0x351f(0x351farg0x0, 0x351farg0x1, 0x351farg0x2, 0x351farg0x3, 0x351farg0x4, 0x351farg0x5, 0x351farg0x6) private {
    ...
    Begin block 0x3531
    prev=[0x36a6B0x351f], succ=[0x452d, 0x3537]
    =================================
    0x3532: v3532 = ISZERO v36a9V351f
    0x3533: v3533(0x452d) = CONST 
    0x3536: JUMPI v3533(0x452d), v3532

    Begin block 0x452d
    prev=[0x3531], succ=[]
    =================================
    0x4534: RETURNPRIVATE v351farg6
...
function 0x36ac(0x36acarg0x0, 0x36acarg0x1) private {
    ...
    Begin block 0x36bf
    prev=[0x36ac], succ=[0x4554, 0x36c6]
    =================================
    0x36c1: v36c1 = ISZERO v36be_0
    0x36c2: v36c2(0x4554) = CONST 
    0x36c5: JUMPI v36c2(0x4554), v36c1

    Begin block 0x4554
    prev=[0x36bf], succ=[]
    =================================
    0x4559: RETURNPRIVATE v36acarg1, v36be_0
...
function 0x36df(0x36dfarg0x0, 0x36dfarg0x1, 0x36dfarg0x2) private {
    ...
    Begin block 0x36ee
    prev=[0x382eB0x36df], succ=[0x4579, 0x36fa]
    =================================
    0x36f5: v36f5 = ISZERO v382e_1V36df
    0x36f6: v36f6(0x4579) = CONST 
    0x36f9: JUMPI v36f6(0x4579), v36f5

    Begin block 0x4579
    prev=[0x36ee], succ=[]
    =================================
    0x4581: RETURNPRIVATE v36dfarg2, v382e_1V36df
...
function 0x398b(0x398barg0x0) private {
    ...
    Begin block 0x3997
    prev=[0x398b], succ=[0x45e7]
    =================================
    0x3997: v3997(0x45e7) = CONST 
    0x399a: JUMP v3997(0x45e7)

    Begin block 0x45e7
    prev=[0x3997], succ=[]
    =================================
    0x45e9: RETURNPRIVATE v398barg0, v398c(0x0)
    ...
    Begin block 0x39b5
    prev=[0x39af], succ=[0x4609]
    =================================
    0x39b5: v39b5(0x4609) = CONST 
    0x39b8: JUMP v39b5(0x4609)

    Begin block 0x4609
    prev=[0x39b5], succ=[]
    =================================
    0x460b: RETURNPRIVATE v398barg0, v398c(0x0)
    ...
    Begin block 0x3a14
    prev=[0x3a03], succ=[0x466f]
    =================================
    0x3a17: v3a17(0x466f) = CONST 
    0x3a1a: JUMP v3a17(0x466f)

    Begin block 0x466f
    prev=[0x3a14], succ=[]
    =================================
    0x4671: RETURNPRIVATE v398barg0, v398c(0x0)

    Begin block 0x39fb
    prev=[0x39e9], succ=[0x464d]
    =================================
    0x39ff: v39ff(0x464d) = CONST 
    0x3a02: JUMP v39ff(0x464d)

    Begin block 0x464d
    prev=[0x39fb], succ=[]
    =================================
    0x464f: RETURNPRIVATE v398barg0, v398c(0x0)

    Begin block 0x39e1
    prev=[0x39b9], succ=[0x462b]
    =================================
    0x39e5: v39e5(0x462b) = CONST 
    0x39e8: JUMP v39e5(0x462b)

    Begin block 0x462b
    prev=[0x39e1], succ=[]
    =================================
    0x462d: RETURNPRIVATE v398barg0, v398c(0x0)
...
function fallback()() public {
    ...
    prev=[], succ=[]
    =================================
    0x3c77: v3c77(0x0) = CONST 
    0x3c7a: REVERT v3c77(0x0), v3c77(0x0)
...
function initialized()() public {
    ...
    prev=[0x1086B0x3d1], succ=[0x3e1b]
    =================================
    0x108fS0x3d1: JUMP v3d2(0x3e1b)

    Begin block 0x3e1b
    prev=[0x108dB0x3d1], succ=[]
    =================================
    0x3e1c: v3e1c(0x40) = CONST 
    0x3e1f: v3e1f = MLOAD v3e1c(0x40)
    0x3e21: v3e21 = ISZERO v108cV3d1
    0x3e22: v3e22 = ISZERO v3e21
    0x3e24: MSTORE v3e1f, v3e22
    0x3e25: v3e25 = MLOAD v3e1c(0x40)
    0x3e29: v3e29(0x0) = SUB v3e1f, v3e25
    0x3e2a: v3e2a(0x20) = CONST 
    0x3e2c: v3e2c(0x20) = ADD v3e2a(0x20), v3e29(0x0)
    0x3e2e: RETURN v3e25, v3e2c(0x20)
...
function mintQuasar(address,uint256,uint256,address,uint256)() public {
    ...
    Begin block 0x10f2
    prev=[0x27bf], succ=[0x3e4e]
    =================================
    0x10fb: JUMP v3da(0x3e4e)

    Begin block 0x3e4e
    prev=[0x10f2], succ=[]
    =================================
    0x3e4f: v3e4f(0x40) = CONST 
    0x3e52: v3e52 = MLOAD v3e4f(0x40)
    0x3e55: MSTORE v3e52, v27be_0
    0x3e56: v3e56 = MLOAD v3e4f(0x40)
    0x3e5a: v3e5a(0x0) = SUB v3e52, v3e56
    0x3e5b: v3e5b(0x20) = CONST 
    0x3e5d: v3e5d(0x20) = ADD v3e5b(0x20), v3e5a(0x0)
    0x3e5f: RETURN v3e56, v3e5d(0x20)
...
function safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)() public {
    ...
    0x1351: v1351(0x42d3) = CONST 
    0x1354: v1354 = CALLER 
    0x135a: v135a(0x281f) = CONST 
    0x135d: CALLPRIVATE v135a(0x281f), v5ae, v526, v4a4, v446, v43d, v1354, v1351(0x42d3)

    Begin block 0x42d3
    prev=[0x133b], succ=[0x3e7f]
    =================================
    0x42d9: JUMP v41c(0x3e7f)
...
function mint(address,uint256)() public {
    ...
    Begin block 0x148f
    prev=[0x143a], succ=[0x42f9]
    =================================
    0x1490: v1490(0x42f9) = CONST 
    0x1495: v1495(0x2af3) = CONST 
    0x1498: v1498_0 = CALLPRIVATE v1495(0x2af3), v629, v624, v1490(0x42f9)

    Begin block 0x42f9
    prev=[0x148f], succ=[0x3ec1]
    =================================
    0x42ff: JUMP v603(0x3ec1)
...
function balanceOfBatch(address[],uint256[])() public {
    ...
    prev=[0xe750x65c], succ=[0x42430x65c]
    =================================
    0xe7c0x65c: v65ce7c(0x1) = CONST 
    0xe7e0x65c: v65ce7e(0x4243) = CONST 
    0xe810x65c: JUMP v65ce7e(0x4243)

    Begin block 0x42430x65c
    prev=[0xe7b0x65c], succ=[0x1697]
    =================================
    0x42480x65c: JUMP v1668(0x1697)

    Begin block 0x1697
    prev=[0xe860x65c, 0x42430x65c], succ=[0x16a2, 0x16a3]
    =================================
...
function burnQuasar(address,uint256)() public {
    ...
    0x2c9c: JUMP v1843(0x431f)

    Begin block 0x431f
    prev=[0x2c4b], succ=[0x3f34]
    =================================
    0x4322: JUMP v7f6(0x3f34)
...
function isOperator(address)() public {
    ...
    0x18fb: JUMP v82a(0x3f55)

    Begin block 0x3f55
    prev=[0x18de], succ=[]
    =================================
    0x3f56: v3f56(0x40) = CONST 
    0x3f59: v3f59 = MLOAD v3f56(0x40)
    0x3f5b: v3f5b = ISZERO v18f9
    0x3f5c: v3f5c = ISZERO v3f5b
    0x3f5e: MSTORE v3f59, v3f5c
    0x3f5f: v3f5f = MLOAD v3f56(0x40)
    0x3f63: v3f63(0x0) = SUB v3f59, v3f5f
    0x3f64: v3f64(0x20) = CONST 
    0x3f66: v3f66(0x20) = ADD v3f64(0x20), v3f63(0x0)
    0x3f68: RETURN v3f5f, v3f66(0x20)
...
function mintBatch(address,uint256,uint256[])() public {
    ...
    prev=[0x2f1bB0x19ed], succ=[0x4394]
    =================================
    0x2f57S0x19ed: JUMP v19ee(0x4394)

    Begin block 0x4394
    prev=[0x2f4eB0x19ed], succ=[0x77f0x84f]
    =================================
    0x439c: JUMP v850(0x77f)

    Begin block 0x77f0x84f
    prev=[0x4394], succ=[0x7a30x84f]
    =================================
...
function updatePowah(address,uint256,uint256)() public {
    ...
    prev=[0x2f6aB0x1b97, 0x2f71B0x1b97], succ=[0x2f89B0x1b97, 0x44e3B0x1b97]
    =================================
    0x2f83_0x0S0x1b97: v2f83_0V1b97 = PHI v2f82_0V1b97, v36a9V2f58V1b97
    0x2f84S0x1b97: v2f84V1b97 = ISZERO v2f83_0V1b97
    0x2f85S0x1b97: v2f85V1b97(0x44e3) = CONST 
    0x2f88S0x1b97: JUMPI v2f85V1b97(0x44e3), v2f84V1b97
    ...
    prev=[0x2fe9B0x1b97], succ=[0x3007B0x1b97, 0x4508B0x1b97]
    =================================
    0x3001S0x1b97: v3001V1b97 = MLOAD v2ff0V1b97
    0x3002S0x1b97: v3002V1b97 = ISZERO v3001V1b97
    0x3003S0x1b97: v3003V1b97(0x4508) = CONST 
    0x3006S0x1b97: JUMPI v3003V1b97(0x4508), v3002V1b97
    ...
    Begin block 0x1c10
    prev=[0x44e3B0x1b97, 0x4508B0x1b97, 0x3075B0x1b97], succ=[0x3f88]
    =================================
    ...
    Begin block 0x4508B0x1b97
    prev=[0x2fffB0x1b97], succ=[0x1c10]
    =================================
    0x450dS0x1b97: JUMP v1bf3(0x1c10)

    Begin block 0x44e3B0x1b97
    prev=[0x2f83B0x1b97], succ=[0x1c10]
    =================================
    0x44e8S0x1b97: JUMP v1bf3(0x1c10)
...
function galaxyCommunity()() public {
    ...
    prev=[], succ=[0x1c3d]
    =================================
    0x9d2: v9d2(0x3fa9) = CONST 
    0x9d5: v9d5(0x1c3d) = CONST 
    0x9d8: JUMP v9d5(0x1c3d)

    Begin block 0x1c3d
    prev=[0x9d1], succ=[0x3fa9]
    =================================
    ...
    0x1c4b: JUMP v9d2(0x3fa9)

    Begin block 0x3fa9
    prev=[0x1c3d], succ=[]
    =================================
    0x3faa: v3faa(0x40) = CONST 
    0x3fad: v3fad = MLOAD v3faa(0x40)
    0x3fae: v3fae(0x1) = CONST 
    0x3fb0: v3fb0(0x1) = CONST 
    0x3fb2: v3fb2(0xa0) = CONST 
    0x3fb4: v3fb4(0x10000000000000000000000000000000000000000) = SHL v3fb2(0xa0), v3fb0(0x1)
    0x3fb5: v3fb5(0xffffffffffffffffffffffffffffffffffffffff) = SUB v3fb4(0x10000000000000000000000000000000000000000), v3fae(0x1)
    0x3fb8: v3fb8 = AND v1c49, v3fb5(0xffffffffffffffffffffffffffffffffffffffff)
    0x3fba: MSTORE v3fad, v3fb8
    0x3fbb: v3fbb = MLOAD v3faa(0x40)
    0x3fbf: v3fbf(0x0) = SUB v3fad, v3fbb
    0x3fc0: v3fc0(0x20) = CONST 
    0x3fc2: v3fc2(0x20) = ADD v3fc0(0x20), v3fbf(0x0)
    0x3fc4: RETURN v3fbb, v3fc2(0x20)
...
function burn(address,uint256)() public {
    ...
    prev=[0x397aB0x38c1B0x307b, 0x3970B0x38c1B0x307b], succ=[0x397aB0x38c1B0x307b, 0x45c4B0x38c1B0x307b]
    =================================
    ...
    0x3976S0x38c1S0x307b: v3976V38c1V307b(0x45c4) = CONST 
    0x3979S0x38c1S0x307b: JUMPI v3976V38c1V307b(0x45c4), v3975V38c1V307b
    ...
    Begin block 0x45c4B0x38c1B0x307b
    prev=[0x3971B0x38c1B0x307b], succ=[0x38dfB0x307b]
    =================================
    0x45c7S0x38c1S0x307b: JUMP v38d6V307b(0x38df)

    Begin block 0x38dfB0x307b
    prev=[0x45c4B0x38c1B0x307b], succ=[0x30ca]
    =================================
    ...
    prev=[0x397aB0x38c1B0x30ca, 0x3970B0x38c1B0x30ca], succ=[0x397aB0x38c1B0x30ca, 0x45c4B0x38c1B0x30ca]
    =================================
    ...
    0x3976S0x38c1S0x30ca: v3976V38c1V30ca(0x45c4) = CONST 
    0x3979S0x38c1S0x30ca: JUMPI v3976V38c1V30ca(0x45c4), v3975V38c1V30ca
    ...
    Begin block 0x45c4B0x38c1B0x30ca
    prev=[0x3971B0x38c1B0x30ca], succ=[0x38dfB0x30ca]
    =================================
    0x45c7S0x38c1S0x30ca: JUMP v38d6V30ca(0x38df)

    Begin block 0x38dfB0x30ca
    prev=[0x45c4B0x38c1B0x30ca], succ=[0x30d8]
    =================================
    0x38e1S0x30ca: JUMP v30cb(0x30d8)

    Begin block 0x30d8
    prev=[0x38dfB0x30ca], succ=[0x43bc]
    =================================
    ...
    0x314d: JUMP v1f3f(0x43bc)

    Begin block 0x43bc
    prev=[0x30d8], succ=[0x4026]
    =================================
    0x43bf: JUMP va42(0x4026)
...
function mintSuper(address,uint256,uint256,address[],uint256[])() public {
    ...
    0x38b30x38e2S0x31d6S0x2069: v38e238b3V31d6V2069(0x45a1) = CONST 
    ...
    prev=[0x397aB0x38b10x38e2B0x31d6B0x2069, 0x3970B0x38b10x38e2B0x31d6B0x2069], succ=[0x397aB0x38b10x38e2B0x31d6B0x2069, 0x45c4B0x38b10x38e2B0x31d6B0x2069]
    =================================
    ...
    0x3976S0x38b10x38e2S0x31d6S0x2069: v3976V38b138e2V31d6V2069(0x45c4) = CONST 
    0x3979S0x38b10x38e2S0x31d6S0x2069: JUMPI v3976V38b138e2V31d6V2069(0x45c4), v3975V38b138e2V31d6V2069
    ...
    Begin block 0x45c4B0x38b10x38e2B0x31d6B0x2069
    prev=[0x3971B0x38b10x38e2B0x31d6B0x2069], succ=[0x45a10x38e2B0x31d6B0x2069]
    =================================
    0x45c7S0x38b10x38e2S0x31d6S0x2069: JUMP v38e238b3V31d6V2069(0x45a1)

    Begin block 0x45a10x38e2B0x31d6B0x2069
    prev=[0x45c4B0x38b10x38e2B0x31d6B0x2069], succ=[0x31f9B0x2069]
    =================================
    0x45a40x38e2S0x31d6S0x2069: JUMP v31efV2069(0x31f9)

    Begin block 0x31f9B0x2069
    prev=[0x45a10x38e2B0x31d6B0x2069], succ=[0x3935B0x31f9B0x2069]
    =================================
    ...
    0x38b30x3935S0x31f9S0x2069: v393538b3V31f9V2069(0x45a1) = CONST 
    ...
    prev=[0x397aB0x38b10x3935B0x31f9B0x2069, 0x3970B0x38b10x3935B0x31f9B0x2069], succ=[0x397aB0x38b10x3935B0x31f9B0x2069, 0x45c4B0x38b10x3935B0x31f9B0x2069]
    =================================
    ...
    0x3976S0x38b10x3935S0x31f9S0x2069: v3976V38b13935V31f9V2069(0x45c4) = CONST 
    0x3979S0x38b10x3935S0x31f9S0x2069: JUMPI v3976V38b13935V31f9V2069(0x45c4), v3975V38b13935V31f9V2069
    ...
    Begin block 0x45c4B0x38b10x3935B0x31f9B0x2069
    prev=[0x3971B0x38b10x3935B0x31f9B0x2069], succ=[0x45a10x3935B0x31f9B0x2069]
    =================================
    0x45c7S0x38b10x3935S0x31f9S0x2069: JUMP v393538b3V31f9V2069(0x45a1)

    Begin block 0x45a10x3935B0x31f9B0x2069
    prev=[0x45c4B0x38b10x3935B0x31f9B0x2069], succ=[0x3216B0x2069]
    =================================
    0x45a40x3935S0x31f9S0x2069: JUMP v3209V2069(0x3216)

    Begin block 0x3216B0x2069
    prev=[0x45a10x3935B0x31f9B0x2069], succ=[0x2078]
    =================================
    0x3222S0x2069: JUMP v206a(0x2078)

    Begin block 0x2078
    prev=[0x3216B0x2069], succ=[0x4068]
    =================================
    0x2083: JUMP va9c(0x4068)

    Begin block 0x4068
    prev=[0x2078], succ=[]
    =================================
    0x4069: v4069(0x40) = CONST 
    0x406c: v406c = MLOAD v4069(0x40)
    0x406f: MSTORE v406c, v31d5_0V2069
    0x4070: v4070 = MLOAD v4069(0x40)
    0x4074: v4074(0x0) = SUB v406c, v4070
    0x4075: v4075(0x20) = CONST 
    0x4077: v4077(0x20) = ADD v4075(0x20), v4074(0x0)
    0x4079: RETURN v4070, v4077(0x20)
...
function isMinter(address)() public {
    ...
    0x20e3: JUMP vbcb(0x4099)

    Begin block 0x4099
    prev=[0x20c6], succ=[]
    =================================
    0x409a: v409a(0x40) = CONST 
    0x409d: v409d = MLOAD v409a(0x40)
    0x409f: v409f = ISZERO v20e1
    0x40a0: v40a0 = ISZERO v409f
    0x40a2: MSTORE v409d, v40a0
    0x40a3: v40a3 = MLOAD v409a(0x40)
    0x40a7: v40a7(0x0) = SUB v409d, v40a3
    0x40a8: v40a8(0x20) = CONST 
    0x40aa: v40aa(0x20) = ADD v40a8(0x20), v40a7(0x0)
    0x40ac: RETURN v40a3, v40aa(0x20)
...
function burnBatch(address,uint256[])() public {
    ...
    prev=[0x24b90xc3c], succ=[0x44270xc3c]
    =================================
    ...
    0x24f00xc3c: vc3c24f0(0x4427) = CONST 
    0x24f30xc3c: JUMP vc3c24f0(0x4427)

    Begin block 0x44270xc3c
    prev=[0x24d10xc3c], succ=[0x232c]
    =================================
    0x442c0xc3c: JUMP v2311(0x232c)

    Begin block 0x232c
    prev=[0x44020xc3c, 0x44270xc3c], succ=[0x2331, 0x236d]
    =================================
    ...
    prev=[0x24b90xc3c], succ=[0x44020xc3c]
    =================================
    0x24cb0xc3c: vc3c24cb(0x0) = CONST 
    0x24cd0xc3c: vc3c24cd(0x4402) = CONST 
    0x24d00xc3c: JUMP vc3c24cd(0x4402)

    Begin block 0x44020xc3c
    prev=[0x24ca0xc3c], succ=[0x232c]
    =================================
    0x44070xc3c: JUMP v2311(0x232c)
    ...
    prev=[0x397aB0x38c1B0x330b, 0x3970B0x38c1B0x330b], succ=[0x397aB0x38c1B0x330b, 0x45c4B0x38c1B0x330b]
    =================================
    ...
    0x3976S0x38c1S0x330b: v3976V38c1V330b(0x45c4) = CONST 
    0x3979S0x38c1S0x330b: JUMPI v3976V38c1V330b(0x45c4), v3975V38c1V330b
    ...
    Begin block 0x45c4B0x38c1B0x330b
    prev=[0x3971B0x38c1B0x330b], succ=[0x38dfB0x330b]
    =================================
    0x45c7S0x38c1S0x330b: JUMP v38d6V330b(0x38df)

    Begin block 0x38dfB0x330b
    prev=[0x45c4B0x38c1B0x330b], succ=[0x3332]
    =================================
    ...
    prev=[0x397aB0x38c1B0x3332, 0x3970B0x38c1B0x3332], succ=[0x397aB0x38c1B0x3332, 0x45c4B0x38c1B0x3332]
    =================================
    ...
    0x3976S0x38c1S0x3332: v3976V38c1V3332(0x45c4) = CONST 
    0x3979S0x38c1S0x3332: JUMPI v3976V38c1V3332(0x45c4), v3975V38c1V3332
    ...
    Begin block 0x45c4B0x38c1B0x3332
    prev=[0x3971B0x38c1B0x3332], succ=[0x38dfB0x3332]
    =================================
    0x45c7S0x38c1S0x3332: JUMP v38d6V3332(0x38df)

    Begin block 0x38dfB0x3332
    prev=[0x45c4B0x38c1B0x3332], succ=[0x3340]
    =================================
    ...
    Begin block 0x23b3
    prev=[0x3473], succ=[0x410e]
    =================================
    0x23b7: JUMP vc3d(0x410e)
...
function starNFTOwner()() public {
    ...
    prev=[], succ=[0x23b8]
    =================================
    0xcbb: vcbb(0x412f) = CONST 
    0xcbe: vcbe(0x23b8) = CONST 
    0xcc1: JUMP vcbe(0x23b8)

    Begin block 0x23b8
    prev=[0xcba], succ=[0x412f]
    =================================
    ...
    0x23c6: JUMP vcbb(0x412f)

    Begin block 0x412f
    prev=[0x23b8], succ=[]
    =================================
    0x4130: v4130(0x40) = CONST 
    0x4133: v4133 = MLOAD v4130(0x40)
    0x4134: v4134(0x1) = CONST 
    0x4136: v4136(0x1) = CONST 
    0x4138: v4138(0xa0) = CONST 
    0x413a: v413a(0x10000000000000000000000000000000000000000) = SHL v4138(0xa0), v4136(0x1)
    0x413b: v413b(0xffffffffffffffffffffffffffffffffffffffff) = SUB v413a(0x10000000000000000000000000000000000000000), v4134(0x1)
    0x413e: v413e = AND v23c4, v413b(0xffffffffffffffffffffffffffffffffffffffff)
    0x4140: MSTORE v4133, v413e
    0x4141: v4141 = MLOAD v4130(0x40)
    0x4145: v4145(0x0) = SUB v4133, v4141
    0x4146: v4146(0x20) = CONST 
    0x4148: v4148(0x20) = ADD v4146(0x20), v4145(0x0)
    0x414a: RETURN v4141, v4148(0x20)
...
function burnSuper(address,uint256)() public {
    ...
    prev=[0x397aB0x38c1B0x348d, 0x3970B0x38c1B0x348d], succ=[0x397aB0x38c1B0x348d, 0x45c4B0x38c1B0x348d]
    =================================
    ...
    0x3976S0x38c1S0x348d: v3976V38c1V348d(0x45c4) = CONST 
    0x3979S0x38c1S0x348d: JUMPI v3976V38c1V348d(0x45c4), v3975V38c1V348d
    ...
    Begin block 0x45c4B0x38c1B0x348d
    prev=[0x3971B0x38c1B0x348d], succ=[0x38dfB0x348d]
    =================================
    0x45c7S0x38c1S0x348d: JUMP v38d6V348d(0x38df)

    Begin block 0x38dfB0x348d
    prev=[0x45c4B0x38c1B0x348d], succ=[0x34a4]
    =================================
    ...
    prev=[0x397aB0x38c1B0x34a4, 0x3970B0x38c1B0x34a4], succ=[0x397aB0x38c1B0x34a4, 0x45c4B0x38c1B0x34a4]
    =================================
    ...
    0x3976S0x38c1S0x34a4: v3976V38c1V34a4(0x45c4) = CONST 
    0x3979S0x38c1S0x34a4: JUMPI v3976V38c1V34a4(0x45c4), v3975V38c1V34a4
    ...
    Begin block 0x45c4B0x38c1B0x34a4
    prev=[0x3971B0x38c1B0x34a4], succ=[0x38dfB0x34a4]
    =================================
    0x45c7S0x38c1S0x34a4: JUMP v38d6V34a4(0x38df)

    Begin block 0x38dfB0x34a4
    prev=[0x45c4B0x38c1B0x34a4], succ=[0x34c1]
    =================================
    ...
    prev=[0x397aB0x38c1B0x34c1, 0x3970B0x38c1B0x34c1], succ=[0x397aB0x38c1B0x34c1, 0x45c4B0x38c1B0x34c1]
    =================================
    ...
    0x3976S0x38c1S0x34c1: v3976V38c1V34c1(0x45c4) = CONST 
    0x3979S0x38c1S0x34c1: JUMPI v3976V38c1V34c1(0x45c4), v3975V38c1V34c1
    ...
    Begin block 0x45c4B0x38c1B0x34c1
    prev=[0x3971B0x38c1B0x34c1], succ=[0x38dfB0x34c1]
    =================================
    0x45c7S0x38c1S0x34c1: JUMP v38d6V34c1(0x38df)

    Begin block 0x38dfB0x34c1
    prev=[0x45c4B0x38c1B0x34c1], succ=[0x34da]
    =================================
    ...
    prev=[0x397aB0x38c1B0x34da, 0x3970B0x38c1B0x34da], succ=[0x397aB0x38c1B0x34da, 0x45c4B0x38c1B0x34da]
    =================================
    ...
    0x3976S0x38c1S0x34da: v3976V38c1V34da(0x45c4) = CONST 
    0x3979S0x38c1S0x34da: JUMPI v3976V38c1V34da(0x45c4), v3975V38c1V34da
    ...
    Begin block 0x45c4B0x38c1B0x34da
    prev=[0x3971B0x38c1B0x34da], succ=[0x38dfB0x34da]
    =================================
    0x45c7S0x38c1S0x34da: JUMP v38d6V34da(0x38df)

    Begin block 0x38dfB0x34da
    prev=[0x45c4B0x38c1B0x34da], succ=[0x34e8]
    =================================
    0x38e1S0x34da: JUMP v34db(0x34e8)

    Begin block 0x34e8
    prev=[0x38dfB0x34da], succ=[0x43df]
    =================================
    ...
    0x351e: JUMP v24b1(0x43df)

    Begin block 0x43df
    prev=[0x34e8], succ=[0x416a]
    =================================
    0x43e2: JUMP vd13(0x416a)
...
function isOwnerOf(address,uint256)() public {
    ...
    prev=[0x24b90xd3e], succ=[0x44270xd3e]
    =================================
    ...
    0x24f00xd3e: vd3e24f0(0x4427) = CONST 
    0x24f30xd3e: JUMP vd3e24f0(0x4427)

    Begin block 0x44270xd3e
    prev=[0x24d10xd3e], succ=[0x418b]
    =================================
    0x442c0xd3e: JUMP vd3f(0x418b)

    Begin block 0x418b
    prev=[0x44020xd3e, 0x44270xd3e], succ=[]
    =================================
    0x418b_0x0: v418b_0 = PHI vd3e24ef, vd3e24cb(0x0)
    0x418c: v418c(0x40) = CONST 
    0x418f: v418f = MLOAD v418c(0x40)
    0x4191: v4191 = ISZERO v418b_0
    0x4192: v4192 = ISZERO v4191
    0x4194: MSTORE v418f, v4192
    0x4195: v4195 = MLOAD v418c(0x40)
    0x4199: v4199(0x0) = SUB v418f, v4195
    0x419a: v419a(0x20) = CONST 
    0x419c: v419c(0x20) = ADD v419a(0x20), v4199(0x0)
    0x419e: RETURN v4195, v419c(0x20)

    Begin block 0x24ca0xd3e
    prev=[0x24b90xd3e], succ=[0x44020xd3e]
    =================================
    0x24cb0xd3e: vd3e24cb(0x0) = CONST 
    0x24cd0xd3e: vd3e24cd(0x4402) = CONST 
    0x24d00xd3e: JUMP vd3e24cd(0x4402)

    Begin block 0x44020xd3e
    prev=[0x24ca0xd3e], succ=[0x418b]
    =================================
    0x44070xd3e: JUMP vd3f(0x418b)
...
function isApprovedForAll(address,address)() public {
    ...
    0x25210xd6a: JUMP vd6b(0x41be)

    Begin block 0x41be
    prev=[0x24f40xd6a], succ=[]
    =================================
    0x41bf: v41bf(0x40) = CONST 
    0x41c2: v41c2 = MLOAD v41bf(0x40)
    0x41c4: v41c4 = ISZERO vd6a251f
    0x41c5: v41c5 = ISZERO v41c4
    0x41c7: MSTORE v41c2, v41c5
    0x41c8: v41c8 = MLOAD v41bf(0x40)
    0x41cc: v41cc(0x0) = SUB v41c2, v41c8
    0x41cd: v41cd(0x20) = CONST 
    0x41cf: v41cf(0x20) = ADD v41cd(0x20), v41cc(0x0)
    0x41d1: RETURN v41c8, v41cf(0x20)
...
function safeTransferFrom(address,address,uint256,uint256,bytes)() public {
    ...
    0x26bd: v26bd(0x444c) = CONST 
    0x26c0: v26c0 = CALLER 
    0x26c6: v26c6(0x351f) = CONST 
    0x26c9: CALLPRIVATE v26c6(0x351f), ve33, vdcf, vdc9, vdc3, vdba, v26c0, v26bd(0x444c)

    Begin block 0x444c
    prev=[0x264f], succ=[0x41f1]
    =================================
    0x4452: JUMP vd99(0x41f1)
...
function starNFTCount()() public {
    ...
    prev=[], succ=[0x26ca]
    =================================
    0xe62: ve62(0x4212) = CONST 
    0xe65: ve65(0x26ca) = CONST 
    0xe68: JUMP ve65(0x26ca)

    Begin block 0x26ca
    prev=[0xe61], succ=[0x4212]
    =================================
    0x26cb: v26cb(0x7) = CONST 
    0x26cd: v26cd = SLOAD v26cb(0x7)
    0x26cf: JUMP ve62(0x4212)

    Begin block 0x4212
    prev=[0x26ca], succ=[]
    =================================
    0x4213: v4213(0x40) = CONST 
    0x4216: v4216 = MLOAD v4213(0x40)
    0x4219: MSTORE v4216, v26cd
    0x421a: v421a = MLOAD v4213(0x40)
    0x421e: v421e(0x0) = SUB v4216, v421a
    0x421f: v421f(0x20) = CONST 
    0x4221: v4221(0x20) = ADD v421f(0x20), v421e(0x0)
    0x4223: RETURN v421a, v4221(0x20)
