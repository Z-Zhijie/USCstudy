function __function_selector__() public {
    ...
    Begin block 0x10
    prev=[0x0], succ=[0x1a, 0xe36]
    =================================
    0x12: v12(0x4) = CONST 
    0x14: v14 = CALLDATASIZE 
    0x15: v15 = LT v14, v12(0x4)
    0xdfd: vdfd(0xe36) = CONST 
    0xdfe: JUMPI vdfd(0xe36), v15
    ...
    Begin block 0x71
    prev=[0x1a], succ=[0xe15, 0x7d]
    =================================
    0x73: v73(0x39af9eb) = CONST 
    0x78: v78 = EQ v73(0x39af9eb), v1f
    0xe0b: ve0b(0xe15) = CONST 
    0xe0c: JUMPI ve0b(0xe15), v78

    Begin block 0xe15
    prev=[0x71], succ=[]
    =================================
    0xe16: ve16(0xae) = CONST 
    0xe17: CALLPRIVATE ve16(0xae)

    Begin block 0x7d
    prev=[0x71], succ=[0xe18, 0x88]
    =================================
    0x7e: v7e(0xc340a24) = CONST 
    0x83: v83 = EQ v7e(0xc340a24), v1f
    0xe0d: ve0d(0xe18) = CONST 
    0xe0e: JUMPI ve0d(0xe18), v83

    Begin block 0xe18
    prev=[0x7d], succ=[]
    =================================
    0xe19: ve19(0xdd) = CONST 
    0xe1a: CALLPRIVATE ve19(0xdd)

    Begin block 0x88
    prev=[0x7d], succ=[0xe1b, 0x93]
    =================================
    0x89: v89(0xce7dc4a) = CONST 
    0x8e: v8e = EQ v89(0xce7dc4a), v1f
    0xe0f: ve0f(0xe1b) = CONST 
    0xe10: JUMPI ve0f(0xe1b), v8e

    Begin block 0xe1b
    prev=[0x88], succ=[]
    =================================
    0xe1c: ve1c(0x101) = CONST 
    0xe1d: CALLPRIVATE ve1c(0x101)

    Begin block 0x93
    prev=[0x88], succ=[0xe1e, 0x9e]
    =================================
    0x94: v94(0x4cf088d9) = CONST 
    0x99: v99 = EQ v94(0x4cf088d9), v1f
    0xe11: ve11(0xe1e) = CONST 
    0xe12: JUMPI ve11(0xe1e), v99

    Begin block 0xe1e
    prev=[0x93], succ=[]
    =================================
    0xe1f: ve1f(0x126) = CONST 
    0xe20: CALLPRIVATE ve1f(0x126)

    Begin block 0x9e
    prev=[0x93], succ=[0xe21, 0xa9]
    =================================
    0x9f: v9f(0x8ddb2864) = CONST 
    0xa4: va4 = EQ v9f(0x8ddb2864), v1f
    0xe13: ve13(0xe21) = CONST 
    0xe14: JUMPI ve13(0xe21), va4

    Begin block 0xe21
    prev=[0x9e], succ=[]
    =================================
    0xe22: ve22(0x12e) = CONST 
    0xe23: CALLPRIVATE ve22(0x12e)
    ...
    Begin block 0x2b
    prev=[0x1a], succ=[0xe24, 0x36]
    =================================
    0x2c: v2c(0x96b55f7d) = CONST 
    0x31: v31 = EQ v2c(0x96b55f7d), v1f
    0xdff: vdff(0xe24) = CONST 
    0xe00: JUMPI vdff(0xe24), v31

    Begin block 0xe24
    prev=[0x2b], succ=[]
    =================================
    0xe25: ve25(0x154) = CONST 
    0xe26: CALLPRIVATE ve25(0x154)

    Begin block 0x36
    prev=[0x2b], succ=[0xe27, 0x41]
    =================================
    0x37: v37(0xa13a7350) = CONST 
    0x3c: v3c = EQ v37(0xa13a7350), v1f
    0xe01: ve01(0xe27) = CONST 
    0xe02: JUMPI ve01(0xe27), v3c

    Begin block 0xe27
    prev=[0x36], succ=[]
    =================================
    0xe28: ve28(0x15c) = CONST 
    0xe29: CALLPRIVATE ve28(0x15c)

    Begin block 0x41
    prev=[0x36], succ=[0xe2a, 0x4c]
    =================================
    0x42: v42(0xc4d66de8) = CONST 
    0x47: v47 = EQ v42(0xc4d66de8), v1f
    0xe03: ve03(0xe2a) = CONST 
    0xe04: JUMPI ve03(0xe2a), v47

    Begin block 0xe2a
    prev=[0x41], succ=[]
    =================================
    0xe2b: ve2b(0x1cc) = CONST 
    0xe2c: CALLPRIVATE ve2b(0x1cc)

    Begin block 0x4c
    prev=[0x41], succ=[0xe2d, 0x57]
    =================================
    0x4d: v4d(0xe3056a34) = CONST 
    0x52: v52 = EQ v4d(0xe3056a34), v1f
    0xe05: ve05(0xe2d) = CONST 
    0xe06: JUMPI ve05(0xe2d), v52

    Begin block 0xe2d
    prev=[0x4c], succ=[]
    =================================
    0xe2e: ve2e(0x1f2) = CONST 
    0xe2f: CALLPRIVATE ve2e(0x1f2)

    Begin block 0x57
    prev=[0x4c], succ=[0xe30, 0x62]
    =================================
    0x58: v58(0xe58bb639) = CONST 
    0x5d: v5d = EQ v58(0xe58bb639), v1f
    0xe07: ve07(0xe30) = CONST 
    0xe08: JUMPI ve07(0xe30), v5d

    Begin block 0xe30
    prev=[0x57], succ=[]
    =================================
    0xe31: ve31(0x1fa) = CONST 
    0xe32: CALLPRIVATE ve31(0x1fa)

    Begin block 0x62
    prev=[0x57], succ=[0x6d, 0xe33]
    =================================
    0x63: v63(0xf235757f) = CONST 
    0x68: v68 = EQ v63(0xf235757f), v1f
    0xe09: ve09(0xe33) = CONST 
    0xe0a: JUMPI ve09(0xe33), v68

    Begin block 0x6d
    prev=[0x62], succ=[0xc0f]
    =================================
    0x6d: v6d(0xc0f) = CONST 
    0x70: JUMP v6d(0xc0f)
    ...
    prev=[0x62], succ=[]
    =================================
    0xe34: ve34(0x202) = CONST 
    0xe35: CALLPRIVATE ve34(0x202)

    Begin block 0xe36
    prev=[0x10], succ=[]
    =================================
    0xe37: ve37(0xbeb) = CONST 
    0xe38: CALLPRIVATE ve37(0xbeb)
...
function staking()() public {
    ...
    prev=[], succ=[0x430]
    =================================
    0x127: v127(0xcc0) = CONST 
    0x12a: v12a(0x430) = CONST 
    0x12d: JUMP v12a(0x430)

    Begin block 0x430
    prev=[0x126], succ=[0xcc0]
    =================================
    ...
    0xccf: vccf = AND v43c, vccc(0xffffffffffffffffffffffffffffffffffffffff)
    0xcd1: MSTORE vcc4, vccf
    0xcd2: vcd2 = MLOAD vcc1(0x40)
    0xcd6: vcd6(0x0) = SUB vcc4, vcd2
    0xcd7: vcd7(0x20) = CONST 
    0xcd9: vcd9(0x20) = ADD vcd7(0x20), vcd6(0x0)
    0xcdb: RETURN vcd2, vcd9(0x20)
...
function getAlphaTier(address)() public {
    ...
    Begin block 0x504
    prev=[0x4ff, 0x4e2], succ=[0xcfb]
    =================================
    0x508: JUMP v12f(0xcfb)

    Begin block 0xcfb
    prev=[0x504], succ=[]
    =================================
    0xcfb_0x0: vcfb_0 = PHI v4c1(0x0), v4ee, v949V4f3
    0xcfc: vcfc(0x40) = CONST 
    0xcff: vcff = MLOAD vcfc(0x40)
    0xd02: MSTORE vcff, vcfb_0
    0xd03: vd03 = MLOAD vcfc(0x40)
    0xd07: vd07(0x0) = SUB vcff, vd03
    0xd08: vd08(0x20) = CONST 
    0xd0a: vd0a(0x20) = ADD vd08(0x20), vd07(0x0)
    0xd0c: RETURN vd03, vd0a(0x20)
...
function tierCount()() public {
    ...
    prev=[], succ=[0x509]
    =================================
    0x155: v155(0xd2c) = CONST 
    0x158: v158(0x509) = CONST 
    0x15b: JUMP v158(0x509)

    Begin block 0x509
    prev=[0x154], succ=[0xd2c]
    =================================
    0x50a: v50a(0x4) = CONST 
    0x50c: v50c = SLOAD v50a(0x4)
    0x50e: JUMP v155(0xd2c)

    Begin block 0xd2c
    prev=[0x509], succ=[]
    =================================
    0xd2d: vd2d(0x40) = CONST 
    0xd30: vd30 = MLOAD vd2d(0x40)
    0xd33: MSTORE vd30, v50c
    0xd34: vd34 = MLOAD vd2d(0x40)
    0xd38: vd38(0x0) = SUB vd30, vd34
    0xd39: vd39(0x20) = CONST 
    0xd3b: vd3b(0x20) = ADD vd39(0x20), vd38(0x0)
    0xd3d: RETURN vd34, vd3b(0x20)
...
function initialize(address)() public {
    ...
    Begin block 0x7d8
    prev=[0x7cd, 0x7ab], succ=[0xd7e]
    =================================
    0x7db: JUMP v1cd(0xd7e)
...
function pendingGovernor()() public {
    ...
    prev=[], succ=[0x7dc]
    =================================
    0x1f3: v1f3(0xd9f) = CONST 
    0x1f6: v1f6(0x7dc) = CONST 
    0x1f9: JUMP v1f6(0x7dc)

    Begin block 0x7dc
    prev=[0x1f2], succ=[0xd9f]
    =================================
    ...
    0xdae: vdae = AND v7e8, vdab(0xffffffffffffffffffffffffffffffffffffffff)
    0xdb0: MSTORE vda3, vdae
    0xdb1: vdb1 = MLOAD vda0(0x40)
    0xdb5: vdb5(0x0) = SUB vda3, vdb1
    0xdb6: vdb6(0x20) = CONST 
    0xdb8: vdb8(0x20) = ADD vdb6(0x20), vdb5(0x0)
    0xdba: RETURN vdb1, vdb8(0x20)
...
function tiers(uint256)() public {
    ...
    0xc3a: MSTORE vc37, v237
    0xc3b: vc3b = MLOAD vc34(0x40)
    0xc3f: vc3f(0x0) = SUB vc37, vc3b
    0xc40: vc40(0x20) = CONST 
    0xc42: vc42(0x20) = ADD vc40(0x20), vc3f(0x0)
    0xc44: RETURN vc3b, vc42(0x20)
...
function governor()() public {
    ...
    prev=[], succ=[0x23a]
    =================================
    0xde: vde(0xc64) = CONST 
    0xe1: ve1(0x23a) = CONST 
    0xe4: JUMP ve1(0x23a)

    Begin block 0x23a
    prev=[0xdd], succ=[0xc64]
    =================================
    ...
    0xc73: vc73 = AND v24c, vc70(0xffffffffffffffffffffffffffffffffffffffff)
    0xc75: MSTORE vc68, vc73
    0xc76: vc76 = MLOAD vc65(0x40)
    0xc7a: vc7a(0x0) = SUB vc68, vc76
    0xc7b: vc7b(0x20) = CONST 
    0xc7d: vc7d(0x20) = ADD vc7b(0x20), vc7a(0x0)
    0xc7f: RETURN vc76, vc7d(0x20)
