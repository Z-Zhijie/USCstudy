function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x4af: v4af(0x4bd) = CONST 
    0x4b0: JUMPI v4af(0x4bd), v8

    Begin block 0xd
    prev=[0x0], succ=[0x40, 0x4c0]
    =================================
    ...
    0x4b1: v4b1(0x4c0) = CONST 
    0x4b2: JUMPI v4b1(0x4c0), v3b

    Begin block 0x40
    prev=[0xd], succ=[0x4c3, 0x4b]
    =================================
    0x41: v41(0x54fd4d50) = CONST 
    0x46: v46 = EQ v41(0x54fd4d50), v34
    0x4b3: v4b3(0x4c3) = CONST 
    0x4b4: JUMPI v4b3(0x4c3), v46

    Begin block 0x4c3
    prev=[0x40], succ=[]
    =================================
    0x4c4: v4c4(0xe8) = CONST 
    0x4c5: CALLPRIVATE v4c4(0xe8)

    Begin block 0x4b
    prev=[0x40], succ=[0x4c6, 0x56]
    =================================
    0x4c: v4c(0x5c60da1b) = CONST 
    0x51: v51 = EQ v4c(0x5c60da1b), v34
    0x4b5: v4b5(0x4c6) = CONST 
    0x4b6: JUMPI v4b5(0x4c6), v51

    Begin block 0x4c6
    prev=[0x4b], succ=[]
    =================================
    0x4c7: v4c7(0x10f) = CONST 
    0x4c8: CALLPRIVATE v4c7(0x10f)

    Begin block 0x56
    prev=[0x4b], succ=[0x4c9, 0x61]
    =================================
    0x57: v57(0x6fde8202) = CONST 
    0x5c: v5c = EQ v57(0x6fde8202), v34
    0x4b7: v4b7(0x4c9) = CONST 
    0x4b8: JUMPI v4b7(0x4c9), v5c

    Begin block 0x4c9
    prev=[0x56], succ=[]
    =================================
    0x4ca: v4ca(0x140) = CONST 
    0x4cb: CALLPRIVATE v4ca(0x140)

    Begin block 0x61
    prev=[0x56], succ=[0x4cc, 0x6c]
    =================================
    0x62: v62(0xa9c45fcb) = CONST 
    0x67: v67 = EQ v62(0xa9c45fcb), v34
    0x4b9: v4b9(0x4cc) = CONST 
    0x4ba: JUMPI v4b9(0x4cc), v67

    Begin block 0x4cc
    prev=[0x61], succ=[]
    =================================
    0x4cd: v4cd(0x155) = CONST 
    0x4ce: CALLPRIVATE v4cd(0x155)

    Begin block 0x6c
    prev=[0x61], succ=[0x4bd, 0x4cf]
    =================================
    0x6d: v6d(0xf1739cae) = CONST 
    0x72: v72 = EQ v6d(0xf1739cae), v34
    0x4bb: v4bb(0x4cf) = CONST 
    0x4bc: JUMPI v4bb(0x4cf), v72

    Begin block 0x4bd
    prev=[0x0, 0x6c], succ=[]
    =================================
    0x4be: v4be(0x77) = CONST 
    0x4bf: CALLPRIVATE v4be(0x77)

    Begin block 0x4cf
    prev=[0x6c], succ=[]
    =================================
    0x4d0: v4d0(0x179) = CONST 
    0x4d1: CALLPRIVATE v4d0(0x179)

    Begin block 0x4c0
    prev=[0xd], succ=[]
    =================================
    0x4c1: v4c1(0xc2) = CONST 
    0x4c2: CALLPRIVATE v4c1(0xc2)
...
function implementation()() public {
    ...
    0x425: v425 = AND v1a6V11b, v422(0xffffffffffffffffffffffffffffffffffffffff)
    0x427: MSTORE v41a, v425
    0x428: v428 = MLOAD v417(0x40)
    0x42c: v42c(0x0) = SUB v41a, v428
    0x42d: v42d(0x20) = CONST 
    0x42f: v42f(0x20) = ADD v42d(0x20), v42c(0x0)
    0x431: RETURN v428, v42f(0x20)
...
function upgradeabilityOwner()() public {
    ...
    0x460: v460 = AND v1e5V14c, v45d(0xffffffffffffffffffffffffffffffffffffffff)
    0x462: MSTORE v455, v460
    0x463: v463 = MLOAD v452(0x40)
    0x467: v467(0x0) = SUB v455, v463
    0x468: v468(0x20) = CONST 
    0x46a: v46a(0x20) = ADD v468(0x20), v467(0x0)
    0x46c: RETURN v463, v46a(0x20)
...
function upgradeToAndCall(uint256,address,bytes)() public {
    ...
    0x178: JUMP v175(0x1e8), v174, v171, v16a, v15c, v156(0x48c)
    ...
    prev=[0x20eB0x155], succ=[0x48c]
    =================================
    0x24fS0x155: JUMP v156(0x48c)
...
function transferProxyOwnership(address)() public {
    ...
    0x199: JUMP v196(0x250), v195, v187(0x4ad)
    ...
    prev=[0x37dB0x185], succ=[0x4ad]
    =================================
    0x2d7S0x185: JUMP v187(0x4ad)
...
function upgradeTo(uint256,address)() public {
    ...
    Begin block 0xce
    prev=[0xc2], succ=[0x3f5]
    =================================
    0xd0: vd0(0x3f5) = CONST 
    0xd3: vd3(0x4) = CONST 
    ...
    0xe5: CALLPRIVATE ve2(0x1a9), ve1, vd5, vd0(0x3f5)
