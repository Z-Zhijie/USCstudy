function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x8fd: v8fd(0x909) = CONST 
    0x8fe: JUMPI v8fd(0x909), v8

    Begin block 0xd
    prev=[0x0], succ=[0x90c, 0x41]
    =================================
    0xd: vd(0x0) = CONST 
    ...
    0x8ff: v8ff(0x90c) = CONST 
    0x900: JUMPI v8ff(0x90c), v3c

    Begin block 0x90c
    prev=[0xd], succ=[]
    =================================
    0x90d: v90d(0x77) = CONST 
    0x90e: CALLPRIVATE v90d(0x77)

    Begin block 0x41
    prev=[0xd], succ=[0x90f, 0x4c]
    =================================
    0x42: v42(0x4f1ef286) = CONST 
    0x47: v47 = EQ v42(0x4f1ef286), v35
    0x901: v901(0x90f) = CONST 
    0x902: JUMPI v901(0x90f), v47

    Begin block 0x90f
    prev=[0x41], succ=[]
    =================================
    0x910: v910(0xc8) = CONST 
    0x911: CALLPRIVATE v910(0xc8)

    Begin block 0x4c
    prev=[0x41], succ=[0x912, 0x57]
    =================================
    0x4d: v4d(0x5c60da1b) = CONST 
    0x52: v52 = EQ v4d(0x5c60da1b), v35
    0x903: v903(0x912) = CONST 
    0x904: JUMPI v903(0x912), v52

    Begin block 0x912
    prev=[0x4c], succ=[]
    =================================
    0x913: v913(0x161) = CONST 
    0x914: CALLPRIVATE v913(0x161)

    Begin block 0x57
    prev=[0x4c], succ=[0x915, 0x62]
    =================================
    0x58: v58(0x8f283970) = CONST 
    0x5d: v5d = EQ v58(0x8f283970), v35
    0x905: v905(0x915) = CONST 
    0x906: JUMPI v905(0x915), v5d

    Begin block 0x915
    prev=[0x57], succ=[]
    =================================
    0x916: v916(0x1b8) = CONST 
    0x917: CALLPRIVATE v916(0x1b8)

    Begin block 0x62
    prev=[0x57], succ=[0x909, 0x918]
    =================================
    0x63: v63(0xf851a440) = CONST 
    0x68: v68 = EQ v63(0xf851a440), v35
    0x907: v907(0x918) = CONST 
    0x908: JUMPI v907(0x918), v68

    Begin block 0x909
    prev=[0x0, 0x62], succ=[]
    =================================
    0x90a: v90a(0x6d) = CONST 
    0x90b: CALLPRIVATE v90a(0x6d)

    Begin block 0x918
    prev=[0x62], succ=[]
    =================================
    0x919: v919(0x209) = CONST 
    0x91a: CALLPRIVATE v919(0x209)
