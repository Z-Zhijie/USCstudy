function __function_selector__() public {
    ...
    0x8fa: JUMPI v8f9(0x905), v8

    Begin block 0xd
    prev=[0x0], succ=[0x908, 0x41]
    =================================
    0xd: vd(0x0) = CONST 
    ...
    0x8fc: JUMPI v8fb(0x908), v3c

    Begin block 0x908
    prev=[0xd], succ=[]
    =================================
    0x909: v909(0x77) = CONST 
    0x90a: CALLPRIVATE v909(0x77)

    Begin block 0x41
    prev=[0xd], succ=[0x90b, 0x4c]
    =================================
    0x42: v42(0x4f1ef286) = CONST 
    0x47: v47 = EQ v42(0x4f1ef286), v35
    0x8fd: v8fd(0x90b) = CONST 
    0x8fe: JUMPI v8fd(0x90b), v47

    Begin block 0x90b
    prev=[0x41], succ=[]
    =================================
    0x90c: v90c(0xc8) = CONST 
    0x90d: CALLPRIVATE v90c(0xc8)

    Begin block 0x4c
    prev=[0x41], succ=[0x90e, 0x57]
    =================================
    0x4d: v4d(0x5c60da1b) = CONST 
    0x52: v52 = EQ v4d(0x5c60da1b), v35
    0x8ff: v8ff(0x90e) = CONST 
    0x900: JUMPI v8ff(0x90e), v52

    Begin block 0x90e
    prev=[0x4c], succ=[]
    =================================
    0x90f: v90f(0x161) = CONST 
    0x910: CALLPRIVATE v90f(0x161)

    Begin block 0x57
    prev=[0x4c], succ=[0x911, 0x62]
    =================================
    0x58: v58(0x8f283970) = CONST 
    0x5d: v5d = EQ v58(0x8f283970), v35
    0x901: v901(0x911) = CONST 
    0x902: JUMPI v901(0x911), v5d

    Begin block 0x911
    prev=[0x57], succ=[]
    =================================
    0x912: v912(0x1b8) = CONST 
    0x913: CALLPRIVATE v912(0x1b8)

    Begin block 0x62
    prev=[0x57], succ=[0x905, 0x914]
    =================================
    0x63: v63(0xf851a440) = CONST 
    0x68: v68 = EQ v63(0xf851a440), v35
    0x903: v903(0x914) = CONST 
    0x904: JUMPI v903(0x914), v68

    Begin block 0x905
    prev=[0x0, 0x62], succ=[]
    =================================
    0x906: v906(0x6d) = CONST 
    0x907: CALLPRIVATE v906(0x6d)

    Begin block 0x914
    prev=[0x62], succ=[]
    =================================
    0x915: v915(0x209) = CONST 
    0x916: CALLPRIVATE v915(0x209)
