function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0xd03: vd03(0xd2f) = CONST 
    0xd04: JUMPI vd03(0xd2f), v8
    ...
    Begin block 0xf2
    prev=[0xab], succ=[0xd32, 0xfe]
    =================================
    0xf4: vf4(0x6fdde03) = CONST 
    0xf9: vf9 = EQ vf4(0x6fdde03), v12
    0xd25: vd25(0xd32) = CONST 
    0xd26: JUMPI vd25(0xd32), vf9

    Begin block 0xd32
    prev=[0xf2], succ=[]
    =================================
    0xd33: vd33(0x1a6) = CONST 
    0xd34: CALLPRIVATE vd33(0x1a6)

    Begin block 0xfe
    prev=[0xf2], succ=[0xd35, 0x109]
    =================================
    0xff: vff(0x18160ddd) = CONST 
    0x104: v104 = EQ vff(0x18160ddd), v12
    0xd27: vd27(0xd35) = CONST 
    0xd28: JUMPI vd27(0xd35), v104

    Begin block 0xd35
    prev=[0xfe], succ=[]
    =================================
    0xd36: vd36(0x230) = CONST 
    0xd37: CALLPRIVATE vd36(0x230)

    Begin block 0x109
    prev=[0xfe], succ=[0xd38, 0x114]
    =================================
    0x10a: v10a(0x1d0806ae) = CONST 
    0x10f: v10f = EQ v10a(0x1d0806ae), v12
    0xd29: vd29(0xd38) = CONST 
    0xd2a: JUMPI vd29(0xd38), v10f

    Begin block 0xd38
    prev=[0x109], succ=[]
    =================================
    0xd39: vd39(0x257) = CONST 
    0xd3a: CALLPRIVATE vd39(0x257)

    Begin block 0x114
    prev=[0x109], succ=[0xd3b, 0x11f]
    =================================
    0x115: v115(0x1f68f20a) = CONST 
    0x11a: v11a = EQ v115(0x1f68f20a), v12
    0xd2b: vd2b(0xd3b) = CONST 
    0xd2c: JUMPI vd2b(0xd3b), v11a

    Begin block 0xd3b
    prev=[0x114], succ=[]
    =================================
    0xd3c: vd3c(0x26c) = CONST 
    0xd3d: CALLPRIVATE vd3c(0x26c)

    Begin block 0x11f
    prev=[0x114], succ=[0xd2f, 0xd3e]
    =================================
    0x120: v120(0x313ce567) = CONST 
    0x125: v125 = EQ v120(0x313ce567), v12
    0xd2d: vd2d(0xd3e) = CONST 
    0xd2e: JUMPI vd2d(0xd3e), v125

    Begin block 0xd2f
    prev=[0x0, 0x11f], succ=[]
    =================================
    0xd30: vd30(0x12a) = CONST 
    0xd31: CALLPRIVATE vd30(0x12a)

    Begin block 0xd3e
    prev=[0x11f], succ=[]
    =================================
    0xd3f: vd3f(0x281) = CONST 
    0xd40: CALLPRIVATE vd3f(0x281)

    Begin block 0xb7
    prev=[0xab], succ=[0xd41, 0xc2]
    =================================
    0xb8: vb8(0x3291c11a) = CONST 
    0xbd: vbd = EQ vb8(0x3291c11a), v12
    0xd1b: vd1b(0xd41) = CONST 
    0xd1c: JUMPI vd1b(0xd41), vbd

    Begin block 0xd41
    prev=[0xb7], succ=[]
    =================================
    0xd42: vd42(0x2ac) = CONST 
    0xd43: CALLPRIVATE vd42(0x2ac)

    Begin block 0xc2
    prev=[0xb7], succ=[0xd44, 0xcd]
    =================================
    0xc3: vc3(0x330691ac) = CONST 
    0xc8: vc8 = EQ vc3(0x330691ac), v12
    0xd1d: vd1d(0xd44) = CONST 
    0xd1e: JUMPI vd1d(0xd44), vc8

    Begin block 0xd44
    prev=[0xc2], succ=[]
    =================================
    0xd45: vd45(0x2d6) = CONST 
    0xd46: CALLPRIVATE vd45(0x2d6)

    Begin block 0xcd
    prev=[0xc2], succ=[0xd47, 0xd8]
    =================================
    0xce: vce(0x56e07d70) = CONST 
    0xd3: vd3 = EQ vce(0x56e07d70), v12
    0xd1f: vd1f(0xd47) = CONST 
    0xd20: JUMPI vd1f(0xd47), vd3

    Begin block 0xd47
    prev=[0xcd], succ=[]
    =================================
    0xd48: vd48(0x2eb) = CONST 
    0xd49: CALLPRIVATE vd48(0x2eb)

    Begin block 0xd8
    prev=[0xcd], succ=[0xd4a, 0xe3]
    =================================
    0xd9: vd9(0x70a08231) = CONST 
    0xde: vde = EQ vd9(0x70a08231), v12
    0xd21: vd21(0xd4a) = CONST 
    0xd22: JUMPI vd21(0xd4a), vde

    Begin block 0xd4a
    prev=[0xd8], succ=[]
    =================================
    0xd4b: vd4b(0x300) = CONST 
    0xd4c: CALLPRIVATE vd4b(0x300)

    Begin block 0xe3
    prev=[0xd8], succ=[0xee, 0xd4d]
    =================================
    0xe4: ve4(0x776d1a01) = CONST 
    0xe9: ve9 = EQ ve4(0x776d1a01), v12
    0xd23: vd23(0xd4d) = CONST 
    0xd24: JUMPI vd23(0xd4d), ve9
    ...
    prev=[0xe3], succ=[]
    =================================
    0xd4e: vd4e(0x333) = CONST 
    0xd4f: CALLPRIVATE vd4e(0x333)
    ...
    Begin block 0x6f
    prev=[0x1e], succ=[0xd50, 0x7b]
    =================================
    0x71: v71(0x797bf385) = CONST 
    0x76: v76 = EQ v71(0x797bf385), v12
    0xd11: vd11(0xd50) = CONST 
    0xd12: JUMPI vd11(0xd50), v76

    Begin block 0xd50
    prev=[0x6f], succ=[]
    =================================
    0xd51: vd51(0x366) = CONST 
    0xd52: CALLPRIVATE vd51(0x366)

    Begin block 0x7b
    prev=[0x6f], succ=[0xd53, 0x86]
    =================================
    0x7c: v7c(0x7b7933b4) = CONST 
    0x81: v81 = EQ v7c(0x7b7933b4), v12
    0xd13: vd13(0xd53) = CONST 
    0xd14: JUMPI vd13(0xd53), v81

    Begin block 0xd53
    prev=[0x7b], succ=[]
    =================================
    0xd54: vd54(0x397) = CONST 
    0xd55: CALLPRIVATE vd54(0x397)

    Begin block 0x86
    prev=[0x7b], succ=[0xd56, 0x91]
    =================================
    0x87: v87(0x7e37c08c) = CONST 
    0x8c: v8c = EQ v87(0x7e37c08c), v12
    0xd15: vd15(0xd56) = CONST 
    0xd16: JUMPI vd15(0xd56), v8c

    Begin block 0xd56
    prev=[0x86], succ=[]
    =================================
    0xd57: vd57(0x3ac) = CONST 
    0xd58: CALLPRIVATE vd57(0x3ac)

    Begin block 0x91
    prev=[0x86], succ=[0xd59, 0x9c]
    =================================
    0x92: v92(0x8da5cb5b) = CONST 
    0x97: v97 = EQ v92(0x8da5cb5b), v12
    0xd17: vd17(0xd59) = CONST 
    0xd18: JUMPI vd17(0xd59), v97

    Begin block 0xd59
    prev=[0x91], succ=[]
    =================================
    0xd5a: vd5a(0x3c1) = CONST 
    0xd5b: CALLPRIVATE vd5a(0x3c1)

    Begin block 0x9c
    prev=[0x91], succ=[0xa7, 0xd5c]
    =================================
    0x9d: v9d(0x8f32d59b) = CONST 
    0xa2: va2 = EQ v9d(0x8f32d59b), v12
    0xd19: vd19(0xd5c) = CONST 
    0xd1a: JUMPI vd19(0xd5c), va2
    ...
    prev=[0x9c], succ=[]
    =================================
    0xd5d: vd5d(0x3d6) = CONST 
    0xd5e: CALLPRIVATE vd5d(0x3d6)

    Begin block 0x29
    prev=[0x1e], succ=[0xd5f, 0x34]
    =================================
    0x2a: v2a(0x95d89b41) = CONST 
    0x2f: v2f = EQ v2a(0x95d89b41), v12
    0xd05: vd05(0xd5f) = CONST 
    0xd06: JUMPI vd05(0xd5f), v2f

    Begin block 0xd5f
    prev=[0x29], succ=[]
    =================================
    0xd60: vd60(0x3ff) = CONST 
    0xd61: CALLPRIVATE vd60(0x3ff)

    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0xd62]
    =================================
    0x35: v35(0xba0e43bf) = CONST 
    0x3a: v3a = EQ v35(0xba0e43bf), v12
    0xd07: vd07(0xd62) = CONST 
    0xd08: JUMPI vd07(0xd62), v3a

    Begin block 0x3f
    prev=[0x34], succ=[0xd65, 0x4a]
    =================================
    0x40: v40(0xd759dbeb) = CONST 
    0x45: v45 = EQ v40(0xd759dbeb), v12
    0xd09: vd09(0xd65) = CONST 
    0xd0a: JUMPI vd09(0xd65), v45

    Begin block 0xd65
    prev=[0x3f], succ=[]
    =================================
    0xd66: vd66(0x429) = CONST 
    0xd67: CALLPRIVATE vd66(0x429)

    Begin block 0x4a
    prev=[0x3f], succ=[0xd68, 0x55]
    =================================
    0x4b: v4b(0xdd62ed3e) = CONST 
    0x50: v50 = EQ v4b(0xdd62ed3e), v12
    0xd0b: vd0b(0xd68) = CONST 
    0xd0c: JUMPI vd0b(0xd68), v50

    Begin block 0xd68
    prev=[0x4a], succ=[]
    =================================
    0xd69: vd69(0x43e) = CONST 
    0xd6a: CALLPRIVATE vd69(0x43e)

    Begin block 0x55
    prev=[0x4a], succ=[0x60, 0xd6b]
    =================================
    0x56: v56(0xef2b0b39) = CONST 
    0x5b: v5b = EQ v56(0xef2b0b39), v12
    0xd0d: vd0d(0xd6b) = CONST 
    0xd0e: JUMPI vd0d(0xd6b), v5b

    Begin block 0x60
    prev=[0x55], succ=[0x6b, 0xd6e]
    =================================
    0x61: v61(0xf2fde38b) = CONST 
    0x66: v66 = EQ v61(0xf2fde38b), v12
    0xd0f: vd0f(0xd6e) = CONST 
    0xd10: JUMPI vd0f(0xd6e), v66
    ...
    prev=[0x60], succ=[]
    =================================
    0xd6f: vd6f(0x48e) = CONST 
    0xd70: CALLPRIVATE vd6f(0x48e)

    Begin block 0xd6b
    prev=[0x55], succ=[]
    =================================
    0xd6c: vd6c(0x479) = CONST 
    0xd6d: CALLPRIVATE vd6c(0x479)

    Begin block 0xd62
    prev=[0x34], succ=[]
    =================================
    0xd63: vd63(0x414) = CONST 
    0xd64: CALLPRIVATE vd63(0x414)
...
function fallback()() public {
    ...
    Begin block 0x134
    prev=[0x12a], succ=[0x8ec]
    =================================
    0x134: v134(0x8ec) = CONST 
    0x137: JUMP v134(0x8ec)
...
function totalSupply()() public {
    ...
    0x914: MSTORE v911, v54f
    0x915: v915 = MLOAD v90e(0x40)
    0x919: v919(0x0) = SUB v911, v915
    0x91a: v91a(0x20) = CONST 
    0x91c: v91c(0x20) = ADD v91a(0x20), v919(0x0)
    0x91e: RETURN v915, v91c(0x20)
...
function initialPrice()() public {
    ...
    =================================
    0x265: v265(0x93e) = CONST 
    0x268: v268(0x552) = CONST 
    0x26b: JUMP v268(0x552)

    Begin block 0x552
    prev=[0x263], succ=[0x93e]
    =================================
    0x553: v553(0xe) = CONST 
    0x555: v555 = SLOAD v553(0xe)
    0x557: JUMP v265(0x93e)

    Begin block 0x93e
    prev=[0x552], succ=[]
    =================================
    0x93f: v93f(0x40) = CONST 
    0x942: v942 = MLOAD v93f(0x40)
    0x945: MSTORE v942, v555
    0x946: v946 = MLOAD v93f(0x40)
    0x94a: v94a(0x0) = SUB v942, v946
    0x94b: v94b(0x20) = CONST 
    0x94d: v94d(0x20) = ADD v94b(0x20), v94a(0x0)
    0x94f: RETURN v946, v94d(0x20)
...
function baseRate()() public {
    ...
    0x976: MSTORE v973, v55b
    0x977: v977 = MLOAD v970(0x40)
    0x97b: v97b(0x0) = SUB v973, v977
    0x97c: v97c(0x20) = CONST 
    0x97e: v97e(0x20) = ADD v97c(0x20), v97b(0x0)
    0x980: RETURN v977, v97e(0x20)
...
function loanParamsIds(uint256)() public {
    ...
    0x9a7: MSTORE v9a4, v576
    0x9a8: v9a8 = MLOAD v9a1(0x40)
    0x9ac: v9ac(0x0) = SUB v9a4, v9a8
    0x9ad: v9ad(0x20) = CONST 
    0x9af: v9af(0x20) = ADD v9ad(0x20), v9ac(0x0)
    0x9b1: RETURN v9a8, v9af(0x20)
...
function rateMultiplier()() public {
    ...
    =================================
    0x2e4: v2e4(0x9d1) = CONST 
    0x2e7: v2e7(0x579) = CONST 
    0x2ea: JUMP v2e7(0x579)

    Begin block 0x579
    prev=[0x2e2], succ=[0x9d1]
    =================================
    0x57a: v57a(0x6) = CONST 
    0x57c: v57c = SLOAD v57a(0x6)
    0x57e: JUMP v2e4(0x9d1)

    Begin block 0x9d1
    prev=[0x579], succ=[]
    =================================
    0x9d2: v9d2(0x40) = CONST 
    0x9d5: v9d5 = MLOAD v9d2(0x40)
    0x9d8: MSTORE v9d5, v57c
    0x9d9: v9d9 = MLOAD v9d2(0x40)
    0x9dd: v9dd(0x0) = SUB v9d5, v9d9
    0x9de: v9de(0x20) = CONST 
    0x9e0: v9e0(0x20) = ADD v9de(0x20), v9dd(0x0)
    0x9e2: RETURN v9d9, v9e0(0x20)
...
function kinkLevel()() public {
    ...
    0xa09: MSTORE va06, v582
    0xa0a: va0a = MLOAD va03(0x40)
    0xa0e: va0e(0x0) = SUB va06, va0a
    0xa0f: va0f(0x20) = CONST 
    0xa11: va11(0x20) = ADD va0f(0x20), va0e(0x0)
    0xa13: RETURN va0a, va11(0x20)
...
function balanceOf(address)() public {
    ...
    0xa3a: MSTORE va37, v59d
    0xa3b: va3b = MLOAD va34(0x40)
    0xa3f: va3f(0x0) = SUB va37, va3b
    0xa40: va40(0x20) = CONST 
    0xa42: va42(0x20) = ADD va40(0x20), va3f(0x0)
    0xa44: RETURN va3b, va42(0x20)
...
function setTarget(address)() public {
    ...
    0x7a7: JUMP v5e9(0xc90)

    Begin block 0xc90
    prev=[0x786], succ=[0xa64]
    =================================
    0xc92: JUMP v341(0xa64)
...
function loanTokenAddress()() public {
    ...
    =================================
    0x374: v374(0xa85) = CONST 
    0x377: v377(0x5f4) = CONST 
    0x37a: JUMP v377(0x5f4)

    Begin block 0x5f4
    prev=[0x372], succ=[0xa85]
    =================================
    ...
    0xa94: va94 = AND v607, va91(0xffffffffffffffffffffffffffffffffffffffff)
    0xa96: MSTORE va89, va94
    0xa97: va97 = MLOAD va86(0x40)
    0xa9b: va9b(0x0) = SUB va89, va97
...
function checkpointSupply()() public {
    ...
    0xac7: MSTORE vac4, v60d
    0xac8: vac8 = MLOAD vac1(0x40)
    0xacc: vacc(0x0) = SUB vac4, vac8
    0xacd: vacd(0x20) = CONST 
    0xacf: vacf(0x20) = ADD vacd(0x20), vacc(0x0)
    0xad1: RETURN vac8, vacf(0x20)
...
function lowUtilRateMultiplier()() public {
    ...
    =================================
    0x3ba: v3ba(0xaf1) = CONST 
    0x3bd: v3bd(0x610) = CONST 
    0x3c0: JUMP v3bd(0x610)

    Begin block 0x610
    prev=[0x3b8], succ=[0xaf1]
    =================================
    0x611: v611(0x8) = CONST 
    0x613: v613 = SLOAD v611(0x8)
    0x615: JUMP v3ba(0xaf1)

    Begin block 0xaf1
    prev=[0x610], succ=[]
    =================================
    0xaf2: vaf2(0x40) = CONST 
    0xaf5: vaf5 = MLOAD vaf2(0x40)
    0xaf8: MSTORE vaf5, v613
    0xaf9: vaf9 = MLOAD vaf2(0x40)
    0xafd: vafd(0x0) = SUB vaf5, vaf9
    0xafe: vafe(0x20) = CONST 
    0xb00: vb00(0x20) = ADD vafe(0x20), vafd(0x0)
    0xb02: RETURN vaf9, vb00(0x20)
...
function owner()() public {
    ...
    =================================
    0x3cf: v3cf(0xb22) = CONST 
    0x3d2: v3d2(0x616) = CONST 
    0x3d5: JUMP v3d2(0x616)

    Begin block 0x616
    prev=[0x3cd], succ=[0xb22]
    =================================
    ...
    0xb31: vb31 = AND v622, vb2e(0xffffffffffffffffffffffffffffffffffffffff)
    0xb33: MSTORE vb26, vb31
    0xb34: vb34 = MLOAD vb23(0x40)
    0xb38: vb38(0x0) = SUB vb26, vb34
    0xb39: vb39(0x20) = CONST 
    0xb3b: vb3b(0x20) = ADD vb39(0x20), vb38(0x0)
    0xb3d: RETURN vb34, vb3b(0x20)
...
function targetLevel()() public {
    ...
    =================================
    0x422: v422(0xb5d) = CONST 
    0x425: v425(0x6a6) = CONST 
    0x428: JUMP v425(0x6a6)

    Begin block 0x6a6
    prev=[0x420], succ=[0xb5d]
    =================================
    0x6a7: v6a7(0x9) = CONST 
    0x6a9: v6a9 = SLOAD v6a7(0x9)
    0x6ab: JUMP v422(0xb5d)

    Begin block 0xb5d
    prev=[0x6a6], succ=[]
    =================================
    0xb5e: vb5e(0x40) = CONST 
    0xb61: vb61 = MLOAD vb5e(0x40)
    0xb64: MSTORE vb61, v6a9
    0xb65: vb65 = MLOAD vb5e(0x40)
    0xb69: vb69(0x0) = SUB vb61, vb65
    0xb6a: vb6a(0x20) = CONST 
    0xb6c: vb6c(0x20) = ADD vb6a(0x20), vb69(0x0)
    0xb6e: RETURN vb65, vb6c(0x20)
...
function lowUtilBaseRate()() public {
    ...
    0xb95: MSTORE vb92, v6af
    0xb96: vb96 = MLOAD vb8f(0x40)
    0xb9a: vb9a(0x0) = SUB vb92, vb96
    0xb9b: vb9b(0x20) = CONST 
    0xb9d: vb9d(0x20) = ADD vb9b(0x20), vb9a(0x0)
    0xb9f: RETURN vb96, vb9d(0x20)
...
function allowance(address,address)() public {
    ...
    0xbc6: MSTORE vbc3, v6da
    0xbc7: vbc7 = MLOAD vbc0(0x40)
    0xbcb: vbcb(0x0) = SUB vbc3, vbc7
    0xbcc: vbcc(0x20) = CONST 
    0xbce: vbce(0x20) = ADD vbcc(0x20), vbcb(0x0)
    0xbd0: RETURN vbc7, vbce(0x20)
...
function maxScaleRate()() public {
    ...
    =================================
    0x487: v487(0xbf0) = CONST 
    0x48a: v48a(0x6dd) = CONST 
    0x48d: JUMP v48a(0x6dd)

    Begin block 0x6dd
    prev=[0x485], succ=[0xbf0]
    =================================
    0x6de: v6de(0xb) = CONST 
    0x6e0: v6e0 = SLOAD v6de(0xb)
    0x6e2: JUMP v487(0xbf0)

    Begin block 0xbf0
    prev=[0x6dd], succ=[]
    =================================
    0xbf1: vbf1(0x40) = CONST 
    0xbf4: vbf4 = MLOAD vbf1(0x40)
    0xbf7: MSTORE vbf4, v6e0
    0xbf8: vbf8 = MLOAD vbf1(0x40)
    0xbfc: vbfc(0x0) = SUB vbf4, vbf8
...
function transferOwnership(address)() public {
    ...
    0x84c: JUMP v72c(0xd00)

    Begin block 0xd00
    prev=[0x7f1], succ=[0xc21]
    =================================
    0xd02: JUMP v49c(0xc21)
...
function 0x4c1(0x4c1arg0x0) private {
    ...
    0x4fa: v4fa(0xc42) = CONST 
    0x4fd: JUMPI v4fa(0xc42), v4f9

    Begin block 0xc42
    prev=[0x4c1], succ=[]
    =================================
    0xc49: RETURNPRIVATE v4c1arg0, v4c9, v4c1arg0
    ...
    0x515: v515(0xc69) = CONST 
    0x518: JUMP v515(0xc69)

    Begin block 0xc69
    prev=[0x506], succ=[]
    =================================
    0xc70: RETURNPRIVATE v4c1arg0, v4c9, v4c1arg0
...
function 0x64b(0x64barg0x0) private {
    ...
    0x687: v687(0xcb2) = CONST 
    0x68a: JUMPI v687(0xcb2), v686

    Begin block 0xcb2
    prev=[0x64b], succ=[]
    =================================
    0xcb9: RETURNPRIVATE v64barg0, v653, v64barg0
    ...
    0x6a2: v6a2(0xcd9) = CONST 
    0x6a5: JUMP v6a2(0xcd9)

    Begin block 0xcd9
    prev=[0x693], succ=[]
    =================================
    0xce0: RETURNPRIVATE v64barg0, v653, v64barg0
