function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x8fe: v8fe(0x90e) = CONST 
    0x8ff: JUMPI v8fe(0x90e), v8

    Begin block 0xd
    prev=[0x0], succ=[0x40, 0x911]
    =================================
    ...
    0x900: v900(0x911) = CONST 
    0x901: JUMPI v900(0x911), v3b

    Begin block 0x40
    prev=[0xd], succ=[0x914, 0x4b]
    =================================
    0x41: v41(0x54fd4d50) = CONST 
    0x46: v46 = EQ v41(0x54fd4d50), v34
    0x902: v902(0x914) = CONST 
    0x903: JUMPI v902(0x914), v46

    Begin block 0x914
    prev=[0x40], succ=[]
    =================================
    0x915: v915(0x133) = CONST 
    0x916: CALLPRIVATE v915(0x133)

    Begin block 0x4b
    prev=[0x40], succ=[0x917, 0x56]
    =================================
    0x4c: v4c(0x5a8b1a9f) = CONST 
    0x51: v51 = EQ v4c(0x5a8b1a9f), v34
    0x904: v904(0x917) = CONST 
    0x905: JUMPI v904(0x917), v51

    Begin block 0x917
    prev=[0x4b], succ=[]
    =================================
    0x918: v918(0x1bd) = CONST 
    0x919: CALLPRIVATE v918(0x1bd)

    Begin block 0x56
    prev=[0x4b], succ=[0x91a, 0x61]
    =================================
    0x57: v57(0x5c60da1b) = CONST 
    0x5c: v5c = EQ v57(0x5c60da1b), v34
    0x906: v906(0x91a) = CONST 
    0x907: JUMPI v906(0x91a), v5c

    Begin block 0x91a
    prev=[0x56], succ=[]
    =================================
    0x91b: v91b(0x21b) = CONST 
    0x91c: CALLPRIVATE v91b(0x21b)

    Begin block 0x61
    prev=[0x56], succ=[0x91d, 0x6c]
    =================================
    0x62: v62(0x6fde8202) = CONST 
    0x67: v67 = EQ v62(0x6fde8202), v34
    0x908: v908(0x91d) = CONST 
    0x909: JUMPI v908(0x91d), v67

    Begin block 0x91d
    prev=[0x61], succ=[]
    =================================
    0x91e: v91e(0x22e) = CONST 
    0x91f: CALLPRIVATE v91e(0x22e)

    Begin block 0x6c
    prev=[0x61], succ=[0x920, 0x77]
    =================================
    0x6d: v6d(0x958a41dd) = CONST 
    0x72: v72 = EQ v6d(0x958a41dd), v34
    0x90a: v90a(0x920) = CONST 
    0x90b: JUMPI v90a(0x920), v72

    Begin block 0x920
    prev=[0x6c], succ=[]
    =================================
    0x921: v921(0x241) = CONST 
    0x922: CALLPRIVATE v921(0x241)

    Begin block 0x77
    prev=[0x6c], succ=[0x90e, 0x923]
    =================================
    0x78: v78(0xf1739cae) = CONST 
    0x7d: v7d = EQ v78(0xf1739cae), v34
    0x90c: v90c(0x923) = CONST 
    0x90d: JUMPI v90c(0x923), v7d

    Begin block 0x90e
    prev=[0x0, 0x77], succ=[]
    =================================
    0x90f: v90f(0x82) = CONST 
    0x910: CALLPRIVATE v90f(0x82)

    Begin block 0x923
    prev=[0x77], succ=[]
    =================================
    0x924: v924(0x2db) = CONST 
    0x925: CALLPRIVATE v924(0x2db)

    Begin block 0x911
    prev=[0xd], succ=[]
    =================================
    0x912: v912(0x104) = CONST 
    0x913: CALLPRIVATE v912(0x104)
...
function proxyOwner()() public {
    ...
    prev=[0x3f6B0x30aB0x10f], succ=[0x771]
    =================================
    0x318S0x10f: JUMP v110(0x771)
    ...
    0x77f: v77f = AND v402V30aV10f, v77c(0xffffffffffffffffffffffffffffffffffffffff)
    0x781: MSTORE v774, v77f
    0x782: v782(0x20) = CONST 
    0x784: v784 = ADD v782(0x20), v774
    0x785: v785(0x40) = CONST 
    0x787: v787 = MLOAD v785(0x40)
    0x78a: v78a(0x20) = SUB v784, v787
...
function upgradeTo(string,address)() public {
    ...
    Begin block 0x1c8
    prev=[0x1bd], succ=[0x7ac]
    =================================
    0x1c9: v1c9(0x7ac) = CONST 
    ...
    0x218: CALLPRIVATE v212(0x3c1), v20f, v1e8, v1c9(0x7ac)
...
function implementation()() public {
    ...
    prev=[0x2faB0x226], succ=[0x7cd]
    =================================
    0x3090x2faS0x226: JUMP v227(0x7cd)
    ...
    0x7db: v7db = AND v306V226, v7d8(0xffffffffffffffffffffffffffffffffffffffff)
    0x7dd: MSTORE v7d0, v7db
    0x7de: v7de(0x20) = CONST 
    0x7e0: v7e0 = ADD v7de(0x20), v7d0
    0x7e1: v7e1(0x40) = CONST 
    0x7e3: v7e3 = MLOAD v7e1(0x40)
    0x7e6: v7e6(0x20) = SUB v7e0, v7e3
...
function upgradeabilityOwner()() public {
    ...
    0x816: v816 = AND v402V239, v813(0xffffffffffffffffffffffffffffffffffffffff)
    0x818: MSTORE v80b, v816
    0x819: v819(0x20) = CONST 
    0x81b: v81b = ADD v819(0x20), v80b
    0x81c: v81c(0x40) = CONST 
    0x81e: v81e = MLOAD v81c(0x40)
    0x821: v821(0x20) = SUB v81b, v81e
    0x823: RETURN v81e, v821(0x20)
...
function upgradeToAndCall(string,address,bytes)() public {
    ...
    0x2da: JUMP v2d0(0x405), v2b5, v28d, v261, v242(0x843)
    ...
    prev=[0x499B0x241], succ=[0x843]
    =================================
    0x4c1S0x241: JUMP v242(0x843)
...
function transferProxyOwnership(address)() public {
    ...
    0x2f9: JUMP v2f6(0x4c2), v2f5, v2e7(0x864)
    ...
    prev=[0x64dB0x2e6], succ=[0x864]
    =================================
    0x556S0x2e6: JUMP v2e7(0x864)
...
function 0x319(0x319arg0x0) private {
    ...
    Begin block 0x321
    prev=[0x67cB0x319], succ=[0x885, 0x371]
    =================================
    ...
    0x36d: v36d(0x885) = CONST 
    0x370: JUMPI v36d(0x885), v36c

    Begin block 0x885
    prev=[0x321], succ=[]
    =================================
    0x88e: RETURNPRIVATE v319arg0, v346
    ...
    0x388: v388(0x8ae) = CONST 
    0x38b: JUMP v388(0x8ae)

    Begin block 0x8ae
    prev=[0x379], succ=[]
    =================================
    0x8b7: RETURNPRIVATE v319arg0, v346
...
function 0x3c1(0x3c1arg0x0, 0x3c1arg0x1, 0x3c1arg0x2) private {
    ...
    0x6feS0x572: v6feV572(0x8d7) = CONST 
    ...
    prev=[0x71bB0x6fcB0x572, 0x70cB0x6fcB0x572], succ=[0x71bB0x6fcB0x572, 0x8faB0x6fcB0x572]
    =================================
    ...
    0x717S0x6fcS0x572: v717V6fcV572(0x8fa) = CONST 
    0x71aS0x6fcS0x572: JUMPI v717V6fcV572(0x8fa), v716V6fcV572
    ...
    Begin block 0x8faB0x6fcB0x572
    prev=[0x712B0x6fcB0x572], succ=[0x3070x70cB0x6fcB0x572]
    =================================
    0x8fdS0x6fcS0x572: JUMP v70dV6fcV572(0x307)

    Begin block 0x3070x70cB0x6fcB0x572
    prev=[0x8faB0x6fcB0x572], succ=[0x8d7B0x572]
    =================================
    0x3090x70cS0x6fcS0x572: JUMP v6feV572(0x8d7)

    Begin block 0x8d7B0x572
    prev=[0x3070x70cB0x6fcB0x572], succ=[0x585]
    =================================
    0x8daS0x572: JUMP v578(0x585)

    Begin block 0x585
    prev=[0x8d7B0x572], succ=[0x5f7]
    =================================
