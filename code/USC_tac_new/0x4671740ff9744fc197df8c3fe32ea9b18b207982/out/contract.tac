function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x4b2: v4b2(0x4c0) = CONST 
    0x4b3: JUMPI v4b2(0x4c0), v8

    Begin block 0xd
    prev=[0x0], succ=[0x40, 0x4c3]
    =================================
    ...
    0x4b5: JUMPI v4b4(0x4c3), v3b

    Begin block 0x40
    prev=[0xd], succ=[0x4c6, 0x4b]
    =================================
    0x41: v41(0x54fd4d50) = CONST 
    0x46: v46 = EQ v41(0x54fd4d50), v34
    0x4b6: v4b6(0x4c6) = CONST 
    0x4b7: JUMPI v4b6(0x4c6), v46

    Begin block 0x4c6
    prev=[0x40], succ=[]
    =================================
    0x4c7: v4c7(0xe8) = CONST 
    0x4c8: CALLPRIVATE v4c7(0xe8)

    Begin block 0x4b
    prev=[0x40], succ=[0x4c9, 0x56]
    =================================
    0x4c: v4c(0x5c60da1b) = CONST 
    0x51: v51 = EQ v4c(0x5c60da1b), v34
    0x4b8: v4b8(0x4c9) = CONST 
    0x4b9: JUMPI v4b8(0x4c9), v51

    Begin block 0x4c9
    prev=[0x4b], succ=[]
    =================================
    0x4ca: v4ca(0x10f) = CONST 
    0x4cb: CALLPRIVATE v4ca(0x10f)

    Begin block 0x56
    prev=[0x4b], succ=[0x4cc, 0x61]
    =================================
    0x57: v57(0x6fde8202) = CONST 
    0x5c: v5c = EQ v57(0x6fde8202), v34
    0x4ba: v4ba(0x4cc) = CONST 
    0x4bb: JUMPI v4ba(0x4cc), v5c

    Begin block 0x4cc
    prev=[0x56], succ=[]
    =================================
    0x4cd: v4cd(0x140) = CONST 
    0x4ce: CALLPRIVATE v4cd(0x140)

    Begin block 0x61
    prev=[0x56], succ=[0x4cf, 0x6c]
    =================================
    0x62: v62(0xa9c45fcb) = CONST 
    0x67: v67 = EQ v62(0xa9c45fcb), v34
    0x4bc: v4bc(0x4cf) = CONST 
    0x4bd: JUMPI v4bc(0x4cf), v67

    Begin block 0x4cf
    prev=[0x61], succ=[]
    =================================
    0x4d0: v4d0(0x155) = CONST 
    0x4d1: CALLPRIVATE v4d0(0x155)

    Begin block 0x6c
    prev=[0x61], succ=[0x4c0, 0x4d2]
    =================================
    0x6d: v6d(0xf1739cae) = CONST 
    0x72: v72 = EQ v6d(0xf1739cae), v34
    0x4be: v4be(0x4d2) = CONST 
    0x4bf: JUMPI v4be(0x4d2), v72

    Begin block 0x4c0
    prev=[0x0, 0x6c], succ=[]
    =================================
    0x4c1: v4c1(0x77) = CONST 
    0x4c2: CALLPRIVATE v4c1(0x77)

    Begin block 0x4d2
    prev=[0x6c], succ=[]
    =================================
    0x4d3: v4d3(0x179) = CONST 
    0x4d4: CALLPRIVATE v4d3(0x179)

    Begin block 0x4c3
    prev=[0xd], succ=[]
    =================================
    0x4c4: v4c4(0xc2) = CONST 
    0x4c5: CALLPRIVATE v4c4(0xc2)
...
function implementation()() public {
    ...
    0x428: v428 = AND v1a6V11b, v425(0xffffffffffffffffffffffffffffffffffffffff)
    0x42a: MSTORE v41d, v428
    0x42b: v42b = MLOAD v41a(0x40)
    0x42f: v42f(0x0) = SUB v41d, v42b
    0x430: v430(0x20) = CONST 
    0x432: v432(0x20) = ADD v430(0x20), v42f(0x0)
    0x434: RETURN v42b, v432(0x20)
...
function upgradeabilityOwner()() public {
    ...
    0x1e7S0x14c: JUMP v14e(0x454)

    Begin block 0x454
    prev=[0x1d9B0x14c], succ=[]
    =================================
    0x455: v455(0x40) = CONST 
    0x458: v458 = MLOAD v455(0x40)
    ...
    0x463: v463 = AND v1e5V14c, v460(0xffffffffffffffffffffffffffffffffffffffff)
    0x465: MSTORE v458, v463
    0x466: v466 = MLOAD v455(0x40)
    0x46a: v46a(0x0) = SUB v458, v466
    0x46b: v46b(0x20) = CONST 
    0x46d: v46d(0x20) = ADD v46b(0x20), v46a(0x0)
    0x46f: RETURN v466, v46d(0x20)
...
function upgradeToAndCall(uint256,address,bytes)() public {
    ...
    0x178: JUMP v175(0x1e8), v174, v171, v16a, v15c, v156(0x48f)
    ...
    prev=[0x20eB0x155], succ=[0x48f]
    =================================
    0x24fS0x155: JUMP v156(0x48f)
...
function transferProxyOwnership(address)() public {
    ...
    0x199: JUMP v196(0x250), v195, v187(0x4b0)
    ...
    prev=[0x37dB0x185], succ=[0x4b0]
    =================================
    0x2d7S0x185: JUMP v187(0x4b0)
...
function upgradeTo(uint256,address)() public {
    ...
    Begin block 0xce
    prev=[0xc2], succ=[0x3f8]
    =================================
    0xd0: vd0(0x3f8) = CONST 
    0xd3: vd3(0x4) = CONST 
    ...
    0xe5: CALLPRIVATE ve2(0x1a9), ve1, vd5, vd0(0x3f8)
