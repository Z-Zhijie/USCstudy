function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x4b9: v4b9(0x4c7) = CONST 
    0x4ba: JUMPI v4b9(0x4c7), v8

    Begin block 0xd
    prev=[0x0], succ=[0x40, 0x4ca]
    =================================
    ...
    0x4bb: v4bb(0x4ca) = CONST 
    0x4bc: JUMPI v4bb(0x4ca), v3b

    Begin block 0x40
    prev=[0xd], succ=[0x4cd, 0x4b]
    =================================
    0x41: v41(0x54fd4d50) = CONST 
    0x46: v46 = EQ v41(0x54fd4d50), v34
    0x4bd: v4bd(0x4cd) = CONST 
    0x4be: JUMPI v4bd(0x4cd), v46

    Begin block 0x4cd
    prev=[0x40], succ=[]
    =================================
    0x4ce: v4ce(0xe8) = CONST 
    0x4cf: CALLPRIVATE v4ce(0xe8)

    Begin block 0x4b
    prev=[0x40], succ=[0x4d0, 0x56]
    =================================
    0x4c: v4c(0x5c60da1b) = CONST 
    0x51: v51 = EQ v4c(0x5c60da1b), v34
    0x4bf: v4bf(0x4d0) = CONST 
    0x4c0: JUMPI v4bf(0x4d0), v51

    Begin block 0x4d0
    prev=[0x4b], succ=[]
    =================================
    0x4d1: v4d1(0x10f) = CONST 
    0x4d2: CALLPRIVATE v4d1(0x10f)

    Begin block 0x56
    prev=[0x4b], succ=[0x4d3, 0x61]
    =================================
    0x57: v57(0x6fde8202) = CONST 
    0x5c: v5c = EQ v57(0x6fde8202), v34
    0x4c1: v4c1(0x4d3) = CONST 
    0x4c2: JUMPI v4c1(0x4d3), v5c

    Begin block 0x4d3
    prev=[0x56], succ=[]
    =================================
    0x4d4: v4d4(0x140) = CONST 
    0x4d5: CALLPRIVATE v4d4(0x140)

    Begin block 0x61
    prev=[0x56], succ=[0x4d6, 0x6c]
    =================================
    0x62: v62(0xa9c45fcb) = CONST 
    0x67: v67 = EQ v62(0xa9c45fcb), v34
    0x4c3: v4c3(0x4d6) = CONST 
    0x4c4: JUMPI v4c3(0x4d6), v67

    Begin block 0x4d6
    prev=[0x61], succ=[]
    =================================
    0x4d7: v4d7(0x155) = CONST 
    0x4d8: CALLPRIVATE v4d7(0x155)

    Begin block 0x6c
    prev=[0x61], succ=[0x4c7, 0x4d9]
    =================================
    0x6d: v6d(0xf1739cae) = CONST 
    0x72: v72 = EQ v6d(0xf1739cae), v34
    0x4c5: v4c5(0x4d9) = CONST 
    0x4c6: JUMPI v4c5(0x4d9), v72

    Begin block 0x4c7
    prev=[0x0, 0x6c], succ=[]
    =================================
    0x4c8: v4c8(0x77) = CONST 
    0x4c9: CALLPRIVATE v4c8(0x77)

    Begin block 0x4d9
    prev=[0x6c], succ=[]
    =================================
    0x4da: v4da(0x179) = CONST 
    0x4db: CALLPRIVATE v4da(0x179)

    Begin block 0x4ca
    prev=[0xd], succ=[]
    =================================
    0x4cb: v4cb(0xc2) = CONST 
    0x4cc: CALLPRIVATE v4cb(0xc2)
...
function implementation()() public {
    ...
    0x42f: v42f = AND v1a6V11b, v42c(0xffffffffffffffffffffffffffffffffffffffff)
    0x431: MSTORE v424, v42f
    0x432: v432 = MLOAD v421(0x40)
    0x436: v436(0x0) = SUB v424, v432
    0x437: v437(0x20) = CONST 
    0x439: v439(0x20) = ADD v437(0x20), v436(0x0)
    0x43b: RETURN v432, v439(0x20)
...
function upgradeabilityOwner()() public {
    ...
    0x46a: v46a = AND v1e5V14c, v467(0xffffffffffffffffffffffffffffffffffffffff)
    0x46c: MSTORE v45f, v46a
    0x46d: v46d = MLOAD v45c(0x40)
    0x471: v471(0x0) = SUB v45f, v46d
    0x472: v472(0x20) = CONST 
    0x474: v474(0x20) = ADD v472(0x20), v471(0x0)
    0x476: RETURN v46d, v474(0x20)
...
function upgradeToAndCall(uint256,address,bytes)() public {
    ...
    0x178: JUMP v175(0x1e8), v174, v171, v16a, v15c, v156(0x496)
    ...
    prev=[0x20eB0x155], succ=[0x496]
    =================================
    0x24fS0x155: JUMP v156(0x496)
...
function transferProxyOwnership(address)() public {
    ...
    0x199: JUMP v196(0x250), v195, v187(0x4b7)
    ...
    prev=[0x37dB0x185], succ=[0x4b7]
    =================================
    0x2d7S0x185: JUMP v187(0x4b7)
...
function upgradeTo(uint256,address)() public {
    ...
    Begin block 0xce
    prev=[0xc2], succ=[0x3ff]
    =================================
    0xd0: vd0(0x3ff) = CONST 
    0xd3: vd3(0x4) = CONST 
    ...
    0xe5: CALLPRIVATE ve2(0x1a9), ve1, vd5, vd0(0x3ff)
