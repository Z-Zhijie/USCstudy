function __function_selector__() public {
    ...
    Begin block 0x4e
    prev=[0xd], succ=[0xb9d, 0x5a]
    =================================
    0x50: v50(0xc870f91) = CONST 
    0x55: v55 = EQ v50(0xc870f91), v12
    0xb94: vb94(0xb9d) = CONST 
    0xb95: JUMPI vb94(0xb9d), v55

    Begin block 0xb9d
    prev=[0x4e], succ=[]
    =================================
    0xb9e: vb9e(0x8b) = CONST 
    0xb9f: CALLPRIVATE vb9e(0x8b)

    Begin block 0x5a
    prev=[0x4e], succ=[0xba0, 0x65]
    =================================
    0x5b: v5b(0x3659cfe6) = CONST 
    0x60: v60 = EQ v5b(0x3659cfe6), v12
    0xb96: vb96(0xba0) = CONST 
    0xb97: JUMPI vb96(0xba0), v60

    Begin block 0xba0
    prev=[0x5a], succ=[]
    =================================
    0xba1: vba1(0xbc) = CONST 
    0xba2: CALLPRIVATE vba1(0xbc)

    Begin block 0x65
    prev=[0x5a], succ=[0x70, 0xba3]
    =================================
    0x66: v66(0x3e47158c) = CONST 
    0x6b: v6b = EQ v66(0x3e47158c), v12
    0xb98: vb98(0xba3) = CONST 
    0xb99: JUMPI vb98(0xba3), v6b
    ...
    prev=[0x65], succ=[]
    =================================
    0xba4: vba4(0xef) = CONST 
    0xba5: CALLPRIVATE vba4(0xef)

    Begin block 0x1e
    prev=[0xd], succ=[0xba6, 0x29]
    =================================
    0x1f: v1f(0x4f1ef286) = CONST 
    0x24: v24 = EQ v1f(0x4f1ef286), v12
    0xb8c: vb8c(0xba6) = CONST 
    0xb8d: JUMPI vb8c(0xba6), v24

    Begin block 0xba6
    prev=[0x1e], succ=[]
    =================================
    0xba7: vba7(0x104) = CONST 
    0xba8: CALLPRIVATE vba7(0x104)

    Begin block 0x29
    prev=[0x1e], succ=[0xba9, 0x34]
    =================================
    0x2a: v2a(0x5c60da1b) = CONST 
    0x2f: v2f = EQ v2a(0x5c60da1b), v12
    0xb8e: vb8e(0xba9) = CONST 
    0xb8f: JUMPI vb8e(0xba9), v2f

    Begin block 0xba9
    prev=[0x29], succ=[]
    =================================
    0xbaa: vbaa(0x184) = CONST 
    0xbab: CALLPRIVATE vbaa(0x184)

    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0xbac]
    =================================
    0x35: v35(0x8f283970) = CONST 
    0x3a: v3a = EQ v35(0x8f283970), v12
    0xb90: vb90(0xbac) = CONST 
    0xb91: JUMPI vb90(0xbac), v3a

    Begin block 0x3f
    prev=[0x34], succ=[0x4a, 0xbaf]
    =================================
    0x40: v40(0xf851a440) = CONST 
    0x45: v45 = EQ v40(0xf851a440), v12
    0xb92: vb92(0xbaf) = CONST 
    0xb93: JUMPI vb92(0xbaf), v45
    ...
    prev=[0x3f], succ=[]
    =================================
    0xbb0: vbb0(0x1cc) = CONST 
    0xbb1: CALLPRIVATE vbb0(0x1cc)

    Begin block 0xbac
    prev=[0x34], succ=[]
    =================================
    0xbad: vbad(0x199) = CONST 
    0xbae: CALLPRIVATE vbad(0x199)

    Begin block 0x74
    prev=[0x0], succ=[0xb9a, 0x83]
    =================================
    ...
    prev=[0x74], succ=[]
    =================================
    0xb9a: vb9a(0xb9c) = CONST 
    0xb9b: CALLPRIVATE vb9a(0xb9c)
...
function upgradeToAndCall(address,bytes)() public {
    ...
    0x3eeS0x279: v3eeV279(0xb1d) = CONST 
    ...
    prev=[0x6b9B0x637B0x3ebB0x279], succ=[0xb85B0x637B0x3ebB0x279]
    =================================
    0x6c4S0x637S0x3ebS0x279: v6c4V637V3ebV279(0xb85) = CONST 
    0x6c7S0x637S0x3ebS0x279: JUMP v6c4V637V3ebV279(0xb85)

    Begin block 0xb85B0x637B0x3ebB0x279
    prev=[0x6c2B0x637B0x3ebB0x279], succ=[0x647B0x3ebB0x279]
    =================================
    0xb8bS0x637S0x3ebS0x279: JUMP v63dV3ebV279(0x647)

    Begin block 0x647B0x3ebB0x279
    prev=[0xb85B0x637B0x3ebB0x279], succ=[0xb1dB0x279]
    =================================
    0x650S0x3ebS0x279: JUMP v3eeV279(0xb1d)

    Begin block 0xb1dB0x279
    prev=[0x647B0x3ebB0x279], succ=[0x2b9]
    =================================
    0xb23S0x279: JUMP v27a(0x2b9)

    Begin block 0x2b9
    prev=[0xb1dB0x279], succ=[0xa91]
    =================================
    0x2bb: v2bb(0xa91) = CONST 
    0x2be: JUMP v2bb(0xa91)

    Begin block 0xa91
    prev=[0x2b9], succ=[0x974]
    =================================
    0xa95: JUMP v105(0x974)
    ...
    =================================
    0x1ea0x104: v1041ea(0xa2c) = CONST 
...
function implementation()() public {
    ...
    Begin block 0x190
    prev=[0x184], succ=[0x995]
    =================================
    0x192: v192(0x995) = CONST 
    0x195: v195(0x2cc) = CONST 
    0x198: v198_0 = CALLPRIVATE v195(0x2cc), v192(0x995)
    ...
    0x9a4: v9a4 = AND v198_0, v9a1(0xffffffffffffffffffffffffffffffffffffffff)
...
function changeAdmin(address)() public {
    ...
    prev=[0x52b], succ=[0xa4d0x199]
    =================================
    0x2360x199: v199236(0xa4d) = CONST 
    0x2390x199: JUMP v199236(0xa4d)

    Begin block 0xa4d0x199
    prev=[0x2350x199], succ=[0x9d0]
    =================================
    0xa4f0x199: JUMP v1a7(0x9d0)

    Begin block 0x9d0
    prev=[0xa4d0x199], succ=[]
    =================================
    0x9d1: STOP 
    ...
    =================================
    0x23b0x199: v19923b(0xa6f) = CONST 
    ...
    =================================
    0x1ea0x199: v1991ea(0xa2c) = CONST 
...
function admin()() public {
    ...
    Begin block 0x1d8
    prev=[0x1cc], succ=[0x9f1]
    =================================
    0x1da: v1da(0x9f1) = CONST 
    0x1dd: v1dd(0x3c0) = CONST 
    0x1e0: v1e0_0 = CALLPRIVATE v1dd(0x3c0), v1da(0x9f1)
    ...
    0xa00: va00 = AND v1e0_0, v9fd(0xffffffffffffffffffffffffffffffffffffffff)
    0xa02: MSTORE v9f5, va00
    0xa03: va03 = MLOAD v9f2(0x40)
    0xa07: va07(0x0) = SUB v9f5, va03
    0xa08: va08(0x20) = CONST 
    0xa0a: va0a(0x20) = ADD va08(0x20), va07(0x0)
    0xa0c: RETURN va03, va0a(0x20)
...
function 0x2cc(0x2ccarg0x0) private {
    ...
    prev=[0x47dB0x2f0], succ=[0xad90x2cc]
    =================================
    0x2fa0x2cc: v2cc2fa(0xad9) = CONST 
    0x2fd0x2cc: JUMP v2cc2fa(0xad9)

    Begin block 0xad90x2cc
    prev=[0x2f70x2cc], succ=[]
    =================================
    0xadb0x2cc: RETURNPRIVATE v2ccarg0, v49fV2f0

    Begin block 0x2fe0x2cc
    prev=[0x2d6], succ=[0x1e10x2cc]
    =================================
    0x2ff0x2cc: v2cc2ff(0xafb) = CONST 
    ...
    =================================
    0x1ea0x2cc: v2cc1ea(0xa2c) = CONST 
...
function 0x3c0(0x3c0arg0x0) private {
    ...
    prev=[0x4c6B0x3e4], succ=[0xad90x3c0]
    =================================
    0x2fa0x3c0: v3c02fa(0xad9) = CONST 
    0x2fd0x3c0: JUMP v3c02fa(0xad9)

    Begin block 0xad90x3c0
    prev=[0x2f70x3c0], succ=[]
    =================================
    0xadb0x3c0: RETURNPRIVATE v3c0arg0, v4e8V3e4

    Begin block 0x2fe0x3c0
    prev=[0x3ca], succ=[0x1e10x3c0]
    =================================
    0x2ff0x3c0: v3c02ff(0xafb) = CONST 
    ...
    =================================
    0x1ea0x3c0: v3c01ea(0xa2c) = CONST 
...
function 0x41d(0x41darg0x0) private {
    ...
    Begin block 0x475
    prev=[0x425], succ=[0xb64B0x475]
    =================================
    0x476: v476(0xb43) = CONST 
    0x479: v479(0xb64) = CONST 
    0x47c: JUMP v479(0xb64), v476(0xb43)

    Begin block 0xb64B0x475
    prev=[0x475], succ=[0xb43]
    =================================
    0xb65S0x475: JUMP v476(0xb43)

    Begin block 0xb43
    prev=[0xb64B0x475], succ=[]
    =================================
    0xb44: RETURNPRIVATE v41darg0
...
function proxyImplementation()() public {
    ...
    prev=[0x2050x1fbB0x97], succ=[0x8dd]
    =================================
    0x20a0x1fbS0x97: JUMP v99(0x8dd)
    ...
    0x8ec: v8ec = AND v49fV1fbV97, v8e9(0xffffffffffffffffffffffffffffffffffffffff)
    0x8ee: MSTORE v8e1, v8ec
    0x8ef: v8ef = MLOAD v8de(0x40)
    0x8f3: v8f3(0x0) = SUB v8e1, v8ef
    0x8f4: v8f4(0x20) = CONST 
    0x8f6: v8f6(0x20) = ADD v8f4(0x20), v8f3(0x0)
    0x8f8: RETURN v8ef, v8f6(0x20)

}

function fallback()() public {
    Begin block 0xb9c
    prev=[], succ=[0x1e10xb9c]
    =================================
    0x7a: v7a(0x89b) = CONST 
    0x7d: v7d(0x1e1) = CONST 
    0x80: JUMP v7d(0x1e1)

    Begin block 0x1e10xb9c
    prev=[0xb9c], succ=[0x1e90xb9c]
    =================================
    0x1e20xb9c: vb9c1e2(0x1e9) = CONST 
    0x1e50xb9c: vb9c1e5(0x41d) = CONST 
    0x1e80xb9c: CALLPRIVATE vb9c1e5(0x41d), vb9c1e2(0x1e9)

    Begin block 0x1e90xb9c
    prev=[0x1e10xb9c], succ=[0x47dB0x1e90xb9c]
    =================================
    0x1ea0xb9c: vb9c1ea(0xa2c) = CONST 
    0x1ed0xb9c: vb9c1ed(0x1f4) = CONST 
    0x1f00xb9c: vb9c1f0(0x47d) = CONST 
    0x1f30xb9c: JUMP vb9c1f0(0x47d)

    Begin block 0x47dB0x1e90xb9c
    prev=[0x1e90xb9c], succ=[0x1f40xb9c]
    =================================
    0x47eS0x1e90xb9c: v47eV1e9b9c(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc) = CONST 
    0x49fS0x1e90xb9c: v49fV1e9b9c = SLOAD v47eV1e9b9c(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc)
    0x4a1S0x1e90xb9c: JUMP vb9c1ed(0x1f4)

    Begin block 0x1f40xb9c
    prev=[0x47dB0x1e90xb9c], succ=[0x4a20xb9c]
    =================================
    0x1f50xb9c: vb9c1f5(0x4a2) = CONST 
    0x1f80xb9c: JUMP vb9c1f5(0x4a2)

    Begin block 0x4a20xb9c
    prev=[0x1f40xb9c], succ=[0x4bd0xb9c, 0x4c10xb9c]
    =================================
    0x4a30xb9c: vb9c4a3 = CALLDATASIZE 
    0x4a40xb9c: vb9c4a4(0x0) = CONST 
    0x4a70xb9c: CALLDATACOPY vb9c4a4(0x0), vb9c4a4(0x0), vb9c4a3
    0x4a80xb9c: vb9c4a8(0x0) = CONST 
    0x4ab0xb9c: vb9c4ab = CALLDATASIZE 
    0x4ac0xb9c: vb9c4ac(0x0) = CONST 
    0x4af0xb9c: vb9c4af = GAS 
    0x4b00xb9c: vb9c4b0 = DELEGATECALL vb9c4af, v49fV1e9b9c, vb9c4ac(0x0), vb9c4ab, vb9c4a8(0x0), vb9c4a8(0x0)
    0x4b10xb9c: vb9c4b1 = RETURNDATASIZE 
    0x4b20xb9c: vb9c4b2(0x0) = CONST 
    0x4b50xb9c: RETURNDATACOPY vb9c4b2(0x0), vb9c4b2(0x0), vb9c4b1
    0x4b80xb9c: vb9c4b8 = ISZERO vb9c4b0
    0x4b90xb9c: vb9c4b9(0x4c1) = CONST 
    0x4bc0xb9c: JUMPI vb9c4b9(0x4c1), vb9c4b8

    Begin block 0x4bd0xb9c
    prev=[0x4a20xb9c], succ=[]
    =================================
    0x4bd0xb9c: vb9c4bd = RETURNDATASIZE 
    0x4be0xb9c: vb9c4be(0x0) = CONST 
    0x4c00xb9c: RETURN vb9c4be(0x0), vb9c4bd

    Begin block 0x4c10xb9c
    prev=[0x4a20xb9c], succ=[]
    =================================
    0x4c20xb9c: vb9c4c2 = RETURNDATASIZE 
    0x4c30xb9c: vb9c4c3(0x0) = CONST 
    0x4c50xb9c: REVERT vb9c4c3(0x0), vb9c4c2
...
function upgradeTo(address)() public {
    ...
    prev=[0x22d], succ=[0xa4d0xbc]
    =================================
    0x2360xbc: vbc236(0xa4d) = CONST 
    0x2390xbc: JUMP vbc236(0xa4d)

    Begin block 0xa4d0xbc
    prev=[0x2350xbc], succ=[0x918]
    =================================
    0xa4f0xbc: JUMP vca(0x918)
...
function proxyAdmin()() public {
    ...
    prev=[0x2050x245B0xfb], succ=[0x939]
    =================================
    0x20a0x245S0xfb: JUMP vfd(0x939)
    ...
    0x948: v948 = AND v4e8V245Vfb, v945(0xffffffffffffffffffffffffffffffffffffffff)
    0x94a: MSTORE v93d, v948
    0x94b: v94b = MLOAD v93a(0x40)
    0x94f: v94f(0x0) = SUB v93d, v94b
    0x950: v950(0x20) = CONST 
    0x952: v952(0x20) = ADD v950(0x20), v94f(0x0)
    0x954: RETURN v94b, v952(0x20)
