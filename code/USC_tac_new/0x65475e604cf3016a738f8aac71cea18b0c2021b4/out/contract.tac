function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x4a4: v4a4(0x4b2) = CONST 
    0x4a5: JUMPI v4a4(0x4b2), v8

    Begin block 0xd
    prev=[0x0], succ=[0x40, 0x4b5]
    =================================
    ...
    0x4a6: v4a6(0x4b5) = CONST 
    0x4a7: JUMPI v4a6(0x4b5), v3b

    Begin block 0x40
    prev=[0xd], succ=[0x4b8, 0x4b]
    =================================
    0x41: v41(0x54fd4d50) = CONST 
    0x46: v46 = EQ v41(0x54fd4d50), v34
    0x4a8: v4a8(0x4b8) = CONST 
    0x4a9: JUMPI v4a8(0x4b8), v46

    Begin block 0x4b8
    prev=[0x40], succ=[]
    =================================
    0x4b9: v4b9(0xe8) = CONST 
    0x4ba: CALLPRIVATE v4b9(0xe8)

    Begin block 0x4b
    prev=[0x40], succ=[0x4bb, 0x56]
    =================================
    0x4c: v4c(0x5c60da1b) = CONST 
    0x51: v51 = EQ v4c(0x5c60da1b), v34
    0x4aa: v4aa(0x4bb) = CONST 
    0x4ab: JUMPI v4aa(0x4bb), v51

    Begin block 0x4bb
    prev=[0x4b], succ=[]
    =================================
    0x4bc: v4bc(0x10f) = CONST 
    0x4bd: CALLPRIVATE v4bc(0x10f)

    Begin block 0x56
    prev=[0x4b], succ=[0x4be, 0x61]
    =================================
    0x57: v57(0x6fde8202) = CONST 
    0x5c: v5c = EQ v57(0x6fde8202), v34
    0x4ac: v4ac(0x4be) = CONST 
    0x4ad: JUMPI v4ac(0x4be), v5c

    Begin block 0x4be
    prev=[0x56], succ=[]
    =================================
    0x4bf: v4bf(0x140) = CONST 
    0x4c0: CALLPRIVATE v4bf(0x140)

    Begin block 0x61
    prev=[0x56], succ=[0x4c1, 0x6c]
    =================================
    0x62: v62(0xa9c45fcb) = CONST 
    0x67: v67 = EQ v62(0xa9c45fcb), v34
    0x4ae: v4ae(0x4c1) = CONST 
    0x4af: JUMPI v4ae(0x4c1), v67

    Begin block 0x4c1
    prev=[0x61], succ=[]
    =================================
    0x4c2: v4c2(0x155) = CONST 
    0x4c3: CALLPRIVATE v4c2(0x155)

    Begin block 0x6c
    prev=[0x61], succ=[0x4b2, 0x4c4]
    =================================
    0x6d: v6d(0xf1739cae) = CONST 
    0x72: v72 = EQ v6d(0xf1739cae), v34
    0x4b0: v4b0(0x4c4) = CONST 
    0x4b1: JUMPI v4b0(0x4c4), v72

    Begin block 0x4b2
    prev=[0x0, 0x6c], succ=[]
    =================================
    0x4b3: v4b3(0x77) = CONST 
    0x4b4: CALLPRIVATE v4b3(0x77)

    Begin block 0x4c4
    prev=[0x6c], succ=[]
    =================================
    0x4c5: v4c5(0x179) = CONST 
    0x4c6: CALLPRIVATE v4c5(0x179)

    Begin block 0x4b5
    prev=[0xd], succ=[]
    =================================
    0x4b6: v4b6(0xc2) = CONST 
    0x4b7: CALLPRIVATE v4b6(0xc2)
...
function implementation()() public {
    ...
    0x41a: v41a = AND v1a6V11b, v417(0xffffffffffffffffffffffffffffffffffffffff)
    0x41c: MSTORE v40f, v41a
    0x41d: v41d = MLOAD v40c(0x40)
    0x421: v421(0x0) = SUB v40f, v41d
    0x422: v422(0x20) = CONST 
    0x424: v424(0x20) = ADD v422(0x20), v421(0x0)
    0x426: RETURN v41d, v424(0x20)
...
function upgradeabilityOwner()() public {
    ...
    0x455: v455 = AND v1e5V14c, v452(0xffffffffffffffffffffffffffffffffffffffff)
    0x457: MSTORE v44a, v455
    0x458: v458 = MLOAD v447(0x40)
    0x45c: v45c(0x0) = SUB v44a, v458
    0x45d: v45d(0x20) = CONST 
    0x45f: v45f(0x20) = ADD v45d(0x20), v45c(0x0)
    0x461: RETURN v458, v45f(0x20)
...
function upgradeToAndCall(uint256,address,bytes)() public {
    ...
    0x178: JUMP v175(0x1e8), v174, v171, v16a, v15c, v156(0x481)
    ...
    prev=[0x20eB0x155], succ=[0x481]
    =================================
    0x24fS0x155: JUMP v156(0x481)
...
function transferProxyOwnership(address)() public {
    ...
    0x199: JUMP v196(0x250), v195, v187(0x4a2)
    ...
    prev=[0x37dB0x185], succ=[0x4a2]
    =================================
    0x2d7S0x185: JUMP v187(0x4a2)
...
function upgradeTo(uint256,address)() public {
    ...
    Begin block 0xce
    prev=[0xc2], succ=[0x3ea]
    =================================
    0xd0: vd0(0x3ea) = CONST 
    0xd3: vd3(0x4) = CONST 
    ...
    0xe5: CALLPRIVATE ve2(0x1a9), ve1, vd5, vd0(0x3ea)
