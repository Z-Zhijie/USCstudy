function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x97e: v97e(0x98a) = CONST 
    0x97f: JUMPI v97e(0x98a), v8
    ...
    Begin block 0x43
    prev=[0xd], succ=[0x98d, 0x4f]
    =================================
    0x45: v45(0x3659cfe6) = CONST 
    0x4a: v4a = EQ v45(0x3659cfe6), v12
    0x986: v986(0x98d) = CONST 
    0x987: JUMPI v986(0x98d), v4a

    Begin block 0x98d
    prev=[0x43], succ=[]
    =================================
    0x98e: v98e(0x64) = CONST 
    0x98f: CALLPRIVATE v98e(0x64)

    Begin block 0x4f
    prev=[0x43], succ=[0x98a, 0x990]
    =================================
    0x50: v50(0x4f1ef286) = CONST 
    0x55: v55 = EQ v50(0x4f1ef286), v12
    0x988: v988(0x990) = CONST 
    0x989: JUMPI v988(0x990), v55

    Begin block 0x98a
    prev=[0x0, 0x4f], succ=[]
    =================================
    0x98b: v98b(0x5a) = CONST 
    0x98c: CALLPRIVATE v98b(0x5a)

    Begin block 0x990
    prev=[0x4f], succ=[]
    =================================
    0x991: v991(0xa4) = CONST 
    0x992: CALLPRIVATE v991(0xa4)

    Begin block 0x1e
    prev=[0xd], succ=[0x993, 0x29]
    =================================
    0x1f: v1f(0x5c60da1b) = CONST 
    0x24: v24 = EQ v1f(0x5c60da1b), v12
    0x980: v980(0x993) = CONST 
    0x981: JUMPI v980(0x993), v24

    Begin block 0x993
    prev=[0x1e], succ=[]
    =================================
    0x994: v994(0x131) = CONST 
    0x995: CALLPRIVATE v994(0x131)

    Begin block 0x29
    prev=[0x1e], succ=[0x996, 0x34]
    =================================
    0x2a: v2a(0x8f283970) = CONST 
    0x2f: v2f = EQ v2a(0x8f283970), v12
    0x982: v982(0x996) = CONST 
    0x983: JUMPI v982(0x996), v2f

    Begin block 0x996
    prev=[0x29], succ=[]
    =================================
    0x997: v997(0x16f) = CONST 
    0x998: CALLPRIVATE v997(0x16f)

    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0x999]
    =================================
    0x35: v35(0xf851a440) = CONST 
    0x3a: v3a = EQ v35(0xf851a440), v12
    0x984: v984(0x999) = CONST 
    0x985: JUMPI v984(0x999), v3a
    ...
    prev=[0x34], succ=[]
    =================================
    0x99a: v99a(0x1af) = CONST 
    0x99b: CALLPRIVATE v99a(0x1af)
...
function implementation()() public {
    ...
    0x51eS0x309S0x13d: JUMP v30cV13d(0x913)

    Begin block 0x913B0x13d
    prev=[0x4faB0x309B0x13d], succ=[0x7b5]
    =================================
    0x917S0x13d: JUMP v13f(0x7b5)

    Begin block 0x7b5
    prev=[0x913B0x13d], succ=[]
    =================================
    0x7b6: v7b6(0x40) = CONST 
    0x7b9: v7b9 = MLOAD v7b6(0x40)
    0x7ba: v7ba(0xffffffffffffffffffffffffffffffffffffffff) = CONST 
    0x7d1: v7d1 = AND v51cV309V13d, v7ba(0xffffffffffffffffffffffffffffffffffffffff)
    0x7d3: MSTORE v7b9, v7d1
    0x7d4: v7d4 = MLOAD v7b6(0x40)
    0x7d8: v7d8(0x0) = SUB v7b9, v7d4
    0x7d9: v7d9(0x20) = CONST 
    0x7db: v7db(0x20) = ADD v7d9(0x20), v7d8(0x0)
    0x7dd: RETURN v7d4, v7db(0x20)
...
function changeAdmin(address)() public {
    ...
    prev=[0x5bd], succ=[0x8870x16f]
    =================================
    0x2230x16f: v16f223(0x887) = CONST 
    0x2260x16f: JUMP v16f223(0x887)

    Begin block 0x8870x16f
    prev=[0x2220x16f], succ=[0x7fd]
    =================================
    0x8890x16f: JUMP v17d(0x7fd)

    Begin block 0x7fd
    prev=[0x8870x16f], succ=[]
    =================================
    0x7fe: STOP 
    ...
    =================================
    0x2280x16f: v16f228(0x8a9) = CONST 
    ...
    =================================
    0x1cd0x16f: v16f1cd(0x866) = CONST 
...
function admin()() public {
    ...
    0x567S0x420S0x1bb: JUMP v423V1bb(0x937)

    Begin block 0x937B0x1bb
    prev=[0x543B0x420B0x1bb], succ=[0x81e]
    =================================
    0x93bS0x1bb: JUMP v1bd(0x81e)

    Begin block 0x81e
    prev=[0x937B0x1bb], succ=[]
    =================================
    0x81f: v81f(0x40) = CONST 
    0x822: v822 = MLOAD v81f(0x40)
    0x823: v823(0xffffffffffffffffffffffffffffffffffffffff) = CONST 
    0x83a: v83a = AND v565V420V1bb, v823(0xffffffffffffffffffffffffffffffffffffffff)
    0x83c: MSTORE v822, v83a
    0x83d: v83d = MLOAD v81f(0x40)
    0x841: v841(0x0) = SUB v822, v83d
    0x842: v842(0x20) = CONST 
    0x844: v844(0x20) = ADD v842(0x20), v841(0x0)
    0x846: RETURN v83d, v844(0x20)
...
function 0x466(0x466arg0x0) private {
    ...
    Begin block 0x4f2
    prev=[0x46e], succ=[0x97cB0x4f2]
    =================================
    0x4f3: v4f3(0x95b) = CONST 
    0x4f6: v4f6(0x97c) = CONST 
    0x4f9: JUMP v4f6(0x97c), v4f3(0x95b)

    Begin block 0x97cB0x4f2
    prev=[0x4f2], succ=[0x95b]
    =================================
    0x97dS0x4f2: JUMP v4f3(0x95b)

    Begin block 0x95b
    prev=[0x97cB0x4f2], succ=[]
    =================================
    0x95c: RETURNPRIVATE v466arg0
...
function upgradeTo(address)() public {
    ...
    prev=[0x21a], succ=[0x8870x64]
    =================================
    0x2230x64: v64223(0x887) = CONST 
    0x2260x64: JUMP v64223(0x887)

    Begin block 0x8870x64
    prev=[0x2220x64], succ=[0x773]
    =================================
    0x8890x64: JUMP v72(0x773)
...
function upgradeToAndCall(address,bytes)() public {
    ...
    Begin block 0x2f6
    prev=[0x2e8], succ=[0x8cb]
    =================================
    0x2f8: v2f8(0x8cb) = CONST 
    0x2fb: JUMP v2f8(0x8cb)

    Begin block 0x8cb
    prev=[0x2f6], succ=[0x794]
    =================================
    0x8cf: JUMP va5(0x794)
