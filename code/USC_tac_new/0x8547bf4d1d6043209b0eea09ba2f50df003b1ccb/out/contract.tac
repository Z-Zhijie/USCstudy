function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x8a2: v8a2(0x8ae) = CONST 
    0x8a3: JUMPI v8a2(0x8ae), v8

    Begin block 0xd
    prev=[0x0], succ=[0x8b1, 0x3a]
    =================================
    ...
    0x8a5: JUMPI v8a4(0x8b1), v35

    Begin block 0x8b1
    prev=[0xd], succ=[]
    =================================
    0x8b2: v8b2(0x70) = CONST 
    0x8b3: CALLPRIVATE v8b2(0x70)

    Begin block 0x3a
    prev=[0xd], succ=[0x8b4, 0x45]
    =================================
    0x3b: v3b(0x4f1ef286) = CONST 
    0x40: v40 = EQ v3b(0x4f1ef286), v2e
    0x8a6: v8a6(0x8b4) = CONST 
    0x8a7: JUMPI v8a6(0x8b4), v40

    Begin block 0x8b4
    prev=[0x3a], succ=[]
    =================================
    0x8b5: v8b5(0xa3) = CONST 
    0x8b6: CALLPRIVATE v8b5(0xa3)

    Begin block 0x45
    prev=[0x3a], succ=[0x8b7, 0x50]
    =================================
    0x46: v46(0x5c60da1b) = CONST 
    0x4b: v4b = EQ v46(0x5c60da1b), v2e
    0x8a8: v8a8(0x8b7) = CONST 
    0x8a9: JUMPI v8a8(0x8b7), v4b

    Begin block 0x8b7
    prev=[0x45], succ=[]
    =================================
    0x8b8: v8b8(0x123) = CONST 
    0x8b9: CALLPRIVATE v8b8(0x123)

    Begin block 0x50
    prev=[0x45], succ=[0x8ba, 0x5b]
    =================================
    0x51: v51(0x8f283970) = CONST 
    0x56: v56 = EQ v51(0x8f283970), v2e
    0x8aa: v8aa(0x8ba) = CONST 
    0x8ab: JUMPI v8aa(0x8ba), v56

    Begin block 0x8ba
    prev=[0x50], succ=[]
    =================================
    0x8bb: v8bb(0x154) = CONST 
    0x8bc: CALLPRIVATE v8bb(0x154)

    Begin block 0x5b
    prev=[0x50], succ=[0x8ae, 0x8bd]
    =================================
    0x5c: v5c(0xf851a440) = CONST 
    0x61: v61 = EQ v5c(0xf851a440), v2e
    0x8ac: v8ac(0x8bd) = CONST 
    0x8ad: JUMPI v8ac(0x8bd), v61

    Begin block 0x8ae
    prev=[0x0, 0x5b], succ=[]
    =================================
    0x8af: v8af(0x66) = CONST 
    0x8b0: CALLPRIVATE v8af(0x66)

    Begin block 0x8bd
    prev=[0x5b], succ=[]
    =================================
    0x8be: v8be(0x187) = CONST 
    0x8bf: CALLPRIVATE v8be(0x187)
...
function implementation()() public {
    ...
    Begin block 0x12f
    prev=[0x123], succ=[0x6f7]
    =================================
    0x131: v131(0x6f7) = CONST 
    0x134: v134(0x29f) = CONST 
    0x137: v137_0 = CALLPRIVATE v134(0x29f), v131(0x6f7)
    ...
    0x706: v706 = AND v137_0, v703(0xffffffffffffffffffffffffffffffffffffffff)
...
function changeAdmin(address)() public {
    ...
    prev=[0x4fc], succ=[0x7af0x154]
    =================================
    0x1e10x154: v1541e1(0x7af) = CONST 
    0x1e40x154: JUMP v1541e1(0x7af)

    Begin block 0x7af0x154
    prev=[0x1e00x154], succ=[0x732]
    =================================
    0x7b10x154: JUMP v162(0x732)

    Begin block 0x732
    prev=[0x7af0x154], succ=[]
    =================================
    0x733: STOP 
    ...
    =================================
    0x1e60x154: v1541e6(0x7d1) = CONST 
    ...
    =================================
    0x1a50x154: v1541a5(0x78e) = CONST 
...
function admin()() public {
    ...
    Begin block 0x193
    prev=[0x187], succ=[0x753]
    =================================
    0x195: v195(0x753) = CONST 
    0x198: v198(0x3b2) = CONST 
    0x19b: v19b_0 = CALLPRIVATE v198(0x3b2), v195(0x753)
    ...
    0x762: v762 = AND v19b_0, v75f(0xffffffffffffffffffffffffffffffffffffffff)
    0x764: MSTORE v757, v762
    0x765: v765 = MLOAD v754(0x40)
    0x769: v769(0x0) = SUB v757, v765
    0x76a: v76a(0x20) = CONST 
    0x76c: v76c(0x20) = ADD v76a(0x20), v769(0x0)
    0x76e: RETURN v765, v76c(0x20)
...
function 0x29f(0x29farg0x0) private {
    ...
    prev=[0x44eB0x2c3], succ=[0x83b0x29f]
    =================================
    0x2cd0x29f: v29f2cd(0x83b) = CONST 
    0x2d00x29f: JUMP v29f2cd(0x83b)

    Begin block 0x83b0x29f
    prev=[0x2ca0x29f], succ=[]
    =================================
    0x83d0x29f: RETURNPRIVATE v29farg0, v470V2c3

    Begin block 0x2d10x29f
    prev=[0x2a9], succ=[0x19c0x29f]
    =================================
    0x2d20x29f: v29f2d2(0x85d) = CONST 
    ...
    =================================
    0x1a50x29f: v29f1a5(0x78e) = CONST 
...
function 0x3b2(0x3b2arg0x0) private {
    ...
    prev=[0x497B0x3d6], succ=[0x83b0x3b2]
    =================================
    0x2cd0x3b2: v3b22cd(0x83b) = CONST 
    0x2d00x3b2: JUMP v3b22cd(0x83b)

    Begin block 0x83b0x3b2
    prev=[0x2ca0x3b2], succ=[]
    =================================
    0x83d0x3b2: RETURNPRIVATE v3b2arg0, v4b9V3d6

    Begin block 0x2d10x3b2
    prev=[0x3bc], succ=[0x19c0x3b2]
    =================================
    0x2d20x3b2: v3b22d2(0x85d) = CONST 
    ...
    =================================
    0x1a50x3b2: v3b21a5(0x78e) = CONST 
...
function 0x3dd(0x3ddarg0x0) private {
    ...
    Begin block 0x446
    prev=[0x3e5], succ=[0x8a0B0x446]
    =================================
    0x447: v447(0x87f) = CONST 
    0x44a: v44a(0x8a0) = CONST 
    0x44d: JUMP v44a(0x8a0), v447(0x87f)

    Begin block 0x8a0B0x446
    prev=[0x446], succ=[0x87f]
    =================================
    0x8a1S0x446: JUMP v447(0x87f)

    Begin block 0x87f
    prev=[0x8a0B0x446], succ=[]
    =================================
    0x880: RETURNPRIVATE v3ddarg0
...
function upgradeTo(address)() public {
    ...
    prev=[0x1d8], succ=[0x7af0x70]
    =================================
    0x1e10x70: v701e1(0x7af) = CONST 
    0x1e40x70: JUMP v701e1(0x7af)

    Begin block 0x7af0x70
    prev=[0x1e00x70], succ=[0x6b5]
    =================================
    0x7b10x70: JUMP v7e(0x6b5)
...
function upgradeToAndCall(address,bytes)() public {
    ...
    Begin block 0x28c
    prev=[0x27c], succ=[0x7f3]
    =================================
    0x28e: v28e(0x7f3) = CONST 
    0x291: JUMP v28e(0x7f3)

    Begin block 0x7f3
    prev=[0x28c], succ=[0x6d6]
    =================================
    0x7f7: JUMP va4(0x6d6)
