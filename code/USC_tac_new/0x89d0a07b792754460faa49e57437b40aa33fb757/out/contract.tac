function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x847: v847(0x861) = CONST 
    0x848: JUMPI v847(0x861), v8

    Begin block 0xd
    prev=[0x0], succ=[0x40, 0x864]
    =================================
    ...
    0x849: v849(0x864) = CONST 
    0x84a: JUMPI v849(0x864), v3b

    Begin block 0x40
    prev=[0xd], succ=[0x867, 0x4b]
    =================================
    0x41: v41(0x178e6079) = CONST 
    0x46: v46 = EQ v41(0x178e6079), v34
    0x84b: v84b(0x867) = CONST 
    0x84c: JUMPI v84b(0x867), v46

    Begin block 0x867
    prev=[0x40], succ=[]
    =================================
    0x868: v868(0x149) = CONST 
    0x869: CALLPRIVATE v868(0x149)

    Begin block 0x4b
    prev=[0x40], succ=[0x86a, 0x56]
    =================================
    0x4c: v4c(0x25012699) = CONST 
    0x51: v51 = EQ v4c(0x25012699), v34
    0x84d: v84d(0x86a) = CONST 
    0x84e: JUMPI v84d(0x86a), v51

    Begin block 0x86a
    prev=[0x4b], succ=[]
    =================================
    0x86b: v86b(0x15c) = CONST 
    0x86c: CALLPRIVATE v86b(0x15c)

    Begin block 0x56
    prev=[0x4b], succ=[0x86d, 0x61]
    =================================
    0x57: v57(0x3bc7ebac) = CONST 
    0x5c: v5c = EQ v57(0x3bc7ebac), v34
    0x84f: v84f(0x86d) = CONST 
    0x850: JUMPI v84f(0x86d), v5c

    Begin block 0x86d
    prev=[0x56], succ=[]
    =================================
    0x86e: v86e(0x16f) = CONST 
    0x86f: CALLPRIVATE v86e(0x16f)

    Begin block 0x61
    prev=[0x56], succ=[0x870, 0x6c]
    =================================
    0x62: v62(0x756f6049) = CONST 
    0x67: v67 = EQ v62(0x756f6049), v34
    0x851: v851(0x870) = CONST 
    0x852: JUMPI v851(0x870), v67

    Begin block 0x870
    prev=[0x61], succ=[]
    =================================
    0x871: v871(0x1ab) = CONST 
    0x872: CALLPRIVATE v871(0x1ab)

    Begin block 0x6c
    prev=[0x61], succ=[0x873, 0x77]
    =================================
    0x6d: v6d(0x80afdea8) = CONST 
    0x72: v72 = EQ v6d(0x80afdea8), v34
    0x853: v853(0x873) = CONST 
    0x854: JUMPI v853(0x873), v72

    Begin block 0x873
    prev=[0x6c], succ=[]
    =================================
    0x874: v874(0x1be) = CONST 
    0x875: CALLPRIVATE v874(0x1be)

    Begin block 0x77
    prev=[0x6c], succ=[0x876, 0x82]
    =================================
    0x78: v78(0xa3b4b07f) = CONST 
    0x7d: v7d = EQ v78(0xa3b4b07f), v34
    0x855: v855(0x876) = CONST 
    0x856: JUMPI v855(0x876), v7d

    Begin block 0x876
    prev=[0x77], succ=[]
    =================================
    0x877: v877(0x1d1) = CONST 
    0x878: CALLPRIVATE v877(0x1d1)

    Begin block 0x82
    prev=[0x77], succ=[0x879, 0x8d]
    =================================
    0x83: v83(0xcbcc65eb) = CONST 
    0x88: v88 = EQ v83(0xcbcc65eb), v34
    0x857: v857(0x879) = CONST 
    0x858: JUMPI v857(0x879), v88

    Begin block 0x879
    prev=[0x82], succ=[]
    =================================
    0x87a: v87a(0x1e4) = CONST 
    0x87b: CALLPRIVATE v87a(0x1e4)

    Begin block 0x8d
    prev=[0x82], succ=[0x87c, 0x98]
    =================================
    0x8e: v8e(0xd4aae0c4) = CONST 
    0x93: v93 = EQ v8e(0xd4aae0c4), v34
    0x859: v859(0x87c) = CONST 
    0x85a: JUMPI v859(0x87c), v93

    Begin block 0x87c
    prev=[0x8d], succ=[]
    =================================
    0x87d: v87d(0x1f7) = CONST 
    0x87e: CALLPRIVATE v87d(0x1f7)

    Begin block 0x98
    prev=[0x8d], succ=[0x87f, 0xa3]
    =================================
    0x99: v99(0xdaa3a163) = CONST 
    0x9e: v9e = EQ v99(0xdaa3a163), v34
    0x85b: v85b(0x87f) = CONST 
    0x85c: JUMPI v85b(0x87f), v9e

    Begin block 0x87f
    prev=[0x98], succ=[]
    =================================
    0x880: v880(0x20a) = CONST 
    0x881: CALLPRIVATE v880(0x20a)

    Begin block 0xa3
    prev=[0x98], succ=[0x882, 0xae]
    =================================
    0xa4: va4(0xdb8a61d4) = CONST 
    0xa9: va9 = EQ va4(0xdb8a61d4), v34
    0x85d: v85d(0x882) = CONST 
    0x85e: JUMPI v85d(0x882), va9

    Begin block 0x882
    prev=[0xa3], succ=[]
    =================================
    0x883: v883(0x231) = CONST 
    0x884: CALLPRIVATE v883(0x231)

    Begin block 0xae
    prev=[0xa3], succ=[0x861, 0x885]
    =================================
    0xaf: vaf(0xea879634) = CONST 
    0xb4: vb4 = EQ vaf(0xea879634), v34
    0x85f: v85f(0x885) = CONST 
    0x860: JUMPI v85f(0x885), vb4

    Begin block 0x861
    prev=[0x0, 0xae], succ=[]
    =================================
    0x862: v862(0xb9) = CONST 
    0x863: CALLPRIVATE v862(0xb9)

    Begin block 0x885
    prev=[0xae], succ=[]
    =================================
    0x886: v886(0x244) = CONST 
    0x887: CALLPRIVATE v886(0x244)

    Begin block 0x864
    prev=[0xd], succ=[]
    =================================
    0x865: v865(0x124) = CONST 
    0x866: CALLPRIVATE v865(0x124)
...
function KERNEL_APP_ID()() public {
    ...
    =================================
    0x130: v130(0x606) = CONST 
    0x133: v133(0x2a1) = CONST 
    0x136: JUMP v133(0x2a1)

    Begin block 0x2a1
    prev=[0x12f], succ=[0x606]
    =================================
    ...
    0x60c: MSTORE v609, v2d2
    0x60d: v60d(0x20) = CONST 
    0x60f: v60f = ADD v60d(0x20), v609
    0x610: v610(0x40) = CONST 
    0x612: v612 = MLOAD v610(0x40)
    0x615: v615(0x20) = SUB v60f, v612
    0x617: RETURN v612, v615(0x20)
...
function APP_ADDR_NAMESPACE()() public {
    ...
    =================================
    0x155: v155(0x637) = CONST 
    0x158: v158(0x2d5) = CONST 
    0x15b: JUMP v158(0x2d5)

    Begin block 0x2d5
    prev=[0x154], succ=[0x637]
    =================================
    ...
    0x63d: MSTORE v63a, v306
    0x63e: v63e(0x20) = CONST 
    0x640: v640 = ADD v63e(0x20), v63a
    0x641: v641(0x40) = CONST 
    0x643: v643 = MLOAD v641(0x40)
    0x646: v646(0x20) = SUB v640, v643
    0x648: RETURN v643, v646(0x20)
...
function KERNEL_APP()() public {
    ...
    =================================
    0x168: v168(0x668) = CONST 
    0x16b: v16b(0x309) = CONST 
    0x16e: JUMP v16b(0x309)

    Begin block 0x309
    prev=[0x167], succ=[0x668]
    =================================
    ...
    0x66e: MSTORE v66b, v382
    0x66f: v66f(0x20) = CONST 
    0x671: v671 = ADD v66f(0x20), v66b
    0x672: v672(0x40) = CONST 
    0x674: v674 = MLOAD v672(0x40)
    0x677: v677(0x20) = SUB v671, v674
...
function pinnedCode()() public {
    ...
    =================================
    0x17b: v17b(0x699) = CONST 
    0x17e: v17e(0x385) = CONST 
    0x181: JUMP v17e(0x385)

    Begin block 0x385
    prev=[0x17a], succ=[0x699]
    =================================
    ...
    0x6b4: v6b4 = AND v39e, v69d(0xffffffffffffffffffffffffffffffffffffffff)
    0x6b6: MSTORE v69c, v6b4
    0x6b7: v6b7(0x20) = CONST 
    0x6b9: v6b9 = ADD v6b7(0x20), v69c
    0x6ba: v6ba(0x40) = CONST 
    0x6bc: v6bc = MLOAD v6ba(0x40)
    0x6bf: v6bf(0x20) = SUB v6b9, v6bc
    0x6c1: RETURN v6bc, v6bf(0x20)
...
function CORE_NAMESPACE()() public {
    ...
    =================================
    0x1b7: v1b7(0x6e1) = CONST 
    0x1ba: v1ba(0x3a1) = CONST 
    0x1bd: JUMP v1ba(0x3a1)

    Begin block 0x3a1
    prev=[0x1b6], succ=[0x6e1]
    =================================
    ...
    0x6e7: MSTORE v6e4, v3d2
    0x6e8: v6e8(0x20) = CONST 
    0x6ea: v6ea = ADD v6e8(0x20), v6e4
    0x6eb: v6eb(0x40) = CONST 
    0x6ed: v6ed = MLOAD v6eb(0x40)
    0x6f0: v6f0(0x20) = SUB v6ea, v6ed
    0x6f2: RETURN v6ed, v6f0(0x20)
...
function appId()() public {
    ...
    0x718: MSTORE v715, v3d8
    0x719: v719(0x20) = CONST 
    0x71b: v71b = ADD v719(0x20), v715
    0x71c: v71c(0x40) = CONST 
    0x71e: v71e = MLOAD v71c(0x40)
    0x721: v721(0x20) = SUB v71b, v71e
    0x723: RETURN v71e, v721(0x20)
...
function ACL_APP()() public {
    ...
    =================================
    0x1dd: v1dd(0x743) = CONST 
    0x1e0: v1e0(0x3db) = CONST 
    0x1e3: JUMP v1e0(0x3db)

    Begin block 0x3db
    prev=[0x1dc], succ=[0x743]
    =================================
...
function ACL_APP_ID()() public {
    ...
    =================================
    0x1f0: v1f0(0x774) = CONST 
    0x1f3: v1f3(0x457) = CONST 
    0x1f6: JUMP v1f3(0x457)

    Begin block 0x457
    prev=[0x1ef], succ=[0x774]
    =================================
...
function kernel()() public {
    ...
    =================================
    0x203: v203(0x7a5) = CONST 
    0x206: v206(0x48b) = CONST 
    0x209: JUMP v206(0x48b)

    Begin block 0x48b
    prev=[0x202], succ=[0x7a5]
    =================================
    ...
    0x7c0: v7c0 = AND v4a4, v7a9(0xffffffffffffffffffffffffffffffffffffffff)
    0x7c2: MSTORE v7a8, v7c0
    0x7c3: v7c3(0x20) = CONST 
    0x7c5: v7c5 = ADD v7c3(0x20), v7a8
    0x7c6: v7c6(0x40) = CONST 
    0x7c8: v7c8 = MLOAD v7c6(0x40)
    0x7cb: v7cb(0x20) = SUB v7c5, v7c8
...
function APP_BASES_NAMESPACE()() public {
    ...
    =================================
    0x23d: v23d(0x7ed) = CONST 
    0x240: v240(0x4ac) = CONST 
    0x243: JUMP v240(0x4ac)

    Begin block 0x4ac
    prev=[0x23c], succ=[0x7ed]
    =================================
    ...
    0x7f3: MSTORE v7f0, v4dd
    0x7f4: v7f4(0x20) = CONST 
    0x7f6: v7f6 = ADD v7f4(0x20), v7f0
    0x7f7: v7f7(0x40) = CONST 
    0x7f9: v7f9 = MLOAD v7f7(0x40)
    0x7fc: v7fc(0x20) = SUB v7f6, v7f9
...
function getCode()() public {
    ...
    prev=[0x5b10x244], succ=[0x81e]
    =================================
    0x2640x244: JUMP v250(0x81e)
    ...
    0x839: v839 = AND v2445b9, v822(0xffffffffffffffffffffffffffffffffffffffff)
    0x83b: MSTORE v821, v839
    0x83c: v83c(0x20) = CONST 
    0x83e: v83e = ADD v83c(0x20), v821
    0x83f: v83f(0x40) = CONST 
    0x841: v841 = MLOAD v83f(0x40)
    0x844: v844(0x20) = SUB v83e, v841
