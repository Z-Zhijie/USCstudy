function __function_selector__() public {
    ...
    =================================
    0x58: v58(0x609da897) = CONST 
    0x5d: v5d = EQ v58(0x609da897), v35
    ...
    =================================
    0x63: v63(0x8f84aa09) = CONST 
    0x68: v68 = EQ v63(0x8f84aa09), v35
    ...
    prev=[0x62], succ=[]
    =================================
    0x4aa: v4aa(0x2b4) = CONST 
    0x4ab: CALLPRIVATE v4aa(0x2b4)
...
function setupCompleted()() public {
    ...
    =================================
    0x3ef: v3ef(0x12) = CONST 
    0x3f1: v3f1(0x1) = CONST 
    0x3f4: v3f4 = SLOAD v3ef(0x12)
    0x3f6: v3f6(0x100) = CONST 
    0x3f9: v3f9(0x100) = EXP v3f6(0x100), v3f1(0x1)
    0x3fb: v3fb = DIV v3f4, v3f9(0x100)
    0x3fc: v3fc(0xff) = CONST 
    0x3fe: v3fe = AND v3fc(0xff), v3fb
    0x400: JUMP v293(0x29a)
...
function ownerAddress()() public {
    ...
    Begin block 0x2bf
    prev=[0x2b4], succ=[0x401]
    =================================
    0x2c0: v2c0(0x2c7) = CONST 
    0x2c3: v2c3(0x401) = CONST 
    0x2c6: JUMP v2c3(0x401)

    Begin block 0x401
    prev=[0x2bf], succ=[0x2c7]
    =================================
    0x402: v402(0x0) = CONST 
    0x406: v406 = SLOAD v402(0x0)
    0x408: v408(0x100) = CONST 
    0x40b: v40b(0x1) = EXP v408(0x100), v402(0x0)
    0x40d: v40d = DIV v406, v40b(0x1)
    ...
    0x2e2: v2e2 = AND v2cd(0xffffffffffffffffffffffffffffffffffffffff), v423
