function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x4ae: v4ae(0x4bc) = CONST 
    0x4af: JUMPI v4ae(0x4bc), v8

    Begin block 0xd
    prev=[0x0], succ=[0x40, 0x4bf]
    =================================
    ...
    0x4b0: v4b0(0x4bf) = CONST 
    0x4b1: JUMPI v4b0(0x4bf), v3b

    Begin block 0x40
    prev=[0xd], succ=[0x4c2, 0x4b]
    =================================
    0x41: v41(0x54fd4d50) = CONST 
    0x46: v46 = EQ v41(0x54fd4d50), v34
    0x4b2: v4b2(0x4c2) = CONST 
    0x4b3: JUMPI v4b2(0x4c2), v46

    Begin block 0x4c2
    prev=[0x40], succ=[]
    =================================
    0x4c3: v4c3(0xe8) = CONST 
    0x4c4: CALLPRIVATE v4c3(0xe8)

    Begin block 0x4b
    prev=[0x40], succ=[0x4c5, 0x56]
    =================================
    0x4c: v4c(0x5c60da1b) = CONST 
    0x51: v51 = EQ v4c(0x5c60da1b), v34
    0x4b4: v4b4(0x4c5) = CONST 
    0x4b5: JUMPI v4b4(0x4c5), v51

    Begin block 0x4c5
    prev=[0x4b], succ=[]
    =================================
    0x4c6: v4c6(0x10f) = CONST 
    0x4c7: CALLPRIVATE v4c6(0x10f)

    Begin block 0x56
    prev=[0x4b], succ=[0x4c8, 0x61]
    =================================
    0x57: v57(0x6fde8202) = CONST 
    0x5c: v5c = EQ v57(0x6fde8202), v34
    0x4b6: v4b6(0x4c8) = CONST 
    0x4b7: JUMPI v4b6(0x4c8), v5c

    Begin block 0x4c8
    prev=[0x56], succ=[]
    =================================
    0x4c9: v4c9(0x140) = CONST 
    0x4ca: CALLPRIVATE v4c9(0x140)

    Begin block 0x61
    prev=[0x56], succ=[0x4cb, 0x6c]
    =================================
    0x62: v62(0xa9c45fcb) = CONST 
    0x67: v67 = EQ v62(0xa9c45fcb), v34
    0x4b8: v4b8(0x4cb) = CONST 
    0x4b9: JUMPI v4b8(0x4cb), v67

    Begin block 0x4cb
    prev=[0x61], succ=[]
    =================================
    0x4cc: v4cc(0x155) = CONST 
    0x4cd: CALLPRIVATE v4cc(0x155)

    Begin block 0x6c
    prev=[0x61], succ=[0x4bc, 0x4ce]
    =================================
    0x6d: v6d(0xf1739cae) = CONST 
    0x72: v72 = EQ v6d(0xf1739cae), v34
    0x4ba: v4ba(0x4ce) = CONST 
    0x4bb: JUMPI v4ba(0x4ce), v72

    Begin block 0x4bc
    prev=[0x0, 0x6c], succ=[]
    =================================
    0x4bd: v4bd(0x77) = CONST 
    0x4be: CALLPRIVATE v4bd(0x77)

    Begin block 0x4ce
    prev=[0x6c], succ=[]
    =================================
    0x4cf: v4cf(0x179) = CONST 
    0x4d0: CALLPRIVATE v4cf(0x179)

    Begin block 0x4bf
    prev=[0xd], succ=[]
    =================================
    0x4c0: v4c0(0xc2) = CONST 
    0x4c1: CALLPRIVATE v4c0(0xc2)
...
function implementation()() public {
    ...
    0x424: v424 = AND v1a6V11b, v421(0xffffffffffffffffffffffffffffffffffffffff)
    0x426: MSTORE v419, v424
    0x427: v427 = MLOAD v416(0x40)
    0x42b: v42b(0x0) = SUB v419, v427
    0x42c: v42c(0x20) = CONST 
    0x42e: v42e(0x20) = ADD v42c(0x20), v42b(0x0)
    0x430: RETURN v427, v42e(0x20)
...
function upgradeabilityOwner()() public {
    ...
    0x45f: v45f = AND v1e5V14c, v45c(0xffffffffffffffffffffffffffffffffffffffff)
    0x461: MSTORE v454, v45f
    0x462: v462 = MLOAD v451(0x40)
    0x466: v466(0x0) = SUB v454, v462
    0x467: v467(0x20) = CONST 
    0x469: v469(0x20) = ADD v467(0x20), v466(0x0)
    0x46b: RETURN v462, v469(0x20)
...
function upgradeToAndCall(uint256,address,bytes)() public {
    ...
    0x178: JUMP v175(0x1e8), v174, v171, v16a, v15c, v156(0x48b)
    ...
    prev=[0x20eB0x155], succ=[0x48b]
    =================================
    0x24fS0x155: JUMP v156(0x48b)
...
function transferProxyOwnership(address)() public {
    ...
    0x199: JUMP v196(0x250), v195, v187(0x4ac)
    ...
    prev=[0x37dB0x185], succ=[0x4ac]
    =================================
    0x2d7S0x185: JUMP v187(0x4ac)
...
function upgradeTo(uint256,address)() public {
    ...
    Begin block 0xce
    prev=[0xc2], succ=[0x3f4]
    =================================
    0xd0: vd0(0x3f4) = CONST 
    0xd3: vd3(0x4) = CONST 
    ...
    0xe5: CALLPRIVATE ve2(0x1a9), ve1, vd5, vd0(0x3f4)
