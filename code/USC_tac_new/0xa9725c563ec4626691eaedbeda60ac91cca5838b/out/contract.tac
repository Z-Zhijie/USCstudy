function __function_selector__() public {
    ...
    Begin block 0x10
    prev=[0x0], succ=[0x1a, 0x472a]
    =================================
    0x12: v12(0x4) = CONST 
    0x14: v14 = CALLDATASIZE 
    0x15: v15 = LT v14, v12(0x4)
    0x4674: v4674(0x472a) = CONST 
    0x4675: JUMPI v4674(0x472a), v15
    ...
    Begin block 0x1ef
    prev=[0x1a8], succ=[0x46be, 0x1fa]
    =================================
    0x1f1: v1f1(0xfdd58e) = CONST 
    0x1f5: v1f5 = EQ v1f1(0xfdd58e), v1f
    0x46b6: v46b6(0x46be) = CONST 
    0x46b7: JUMPI v46b6(0x46be), v1f5

    Begin block 0x46be
    prev=[0x1ef], succ=[]
    =================================
    0x46bf: v46bf(0x220) = CONST 
    0x46c0: CALLPRIVATE v46bf(0x220)

    Begin block 0x1fa
    prev=[0x1ef], succ=[0x46c1, 0x205]
    =================================
    0x1fb: v1fb(0x1ffc9a7) = CONST 
    0x200: v200 = EQ v1fb(0x1ffc9a7), v1f
    0x46b8: v46b8(0x46c1) = CONST 
    0x46b9: JUMPI v46b8(0x46c1), v200

    Begin block 0x46c1
    prev=[0x1fa], succ=[]
    =================================
    0x46c2: v46c2(0x25e) = CONST 
    0x46c3: CALLPRIVATE v46c2(0x25e)

    Begin block 0x205
    prev=[0x1fa], succ=[0x46c4, 0x210]
    =================================
    0x206: v206(0x2fe5305) = CONST 
    0x20b: v20b = EQ v206(0x2fe5305), v1f
    0x46ba: v46ba(0x46c4) = CONST 
    0x46bb: JUMPI v46ba(0x46c4), v20b

    Begin block 0x46c4
    prev=[0x205], succ=[]
    =================================
    0x46c5: v46c5(0x299) = CONST 
    0x46c6: CALLPRIVATE v46c5(0x299)

    Begin block 0x210
    prev=[0x205], succ=[0x46c7, 0x21b]
    =================================
    0x211: v211(0xe89341c) = CONST 
    0x216: v216 = EQ v211(0xe89341c), v1f
    0x46bc: v46bc(0x46c7) = CONST 
    0x46bd: JUMPI v46bc(0x46c7), v216

    Begin block 0x46c7
    prev=[0x210], succ=[]
    =================================
    0x46c8: v46c8(0x33f) = CONST 
    0x46c9: CALLPRIVATE v46c8(0x33f)
    ...
    Begin block 0x1b4
    prev=[0x1a8], succ=[0x46ca, 0x1bf]
    =================================
    0x1b5: v1b5(0x158ef93e) = CONST 
    0x1ba: v1ba = EQ v1b5(0x158ef93e), v1f
    0x46ac: v46ac(0x46ca) = CONST 
    0x46ad: JUMPI v46ac(0x46ca), v1ba

    Begin block 0x46ca
    prev=[0x1b4], succ=[]
    =================================
    0x46cb: v46cb(0x3d1) = CONST 
    0x46cc: CALLPRIVATE v46cb(0x3d1)

    Begin block 0x1bf
    prev=[0x1b4], succ=[0x46cd, 0x1ca]
    =================================
    0x1c0: v1c0(0x2de041f9) = CONST 
    0x1c5: v1c5 = EQ v1c0(0x2de041f9), v1f
    0x46ae: v46ae(0x46cd) = CONST 
    0x46af: JUMPI v46ae(0x46cd), v1c5

    Begin block 0x46cd
    prev=[0x1bf], succ=[]
    =================================
    0x46ce: v46ce(0x3d9) = CONST 
    0x46cf: CALLPRIVATE v46ce(0x3d9)

    Begin block 0x1ca
    prev=[0x1bf], succ=[0x46d0, 0x1d5]
    =================================
    0x1cb: v1cb(0x2eb2c2d6) = CONST 
    0x1d0: v1d0 = EQ v1cb(0x2eb2c2d6), v1f
    0x46b0: v46b0(0x46d0) = CONST 
    0x46b1: JUMPI v46b0(0x46d0), v1d0

    Begin block 0x46d0
    prev=[0x1ca], succ=[]
    =================================
    0x46d1: v46d1(0x41b) = CONST 
    0x46d2: CALLPRIVATE v46d1(0x41b)

    Begin block 0x1d5
    prev=[0x1ca], succ=[0x46d3, 0x1e0]
    =================================
    0x1d6: v1d6(0x3092afd5) = CONST 
    0x1db: v1db = EQ v1d6(0x3092afd5), v1f
    0x46b2: v46b2(0x46d3) = CONST 
    0x46b3: JUMPI v46b2(0x46d3), v1db

    Begin block 0x46d3
    prev=[0x1d5], succ=[]
    =================================
    0x46d4: v46d4(0x5dc) = CONST 
    0x46d5: CALLPRIVATE v46d4(0x5dc)

    Begin block 0x1e0
    prev=[0x1d5], succ=[0x1eb, 0x46d6]
    =================================
    0x1e1: v1e1(0x40c10f19) = CONST 
    0x1e6: v1e6 = EQ v1e1(0x40c10f19), v1f
    0x46b4: v46b4(0x46d6) = CONST 
    0x46b5: JUMPI v46b4(0x46d6), v1e6

    Begin block 0x1eb
    prev=[0x1e0], succ=[0x3d74]
    =================================
    0x1eb: v1eb(0x3d74) = CONST 
    0x1ee: JUMP v1eb(0x3d74)

    Begin block 0x3d74
    prev=[0x1eb], succ=[]
    =================================
    0x3d75: v3d75(0x0) = CONST 
    0x3d78: REVERT v3d75(0x0), v3d75(0x0)

    Begin block 0x46d6
    prev=[0x1e0], succ=[]
    =================================
    0x46d7: v46d7(0x602) = CONST 
    0x46d8: CALLPRIVATE v46d7(0x602)
    ...
    Begin block 0x177
    prev=[0x131], succ=[0x46d9, 0x183]
    =================================
    0x179: v179(0x485cc955) = CONST 
    0x17e: v17e = EQ v179(0x485cc955), v1f
    0x46a4: v46a4(0x46d9) = CONST 
    0x46a5: JUMPI v46a4(0x46d9), v17e

    Begin block 0x46d9
    prev=[0x177], succ=[]
    =================================
    0x46da: v46da(0x62e) = CONST 
    0x46db: CALLPRIVATE v46da(0x62e)

    Begin block 0x183
    prev=[0x177], succ=[0x46dc, 0x18e]
    =================================
    0x184: v184(0x4e1273f4) = CONST 
    0x189: v189 = EQ v184(0x4e1273f4), v1f
    0x46a6: v46a6(0x46dc) = CONST 
    0x46a7: JUMPI v46a6(0x46dc), v189

    Begin block 0x46dc
    prev=[0x183], succ=[]
    =================================
    0x46dd: v46dd(0x65c) = CONST 
    0x46de: CALLPRIVATE v46dd(0x65c)

    Begin block 0x18e
    prev=[0x183], succ=[0x46df, 0x199]
    =================================
    0x18f: v18f(0x4fb2e45d) = CONST 
    0x194: v194 = EQ v18f(0x4fb2e45d), v1f
    0x46a8: v46a8(0x46df) = CONST 
    0x46a9: JUMPI v46a8(0x46df), v194

    Begin block 0x46df
    prev=[0x18e], succ=[]
    =================================
    0x46e0: v46e0(0x7cf) = CONST 
    0x46e1: CALLPRIVATE v46e0(0x7cf)

    Begin block 0x199
    prev=[0x18e], succ=[0x1a4, 0x46e2]
    =================================
    0x19a: v19a(0x540865fe) = CONST 
    0x19f: v19f = EQ v19a(0x540865fe), v1f
    0x46aa: v46aa(0x46e2) = CONST 
    0x46ab: JUMPI v46aa(0x46e2), v19f

    Begin block 0x1a4
    prev=[0x199], succ=[0x3d50]
    =================================
    0x1a4: v1a4(0x3d50) = CONST 
    0x1a7: JUMP v1a4(0x3d50)

    Begin block 0x3d50
    prev=[0x1a4], succ=[]
    =================================
    0x3d51: v3d51(0x0) = CONST 
    0x3d54: REVERT v3d51(0x0), v3d51(0x0)

    Begin block 0x46e2
    prev=[0x199], succ=[]
    =================================
    0x46e3: v46e3(0x7f5) = CONST 
    0x46e4: CALLPRIVATE v46e3(0x7f5)

    Begin block 0x13c
    prev=[0x131], succ=[0x46e5, 0x147]
    =================================
    0x13d: v13d(0x6c0360eb) = CONST 
    0x142: v142 = EQ v13d(0x6c0360eb), v1f
    0x469a: v469a(0x46e5) = CONST 
    0x469b: JUMPI v469a(0x46e5), v142

    Begin block 0x46e5
    prev=[0x13c], succ=[]
    =================================
    0x46e6: v46e6(0x821) = CONST 
    0x46e7: CALLPRIVATE v46e6(0x821)

    Begin block 0x147
    prev=[0x13c], succ=[0x46e8, 0x152]
    =================================
    0x148: v148(0x6d70f7ae) = CONST 
    0x14d: v14d = EQ v148(0x6d70f7ae), v1f
    0x469c: v469c(0x46e8) = CONST 
    0x469d: JUMPI v469c(0x46e8), v14d

    Begin block 0x46e8
    prev=[0x147], succ=[]
    =================================
    0x46e9: v46e9(0x829) = CONST 
    0x46ea: CALLPRIVATE v46e9(0x829)

    Begin block 0x152
    prev=[0x147], succ=[0x46eb, 0x15d]
    =================================
    0x153: v153(0x70c2f239) = CONST 
    0x158: v158 = EQ v153(0x70c2f239), v1f
    0x469e: v469e(0x46eb) = CONST 
    0x469f: JUMPI v469e(0x46eb), v158

    Begin block 0x46eb
    prev=[0x152], succ=[]
    =================================
    0x46ec: v46ec(0x84f) = CONST 
    0x46ed: CALLPRIVATE v46ec(0x84f)

    Begin block 0x15d
    prev=[0x152], succ=[0x46ee, 0x168]
    =================================
    0x15e: v15e(0x7a2a4b32) = CONST 
    0x163: v163 = EQ v15e(0x7a2a4b32), v1f
    0x46a0: v46a0(0x46ee) = CONST 
    0x46a1: JUMPI v46a0(0x46ee), v163

    Begin block 0x46ee
    prev=[0x15d], succ=[]
    =================================
    0x46ef: v46ef(0x8d2) = CONST 
    0x46f0: CALLPRIVATE v46ef(0x8d2)

    Begin block 0x168
    prev=[0x15d], succ=[0x173, 0x46f1]
    =================================
    0x169: v169(0x8a89bb14) = CONST 
    0x16e: v16e = EQ v169(0x8a89bb14), v1f
    0x46a2: v46a2(0x46f1) = CONST 
    0x46a3: JUMPI v46a2(0x46f1), v16e

    Begin block 0x173
    prev=[0x168], succ=[0x3d2c]
    =================================
    0x173: v173(0x3d2c) = CONST 
    0x176: JUMP v173(0x3d2c)
    ...
    prev=[0x168], succ=[]
    =================================
    0x46f2: v46f2(0x99f) = CONST 
    0x46f3: CALLPRIVATE v46f2(0x99f)
    ...
    Begin block 0xf4
    prev=[0xad], succ=[0x100, 0x46f4]
    =================================
    0xf6: vf6(0x9204aac6) = CONST 
    0xfb: vfb = EQ vf6(0x9204aac6), v1f
    0x4692: v4692(0x46f4) = CONST 
    0x4693: JUMPI v4692(0x46f4), vfb

    Begin block 0x100
    prev=[0xf4], succ=[0x46f7, 0x10b]
    =================================
    0x101: v101(0x983b2d56) = CONST 
    0x106: v106 = EQ v101(0x983b2d56), v1f
    0x4694: v4694(0x46f7) = CONST 
    0x4695: JUMPI v4694(0x46f7), v106

    Begin block 0x46f7
    prev=[0x100], succ=[]
    =================================
    0x46f8: v46f8(0x9f5) = CONST 
    0x46f9: CALLPRIVATE v46f8(0x9f5)

    Begin block 0x10b
    prev=[0x100], succ=[0x46fa, 0x116]
    =================================
    0x10c: v10c(0x9870d7fe) = CONST 
    0x111: v111 = EQ v10c(0x9870d7fe), v1f
    0x4696: v4696(0x46fa) = CONST 
    0x4697: JUMPI v4696(0x46fa), v111

    Begin block 0x46fa
    prev=[0x10b], succ=[]
    =================================
    0x46fb: v46fb(0xa1b) = CONST 
    0x46fc: CALLPRIVATE v46fb(0xa1b)

    Begin block 0x116
    prev=[0x10b], succ=[0x121, 0x46fd]
    =================================
    0x117: v117(0x9dc29fac) = CONST 
    0x11c: v11c = EQ v117(0x9dc29fac), v1f
    0x4698: v4698(0x46fd) = CONST 
    0x4699: JUMPI v4698(0x46fd), v11c

    Begin block 0x121
    prev=[0x116], succ=[0x3d08]
    =================================
    0x121: v121(0x3d08) = CONST 
    0x124: JUMP v121(0x3d08)
    ...
    prev=[0x116], succ=[]
    =================================
    0x46fe: v46fe(0xa41) = CONST 
    0x46ff: CALLPRIVATE v46fe(0xa41)

    Begin block 0x46f4
    prev=[0xf4], succ=[]
    =================================
    0x46f5: v46f5(0x9d1) = CONST 
    0x46f6: CALLPRIVATE v46f5(0x9d1)

    Begin block 0xb9
    prev=[0xad], succ=[0x4700, 0xc4]
    =================================
    0xba: vba(0xa22cb465) = CONST 
    0xbf: vbf = EQ vba(0xa22cb465), v1f
    0x4688: v4688(0x4700) = CONST 
    0x4689: JUMPI v4688(0x4700), vbf

    Begin block 0x4700
    prev=[0xb9], succ=[]
    =================================
    0x4701: v4701(0xa6d) = CONST 
    0x4702: CALLPRIVATE v4701(0xa6d)

    Begin block 0xc4
    prev=[0xb9], succ=[0x4703, 0xcf]
    =================================
    0xc5: vc5(0xa36dc62c) = CONST 
    0xca: vca = EQ vc5(0xa36dc62c), v1f
    0x468a: v468a(0x4703) = CONST 
    0x468b: JUMPI v468a(0x4703), vca

    Begin block 0x4703
    prev=[0xc4], succ=[]
    =================================
    0x4704: v4704(0xa9b) = CONST 
    0x4705: CALLPRIVATE v4704(0xa9b)

    Begin block 0xcf
    prev=[0xc4], succ=[0x4706, 0xda]
    =================================
    0xd0: vd0(0xa4a87571) = CONST 
    0xd5: vd5 = EQ vd0(0xa4a87571), v1f
    0x468c: v468c(0x4706) = CONST 
    0x468d: JUMPI v468c(0x4706), vd5

    Begin block 0x4706
    prev=[0xcf], succ=[]
    =================================
    0x4707: v4707(0xb75) = CONST 
    0x4708: CALLPRIVATE v4707(0xb75)

    Begin block 0xda
    prev=[0xcf], succ=[0xe5, 0x4709]
    =================================
    0xdb: vdb(0xaa271e1a) = CONST 
    0xe0: ve0 = EQ vdb(0xaa271e1a), v1f
    0x468e: v468e(0x4709) = CONST 
    0x468f: JUMPI v468e(0x4709), ve0

    Begin block 0xe5
    prev=[0xda], succ=[0xf0, 0x470c]
    =================================
    0xe6: ve6(0xaa936a0d) = CONST 
    0xeb: veb = EQ ve6(0xaa936a0d), v1f
    0x4690: v4690(0x470c) = CONST 
    0x4691: JUMPI v4690(0x470c), veb

    Begin block 0xf0
    prev=[0xe5], succ=[0x3ce4]
    =================================
    0xf0: vf0(0x3ce4) = CONST 
    0xf3: JUMP vf0(0x3ce4)

    Begin block 0x3ce4
    prev=[0xf0], succ=[]
    =================================
    0x3ce5: v3ce5(0x0) = CONST 
    0x3ce8: REVERT v3ce5(0x0), v3ce5(0x0)

    Begin block 0x470c
    prev=[0xe5], succ=[]
    =================================
    0x470d: v470d(0xbf0) = CONST 
    0x470e: CALLPRIVATE v470d(0xbf0)

    Begin block 0x4709
    prev=[0xda], succ=[]
    =================================
    0x470a: v470a(0xbca) = CONST 
    0x470b: CALLPRIVATE v470a(0xbca)
    ...
    Begin block 0x7c
    prev=[0x36], succ=[0x470f, 0x88]
    =================================
    0x7e: v7e(0xac8a584a) = CONST 
    0x83: v83 = EQ v7e(0xac8a584a), v1f
    0x4680: v4680(0x470f) = CONST 
    0x4681: JUMPI v4680(0x470f), v83

    Begin block 0x470f
    prev=[0x7c], succ=[]
    =================================
    0x4710: v4710(0xc16) = CONST 
    0x4711: CALLPRIVATE v4710(0xc16)

    Begin block 0x88
    prev=[0x7c], succ=[0x4712, 0x93]
    =================================
    0x89: v89(0xb2dc5dc3) = CONST 
    0x8e: v8e = EQ v89(0xb2dc5dc3), v1f
    0x4682: v4682(0x4712) = CONST 
    0x4683: JUMPI v4682(0x4712), v8e

    Begin block 0x4712
    prev=[0x88], succ=[]
    =================================
    0x4713: v4713(0xc3c) = CONST 
    0x4714: CALLPRIVATE v4713(0xc3c)

    Begin block 0x93
    prev=[0x88], succ=[0x4715, 0x9e]
    =================================
    0x94: v94(0xb738592d) = CONST 
    0x99: v99 = EQ v94(0xb738592d), v1f
    0x4684: v4684(0x4715) = CONST 
    0x4685: JUMPI v4684(0x4715), v99

    Begin block 0x4715
    prev=[0x93], succ=[]
    =================================
    0x4716: v4716(0xcba) = CONST 
    0x4717: CALLPRIVATE v4716(0xcba)

    Begin block 0x9e
    prev=[0x93], succ=[0xa9, 0x4718]
    =================================
    0x9f: v9f(0xb774b2b1) = CONST 
    0xa4: va4 = EQ v9f(0xb774b2b1), v1f
    0x4686: v4686(0x4718) = CONST 
    0x4687: JUMPI v4686(0x4718), va4

    Begin block 0xa9
    prev=[0x9e], succ=[0x3cc0]
    =================================
    0xa9: va9(0x3cc0) = CONST 
    0xac: JUMP va9(0x3cc0)

    Begin block 0x3cc0
    prev=[0xa9], succ=[]
    =================================
    0x3cc1: v3cc1(0x0) = CONST 
    0x3cc4: REVERT v3cc1(0x0), v3cc1(0x0)

    Begin block 0x4718
    prev=[0x9e], succ=[]
    =================================
    0x4719: v4719(0xcc2) = CONST 
    0x471a: CALLPRIVATE v4719(0xcc2)

    Begin block 0x41
    prev=[0x36], succ=[0x471b, 0x4c]
    =================================
    0x42: v42(0xc46d0771) = CONST 
    0x47: v47 = EQ v42(0xc46d0771), v1f
    0x4676: v4676(0x471b) = CONST 
    0x4677: JUMPI v4676(0x471b), v47

    Begin block 0x471b
    prev=[0x41], succ=[]
    =================================
    0x471c: v471c(0xd12) = CONST 
    0x471d: CALLPRIVATE v471c(0xd12)

    Begin block 0x4c
    prev=[0x41], succ=[0x471e, 0x57]
    =================================
    0x4d: v4d(0xc5b8f772) = CONST 
    0x52: v52 = EQ v4d(0xc5b8f772), v1f
    0x4678: v4678(0x471e) = CONST 
    0x4679: JUMPI v4678(0x471e), v52

    Begin block 0x471e
    prev=[0x4c], succ=[]
    =================================
    0x471f: v471f(0xd3e) = CONST 
    0x4720: CALLPRIVATE v471f(0xd3e)

    Begin block 0x57
    prev=[0x4c], succ=[0x62, 0x4721]
    =================================
    0x58: v58(0xe985e9c5) = CONST 
    0x5d: v5d = EQ v58(0xe985e9c5), v1f
    0x467a: v467a(0x4721) = CONST 
    0x467b: JUMPI v467a(0x4721), v5d

    Begin block 0x62
    prev=[0x57], succ=[0x4724, 0x6d]
    =================================
    0x63: v63(0xf242432a) = CONST 
    0x68: v68 = EQ v63(0xf242432a), v1f
    0x467c: v467c(0x4724) = CONST 
    0x467d: JUMPI v467c(0x4724), v68

    Begin block 0x4724
    prev=[0x62], succ=[]
    =================================
    0x4725: v4725(0xd98) = CONST 
    0x4726: CALLPRIVATE v4725(0xd98)

    Begin block 0x6d
    prev=[0x62], succ=[0x78, 0x4727]
    =================================
    0x6e: v6e(0xf2ebbc3d) = CONST 
    0x73: v73 = EQ v6e(0xf2ebbc3d), v1f
    0x467e: v467e(0x4727) = CONST 
    0x467f: JUMPI v467e(0x4727), v73

    Begin block 0x78
    prev=[0x6d], succ=[0x3c9c]
    =================================
    0x78: v78(0x3c9c) = CONST 
    0x7b: JUMP v78(0x3c9c)
    ...
    prev=[0x6d], succ=[]
    =================================
    0x4728: v4728(0xe61) = CONST 
    0x4729: CALLPRIVATE v4728(0xe61)

    Begin block 0x4721
    prev=[0x57], succ=[]
    =================================
    0x4722: v4722(0xd6a) = CONST 
    0x4723: CALLPRIVATE v4722(0xd6a)

    Begin block 0x472a
    prev=[0x10], succ=[]
    =================================
    0x472b: v472b(0x3c78) = CONST 
    0x472c: CALLPRIVATE v472b(0x3c78)

}

function 0x184b(0x184barg0x0) private {
    Begin block 0x184b
    prev=[], succ=[0x4344, 0x188e]
    =================================
    ...
    0x188a: v188a(0x4344) = CONST 
    0x188d: JUMPI v188a(0x4344), v1889

    Begin block 0x4344
    prev=[0x184b], succ=[]
    =================================
    0x434d: RETURNPRIVATE v184barg0, v1853
    ...
    0x18a5: v18a5(0x436d) = CONST 
    0x18a8: JUMP v18a5(0x436d)

    Begin block 0x436d
    prev=[0x1896], succ=[]
    =================================
    0x4376: RETURNPRIVATE v184barg0, v1853
...
function balanceOf(address,uint256)() public {
    ...
    prev=[0xe750x220], succ=[0x42450x220]
    =================================
    0xe7c0x220: v220e7c(0x1) = CONST 
    0xe7e0x220: v220e7e(0x4245) = CONST 
    0xe810x220: JUMP v220e7e(0x4245)

    Begin block 0x42450x220
    prev=[0xe7b0x220], succ=[0x3d98]
    =================================
    0x424a0x220: JUMP v221(0x3d98)

    Begin block 0x3d98
    prev=[0xe860x220, 0x42450x220], succ=[]
    =================================
    0x3d98_0x0: v3d98_0 = PHI v220e84(0x0), v220e7c(0x1)
    0x3d99: v3d99(0x40) = CONST 
    0x3d9c: v3d9c = MLOAD v3d99(0x40)
    0x3d9f: MSTORE v3d9c, v3d98_0
    0x3da0: v3da0 = MLOAD v3d99(0x40)
    0x3da4: v3da4(0x0) = SUB v3d9c, v3da0
    0x3da5: v3da5(0x20) = CONST 
    0x3da7: v3da7(0x20) = ADD v3da5(0x20), v3da4(0x0)
    0x3da9: RETURN v3da0, v3da7(0x20)
    ...
    prev=[0xe820x220], succ=[0x3d98]
    =================================
    0xe8b0x220: JUMP v221(0x3d98)
...
function 0x24b9(0x24b9arg0x0, 0x24b9arg0x1, 0x24b9arg0x2) private {
    ...
    0x24f00x24b9: v24b924f0(0x4429) = CONST 
    0x24f30x24b9: JUMP v24b924f0(0x4429)

    Begin block 0x44290x24b9
    prev=[0x24d10x24b9], succ=[]
    =================================
    0x442e0x24b9: RETURNPRIVATE v24b9arg2, v24b924ef

    Begin block 0x24ca0x24b9
    prev=[0x24b9], succ=[0x44040x24b9]
    =================================
    0x24cb0x24b9: v24b924cb(0x0) = CONST 
    0x24cd0x24b9: v24b924cd(0x4404) = CONST 
    0x24d00x24b9: JUMP v24b924cd(0x4404)

    Begin block 0x44040x24b9
    prev=[0x24ca0x24b9], succ=[]
    =================================
    0x44090x24b9: RETURNPRIVATE v24b9arg2, v24b924cb(0x0)
...
function supportsInterface(bytes4)() public {
    ...
    Begin block 0xeaa
    prev=[0xe8c], succ=[0x3dc9]
    =================================
    0xeae: JUMP v25f(0x3dc9)
    ...
    0x3dcf: v3dcf = ISZERO vea9
    0x3dd0: v3dd0 = ISZERO v3dcf
    0x3dd2: MSTORE v3dcd, v3dd0
    0x3dd3: v3dd3 = MLOAD v3dca(0x40)
    0x3dd7: v3dd7(0x0) = SUB v3dcd, v3dd3
...
function 0x26d0(0x26d0arg0x0, 0x26d0arg0x1) private {
    ...
    0x26f1: v26f1(0x4474) = CONST 
    0x26f4: JUMP v26f1(0x4474)

    Begin block 0x4474
    prev=[0x26d8], succ=[]
    =================================
    0x4478: RETURNPRIVATE v26d0arg1, v26dc
...
function 0x281f(0x281farg0x0, 0x281farg0x1, 0x281farg0x2, 0x281farg0x3, 0x281farg0x4, 0x281farg0x5, 0x281farg0x6) private {
    ...
    Begin block 0x2831
    prev=[0x36a6B0x281f], succ=[0x4498, 0x2837]
    =================================
    0x2832: v2832 = ISZERO v36a9V281f
    0x2833: v2833(0x4498) = CONST 
    0x2836: JUMPI v2833(0x4498), v2832

    Begin block 0x4498
    prev=[0x2831], succ=[]
    =================================
    0x449f: RETURNPRIVATE v281farg6
...
function setURI(string)() public {
    ...
    0x38b30x3835S0xf09: v383538b3Vf09(0x45a3) = CONST 
    ...
    prev=[0x397aB0x38b10x3835B0xf09, 0x3970B0x38b10x3835B0xf09], succ=[0x397aB0x38b10x3835B0xf09, 0x45c6B0x38b10x3835B0xf09]
    =================================
    ...
    0x3976S0x38b10x3835S0xf09: v3976V38b13835Vf09(0x45c6) = CONST 
    0x3979S0x38b10x3835S0xf09: JUMPI v3976V38b13835Vf09(0x45c6), v3975V38b13835Vf09
    ...
    Begin block 0x45c6B0x38b10x3835B0xf09
    prev=[0x3971B0x38b10x3835B0xf09], succ=[0x45a30x3835B0xf09]
    =================================
    0x45c9S0x38b10x3835S0xf09: JUMP v383538b3Vf09(0x45a3)

    Begin block 0x45a30x3835B0xf09
    prev=[0x45c6B0x38b10x3835B0xf09], succ=[0x426a]
    =================================
    0x45a60x3835S0xf09: JUMP vf0c(0x426a)

    Begin block 0x426a
    prev=[0x45a30x3835B0xf09], succ=[0x3dfc]
    =================================
    0x426d: JUMP v29a(0x3dfc)
...
function 0x2af3(0x2af3arg0x0, 0x2af3arg0x1, 0x2af3arg0x2) private {
    ...
    0x2c4a: CALLPRIVATE v2c47(0x351f), v2c39, v2c35(0x1), v2b59, v2af3arg1, v2c31(0x0), v2c30, v2c2d(0x44bf)

    Begin block 0x44bf
    prev=[0x2b50], succ=[]
    =================================
    0x44c5: RETURNPRIVATE v2af3arg2, v2b59
...
function uri(uint256)() public {
    ...
    0x1082: v1082(0x42b1) = CONST 
    0x1085: JUMP v1082(0x42b1)

    Begin block 0x42b1
    prev=[0x103a], succ=[0x35c0x33f]
    =================================
    0x42b5: JUMP v340(0x35c)

    Begin block 0x35c0x33f
    prev=[0x428d, 0x42b1], succ=[0x37e0x33f]
    =================================
    ...
    0xfa1: vfa1(0x428d) = CONST 
    0xfa4: JUMP vfa1(0x428d)

    Begin block 0x428d
    prev=[0xf91], succ=[0x35c0x33f]
    =================================
    0x4291: JUMP v340(0x35c)
...
function 0x351f(0x351farg0x0, 0x351farg0x1, 0x351farg0x2, 0x351farg0x3, 0x351farg0x4, 0x351farg0x5, 0x351farg0x6) private {
    ...
    Begin block 0x3531
    prev=[0x36a6B0x351f], succ=[0x452f, 0x3537]
    =================================
    0x3532: v3532 = ISZERO v36a9V351f
    0x3533: v3533(0x452f) = CONST 
    0x3536: JUMPI v3533(0x452f), v3532

    Begin block 0x452f
    prev=[0x3531], succ=[]
    =================================
    0x4536: RETURNPRIVATE v351farg6
...
function 0x36ac(0x36acarg0x0, 0x36acarg0x1) private {
    ...
    Begin block 0x36bf
    prev=[0x36ac], succ=[0x4556, 0x36c6]
    =================================
    0x36c1: v36c1 = ISZERO v36be_0
    0x36c2: v36c2(0x4556) = CONST 
    0x36c5: JUMPI v36c2(0x4556), v36c1

    Begin block 0x4556
    prev=[0x36bf], succ=[]
    =================================
    0x455b: RETURNPRIVATE v36acarg1, v36be_0
...
function 0x36df(0x36dfarg0x0, 0x36dfarg0x1, 0x36dfarg0x2) private {
    ...
    Begin block 0x36ee
    prev=[0x382eB0x36df], succ=[0x457b, 0x36fa]
    =================================
    0x36f5: v36f5 = ISZERO v382e_1V36df
    0x36f6: v36f6(0x457b) = CONST 
    0x36f9: JUMPI v36f6(0x457b), v36f5

    Begin block 0x457b
    prev=[0x36ee], succ=[]
    =================================
    0x4583: RETURNPRIVATE v36dfarg2, v382e_1V36df
...
function 0x398b(0x398barg0x0) private {
    ...
    Begin block 0x3997
    prev=[0x398b], succ=[0x45e9]
    =================================
    0x3997: v3997(0x45e9) = CONST 
    0x399a: JUMP v3997(0x45e9)

    Begin block 0x45e9
    prev=[0x3997], succ=[]
    =================================
    0x45eb: RETURNPRIVATE v398barg0, v398c(0x0)
    ...
    Begin block 0x39b5
    prev=[0x39af], succ=[0x460b]
    =================================
    0x39b5: v39b5(0x460b) = CONST 
    0x39b8: JUMP v39b5(0x460b)

    Begin block 0x460b
    prev=[0x39b5], succ=[]
    =================================
    0x460d: RETURNPRIVATE v398barg0, v398c(0x0)
    ...
    Begin block 0x3a14
    prev=[0x3a03], succ=[0x4671]
    =================================
    0x3a17: v3a17(0x4671) = CONST 
    0x3a1a: JUMP v3a17(0x4671)

    Begin block 0x4671
    prev=[0x3a14], succ=[]
    =================================
    0x4673: RETURNPRIVATE v398barg0, v398c(0x0)

    Begin block 0x39fb
    prev=[0x39e9], succ=[0x464f]
    =================================
    0x39ff: v39ff(0x464f) = CONST 
    0x3a02: JUMP v39ff(0x464f)

    Begin block 0x464f
    prev=[0x39fb], succ=[]
    =================================
    0x4651: RETURNPRIVATE v398barg0, v398c(0x0)

    Begin block 0x39e1
    prev=[0x39b9], succ=[0x462d]
    =================================
    0x39e5: v39e5(0x462d) = CONST 
    0x39e8: JUMP v39e5(0x462d)

    Begin block 0x462d
    prev=[0x39e1], succ=[]
    =================================
    0x462f: RETURNPRIVATE v398barg0, v398c(0x0)
...
function fallback()() public {
    ...
    0x3c7c: REVERT v3c79(0x0), v3c79(0x0)
...
function initialized()() public {
    ...
    prev=[0x1086B0x3d1], succ=[0x3e1d]
    =================================
    0x108fS0x3d1: JUMP v3d2(0x3e1d)

    Begin block 0x3e1d
    prev=[0x108dB0x3d1], succ=[]
    =================================
    0x3e1e: v3e1e(0x40) = CONST 
    0x3e21: v3e21 = MLOAD v3e1e(0x40)
    0x3e23: v3e23 = ISZERO v108cV3d1
    0x3e24: v3e24 = ISZERO v3e23
    0x3e26: MSTORE v3e21, v3e24
    0x3e27: v3e27 = MLOAD v3e1e(0x40)
    0x3e2b: v3e2b(0x0) = SUB v3e21, v3e27
    0x3e2c: v3e2c(0x20) = CONST 
    0x3e2e: v3e2e(0x20) = ADD v3e2c(0x20), v3e2b(0x0)
    0x3e30: RETURN v3e27, v3e2e(0x20)
...
function mintQuasar(address,uint256,uint256,address,uint256)() public {
    ...
    Begin block 0x10f2
    prev=[0x27bf], succ=[0x3e50]
    =================================
    0x10fb: JUMP v3da(0x3e50)
    ...
    0x3e57: MSTORE v3e54, v27be_0
    0x3e58: v3e58 = MLOAD v3e51(0x40)
    0x3e5c: v3e5c(0x0) = SUB v3e54, v3e58
    0x3e5d: v3e5d(0x20) = CONST 
    0x3e5f: v3e5f(0x20) = ADD v3e5d(0x20), v3e5c(0x0)
    0x3e61: RETURN v3e58, v3e5f(0x20)
...
function safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)() public {
    ...
    0x1351: v1351(0x42d5) = CONST 
    0x1354: v1354 = CALLER 
    0x135a: v135a(0x281f) = CONST 
    0x135d: CALLPRIVATE v135a(0x281f), v5ae, v526, v4a4, v446, v43d, v1354, v1351(0x42d5)

    Begin block 0x42d5
    prev=[0x133b], succ=[0x3e81]
    =================================
    0x42db: JUMP v41c(0x3e81)
...
function mint(address,uint256)() public {
    ...
    Begin block 0x148f
    prev=[0x143a], succ=[0x42fb]
    =================================
    0x1490: v1490(0x42fb) = CONST 
    0x1495: v1495(0x2af3) = CONST 
    0x1498: v1498_0 = CALLPRIVATE v1495(0x2af3), v629, v624, v1490(0x42fb)

    Begin block 0x42fb
    prev=[0x148f], succ=[0x3ec3]
    =================================
    0x4301: JUMP v603(0x3ec3)

    Begin block 0x3ec3
    prev=[0x42fb], succ=[]
    =================================
    0x3ec4: v3ec4(0x40) = CONST 
    0x3ec7: v3ec7 = MLOAD v3ec4(0x40)
    0x3eca: MSTORE v3ec7, v1498_0
    0x3ecb: v3ecb = MLOAD v3ec4(0x40)
    0x3ecf: v3ecf(0x0) = SUB v3ec7, v3ecb
    0x3ed0: v3ed0(0x20) = CONST 
    0x3ed2: v3ed2(0x20) = ADD v3ed0(0x20), v3ecf(0x0)
    0x3ed4: RETURN v3ecb, v3ed2(0x20)
...
function balanceOfBatch(address[],uint256[])() public {
    ...
    prev=[0xe750x65c], succ=[0x42450x65c]
    =================================
    0xe7c0x65c: v65ce7c(0x1) = CONST 
    0xe7e0x65c: v65ce7e(0x4245) = CONST 
    0xe810x65c: JUMP v65ce7e(0x4245)

    Begin block 0x42450x65c
    prev=[0xe7b0x65c], succ=[0x1697]
    =================================
    0x424a0x65c: JUMP v1668(0x1697)

    Begin block 0x1697
    prev=[0xe860x65c, 0x42450x65c], succ=[0x16a2, 0x16a3]
    =================================
...
function burnQuasar(address,uint256)() public {
    ...
    0x2c9c: JUMP v1843(0x4321)

    Begin block 0x4321
    prev=[0x2c4b], succ=[0x3f36]
    =================================
    0x4324: JUMP v7f6(0x3f36)
...
function isOperator(address)() public {
    ...
    0x18fb: JUMP v82a(0x3f57)

    Begin block 0x3f57
    prev=[0x18de], succ=[]
    =================================
    0x3f58: v3f58(0x40) = CONST 
    0x3f5b: v3f5b = MLOAD v3f58(0x40)
    0x3f5d: v3f5d = ISZERO v18f9
    0x3f5e: v3f5e = ISZERO v3f5d
    0x3f60: MSTORE v3f5b, v3f5e
    0x3f61: v3f61 = MLOAD v3f58(0x40)
    0x3f65: v3f65(0x0) = SUB v3f5b, v3f61
    0x3f66: v3f66(0x20) = CONST 
    0x3f68: v3f68(0x20) = ADD v3f66(0x20), v3f65(0x0)
    0x3f6a: RETURN v3f61, v3f68(0x20)
...
function mintBatch(address,uint256,uint256[])() public {
    ...
    prev=[0x2f1bB0x19ed], succ=[0x4396]
    =================================
    0x2f57S0x19ed: JUMP v19ee(0x4396)

    Begin block 0x4396
    prev=[0x2f4eB0x19ed], succ=[0x77f0x84f]
    =================================
    0x439e: JUMP v850(0x77f)

    Begin block 0x77f0x84f
    prev=[0x4396], succ=[0x7a30x84f]
    =================================
...
function updatePowah(address,uint256,uint256)() public {
    ...
    prev=[0x2f6aB0x1b97, 0x2f71B0x1b97], succ=[0x2f89B0x1b97, 0x44e5B0x1b97]
    =================================
    0x2f83_0x0S0x1b97: v2f83_0V1b97 = PHI v2f82_0V1b97, v36a9V2f58V1b97
    0x2f84S0x1b97: v2f84V1b97 = ISZERO v2f83_0V1b97
    0x2f85S0x1b97: v2f85V1b97(0x44e5) = CONST 
    0x2f88S0x1b97: JUMPI v2f85V1b97(0x44e5), v2f84V1b97
    ...
    prev=[0x2fe9B0x1b97], succ=[0x3007B0x1b97, 0x450aB0x1b97]
    =================================
    0x3001S0x1b97: v3001V1b97 = MLOAD v2ff0V1b97
    0x3002S0x1b97: v3002V1b97 = ISZERO v3001V1b97
    0x3003S0x1b97: v3003V1b97(0x450a) = CONST 
    0x3006S0x1b97: JUMPI v3003V1b97(0x450a), v3002V1b97
    ...
    Begin block 0x1c10
    prev=[0x44e5B0x1b97, 0x450aB0x1b97, 0x3075B0x1b97], succ=[0x3f8a]
    =================================
    ...
    Begin block 0x450aB0x1b97
    prev=[0x2fffB0x1b97], succ=[0x1c10]
    =================================
    0x450fS0x1b97: JUMP v1bf3(0x1c10)

    Begin block 0x44e5B0x1b97
    prev=[0x2f83B0x1b97], succ=[0x1c10]
    =================================
    0x44eaS0x1b97: JUMP v1bf3(0x1c10)
...
function galaxyCommunity()() public {
    ...
    prev=[], succ=[0x1c3d]
    =================================
    0x9d2: v9d2(0x3fab) = CONST 
    0x9d5: v9d5(0x1c3d) = CONST 
    0x9d8: JUMP v9d5(0x1c3d)

    Begin block 0x1c3d
    prev=[0x9d1], succ=[0x3fab]
    =================================
    ...
    0x1c4b: JUMP v9d2(0x3fab)

    Begin block 0x3fab
    prev=[0x1c3d], succ=[]
    =================================
    0x3fac: v3fac(0x40) = CONST 
    0x3faf: v3faf = MLOAD v3fac(0x40)
    ...
    0x3fba: v3fba = AND v1c49, v3fb7(0xffffffffffffffffffffffffffffffffffffffff)
    0x3fbc: MSTORE v3faf, v3fba
    0x3fbd: v3fbd = MLOAD v3fac(0x40)
    0x3fc1: v3fc1(0x0) = SUB v3faf, v3fbd
    0x3fc2: v3fc2(0x20) = CONST 
    0x3fc4: v3fc4(0x20) = ADD v3fc2(0x20), v3fc1(0x0)
    0x3fc6: RETURN v3fbd, v3fc4(0x20)
...
function burn(address,uint256)() public {
    ...
    prev=[0x397aB0x38c1B0x307b, 0x3970B0x38c1B0x307b], succ=[0x397aB0x38c1B0x307b, 0x45c6B0x38c1B0x307b]
    =================================
    ...
    0x3976S0x38c1S0x307b: v3976V38c1V307b(0x45c6) = CONST 
    0x3979S0x38c1S0x307b: JUMPI v3976V38c1V307b(0x45c6), v3975V38c1V307b
    ...
    Begin block 0x45c6B0x38c1B0x307b
    prev=[0x3971B0x38c1B0x307b], succ=[0x38dfB0x307b]
    =================================
    0x45c9S0x38c1S0x307b: JUMP v38d6V307b(0x38df)

    Begin block 0x38dfB0x307b
    prev=[0x45c6B0x38c1B0x307b], succ=[0x30ca]
    =================================
    ...
    prev=[0x397aB0x38c1B0x30ca, 0x3970B0x38c1B0x30ca], succ=[0x397aB0x38c1B0x30ca, 0x45c6B0x38c1B0x30ca]
    =================================
    ...
    0x3976S0x38c1S0x30ca: v3976V38c1V30ca(0x45c6) = CONST 
    0x3979S0x38c1S0x30ca: JUMPI v3976V38c1V30ca(0x45c6), v3975V38c1V30ca
    ...
    Begin block 0x45c6B0x38c1B0x30ca
    prev=[0x3971B0x38c1B0x30ca], succ=[0x38dfB0x30ca]
    =================================
    0x45c9S0x38c1S0x30ca: JUMP v38d6V30ca(0x38df)

    Begin block 0x38dfB0x30ca
    prev=[0x45c6B0x38c1B0x30ca], succ=[0x30d8]
    =================================
    0x38e1S0x30ca: JUMP v30cb(0x30d8)

    Begin block 0x30d8
    prev=[0x38dfB0x30ca], succ=[0x43be]
    =================================
    ...
    0x314d: JUMP v1f3f(0x43be)

    Begin block 0x43be
    prev=[0x30d8], succ=[0x4028]
    =================================
    0x43c1: JUMP va42(0x4028)
...
function mintSuper(address,uint256,uint256,address[],uint256[])() public {
    ...
    0x38b30x38e2S0x31d6S0x2069: v38e238b3V31d6V2069(0x45a3) = CONST 
    ...
    prev=[0x397aB0x38b10x38e2B0x31d6B0x2069, 0x3970B0x38b10x38e2B0x31d6B0x2069], succ=[0x397aB0x38b10x38e2B0x31d6B0x2069, 0x45c6B0x38b10x38e2B0x31d6B0x2069]
    =================================
    ...
    0x3976S0x38b10x38e2S0x31d6S0x2069: v3976V38b138e2V31d6V2069(0x45c6) = CONST 
    0x3979S0x38b10x38e2S0x31d6S0x2069: JUMPI v3976V38b138e2V31d6V2069(0x45c6), v3975V38b138e2V31d6V2069
    ...
    Begin block 0x45c6B0x38b10x38e2B0x31d6B0x2069
    prev=[0x3971B0x38b10x38e2B0x31d6B0x2069], succ=[0x45a30x38e2B0x31d6B0x2069]
    =================================
    0x45c9S0x38b10x38e2S0x31d6S0x2069: JUMP v38e238b3V31d6V2069(0x45a3)

    Begin block 0x45a30x38e2B0x31d6B0x2069
    prev=[0x45c6B0x38b10x38e2B0x31d6B0x2069], succ=[0x31f9B0x2069]
    =================================
    0x45a60x38e2S0x31d6S0x2069: JUMP v31efV2069(0x31f9)

    Begin block 0x31f9B0x2069
    prev=[0x45a30x38e2B0x31d6B0x2069], succ=[0x3935B0x31f9B0x2069]
    =================================
    ...
    0x38b30x3935S0x31f9S0x2069: v393538b3V31f9V2069(0x45a3) = CONST 
    ...
    prev=[0x397aB0x38b10x3935B0x31f9B0x2069, 0x3970B0x38b10x3935B0x31f9B0x2069], succ=[0x397aB0x38b10x3935B0x31f9B0x2069, 0x45c6B0x38b10x3935B0x31f9B0x2069]
    =================================
    ...
    0x3976S0x38b10x3935S0x31f9S0x2069: v3976V38b13935V31f9V2069(0x45c6) = CONST 
    0x3979S0x38b10x3935S0x31f9S0x2069: JUMPI v3976V38b13935V31f9V2069(0x45c6), v3975V38b13935V31f9V2069
    ...
    Begin block 0x45c6B0x38b10x3935B0x31f9B0x2069
    prev=[0x3971B0x38b10x3935B0x31f9B0x2069], succ=[0x45a30x3935B0x31f9B0x2069]
    =================================
    0x45c9S0x38b10x3935S0x31f9S0x2069: JUMP v393538b3V31f9V2069(0x45a3)

    Begin block 0x45a30x3935B0x31f9B0x2069
    prev=[0x45c6B0x38b10x3935B0x31f9B0x2069], succ=[0x3216B0x2069]
    =================================
    0x45a60x3935S0x31f9S0x2069: JUMP v3209V2069(0x3216)

    Begin block 0x3216B0x2069
    prev=[0x45a30x3935B0x31f9B0x2069], succ=[0x2078]
    =================================
    0x3222S0x2069: JUMP v206a(0x2078)

    Begin block 0x2078
    prev=[0x3216B0x2069], succ=[0x406a]
    =================================
    0x2083: JUMP va9c(0x406a)

    Begin block 0x406a
    prev=[0x2078], succ=[]
    =================================
    0x406b: v406b(0x40) = CONST 
    0x406e: v406e = MLOAD v406b(0x40)
    0x4071: MSTORE v406e, v31d5_0V2069
    0x4072: v4072 = MLOAD v406b(0x40)
    0x4076: v4076(0x0) = SUB v406e, v4072
    0x4077: v4077(0x20) = CONST 
    0x4079: v4079(0x20) = ADD v4077(0x20), v4076(0x0)
    0x407b: RETURN v4072, v4079(0x20)
...
function isMinter(address)() public {
    ...
    0x20e3: JUMP vbcb(0x409b)

    Begin block 0x409b
    prev=[0x20c6], succ=[]
    =================================
    0x409c: v409c(0x40) = CONST 
    0x409f: v409f = MLOAD v409c(0x40)
    0x40a1: v40a1 = ISZERO v20e1
    0x40a2: v40a2 = ISZERO v40a1
    0x40a4: MSTORE v409f, v40a2
    0x40a5: v40a5 = MLOAD v409c(0x40)
    0x40a9: v40a9(0x0) = SUB v409f, v40a5
    0x40aa: v40aa(0x20) = CONST 
    0x40ac: v40ac(0x20) = ADD v40aa(0x20), v40a9(0x0)
    0x40ae: RETURN v40a5, v40ac(0x20)
...
function burnBatch(address,uint256[])() public {
    ...
    prev=[0x24b90xc3c], succ=[0x44290xc3c]
    =================================
    ...
    0x24f00xc3c: vc3c24f0(0x4429) = CONST 
    0x24f30xc3c: JUMP vc3c24f0(0x4429)

    Begin block 0x44290xc3c
    prev=[0x24d10xc3c], succ=[0x232c]
    =================================
    0x442e0xc3c: JUMP v2311(0x232c)

    Begin block 0x232c
    prev=[0x44040xc3c, 0x44290xc3c], succ=[0x2331, 0x236d]
    =================================
    ...
    prev=[0x24b90xc3c], succ=[0x44040xc3c]
    =================================
    0x24cb0xc3c: vc3c24cb(0x0) = CONST 
    0x24cd0xc3c: vc3c24cd(0x4404) = CONST 
    0x24d00xc3c: JUMP vc3c24cd(0x4404)

    Begin block 0x44040xc3c
    prev=[0x24ca0xc3c], succ=[0x232c]
    =================================
    0x44090xc3c: JUMP v2311(0x232c)
    ...
    prev=[0x397aB0x38c1B0x330b, 0x3970B0x38c1B0x330b], succ=[0x397aB0x38c1B0x330b, 0x45c6B0x38c1B0x330b]
    =================================
    ...
    0x3976S0x38c1S0x330b: v3976V38c1V330b(0x45c6) = CONST 
    0x3979S0x38c1S0x330b: JUMPI v3976V38c1V330b(0x45c6), v3975V38c1V330b
    ...
    Begin block 0x45c6B0x38c1B0x330b
    prev=[0x3971B0x38c1B0x330b], succ=[0x38dfB0x330b]
    =================================
    0x45c9S0x38c1S0x330b: JUMP v38d6V330b(0x38df)

    Begin block 0x38dfB0x330b
    prev=[0x45c6B0x38c1B0x330b], succ=[0x3332]
    =================================
    ...
    prev=[0x397aB0x38c1B0x3332, 0x3970B0x38c1B0x3332], succ=[0x397aB0x38c1B0x3332, 0x45c6B0x38c1B0x3332]
    =================================
    ...
    0x3976S0x38c1S0x3332: v3976V38c1V3332(0x45c6) = CONST 
    0x3979S0x38c1S0x3332: JUMPI v3976V38c1V3332(0x45c6), v3975V38c1V3332
    ...
    Begin block 0x45c6B0x38c1B0x3332
    prev=[0x3971B0x38c1B0x3332], succ=[0x38dfB0x3332]
    =================================
    0x45c9S0x38c1S0x3332: JUMP v38d6V3332(0x38df)

    Begin block 0x38dfB0x3332
    prev=[0x45c6B0x38c1B0x3332], succ=[0x3340]
    =================================
    ...
    Begin block 0x23b3
    prev=[0x3473], succ=[0x4110]
    =================================
    0x23b7: JUMP vc3d(0x4110)
...
function starNFTOwner()() public {
    ...
    prev=[], succ=[0x23b8]
    =================================
    0xcbb: vcbb(0x4131) = CONST 
    0xcbe: vcbe(0x23b8) = CONST 
    0xcc1: JUMP vcbe(0x23b8)

    Begin block 0x23b8
    prev=[0xcba], succ=[0x4131]
    =================================
    ...
    0x23c6: JUMP vcbb(0x4131)

    Begin block 0x4131
    prev=[0x23b8], succ=[]
    =================================
    0x4132: v4132(0x40) = CONST 
    0x4135: v4135 = MLOAD v4132(0x40)
    0x4136: v4136(0x1) = CONST 
    0x4138: v4138(0x1) = CONST 
    0x413a: v413a(0xa0) = CONST 
    0x413c: v413c(0x10000000000000000000000000000000000000000) = SHL v413a(0xa0), v4138(0x1)
    0x413d: v413d(0xffffffffffffffffffffffffffffffffffffffff) = SUB v413c(0x10000000000000000000000000000000000000000), v4136(0x1)
    0x4140: v4140 = AND v23c4, v413d(0xffffffffffffffffffffffffffffffffffffffff)
    0x4142: MSTORE v4135, v4140
    0x4143: v4143 = MLOAD v4132(0x40)
    0x4147: v4147(0x0) = SUB v4135, v4143
...
function burnSuper(address,uint256)() public {
    ...
    prev=[0x397aB0x38c1B0x348d, 0x3970B0x38c1B0x348d], succ=[0x397aB0x38c1B0x348d, 0x45c6B0x38c1B0x348d]
    =================================
    ...
    0x3976S0x38c1S0x348d: v3976V38c1V348d(0x45c6) = CONST 
    0x3979S0x38c1S0x348d: JUMPI v3976V38c1V348d(0x45c6), v3975V38c1V348d
    ...
    Begin block 0x45c6B0x38c1B0x348d
    prev=[0x3971B0x38c1B0x348d], succ=[0x38dfB0x348d]
    =================================
    0x45c9S0x38c1S0x348d: JUMP v38d6V348d(0x38df)

    Begin block 0x38dfB0x348d
    prev=[0x45c6B0x38c1B0x348d], succ=[0x34a4]
    =================================
    ...
    prev=[0x397aB0x38c1B0x34a4, 0x3970B0x38c1B0x34a4], succ=[0x397aB0x38c1B0x34a4, 0x45c6B0x38c1B0x34a4]
    =================================
    ...
    0x3976S0x38c1S0x34a4: v3976V38c1V34a4(0x45c6) = CONST 
    0x3979S0x38c1S0x34a4: JUMPI v3976V38c1V34a4(0x45c6), v3975V38c1V34a4
    ...
    Begin block 0x45c6B0x38c1B0x34a4
    prev=[0x3971B0x38c1B0x34a4], succ=[0x38dfB0x34a4]
    =================================
    0x45c9S0x38c1S0x34a4: JUMP v38d6V34a4(0x38df)

    Begin block 0x38dfB0x34a4
    prev=[0x45c6B0x38c1B0x34a4], succ=[0x34c1]
    =================================
    ...
    prev=[0x397aB0x38c1B0x34c1, 0x3970B0x38c1B0x34c1], succ=[0x397aB0x38c1B0x34c1, 0x45c6B0x38c1B0x34c1]
    =================================
    ...
    0x3976S0x38c1S0x34c1: v3976V38c1V34c1(0x45c6) = CONST 
    0x3979S0x38c1S0x34c1: JUMPI v3976V38c1V34c1(0x45c6), v3975V38c1V34c1
    ...
    Begin block 0x45c6B0x38c1B0x34c1
    prev=[0x3971B0x38c1B0x34c1], succ=[0x38dfB0x34c1]
    =================================
    0x45c9S0x38c1S0x34c1: JUMP v38d6V34c1(0x38df)

    Begin block 0x38dfB0x34c1
    prev=[0x45c6B0x38c1B0x34c1], succ=[0x34da]
    =================================
    ...
    prev=[0x397aB0x38c1B0x34da, 0x3970B0x38c1B0x34da], succ=[0x397aB0x38c1B0x34da, 0x45c6B0x38c1B0x34da]
    =================================
    ...
    0x3976S0x38c1S0x34da: v3976V38c1V34da(0x45c6) = CONST 
    0x3979S0x38c1S0x34da: JUMPI v3976V38c1V34da(0x45c6), v3975V38c1V34da
    ...
    Begin block 0x45c6B0x38c1B0x34da
    prev=[0x3971B0x38c1B0x34da], succ=[0x38dfB0x34da]
    =================================
    0x45c9S0x38c1S0x34da: JUMP v38d6V34da(0x38df)

    Begin block 0x38dfB0x34da
    prev=[0x45c6B0x38c1B0x34da], succ=[0x34e8]
    =================================
    0x38e1S0x34da: JUMP v34db(0x34e8)

    Begin block 0x34e8
    prev=[0x38dfB0x34da], succ=[0x43e1]
    =================================
    ...
    0x351e: JUMP v24b1(0x43e1)

    Begin block 0x43e1
    prev=[0x34e8], succ=[0x416c]
    =================================
    0x43e4: JUMP vd13(0x416c)
...
function isOwnerOf(address,uint256)() public {
    ...
    prev=[0x24b90xd3e], succ=[0x44290xd3e]
    =================================
    ...
    0x24f00xd3e: vd3e24f0(0x4429) = CONST 
    0x24f30xd3e: JUMP vd3e24f0(0x4429)

    Begin block 0x44290xd3e
    prev=[0x24d10xd3e], succ=[0x418d]
    =================================
    0x442e0xd3e: JUMP vd3f(0x418d)

    Begin block 0x418d
    prev=[0x44040xd3e, 0x44290xd3e], succ=[]
    =================================
    0x418d_0x0: v418d_0 = PHI vd3e24ef, vd3e24cb(0x0)
    0x418e: v418e(0x40) = CONST 
    0x4191: v4191 = MLOAD v418e(0x40)
    0x4193: v4193 = ISZERO v418d_0
    0x4194: v4194 = ISZERO v4193
    0x4196: MSTORE v4191, v4194
    0x4197: v4197 = MLOAD v418e(0x40)
    0x419b: v419b(0x0) = SUB v4191, v4197
    0x419c: v419c(0x20) = CONST 
    0x419e: v419e(0x20) = ADD v419c(0x20), v419b(0x0)
    0x41a0: RETURN v4197, v419e(0x20)

    Begin block 0x24ca0xd3e
    prev=[0x24b90xd3e], succ=[0x44040xd3e]
    =================================
    0x24cb0xd3e: vd3e24cb(0x0) = CONST 
    0x24cd0xd3e: vd3e24cd(0x4404) = CONST 
    0x24d00xd3e: JUMP vd3e24cd(0x4404)

    Begin block 0x44040xd3e
    prev=[0x24ca0xd3e], succ=[0x418d]
    =================================
    0x44090xd3e: JUMP vd3f(0x418d)
...
function isApprovedForAll(address,address)() public {
    ...
    0x41c6: v41c6 = ISZERO vd6a251f
    0x41c7: v41c7 = ISZERO v41c6
    0x41c9: MSTORE v41c4, v41c7
    0x41ca: v41ca = MLOAD v41c1(0x40)
    0x41ce: v41ce(0x0) = SUB v41c4, v41ca
...
function safeTransferFrom(address,address,uint256,uint256,bytes)() public {
    ...
    0x26bd: v26bd(0x444e) = CONST 
    0x26c0: v26c0 = CALLER 
    0x26c6: v26c6(0x351f) = CONST 
    0x26c9: CALLPRIVATE v26c6(0x351f), ve33, vdcf, vdc9, vdc3, vdba, v26c0, v26bd(0x444e)

    Begin block 0x444e
    prev=[0x264f], succ=[0x41f3]
    =================================
    0x4454: JUMP vd99(0x41f3)
...
function starNFTCount()() public {
    ...
    0x421b: MSTORE v4218, v26cd
    0x421c: v421c = MLOAD v4215(0x40)
    0x4220: v4220(0x0) = SUB v4218, v421c
    0x4221: v4221(0x20) = CONST 
    0x4223: v4223(0x20) = ADD v4221(0x20), v4220(0x0)
    0x4225: RETURN v421c, v4223(0x20)
