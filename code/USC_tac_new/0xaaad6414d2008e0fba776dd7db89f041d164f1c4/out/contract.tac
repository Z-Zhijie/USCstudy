function __function_selector__() public {
    ...
    0xaaa: JUMPI vaa9(0xab6), v19

    Begin block 0xab6
    prev=[0xd], succ=[]
    =================================
    0xab7: vab7(0x65) = CONST 
    0xab8: CALLPRIVATE vab7(0x65)

    Begin block 0x1e
    prev=[0xd], succ=[0xab9, 0x29]
    =================================
    0x1f: v1f(0x4f1ef286) = CONST 
    0x24: v24 = EQ v1f(0x4f1ef286), v12
    0xaab: vaab(0xab9) = CONST 
    0xaac: JUMPI vaab(0xab9), v24

    Begin block 0xab9
    prev=[0x1e], succ=[]
    =================================
    0xaba: vaba(0x98) = CONST 
    0xabb: CALLPRIVATE vaba(0x98)

    Begin block 0x29
    prev=[0x1e], succ=[0xabc, 0x34]
    =================================
    0x2a: v2a(0x5c60da1b) = CONST 
    0x2f: v2f = EQ v2a(0x5c60da1b), v12
    0xaad: vaad(0xabc) = CONST 
    0xaae: JUMPI vaad(0xabc), v2f

    Begin block 0xabc
    prev=[0x29], succ=[]
    =================================
    0xabd: vabd(0x118) = CONST 
    0xabe: CALLPRIVATE vabd(0x118)

    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0xabf]
    =================================
    0x35: v35(0x8f283970) = CONST 
    0x3a: v3a = EQ v35(0x8f283970), v12
    0xaaf: vaaf(0xabf) = CONST 
    0xab0: JUMPI vaaf(0xabf), v3a

    Begin block 0x3f
    prev=[0x34], succ=[0x4a, 0xac2]
    =================================
    0x40: v40(0xf851a440) = CONST 
    0x45: v45 = EQ v40(0xf851a440), v12
    0xab1: vab1(0xac2) = CONST 
    0xab2: JUMPI vab1(0xac2), v45
    ...
    prev=[0x3f], succ=[]
    =================================
    0xac3: vac3(0x17c) = CONST 
    0xac4: CALLPRIVATE vac3(0x17c)

    Begin block 0xabf
    prev=[0x34], succ=[]
    =================================
    0xac0: vac0(0x149) = CONST 
    0xac1: CALLPRIVATE vac0(0x149)

    Begin block 0x4e
    prev=[0x0], succ=[0xab3, 0x5d]
    =================================
    ...
    prev=[0x4e], succ=[]
    =================================
    0xab3: vab3(0xab5) = CONST 
    0xab4: CALLPRIVATE vab3(0xab5)
...
function implementation()() public {
    ...
    Begin block 0x124
    prev=[0x118], succ=[0x8b2]
    =================================
    0x126: v126(0x8b2) = CONST 
    0x129: v129(0x262) = CONST 
    0x12c: v12c_0 = CALLPRIVATE v129(0x262), v126(0x8b2)
    ...
    0x8c1: v8c1 = AND v12c_0, v8be(0xffffffffffffffffffffffffffffffffffffffff)
    0x8c3: MSTORE v8b6, v8c1
    0x8c4: v8c4 = MLOAD v8b3(0x40)
    0x8c8: v8c8(0x0) = SUB v8b6, v8c4
    0x8c9: v8c9(0x20) = CONST 
    0x8cb: v8cb(0x20) = ADD v8c9(0x20), v8c8(0x0)
    0x8cd: RETURN v8c4, v8cb(0x20)
...
function changeAdmin(address)() public {
    ...
    prev=[0x4c4], succ=[0x96a0x149]
    =================================
    0x1d60x149: v1491d6(0x96a) = CONST 
    0x1d90x149: JUMP v1491d6(0x96a)

    Begin block 0x96a0x149
    prev=[0x1d50x149], succ=[0x8ed]
    =================================
    0x96c0x149: JUMP v157(0x8ed)

    Begin block 0x8ed
    prev=[0x96a0x149], succ=[]
    =================================
    0x8ee: STOP 
    ...
    =================================
    0x1db0x149: v1491db(0x98c) = CONST 
    ...
    =================================
    0x19a0x149: v14919a(0x949) = CONST 
...
function admin()() public {
    ...
    Begin block 0x188
    prev=[0x17c], succ=[0x90e]
    =================================
    0x18a: v18a(0x90e) = CONST 
    0x18d: v18d(0x359) = CONST 
    0x190: v190_0 = CALLPRIVATE v18d(0x359), v18a(0x90e)

    Begin block 0x90e
    prev=[0x188], succ=[]
    =================================
    0x90f: v90f(0x40) = CONST 
    0x912: v912 = MLOAD v90f(0x40)
    ...
    0x91d: v91d = AND v190_0, v91a(0xffffffffffffffffffffffffffffffffffffffff)
    0x91f: MSTORE v912, v91d
    0x920: v920 = MLOAD v90f(0x40)
    0x924: v924(0x0) = SUB v912, v920
    0x925: v925(0x20) = CONST 
    0x927: v927(0x20) = ADD v925(0x20), v924(0x0)
    0x929: RETURN v920, v927(0x20)
...
function 0x262(0x262arg0x0) private {
    ...
    prev=[0x416B0x286], succ=[0x9f60x262]
    =================================
    0x2900x262: v262290(0x9f6) = CONST 
    0x2930x262: JUMP v262290(0x9f6)

    Begin block 0x9f60x262
    prev=[0x28d0x262], succ=[]
    =================================
    0x9f80x262: RETURNPRIVATE v262arg0, v438V286

    Begin block 0x2940x262
    prev=[0x26c], succ=[0x1910x262]
    =================================
    0x2950x262: v262295(0xa18) = CONST 
    ...
    =================================
    0x19a0x262: v26219a(0x949) = CONST 
...
function 0x359(0x359arg0x0) private {
    ...
    prev=[0x45fB0x37d], succ=[0x9f60x359]
    =================================
    0x2900x359: v359290(0x9f6) = CONST 
    0x2930x359: JUMP v359290(0x9f6)

    Begin block 0x9f60x359
    prev=[0x28d0x359], succ=[]
    =================================
    0x9f80x359: RETURNPRIVATE v359arg0, v481V37d

    Begin block 0x2940x359
    prev=[0x363], succ=[0x1910x359]
    =================================
    0x2950x359: v359295(0xa18) = CONST 
    ...
    =================================
    0x19a0x359: v35919a(0x949) = CONST 
...
function 0x3b6(0x3b6arg0x0) private {
    ...
    Begin block 0x40e
    prev=[0x3be], succ=[0xa81B0x40e]
    =================================
    0x40f: v40f(0xa60) = CONST 
    0x412: v412(0xa81) = CONST 
    0x415: JUMP v412(0xa81), v40f(0xa60)

    Begin block 0xa81B0x40e
    prev=[0x40e], succ=[0xa60]
    =================================
    0xa82S0x40e: JUMP v40f(0xa60)

    Begin block 0xa60
    prev=[0xa81B0x40e], succ=[]
    =================================
    0xa61: RETURNPRIVATE v3b6arg0
...
function upgradeTo(address)() public {
    ...
    prev=[0x1cd], succ=[0x96a0x65]
    =================================
    0x1d60x65: v651d6(0x96a) = CONST 
    0x1d90x65: JUMP v651d6(0x96a)

    Begin block 0x96a0x65
    prev=[0x1d50x65], succ=[0x870]
    =================================
    0x96c0x65: JUMP v73(0x870)
...
function upgradeToAndCall(address,bytes)() public {
    ...
    0x387S0x20f: v387V20f(0xa3a) = CONST 
    ...
    prev=[0x653B0x5d1B0x384B0x20f], succ=[0xaa2B0x5d1B0x384B0x20f]
    =================================
    0x65eS0x5d1S0x384S0x20f: v65eV5d1V384V20f(0xaa2) = CONST 
    0x661S0x5d1S0x384S0x20f: JUMP v65eV5d1V384V20f(0xaa2)

    Begin block 0xaa2B0x5d1B0x384B0x20f
    prev=[0x65cB0x5d1B0x384B0x20f], succ=[0x5e1B0x384B0x20f]
    =================================
    0xaa8S0x5d1S0x384S0x20f: JUMP v5d7V384V20f(0x5e1)

    Begin block 0x5e1B0x384B0x20f
    prev=[0xaa2B0x5d1B0x384B0x20f], succ=[0xa3aB0x20f]
    =================================
    0x5eaS0x384S0x20f: JUMP v387V20f(0xa3a)

    Begin block 0xa3aB0x20f
    prev=[0x5e1B0x384B0x20f], succ=[0x24f]
    =================================
    0xa40S0x20f: JUMP v210(0x24f)

    Begin block 0x24f
    prev=[0xa3aB0x20f], succ=[0x9ae]
    =================================
    0x251: v251(0x9ae) = CONST 
    0x254: JUMP v251(0x9ae)

    Begin block 0x9ae
    prev=[0x24f], succ=[0x891]
    =================================
    0x9b2: JUMP v99(0x891)
...
function fallback()() public {
    Begin block 0xab5
    prev=[], succ=[0x1910xab5]
    =================================
    0x54: v54(0x82e) = CONST 
    0x57: v57(0x191) = CONST 
    0x5a: JUMP v57(0x191)

    Begin block 0x1910xab5
    prev=[0xab5], succ=[0x1990xab5]
    =================================
    0x1920xab5: vab5192(0x199) = CONST 
    0x1950xab5: vab5195(0x3b6) = CONST 
    0x1980xab5: CALLPRIVATE vab5195(0x3b6), vab5192(0x199)

    Begin block 0x1990xab5
    prev=[0x1910xab5], succ=[0x416B0x1990xab5]
    =================================
    0x19a0xab5: vab519a(0x949) = CONST 
    0x19d0xab5: vab519d(0x1a4) = CONST 
    0x1a00xab5: vab51a0(0x416) = CONST 
    0x1a30xab5: JUMP vab51a0(0x416)

    Begin block 0x416B0x1990xab5
    prev=[0x1990xab5], succ=[0x1a40xab5]
    =================================
    0x417S0x1990xab5: v417V199ab5(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc) = CONST 
    0x438S0x1990xab5: v438V199ab5 = SLOAD v417V199ab5(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc)
    0x43aS0x1990xab5: JUMP vab519d(0x1a4)

    Begin block 0x1a40xab5
    prev=[0x416B0x1990xab5], succ=[0x43b0xab5]
    =================================
    0x1a50xab5: vab51a5(0x43b) = CONST 
    0x1a80xab5: JUMP vab51a5(0x43b)

    Begin block 0x43b0xab5
    prev=[0x1a40xab5], succ=[0x4560xab5, 0x45a0xab5]
    =================================
    0x43c0xab5: vab543c = CALLDATASIZE 
    0x43d0xab5: vab543d(0x0) = CONST 
    0x4400xab5: CALLDATACOPY vab543d(0x0), vab543d(0x0), vab543c
    0x4410xab5: vab5441(0x0) = CONST 
    0x4440xab5: vab5444 = CALLDATASIZE 
    0x4450xab5: vab5445(0x0) = CONST 
    0x4480xab5: vab5448 = GAS 
    0x4490xab5: vab5449 = DELEGATECALL vab5448, v438V199ab5, vab5445(0x0), vab5444, vab5441(0x0), vab5441(0x0)
    0x44a0xab5: vab544a = RETURNDATASIZE 
    0x44b0xab5: vab544b(0x0) = CONST 
    0x44e0xab5: RETURNDATACOPY vab544b(0x0), vab544b(0x0), vab544a
    0x4510xab5: vab5451 = ISZERO vab5449
    0x4520xab5: vab5452(0x45a) = CONST 
    0x4550xab5: JUMPI vab5452(0x45a), vab5451

    Begin block 0x4560xab5
    prev=[0x43b0xab5], succ=[]
    =================================
    0x4560xab5: vab5456 = RETURNDATASIZE 
    0x4570xab5: vab5457(0x0) = CONST 
    0x4590xab5: RETURN vab5457(0x0), vab5456

    Begin block 0x45a0xab5
    prev=[0x43b0xab5], succ=[]
    =================================
    0x45b0xab5: vab545b = RETURNDATASIZE 
    0x45c0xab5: vab545c(0x0) = CONST 
    0x45e0xab5: REVERT vab545c(0x0), vab545b
