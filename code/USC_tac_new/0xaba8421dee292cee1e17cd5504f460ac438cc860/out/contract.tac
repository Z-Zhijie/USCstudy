function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x4ac: v4ac(0x4ba) = CONST 
    0x4ad: JUMPI v4ac(0x4ba), v8

    Begin block 0xd
    prev=[0x0], succ=[0x40, 0x4bd]
    =================================
    ...
    0x4ae: v4ae(0x4bd) = CONST 
    0x4af: JUMPI v4ae(0x4bd), v3b

    Begin block 0x40
    prev=[0xd], succ=[0x4c0, 0x4b]
    =================================
    0x41: v41(0x54fd4d50) = CONST 
    0x46: v46 = EQ v41(0x54fd4d50), v34
    0x4b0: v4b0(0x4c0) = CONST 
    0x4b1: JUMPI v4b0(0x4c0), v46

    Begin block 0x4c0
    prev=[0x40], succ=[]
    =================================
    0x4c1: v4c1(0xe8) = CONST 
    0x4c2: CALLPRIVATE v4c1(0xe8)

    Begin block 0x4b
    prev=[0x40], succ=[0x4c3, 0x56]
    =================================
    0x4c: v4c(0x5c60da1b) = CONST 
    0x51: v51 = EQ v4c(0x5c60da1b), v34
    0x4b2: v4b2(0x4c3) = CONST 
    0x4b3: JUMPI v4b2(0x4c3), v51

    Begin block 0x4c3
    prev=[0x4b], succ=[]
    =================================
    0x4c4: v4c4(0x10f) = CONST 
    0x4c5: CALLPRIVATE v4c4(0x10f)

    Begin block 0x56
    prev=[0x4b], succ=[0x4c6, 0x61]
    =================================
    0x57: v57(0x6fde8202) = CONST 
    0x5c: v5c = EQ v57(0x6fde8202), v34
    0x4b4: v4b4(0x4c6) = CONST 
    0x4b5: JUMPI v4b4(0x4c6), v5c

    Begin block 0x4c6
    prev=[0x56], succ=[]
    =================================
    0x4c7: v4c7(0x140) = CONST 
    0x4c8: CALLPRIVATE v4c7(0x140)

    Begin block 0x61
    prev=[0x56], succ=[0x4c9, 0x6c]
    =================================
    0x62: v62(0xa9c45fcb) = CONST 
    0x67: v67 = EQ v62(0xa9c45fcb), v34
    0x4b6: v4b6(0x4c9) = CONST 
    0x4b7: JUMPI v4b6(0x4c9), v67

    Begin block 0x4c9
    prev=[0x61], succ=[]
    =================================
    0x4ca: v4ca(0x155) = CONST 
    0x4cb: CALLPRIVATE v4ca(0x155)

    Begin block 0x6c
    prev=[0x61], succ=[0x4ba, 0x4cc]
    =================================
    0x6d: v6d(0xf1739cae) = CONST 
    0x72: v72 = EQ v6d(0xf1739cae), v34
    0x4b8: v4b8(0x4cc) = CONST 
    0x4b9: JUMPI v4b8(0x4cc), v72

    Begin block 0x4ba
    prev=[0x0, 0x6c], succ=[]
    =================================
    0x4bb: v4bb(0x77) = CONST 
    0x4bc: CALLPRIVATE v4bb(0x77)

    Begin block 0x4cc
    prev=[0x6c], succ=[]
    =================================
    0x4cd: v4cd(0x179) = CONST 
    0x4ce: CALLPRIVATE v4cd(0x179)

    Begin block 0x4bd
    prev=[0xd], succ=[]
    =================================
    0x4be: v4be(0xc2) = CONST 
    0x4bf: CALLPRIVATE v4be(0xc2)
...
function implementation()() public {
    ...
    0x1a8S0x11b: JUMP v11d(0x413)

    Begin block 0x413
    prev=[0x19aB0x11b], succ=[]
    =================================
    0x414: v414(0x40) = CONST 
    0x417: v417 = MLOAD v414(0x40)
    ...
    0x422: v422 = AND v1a6V11b, v41f(0xffffffffffffffffffffffffffffffffffffffff)
    0x424: MSTORE v417, v422
    0x425: v425 = MLOAD v414(0x40)
    0x429: v429(0x0) = SUB v417, v425
    0x42a: v42a(0x20) = CONST 
    0x42c: v42c(0x20) = ADD v42a(0x20), v429(0x0)
    0x42e: RETURN v425, v42c(0x20)
...
function upgradeabilityOwner()() public {
    ...
    0x1e7S0x14c: JUMP v14e(0x44e)

    Begin block 0x44e
    prev=[0x1d9B0x14c], succ=[]
    =================================
    0x44f: v44f(0x40) = CONST 
    0x452: v452 = MLOAD v44f(0x40)
    0x453: v453(0x1) = CONST 
    0x455: v455(0xa0) = CONST 
    0x457: v457(0x2) = CONST 
    0x459: v459(0x10000000000000000000000000000000000000000) = EXP v457(0x2), v455(0xa0)
    0x45a: v45a(0xffffffffffffffffffffffffffffffffffffffff) = SUB v459(0x10000000000000000000000000000000000000000), v453(0x1)
    0x45d: v45d = AND v1e5V14c, v45a(0xffffffffffffffffffffffffffffffffffffffff)
    0x45f: MSTORE v452, v45d
    0x460: v460 = MLOAD v44f(0x40)
    0x464: v464(0x0) = SUB v452, v460
    0x465: v465(0x20) = CONST 
    0x467: v467(0x20) = ADD v465(0x20), v464(0x0)
    0x469: RETURN v460, v467(0x20)
...
function upgradeToAndCall(uint256,address,bytes)() public {
    ...
    0x178: JUMP v175(0x1e8), v174, v171, v16a, v15c, v156(0x489)
    ...
    prev=[0x20eB0x155], succ=[0x489]
    =================================
    0x24fS0x155: JUMP v156(0x489)
...
function transferProxyOwnership(address)() public {
    ...
    0x199: JUMP v196(0x250), v195, v187(0x4aa)
    ...
    prev=[0x37dB0x185], succ=[0x4aa]
    =================================
    0x2d7S0x185: JUMP v187(0x4aa)
...
function upgradeTo(uint256,address)() public {
    ...
    Begin block 0xce
    prev=[0xc2], succ=[0x3f2]
    =================================
    0xd0: vd0(0x3f2) = CONST 
    0xd3: vd3(0x4) = CONST 
    ...
    0xe5: CALLPRIVATE ve2(0x1a9), ve1, vd5, vd0(0x3f2)
