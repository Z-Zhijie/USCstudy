function __function_selector__() public {
    ...
    0x90a: JUMPI v909(0x915), v8

    Begin block 0xd
    prev=[0x0], succ=[0x918, 0x41]
    =================================
    0xd: vd(0x0) = CONST 
    ...
    0x90c: JUMPI v90b(0x918), v3c

    Begin block 0x918
    prev=[0xd], succ=[]
    =================================
    0x919: v919(0x77) = CONST 
    0x91a: CALLPRIVATE v919(0x77)

    Begin block 0x41
    prev=[0xd], succ=[0x91b, 0x4c]
    =================================
    0x42: v42(0x4f1ef286) = CONST 
    0x47: v47 = EQ v42(0x4f1ef286), v35
    0x90d: v90d(0x91b) = CONST 
    0x90e: JUMPI v90d(0x91b), v47

    Begin block 0x91b
    prev=[0x41], succ=[]
    =================================
    0x91c: v91c(0xc8) = CONST 
    0x91d: CALLPRIVATE v91c(0xc8)

    Begin block 0x4c
    prev=[0x41], succ=[0x91e, 0x57]
    =================================
    0x4d: v4d(0x5c60da1b) = CONST 
    0x52: v52 = EQ v4d(0x5c60da1b), v35
    0x90f: v90f(0x91e) = CONST 
    0x910: JUMPI v90f(0x91e), v52

    Begin block 0x91e
    prev=[0x4c], succ=[]
    =================================
    0x91f: v91f(0x161) = CONST 
    0x920: CALLPRIVATE v91f(0x161)

    Begin block 0x57
    prev=[0x4c], succ=[0x921, 0x62]
    =================================
    0x58: v58(0x8f283970) = CONST 
    0x5d: v5d = EQ v58(0x8f283970), v35
    0x911: v911(0x921) = CONST 
    0x912: JUMPI v911(0x921), v5d

    Begin block 0x921
    prev=[0x57], succ=[]
    =================================
    0x922: v922(0x1b8) = CONST 
    0x923: CALLPRIVATE v922(0x1b8)

    Begin block 0x62
    prev=[0x57], succ=[0x915, 0x924]
    =================================
    0x63: v63(0xf851a440) = CONST 
    0x68: v68 = EQ v63(0xf851a440), v35
    0x913: v913(0x924) = CONST 
    0x914: JUMPI v913(0x924), v68

    Begin block 0x915
    prev=[0x0, 0x62], succ=[]
    =================================
    0x916: v916(0x6d) = CONST 
    0x917: CALLPRIVATE v916(0x6d)

    Begin block 0x924
    prev=[0x62], succ=[]
    =================================
    0x925: v925(0x209) = CONST 
    0x926: CALLPRIVATE v925(0x209)
