function __function_selector__() public {
    ...
    0x8d5: v8d5(0x8e2) = CONST 
    0x8d6: JUMPI v8d5(0x8e2), v19

    Begin block 0x8e2
    prev=[0xd], succ=[]
    =================================
    0x8e3: v8e3(0x67) = CONST 
    0x8e4: CALLPRIVATE v8e3(0x67)

    Begin block 0x1e
    prev=[0xd], succ=[0x8e5, 0x29]
    =================================
    0x1f: v1f(0x4f1ef286) = CONST 
    0x24: v24 = EQ v1f(0x4f1ef286), v12
    0x8d7: v8d7(0x8e5) = CONST 
    0x8d8: JUMPI v8d7(0x8e5), v24

    Begin block 0x8e5
    prev=[0x1e], succ=[]
    =================================
    0x8e6: v8e6(0xb8) = CONST 
    0x8e7: CALLPRIVATE v8e6(0xb8)

    Begin block 0x29
    prev=[0x1e], succ=[0x8e8, 0x34]
    =================================
    0x2a: v2a(0x5c60da1b) = CONST 
    0x2f: v2f = EQ v2a(0x5c60da1b), v12
    0x8d9: v8d9(0x8e8) = CONST 
    0x8da: JUMPI v8d9(0x8e8), v2f
    ...
    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0x8eb]
    =================================
    0x35: v35(0x8f283970) = CONST 
    0x3a: v3a = EQ v35(0x8f283970), v12
    0x8db: v8db(0x8eb) = CONST 
    0x8dc: JUMPI v8db(0x8eb), v3a

    Begin block 0x3f
    prev=[0x34], succ=[0x4a, 0x8ee]
    =================================
    0x40: v40(0xf851a440) = CONST 
    0x45: v45 = EQ v40(0xf851a440), v12
    0x8dd: v8dd(0x8ee) = CONST 
    0x8de: JUMPI v8dd(0x8ee), v45
    ...
    prev=[0x3f], succ=[]
    =================================
    0x8ef: v8ef(0x1f9) = CONST 
    0x8f0: CALLPRIVATE v8ef(0x1f9)

    Begin block 0x8eb
    prev=[0x34], succ=[]
    =================================
    0x8ec: v8ec(0x1a8) = CONST 
    0x8ed: CALLPRIVATE v8ec(0x1a8)

    Begin block 0x4e
    prev=[0x0], succ=[0x8df, 0x5d]
    =================================
    ...
    prev=[0x4e], succ=[]
    =================================
    0x8df: v8df(0x8e1) = CONST 
    0x8e0: CALLPRIVATE v8df(0x8e1)
...
function fallback()() public {
    Begin block 0x8e1
    prev=[], succ=[0x2500x8e1]
    =================================
    0x54: v54(0x5b) = CONST 
    0x57: v57(0x250) = CONST 
    0x5a: JUMP v57(0x250)

    Begin block 0x2500x8e1
    prev=[0x8e1], succ=[0x2580x8e1]
    =================================
    0x2510x8e1: v8e1251(0x258) = CONST 
    0x2540x8e1: v8e1254(0x5d1) = CONST 
    0x2570x8e1: CALLPRIVATE v8e1254(0x5d1), v8e1251(0x258)

    Begin block 0x2580x8e1
    prev=[0x2500x8e1], succ=[0x667B0x2580x8e1]
    =================================
    0x2590x8e1: v8e1259(0x268) = CONST 
    0x25c0x8e1: v8e125c(0x263) = CONST 
    0x25f0x8e1: v8e125f(0x667) = CONST 
    0x2620x8e1: JUMP v8e125f(0x667)

    Begin block 0x667B0x2580x8e1
    prev=[0x2580x8e1], succ=[0x2630x8e1]
    =================================
    0x668S0x2580x8e1: v668V2588e1(0x0) = CONST 
    0x66bS0x2580x8e1: v66bV2588e1(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc) = CONST 
    0x68cS0x2580x8e1: v68cV2588e1(0x0) = CONST 
    0x68eS0x2580x8e1: v68eV2588e1(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc) = SHL v68cV2588e1(0x0), v66bV2588e1(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc)
    0x692S0x2580x8e1: v692V2588e1 = SLOAD v68eV2588e1(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc)
    0x697S0x2580x8e1: JUMP v8e125c(0x263)

    Begin block 0x2630x8e1
    prev=[0x667B0x2580x8e1], succ=[0x6980x8e1]
    =================================
    0x2640x8e1: v8e1264(0x698) = CONST 
    0x2670x8e1: JUMP v8e1264(0x698)

    Begin block 0x6980x8e1
    prev=[0x2630x8e1], succ=[0x6b50x8e1, 0x6b90x8e1]
    =================================
    0x6990x8e1: v8e1699 = CALLDATASIZE 
    0x69a0x8e1: v8e169a(0x0) = CONST 
    0x69d0x8e1: CALLDATACOPY v8e169a(0x0), v8e169a(0x0), v8e1699
    0x69e0x8e1: v8e169e(0x0) = CONST 
    0x6a10x8e1: v8e16a1 = CALLDATASIZE 
    0x6a20x8e1: v8e16a2(0x0) = CONST 
    0x6a50x8e1: v8e16a5 = GAS 
    0x6a60x8e1: v8e16a6 = DELEGATECALL v8e16a5, v692V2588e1, v8e16a2(0x0), v8e16a1, v8e169e(0x0), v8e169e(0x0)
    0x6a70x8e1: v8e16a7 = RETURNDATASIZE 
    0x6a80x8e1: v8e16a8(0x0) = CONST 
    0x6ab0x8e1: RETURNDATACOPY v8e16a8(0x0), v8e16a8(0x0), v8e16a7
    0x6ad0x8e1: v8e16ad(0x0) = CONST 
    0x6b00x8e1: v8e16b0 = EQ v8e16a6, v8e16ad(0x0)
    0x6b10x8e1: v8e16b1(0x6b9) = CONST 
    0x6b40x8e1: JUMPI v8e16b1(0x6b9), v8e16b0

    Begin block 0x6b50x8e1
    prev=[0x6980x8e1], succ=[]
    =================================
    0x6b50x8e1: v8e16b5 = RETURNDATASIZE 
    0x6b60x8e1: v8e16b6(0x0) = CONST 
    0x6b80x8e1: RETURN v8e16b6(0x0), v8e16b5

    Begin block 0x6b90x8e1
    prev=[0x6980x8e1], succ=[]
    =================================
    0x6ba0x8e1: v8e16ba = RETURNDATASIZE 
    0x6bb0x8e1: v8e16bb(0x0) = CONST 
    0x6bd0x8e1: REVERT v8e16bb(0x0), v8e16ba
