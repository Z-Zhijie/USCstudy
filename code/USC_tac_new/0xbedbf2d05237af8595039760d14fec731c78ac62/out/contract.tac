function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x4b7: v4b7(0x4c5) = CONST 
    0x4b8: JUMPI v4b7(0x4c5), v8

    Begin block 0xd
    prev=[0x0], succ=[0x40, 0x4c8]
    =================================
    ...
    0x4b9: v4b9(0x4c8) = CONST 
    0x4ba: JUMPI v4b9(0x4c8), v3b

    Begin block 0x40
    prev=[0xd], succ=[0x4cb, 0x4b]
    =================================
    0x41: v41(0x54fd4d50) = CONST 
    0x46: v46 = EQ v41(0x54fd4d50), v34
    0x4bb: v4bb(0x4cb) = CONST 
    0x4bc: JUMPI v4bb(0x4cb), v46

    Begin block 0x4cb
    prev=[0x40], succ=[]
    =================================
    0x4cc: v4cc(0xe8) = CONST 
    0x4cd: CALLPRIVATE v4cc(0xe8)

    Begin block 0x4b
    prev=[0x40], succ=[0x4ce, 0x56]
    =================================
    0x4c: v4c(0x5c60da1b) = CONST 
    0x51: v51 = EQ v4c(0x5c60da1b), v34
    0x4bd: v4bd(0x4ce) = CONST 
    0x4be: JUMPI v4bd(0x4ce), v51

    Begin block 0x4ce
    prev=[0x4b], succ=[]
    =================================
    0x4cf: v4cf(0x10f) = CONST 
    0x4d0: CALLPRIVATE v4cf(0x10f)

    Begin block 0x56
    prev=[0x4b], succ=[0x4d1, 0x61]
    =================================
    0x57: v57(0x6fde8202) = CONST 
    0x5c: v5c = EQ v57(0x6fde8202), v34
    0x4bf: v4bf(0x4d1) = CONST 
    0x4c0: JUMPI v4bf(0x4d1), v5c

    Begin block 0x4d1
    prev=[0x56], succ=[]
    =================================
    0x4d2: v4d2(0x140) = CONST 
    0x4d3: CALLPRIVATE v4d2(0x140)

    Begin block 0x61
    prev=[0x56], succ=[0x4d4, 0x6c]
    =================================
    0x62: v62(0xa9c45fcb) = CONST 
    0x67: v67 = EQ v62(0xa9c45fcb), v34
    0x4c1: v4c1(0x4d4) = CONST 
    0x4c2: JUMPI v4c1(0x4d4), v67

    Begin block 0x4d4
    prev=[0x61], succ=[]
    =================================
    0x4d5: v4d5(0x155) = CONST 
    0x4d6: CALLPRIVATE v4d5(0x155)

    Begin block 0x6c
    prev=[0x61], succ=[0x4c5, 0x4d7]
    =================================
    0x6d: v6d(0xf1739cae) = CONST 
    0x72: v72 = EQ v6d(0xf1739cae), v34
    0x4c3: v4c3(0x4d7) = CONST 
    0x4c4: JUMPI v4c3(0x4d7), v72

    Begin block 0x4c5
    prev=[0x0, 0x6c], succ=[]
    =================================
    0x4c6: v4c6(0x77) = CONST 
    0x4c7: CALLPRIVATE v4c6(0x77)

    Begin block 0x4d7
    prev=[0x6c], succ=[]
    =================================
    0x4d8: v4d8(0x179) = CONST 
    0x4d9: CALLPRIVATE v4d8(0x179)

    Begin block 0x4c8
    prev=[0xd], succ=[]
    =================================
    0x4c9: v4c9(0xc2) = CONST 
    0x4ca: CALLPRIVATE v4c9(0xc2)
...
function implementation()() public {
    ...
    0x1a8S0x11b: JUMP v11d(0x41e)

    Begin block 0x41e
    prev=[0x19aB0x11b], succ=[]
    =================================
    0x41f: v41f(0x40) = CONST 
    0x422: v422 = MLOAD v41f(0x40)
    0x423: v423(0x1) = CONST 
    0x425: v425(0xa0) = CONST 
    0x427: v427(0x2) = CONST 
    0x429: v429(0x10000000000000000000000000000000000000000) = EXP v427(0x2), v425(0xa0)
    0x42a: v42a(0xffffffffffffffffffffffffffffffffffffffff) = SUB v429(0x10000000000000000000000000000000000000000), v423(0x1)
    0x42d: v42d = AND v1a6V11b, v42a(0xffffffffffffffffffffffffffffffffffffffff)
    0x42f: MSTORE v422, v42d
    0x430: v430 = MLOAD v41f(0x40)
    0x434: v434(0x0) = SUB v422, v430
    0x435: v435(0x20) = CONST 
    0x437: v437(0x20) = ADD v435(0x20), v434(0x0)
    0x439: RETURN v430, v437(0x20)
...
function upgradeabilityOwner()() public {
    ...
    0x468: v468 = AND v1e5V14c, v465(0xffffffffffffffffffffffffffffffffffffffff)
    0x46a: MSTORE v45d, v468
    0x46b: v46b = MLOAD v45a(0x40)
    0x46f: v46f(0x0) = SUB v45d, v46b
    0x470: v470(0x20) = CONST 
    0x472: v472(0x20) = ADD v470(0x20), v46f(0x0)
    0x474: RETURN v46b, v472(0x20)
...
function upgradeToAndCall(uint256,address,bytes)() public {
    ...
    0x178: JUMP v175(0x1e8), v174, v171, v16a, v15c, v156(0x494)
    ...
    prev=[0x20eB0x155], succ=[0x494]
    =================================
    0x24fS0x155: JUMP v156(0x494)
...
function transferProxyOwnership(address)() public {
    ...
    0x199: JUMP v196(0x250), v195, v187(0x4b5)
    ...
    prev=[0x37dB0x185], succ=[0x4b5]
    =================================
    0x2d7S0x185: JUMP v187(0x4b5)
...
function upgradeTo(uint256,address)() public {
    ...
    Begin block 0xce
    prev=[0xc2], succ=[0x3fd]
    =================================
    0xd0: vd0(0x3fd) = CONST 
    0xd3: vd3(0x4) = CONST 
    ...
    0xe5: CALLPRIVATE ve2(0x1a9), ve1, vd5, vd0(0x3fd)
