function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x4b3: v4b3(0x4c1) = CONST 
    0x4b4: JUMPI v4b3(0x4c1), v8

    Begin block 0xd
    prev=[0x0], succ=[0x40, 0x4c4]
    =================================
    ...
    0x4b5: v4b5(0x4c4) = CONST 
    0x4b6: JUMPI v4b5(0x4c4), v3b

    Begin block 0x40
    prev=[0xd], succ=[0x4c7, 0x4b]
    =================================
    0x41: v41(0x54fd4d50) = CONST 
    0x46: v46 = EQ v41(0x54fd4d50), v34
    0x4b7: v4b7(0x4c7) = CONST 
    0x4b8: JUMPI v4b7(0x4c7), v46

    Begin block 0x4c7
    prev=[0x40], succ=[]
    =================================
    0x4c8: v4c8(0xe8) = CONST 
    0x4c9: CALLPRIVATE v4c8(0xe8)

    Begin block 0x4b
    prev=[0x40], succ=[0x4ca, 0x56]
    =================================
    0x4c: v4c(0x5c60da1b) = CONST 
    0x51: v51 = EQ v4c(0x5c60da1b), v34
    0x4b9: v4b9(0x4ca) = CONST 
    0x4ba: JUMPI v4b9(0x4ca), v51

    Begin block 0x4ca
    prev=[0x4b], succ=[]
    =================================
    0x4cb: v4cb(0x10f) = CONST 
    0x4cc: CALLPRIVATE v4cb(0x10f)

    Begin block 0x56
    prev=[0x4b], succ=[0x4cd, 0x61]
    =================================
    0x57: v57(0x6fde8202) = CONST 
    0x5c: v5c = EQ v57(0x6fde8202), v34
    0x4bb: v4bb(0x4cd) = CONST 
    0x4bc: JUMPI v4bb(0x4cd), v5c

    Begin block 0x4cd
    prev=[0x56], succ=[]
    =================================
    0x4ce: v4ce(0x140) = CONST 
    0x4cf: CALLPRIVATE v4ce(0x140)

    Begin block 0x61
    prev=[0x56], succ=[0x4d0, 0x6c]
    =================================
    0x62: v62(0xa9c45fcb) = CONST 
    0x67: v67 = EQ v62(0xa9c45fcb), v34
    0x4bd: v4bd(0x4d0) = CONST 
    0x4be: JUMPI v4bd(0x4d0), v67

    Begin block 0x4d0
    prev=[0x61], succ=[]
    =================================
    0x4d1: v4d1(0x155) = CONST 
    0x4d2: CALLPRIVATE v4d1(0x155)

    Begin block 0x6c
    prev=[0x61], succ=[0x4c1, 0x4d3]
    =================================
    0x6d: v6d(0xf1739cae) = CONST 
    0x72: v72 = EQ v6d(0xf1739cae), v34
    0x4bf: v4bf(0x4d3) = CONST 
    0x4c0: JUMPI v4bf(0x4d3), v72

    Begin block 0x4c1
    prev=[0x0, 0x6c], succ=[]
    =================================
    0x4c2: v4c2(0x77) = CONST 
    0x4c3: CALLPRIVATE v4c2(0x77)

    Begin block 0x4d3
    prev=[0x6c], succ=[]
    =================================
    0x4d4: v4d4(0x179) = CONST 
    0x4d5: CALLPRIVATE v4d4(0x179)

    Begin block 0x4c4
    prev=[0xd], succ=[]
    =================================
    0x4c5: v4c5(0xc2) = CONST 
    0x4c6: CALLPRIVATE v4c5(0xc2)
...
function implementation()() public {
    ...
    0x429: v429 = AND v1a6V11b, v426(0xffffffffffffffffffffffffffffffffffffffff)
    0x42b: MSTORE v41e, v429
    0x42c: v42c = MLOAD v41b(0x40)
    0x430: v430(0x0) = SUB v41e, v42c
    0x431: v431(0x20) = CONST 
    0x433: v433(0x20) = ADD v431(0x20), v430(0x0)
    0x435: RETURN v42c, v433(0x20)
...
function upgradeabilityOwner()() public {
    ...
    0x460: v460(0x10000000000000000000000000000000000000000) = EXP v45e(0x2), v45c(0xa0)
    0x461: v461(0xffffffffffffffffffffffffffffffffffffffff) = SUB v460(0x10000000000000000000000000000000000000000), v45a(0x1)
    0x464: v464 = AND v1e5V14c, v461(0xffffffffffffffffffffffffffffffffffffffff)
    0x466: MSTORE v459, v464
    0x467: v467 = MLOAD v456(0x40)
    0x46b: v46b(0x0) = SUB v459, v467
    0x46c: v46c(0x20) = CONST 
    0x46e: v46e(0x20) = ADD v46c(0x20), v46b(0x0)
    0x470: RETURN v467, v46e(0x20)
...
function upgradeToAndCall(uint256,address,bytes)() public {
    ...
    0x178: JUMP v175(0x1e8), v174, v171, v16a, v15c, v156(0x490)
    ...
    prev=[0x20eB0x155], succ=[0x490]
    =================================
    0x24fS0x155: JUMP v156(0x490)
...
function transferProxyOwnership(address)() public {
    ...
    0x199: JUMP v196(0x250), v195, v187(0x4b1)
    ...
    prev=[0x37dB0x185], succ=[0x4b1]
    =================================
    0x2d7S0x185: JUMP v187(0x4b1)
...
function upgradeTo(uint256,address)() public {
    ...
    Begin block 0xce
    prev=[0xc2], succ=[0x3f9]
    =================================
    0xd0: vd0(0x3f9) = CONST 
    0xd3: vd3(0x4) = CONST 
    ...
    0xe5: CALLPRIVATE ve2(0x1a9), ve1, vd5, vd0(0x3f9)
