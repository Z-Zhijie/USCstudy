function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x47f: v47f(0x489) = CONST 
    0x480: JUMPI v47f(0x489), v8

    Begin block 0xd
    prev=[0x0], succ=[0x48c, 0x1e]
    =================================
    0xd: vd(0x0) = CONST 
    ...
    0x481: v481(0x48c) = CONST 
    0x482: JUMPI v481(0x48c), v19

    Begin block 0x48c
    prev=[0xd], succ=[]
    =================================
    0x48d: v48d(0xb1) = CONST 
    0x48e: CALLPRIVATE v48d(0xb1)

    Begin block 0x1e
    prev=[0xd], succ=[0x48f, 0x29]
    =================================
    0x1f: v1f(0x3659cfe6) = CONST 
    0x24: v24 = EQ v1f(0x3659cfe6), v12
    0x483: v483(0x48f) = CONST 
    0x484: JUMPI v483(0x48f), v24

    Begin block 0x48f
    prev=[0x1e], succ=[]
    =================================
    0x490: v490(0xf2) = CONST 
    0x491: CALLPRIVATE v490(0xf2)

    Begin block 0x29
    prev=[0x1e], succ=[0x492, 0x34]
    =================================
    0x2a: v2a(0x5c60da1b) = CONST 
    0x2f: v2f = EQ v2a(0x5c60da1b), v12
    0x485: v485(0x492) = CONST 
    0x486: JUMPI v485(0x492), v2f

    Begin block 0x492
    prev=[0x29], succ=[]
    =================================
    0x493: v493(0x143) = CONST 
    0x494: CALLPRIVATE v493(0x143)

    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0x495]
    =================================
    0x35: v35(0xf1739cae) = CONST 
    0x3a: v3a = EQ v35(0xf1739cae), v12
    0x487: v487(0x495) = CONST 
    0x488: JUMPI v487(0x495), v3a
    ...
    prev=[0x34], succ=[]
    =================================
    0x496: v496(0x184) = CONST 
    0x497: CALLPRIVATE v496(0x184)

    Begin block 0x489
    prev=[0x0], succ=[]
    =================================
    0x48a: v48a(0x43) = CONST 
    0x48b: CALLPRIVATE v48a(0x43)
