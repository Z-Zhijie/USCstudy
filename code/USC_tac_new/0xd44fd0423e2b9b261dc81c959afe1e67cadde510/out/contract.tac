function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x8a8: v8a8(0x8b4) = CONST 
    0x8a9: JUMPI v8a8(0x8b4), v8

    Begin block 0xd
    prev=[0x0], succ=[0x8b7, 0x3a]
    =================================
    ...
    0x8ab: JUMPI v8aa(0x8b7), v35

    Begin block 0x8b7
    prev=[0xd], succ=[]
    =================================
    0x8b8: v8b8(0x70) = CONST 
    0x8b9: CALLPRIVATE v8b8(0x70)

    Begin block 0x3a
    prev=[0xd], succ=[0x8ba, 0x45]
    =================================
    0x3b: v3b(0x4f1ef286) = CONST 
    0x40: v40 = EQ v3b(0x4f1ef286), v2e
    0x8ac: v8ac(0x8ba) = CONST 
    0x8ad: JUMPI v8ac(0x8ba), v40

    Begin block 0x8ba
    prev=[0x3a], succ=[]
    =================================
    0x8bb: v8bb(0xa3) = CONST 
    0x8bc: CALLPRIVATE v8bb(0xa3)

    Begin block 0x45
    prev=[0x3a], succ=[0x8bd, 0x50]
    =================================
    0x46: v46(0x5c60da1b) = CONST 
    0x4b: v4b = EQ v46(0x5c60da1b), v2e
    0x8ae: v8ae(0x8bd) = CONST 
    0x8af: JUMPI v8ae(0x8bd), v4b

    Begin block 0x8bd
    prev=[0x45], succ=[]
    =================================
    0x8be: v8be(0x123) = CONST 
    0x8bf: CALLPRIVATE v8be(0x123)

    Begin block 0x50
    prev=[0x45], succ=[0x8c0, 0x5b]
    =================================
    0x51: v51(0x8f283970) = CONST 
    0x56: v56 = EQ v51(0x8f283970), v2e
    0x8b0: v8b0(0x8c0) = CONST 
    0x8b1: JUMPI v8b0(0x8c0), v56

    Begin block 0x8c0
    prev=[0x50], succ=[]
    =================================
    0x8c1: v8c1(0x154) = CONST 
    0x8c2: CALLPRIVATE v8c1(0x154)

    Begin block 0x5b
    prev=[0x50], succ=[0x8b4, 0x8c3]
    =================================
    0x5c: v5c(0xf851a440) = CONST 
    0x61: v61 = EQ v5c(0xf851a440), v2e
    0x8b2: v8b2(0x8c3) = CONST 
    0x8b3: JUMPI v8b2(0x8c3), v61

    Begin block 0x8b4
    prev=[0x0, 0x5b], succ=[]
    =================================
    0x8b5: v8b5(0x66) = CONST 
    0x8b6: CALLPRIVATE v8b5(0x66)

    Begin block 0x8c3
    prev=[0x5b], succ=[]
    =================================
    0x8c4: v8c4(0x187) = CONST 
    0x8c5: CALLPRIVATE v8c4(0x187)
...
function implementation()() public {
    ...
    0x137: v137_0 = CALLPRIVATE v134(0x29f), v131(0x6fd)
    ...
    0x708: v708(0x10000000000000000000000000000000000000000) = EXP v706(0x2), v704(0xa0)
...
function changeAdmin(address)() public {
    ...
    =================================
    0x498S0x2dc: v498V2dc(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b) = CONST 
    0x4b9S0x2dc: v4b9V2dc = SLOAD v498V2dc(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b)
    ...
    =================================
    0x498S0x35e: v498V35e(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b) = CONST 
    0x4b9S0x35e: v4b9V35e = SLOAD v498V35e(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b)
    ...
    =================================
    0x4fd: v4fd(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b) = CONST 
    0x51e: SSTORE v4fd(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b), v182
    0x51f: JUMP v3aa(0x1e0)

    Begin block 0x1e00x154
    prev=[0x4fc], succ=[0x7b50x154]
    =================================
    0x1e10x154: v1541e1(0x7b5) = CONST 
    0x1e40x154: JUMP v1541e1(0x7b5)

    Begin block 0x7b50x154
    prev=[0x1e00x154], succ=[0x738]
    =================================
    0x7b70x154: JUMP v162(0x738)

    Begin block 0x738
    prev=[0x7b50x154], succ=[]
    =================================
    0x739: STOP 
    ...
    =================================
    0x1e60x154: v1541e6(0x7d7) = CONST 
    ...
    =================================
    0x1a50x154: v1541a5(0x794) = CONST 
    ...
    =================================
    0x44fS0x1a40x154: v44fV1a4154(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3) = CONST 
    0x470S0x1a40x154: v470V1a4154 = SLOAD v44fV1a4154(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3)
...
function admin()() public {
    ...
    0x19b: v19b_0 = CALLPRIVATE v198(0x3b2), v195(0x759)
    ...
    0x762: v762(0x2) = CONST 
    0x764: v764(0x10000000000000000000000000000000000000000) = EXP v762(0x2), v760(0xa0)
...
function 0x29f(0x29farg0x0) private {
    ...
    =================================
    0x498S0x29f: v498V29f(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b) = CONST 
    0x4b9S0x29f: v4b9V29f = SLOAD v498V29f(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b)
    ...
    =================================
    0x44fS0x2c3: v44fV2c3(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3) = CONST 
    0x470S0x2c3: v470V2c3 = SLOAD v44fV2c3(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3)
    0x472S0x2c3: JUMP v2c3(0x2ca)

    Begin block 0x2ca0x29f
    prev=[0x44eB0x2c3], succ=[0x8410x29f]
    =================================
    0x2cd0x29f: v29f2cd(0x841) = CONST 
    0x2d00x29f: JUMP v29f2cd(0x841)

    Begin block 0x8410x29f
    prev=[0x2ca0x29f], succ=[]
    =================================
    0x8430x29f: RETURNPRIVATE v29farg0, v470V2c3

    Begin block 0x2d10x29f
    prev=[0x2a9], succ=[0x19c0x29f]
    =================================
    0x2d20x29f: v29f2d2(0x863) = CONST 
    ...
    =================================
    0x1a50x29f: v29f1a5(0x794) = CONST 
    ...
    =================================
    0x44fS0x1a40x29f: v44fV1a429f(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3) = CONST 
    0x470S0x1a40x29f: v470V1a429f = SLOAD v44fV1a429f(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3)
...
function 0x3b2(0x3b2arg0x0) private {
    ...
    =================================
    0x498S0x3b2: v498V3b2(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b) = CONST 
    0x4b9S0x3b2: v4b9V3b2 = SLOAD v498V3b2(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b)
    ...
    =================================
    0x498S0x3d6: v498V3d6(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b) = CONST 
    0x4b9S0x3d6: v4b9V3d6 = SLOAD v498V3d6(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b)
    0x4bbS0x3d6: JUMP v3d6(0x2ca)

    Begin block 0x2ca0x3b2
    prev=[0x497B0x3d6], succ=[0x8410x3b2]
    =================================
    0x2cd0x3b2: v3b22cd(0x841) = CONST 
    0x2d00x3b2: JUMP v3b22cd(0x841)

    Begin block 0x8410x3b2
    prev=[0x2ca0x3b2], succ=[]
    =================================
    0x8430x3b2: RETURNPRIVATE v3b2arg0, v4b9V3d6

    Begin block 0x2d10x3b2
    prev=[0x3bc], succ=[0x19c0x3b2]
    =================================
    0x2d20x3b2: v3b22d2(0x863) = CONST 
    ...
    =================================
    0x1a50x3b2: v3b21a5(0x794) = CONST 
    ...
    =================================
    0x44fS0x1a40x3b2: v44fV1a43b2(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3) = CONST 
    0x470S0x1a40x3b2: v470V1a43b2 = SLOAD v44fV1a43b2(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3)
...
function 0x3dd(0x3ddarg0x0) private {
    ...
    =================================
    0x498S0x3dd: v498V3dd(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b) = CONST 
    0x4b9S0x3dd: v4b9V3dd = SLOAD v498V3dd(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b)
    ...
    Begin block 0x446
    prev=[0x3e5], succ=[0x8a6B0x446]
    =================================
    0x447: v447(0x885) = CONST 
    0x44a: v44a(0x8a6) = CONST 
    0x44d: JUMP v44a(0x8a6), v447(0x885)

    Begin block 0x8a6B0x446
    prev=[0x446], succ=[0x885]
    =================================
    0x8a7S0x446: JUMP v447(0x885)

    Begin block 0x885
    prev=[0x8a6B0x446], succ=[]
    =================================
    0x886: RETURNPRIVATE v3ddarg0
...
function 0x4bc(0x4bcarg0x0, 0x4bcarg0x1) private {
    ...
    =================================
    0x581: v581(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3) = CONST 
    0x5a2: SSTORE v581(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3), v4bcarg0
...
function fallback()() public {
    ...
    =================================
    0x44fS0x1a40x66: v44fV1a466(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3) = CONST 
    0x470S0x1a40x66: v470V1a466 = SLOAD v44fV1a466(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3)
...
function upgradeTo(address)() public {
    ...
    =================================
    0x498S0x1b6: v498V1b6(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b) = CONST 
    0x4b9S0x1b6: v4b9V1b6 = SLOAD v498V1b6(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b)
    ...
    prev=[0x1d8], succ=[0x7b50x70]
    =================================
    0x1e10x70: v701e1(0x7b5) = CONST 
    0x1e40x70: JUMP v701e1(0x7b5)

    Begin block 0x7b50x70
    prev=[0x1e00x70], succ=[0x6bb]
    =================================
    0x7b70x70: JUMP v7e(0x6bb)
    ...
    =================================
    0x44fS0x1a40x70: v44fV1a470(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3) = CONST 
    0x470S0x1a40x70: v470V1a470 = SLOAD v44fV1a470(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3)
...
function upgradeToAndCall(address,bytes)() public {
    ...
    =================================
    0x498S0x1f0: v498V1f0(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b) = CONST 
    0x4b9S0x1f0: v4b9V1f0 = SLOAD v498V1f0(0x10d6a54a4754c8869d6886b5f5d7fbfa5b4522237ea5c60d11bc4e7a1ff9390b)
    ...
    Begin block 0x28c
    prev=[0x27c], succ=[0x7f9]
    =================================
    0x28e: v28e(0x7f9) = CONST 
    0x291: JUMP v28e(0x7f9)

    Begin block 0x7f9
    prev=[0x28c], succ=[0x6dc]
    =================================
    0x7fd: JUMP va4(0x6dc)
    ...
    =================================
    0x44fS0x1a40xa3: v44fV1a4a3(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3) = CONST 
    0x470S0x1a40xa3: v470V1a4a3 = SLOAD v44fV1a4a3(0x7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3)
