function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0xc33: vc33(0xc43) = CONST 
    0xc34: JUMPI vc33(0xc43), v8
    ...
    Begin block 0x4e
    prev=[0xd], succ=[0xc46, 0x5a]
    =================================
    0x50: v50(0x3659cfe6) = CONST 
    0x55: v55 = EQ v50(0x3659cfe6), v12
    0xc3d: vc3d(0xc46) = CONST 
    0xc3e: JUMPI vc3d(0xc46), v55

    Begin block 0xc46
    prev=[0x4e], succ=[]
    =================================
    0xc47: vc47(0x7a) = CONST 
    0xc48: CALLPRIVATE vc47(0x7a)

    Begin block 0x5a
    prev=[0x4e], succ=[0xc49, 0x65]
    =================================
    0x5b: v5b(0x4f1ef286) = CONST 
    0x60: v60 = EQ v5b(0x4f1ef286), v12
    0xc3f: vc3f(0xc49) = CONST 
    0xc40: JUMPI vc3f(0xc49), v60

    Begin block 0xc49
    prev=[0x5a], succ=[]
    =================================
    0xc4a: vc4a(0xad) = CONST 
    0xc4b: CALLPRIVATE vc4a(0xad)

    Begin block 0x65
    prev=[0x5a], succ=[0xc43, 0xc4c]
    =================================
    0x66: v66(0x5c60da1b) = CONST 
    0x6b: v6b = EQ v66(0x5c60da1b), v12
    0xc41: vc41(0xc4c) = CONST 
    0xc42: JUMPI vc41(0xc4c), v6b

    Begin block 0xc43
    prev=[0x0, 0x65], succ=[]
    =================================
    0xc44: vc44(0x70) = CONST 
    0xc45: CALLPRIVATE vc44(0x70)

    Begin block 0xc4c
    prev=[0x65], succ=[]
    =================================
    0xc4d: vc4d(0x12d) = CONST 
    0xc4e: CALLPRIVATE vc4d(0x12d)

    Begin block 0x1e
    prev=[0xd], succ=[0xc4f, 0x29]
    =================================
    0x1f: v1f(0x8f283970) = CONST 
    0x24: v24 = EQ v1f(0x8f283970), v12
    0xc35: vc35(0xc4f) = CONST 
    0xc36: JUMPI vc35(0xc4f), v24

    Begin block 0xc4f
    prev=[0x1e], succ=[]
    =================================
    0xc50: vc50(0x15e) = CONST 
    0xc51: CALLPRIVATE vc50(0x15e)

    Begin block 0x29
    prev=[0x1e], succ=[0xc52, 0x34]
    =================================
    0x2a: v2a(0xcf7a1d77) = CONST 
    0x2f: v2f = EQ v2a(0xcf7a1d77), v12
    0xc37: vc37(0xc52) = CONST 
    0xc38: JUMPI vc37(0xc52), v2f

    Begin block 0xc52
    prev=[0x29], succ=[]
    =================================
    0xc53: vc53(0x191) = CONST 
    0xc54: CALLPRIVATE vc53(0x191)

    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0xc55]
    =================================
    0x35: v35(0xd1f57894) = CONST 
    0x3a: v3a = EQ v35(0xd1f57894), v12
    0xc39: vc39(0xc55) = CONST 
    0xc3a: JUMPI vc39(0xc55), v3a

    Begin block 0x3f
    prev=[0x34], succ=[0x4a, 0xc58]
    =================================
    0x40: v40(0xf851a440) = CONST 
    0x45: v45 = EQ v40(0xf851a440), v12
    0xc3b: vc3b(0xc58) = CONST 
    0xc3c: JUMPI vc3b(0xc58), v45
    ...
    prev=[0x3f], succ=[]
    =================================
    0xc59: vc59(0x306) = CONST 
    0xc5a: CALLPRIVATE vc59(0x306)

    Begin block 0xc55
    prev=[0x34], succ=[]
    =================================
    0xc56: vc56(0x250) = CONST 
    0xc57: CALLPRIVATE vc56(0x250)
...
function implementation()() public {
    ...
    Begin block 0x139
    prev=[0x12d], succ=[0x9fe]
    =================================
    0x13b: v13b(0x9fe) = CONST 
    0x13e: v13e(0x41c) = CONST 
    0x141: v141_0 = CALLPRIVATE v13e(0x41c), v13b(0x9fe)
    ...
    0xa0d: va0d = AND v141_0, va0a(0xffffffffffffffffffffffffffffffffffffffff)
    0xa0f: MSTORE va02, va0d
    0xa10: va10 = MLOAD v9ff(0x40)
    0xa14: va14(0x0) = SUB va02, va10
    0xa15: va15(0x20) = CONST 
    0xa17: va17(0x20) = ADD va15(0x20), va14(0x0)
    0xa19: RETURN va10, va17(0x20)
...
function changeAdmin(address)() public {
    ...
    prev=[0x812B0x4e8], succ=[0xaf80x15e]
    =================================
    0x3600x15e: v15e360(0xaf8) = CONST 
    0x3630x15e: JUMP v15e360(0xaf8)

    Begin block 0xaf80x15e
    prev=[0x35f0x15e], succ=[0xa39]
    =================================
    0xafa0x15e: JUMP v16c(0xa39)

    Begin block 0xa39
    prev=[0xaf80x15e], succ=[]
    =================================
    0xa3a: STOP 
    ...
    =================================
    0x3650x15e: v15e365(0xb1a) = CONST 
    ...
    =================================
    0x3240x15e: v15e324(0xad7) = CONST 
...
function initialize(address,address,bytes)() public {
    ...
    prev=[0x6a10x599B0x530, 0x6c20x599B0x530], succ=[0x6d10x599B0x530, 0xbec0x599B0x530]
    =================================
    0x6cd0x599S0x530: v5996cdV530(0xbec) = CONST 
    0x6d00x599S0x530: JUMPI v5996cdV530(0xbec), v599693V530
    ...
    Begin block 0xbec0x599B0x530
    prev=[0x6c70x599B0x530], succ=[0x53a]
    =================================
    0xbf00x599S0x530: JUMP v531(0x53a)

    Begin block 0x53a
    prev=[0x6d50x599B0x530, 0xbec0x599B0x530], succ=[0x58f, 0x590]
    =================================
    ...
    =================================
    0x591: v591(0xbc8) = CONST 
    0x595: v595(0x812) = CONST 
    0x598: JUMP v595(0x812), v1bc, v591(0xbc8)

    Begin block 0x812B0x590
    prev=[0x590], succ=[0xbc8]
    =================================
    ...
    0x835S0x590: JUMP v591(0xbc8)

    Begin block 0xbc8
    prev=[0x812B0x590], succ=[0xa5a]
    =================================
    0xbcc: JUMP v192(0xa5a)
...
function initialize(address,bytes)() public {
    ...
    prev=[0x6a10x250, 0x6c20x250], succ=[0x6d10x250, 0xbec0x250]
    =================================
    0x6cd0x250: v2506cd(0xbec) = CONST 
    0x6d00x250: JUMPI v2506cd(0xbec), v250693
    ...
    Begin block 0xbec0x250
    prev=[0x6c70x250], succ=[0xa7b]
    =================================
    0xbf00x250: JUMP v251(0xa7b)

    Begin block 0xa7b
    prev=[0x6d50x250, 0xbec0x250], succ=[]
    =================================
    0xa7c: STOP 
    ...
    prev=[0x61f0x250], succ=[0xa7b]
    =================================
    0x6d80x250: JUMP v251(0xa7b)
...
function admin()() public {
    ...
    Begin block 0x312
    prev=[0x306], succ=[0xa9c]
    =================================
    0x314: v314(0xa9c) = CONST 
    0x317: v317(0x6d9) = CONST 
    0x31a: v31a_0 = CALLPRIVATE v317(0x6d9), v314(0xa9c)
    ...
    0xaab: vaab = AND v31a_0, vaa8(0xffffffffffffffffffffffffffffffffffffffff)
...
function 0x41c(0x41carg0x0) private {
    ...
    prev=[0x764B0x440], succ=[0xb840x41c]
    =================================
    0x44a0x41c: v41c44a(0xb84) = CONST 
    0x44d0x41c: JUMP v41c44a(0xb84)

    Begin block 0xb840x41c
    prev=[0x4470x41c], succ=[]
    =================================
    0xb860x41c: RETURNPRIVATE v41carg0, v786V440

    Begin block 0x44e0x41c
    prev=[0x426], succ=[0x31b0x41c]
    =================================
    0x44f0x41c: v41c44f(0xba6) = CONST 
    ...
    =================================
    0x3240x41c: v41c324(0xad7) = CONST 
...
function 0x6d9(0x6d9arg0x0) private {
    ...
    prev=[0x7adB0x6fd], succ=[0xb840x6d9]
    =================================
    0x44a0x6d9: v6d944a(0xb84) = CONST 
    0x44d0x6d9: JUMP v6d944a(0xb84)

    Begin block 0xb840x6d9
    prev=[0x4470x6d9], succ=[]
    =================================
    0xb860x6d9: RETURNPRIVATE v6d9arg0, v7cfV6fd

    Begin block 0x44e0x6d9
    prev=[0x6e3], succ=[0x31b0x6d9]
    =================================
    0x44f0x6d9: v6d944f(0xba6) = CONST 
    ...
    =================================
    0x3240x6d9: v6d9324(0xad7) = CONST 
...
function 0x704(0x704arg0x0) private {
    ...
    Begin block 0x75c
    prev=[0x70c], succ=[0xc31B0x75c]
    =================================
    0x75d: v75d(0xc10) = CONST 
    0x760: v760(0xc31) = CONST 
    0x763: JUMP v760(0xc31), v75d(0xc10)

    Begin block 0xc31B0x75c
    prev=[0x75c], succ=[0xc10]
    =================================
    0xc32S0x75c: JUMP v75d(0xc10)

    Begin block 0xc10
    prev=[0xc31B0x75c], succ=[]
    =================================
    0xc11: RETURNPRIVATE v704arg0
...
function upgradeTo(address)() public {
    ...
    prev=[0x7dbB0x357], succ=[0xaf80x7a]
    =================================
    0x3600x7a: v7a360(0xaf8) = CONST 
    0x3630x7a: JUMP v7a360(0xaf8)

    Begin block 0xaf80x7a
    prev=[0x35f0x7a], succ=[0x9bc]
    =================================
    0xafa0x7a: JUMP v88(0x9bc)
...
function upgradeToAndCall(address,bytes)() public {
    ...
    Begin block 0x409
    prev=[0x3fb], succ=[0xb3c]
    =================================
    0x40b: v40b(0xb3c) = CONST 
    0x40e: JUMP v40b(0xb3c)

    Begin block 0xb3c
    prev=[0x409], succ=[0x9dd]
    =================================
    0xb40: JUMP vae(0x9dd)
