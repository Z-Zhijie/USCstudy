function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x47d: v47d(0x483) = CONST 
    0x47e: JUMPI v47d(0x483), v8

    Begin block 0xd
    prev=[0x0], succ=[0x486, 0x1e]
    =================================
    0xd: vd(0x0) = CONST 
    ...
    0x480: JUMPI v47f(0x486), v19

    Begin block 0x486
    prev=[0xd], succ=[]
    =================================
    0x487: v487(0x33) = CONST 
    0x488: CALLPRIVATE v487(0x33)

    Begin block 0x1e
    prev=[0xd], succ=[0x483, 0x489]
    =================================
    0x1f: v1f(0xd55ec697) = CONST 
    0x24: v24 = EQ v1f(0xd55ec697), v12
    0x481: v481(0x489) = CONST 
    0x482: JUMPI v481(0x489), v24

    Begin block 0x483
    prev=[0x0, 0x1e], succ=[]
    =================================
    0x484: v484(0x29) = CONST 
    0x485: CALLPRIVATE v484(0x29)

    Begin block 0x489
    prev=[0x1e], succ=[]
    =================================
    0x48a: v48a(0x64) = CONST 
    0x48b: CALLPRIVATE v48a(0x64)
...
function fallback()() public {
    ...
    prev=[], succ=[0x79]
    =================================
    0x2a: v2a(0x418) = CONST 
    0x2d: v2d(0x79) = CONST 
    0x30: JUMP v2d(0x79)

    Begin block 0x79
    prev=[0x29], succ=[0x45aB0x79]
    =================================
    0x7a: v7a(0x81) = CONST 
    0x7d: v7d(0x45a) = CONST 
    0x80: JUMP v7d(0x45a), v7a(0x81)

    Begin block 0x45aB0x79
    prev=[0x79], succ=[0x81]
    =================================
    0x45bS0x79: JUMP v7a(0x81)

    Begin block 0x81
    prev=[0x45aB0x79], succ=[0x271B0x81]
    =================================
    0x82: v82(0x47b) = CONST 
    0x85: v85(0x8c) = CONST 
...
function upgrade()() public {
    ...
    =================================
    0x72: v72(0x439) = CONST 
    0x75: v75(0xa2) = CONST 
    0x78: JUMP v75(0xa2), v72(0x439)
    ...
    prev=[0x22aB0x70], succ=[0x439]
    =================================
    0x270S0x70: JUMP v72(0x439)
