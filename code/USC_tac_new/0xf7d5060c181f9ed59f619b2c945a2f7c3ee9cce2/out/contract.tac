function __function_selector__() public {
    ...
    0x7: v7 = CALLDATASIZE 
    0x8: v8 = LT v7, v5(0x4)
    0x49b: v49b(0x4a9) = CONST 
    0x49c: JUMPI v49b(0x4a9), v8

    Begin block 0xd
    prev=[0x0], succ=[0x40, 0x4ac]
    =================================
    ...
    0x49d: v49d(0x4ac) = CONST 
    0x49e: JUMPI v49d(0x4ac), v3b

    Begin block 0x40
    prev=[0xd], succ=[0x4af, 0x4b]
    =================================
    0x41: v41(0x54fd4d50) = CONST 
    0x46: v46 = EQ v41(0x54fd4d50), v34
    0x49f: v49f(0x4af) = CONST 
    0x4a0: JUMPI v49f(0x4af), v46

    Begin block 0x4af
    prev=[0x40], succ=[]
    =================================
    0x4b0: v4b0(0xe8) = CONST 
    0x4b1: CALLPRIVATE v4b0(0xe8)

    Begin block 0x4b
    prev=[0x40], succ=[0x4b2, 0x56]
    =================================
    0x4c: v4c(0x5c60da1b) = CONST 
    0x51: v51 = EQ v4c(0x5c60da1b), v34
    0x4a1: v4a1(0x4b2) = CONST 
    0x4a2: JUMPI v4a1(0x4b2), v51

    Begin block 0x4b2
    prev=[0x4b], succ=[]
    =================================
    0x4b3: v4b3(0x10f) = CONST 
    0x4b4: CALLPRIVATE v4b3(0x10f)

    Begin block 0x56
    prev=[0x4b], succ=[0x4b5, 0x61]
    =================================
    0x57: v57(0x6fde8202) = CONST 
    0x5c: v5c = EQ v57(0x6fde8202), v34
    0x4a3: v4a3(0x4b5) = CONST 
    0x4a4: JUMPI v4a3(0x4b5), v5c

    Begin block 0x4b5
    prev=[0x56], succ=[]
    =================================
    0x4b6: v4b6(0x140) = CONST 
    0x4b7: CALLPRIVATE v4b6(0x140)

    Begin block 0x61
    prev=[0x56], succ=[0x4b8, 0x6c]
    =================================
    0x62: v62(0xa9c45fcb) = CONST 
    0x67: v67 = EQ v62(0xa9c45fcb), v34
    0x4a5: v4a5(0x4b8) = CONST 
    0x4a6: JUMPI v4a5(0x4b8), v67

    Begin block 0x4b8
    prev=[0x61], succ=[]
    =================================
    0x4b9: v4b9(0x155) = CONST 
    0x4ba: CALLPRIVATE v4b9(0x155)

    Begin block 0x6c
    prev=[0x61], succ=[0x4a9, 0x4bb]
    =================================
    0x6d: v6d(0xf1739cae) = CONST 
    0x72: v72 = EQ v6d(0xf1739cae), v34
    0x4a7: v4a7(0x4bb) = CONST 
    0x4a8: JUMPI v4a7(0x4bb), v72

    Begin block 0x4a9
    prev=[0x0, 0x6c], succ=[]
    =================================
    0x4aa: v4aa(0x77) = CONST 
    0x4ab: CALLPRIVATE v4aa(0x77)

    Begin block 0x4bb
    prev=[0x6c], succ=[]
    =================================
    0x4bc: v4bc(0x179) = CONST 
    0x4bd: CALLPRIVATE v4bc(0x179)

    Begin block 0x4ac
    prev=[0xd], succ=[]
    =================================
    0x4ad: v4ad(0xc2) = CONST 
    0x4ae: CALLPRIVATE v4ad(0xc2)
...
function implementation()() public {
    ...
    0x1a8S0x11b: JUMP v11d(0x402)

    Begin block 0x402
    prev=[0x19aB0x11b], succ=[]
    =================================
    0x403: v403(0x40) = CONST 
    0x406: v406 = MLOAD v403(0x40)
    0x407: v407(0x1) = CONST 
    0x409: v409(0xa0) = CONST 
    0x40b: v40b(0x2) = CONST 
    0x40d: v40d(0x10000000000000000000000000000000000000000) = EXP v40b(0x2), v409(0xa0)
    0x40e: v40e(0xffffffffffffffffffffffffffffffffffffffff) = SUB v40d(0x10000000000000000000000000000000000000000), v407(0x1)
    0x411: v411 = AND v1a6V11b, v40e(0xffffffffffffffffffffffffffffffffffffffff)
    0x413: MSTORE v406, v411
    0x414: v414 = MLOAD v403(0x40)
    0x418: v418(0x0) = SUB v406, v414
    0x419: v419(0x20) = CONST 
    0x41b: v41b(0x20) = ADD v419(0x20), v418(0x0)
    0x41d: RETURN v414, v41b(0x20)
...
function upgradeabilityOwner()() public {
    ...
    0x44c: v44c = AND v1e5V14c, v449(0xffffffffffffffffffffffffffffffffffffffff)
    0x44e: MSTORE v441, v44c
    0x44f: v44f = MLOAD v43e(0x40)
    0x453: v453(0x0) = SUB v441, v44f
    0x454: v454(0x20) = CONST 
    0x456: v456(0x20) = ADD v454(0x20), v453(0x0)
    0x458: RETURN v44f, v456(0x20)
...
function upgradeToAndCall(uint256,address,bytes)() public {
    ...
    0x178: JUMP v175(0x1e8), v174, v171, v16a, v15c, v156(0x478)
    ...
    prev=[0x20eB0x155], succ=[0x478]
    =================================
    0x24fS0x155: JUMP v156(0x478)
...
function transferProxyOwnership(address)() public {
    ...
    0x199: JUMP v196(0x250), v195, v187(0x499)
    ...
    prev=[0x37dB0x185], succ=[0x499]
    =================================
    0x2d7S0x185: JUMP v187(0x499)
...
function upgradeTo(uint256,address)() public {
    ...
    Begin block 0xce
    prev=[0xc2], succ=[0x3e1]
    =================================
    0xd0: vd0(0x3e1) = CONST 
    0xd3: vd3(0x4) = CONST 
    ...
    0xe5: CALLPRIVATE ve2(0x1a9), ve1, vd5, vd0(0x3e1)
