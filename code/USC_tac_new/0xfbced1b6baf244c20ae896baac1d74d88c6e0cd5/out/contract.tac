function __function_selector__() public {
    ...
    0xa31: va31(0xa40) = CONST 
    0xa32: JUMPI va31(0xa40), v19

    Begin block 0xa40
    prev=[0xd], succ=[]
    =================================
    0xa41: va41(0x72) = CONST 
    0xa42: CALLPRIVATE va41(0x72)

    Begin block 0x1e
    prev=[0xd], succ=[0xa43, 0x29]
    =================================
    0x1f: v1f(0x5fe48394) = CONST 
    0x24: v24 = EQ v1f(0x5fe48394), v12
    0xa33: va33(0xa43) = CONST 
    0xa34: JUMPI va33(0xa43), v24

    Begin block 0xa43
    prev=[0x1e], succ=[]
    =================================
    0xa44: va44(0x89) = CONST 
    0xa45: CALLPRIVATE va44(0x89)

    Begin block 0x29
    prev=[0x1e], succ=[0xa46, 0x34]
    =================================
    0x2a: v2a(0x88b4b861) = CONST 
    0x2f: v2f = EQ v2a(0x88b4b861), v12
    0xa35: va35(0xa46) = CONST 
    0xa36: JUMPI va35(0xa46), v2f

    Begin block 0xa46
    prev=[0x29], succ=[]
    =================================
    0xa47: va47(0x122) = CONST 
    0xa48: CALLPRIVATE va47(0x122)

    Begin block 0x34
    prev=[0x29], succ=[0x3f, 0xa49]
    =================================
    0x35: v35(0x8f283970) = CONST 
    0x3a: v3a = EQ v35(0x8f283970), v12
    0xa37: va37(0xa49) = CONST 
    0xa38: JUMPI va37(0xa49), v3a

    Begin block 0x3f
    prev=[0x34], succ=[0xa4c, 0x4a]
    =================================
    0x40: v40(0xd55ec697) = CONST 
    0x45: v45 = EQ v40(0xd55ec697), v12
    0xa39: va39(0xa4c) = CONST 
    0xa3a: JUMPI va39(0xa4c), v45

    Begin block 0xa4c
    prev=[0x3f], succ=[]
    =================================
    0xa4d: va4d(0x1c4) = CONST 
    0xa4e: CALLPRIVATE va4d(0x1c4)

    Begin block 0x4a
    prev=[0x3f], succ=[0x55, 0xa4f]
    =================================
    0x4b: v4b(0xfddb1a23) = CONST 
    0x50: v50 = EQ v4b(0xfddb1a23), v12
    0xa3b: va3b(0xa4f) = CONST 
    0xa3c: JUMPI va3b(0xa4f), v50
    ...
    prev=[0x4a], succ=[]
    =================================
    0xa50: va50(0x1db) = CONST 
    0xa51: CALLPRIVATE va50(0x1db)

    Begin block 0xa49
    prev=[0x34], succ=[]
    =================================
    0xa4a: va4a(0x173) = CONST 
    0xa4b: CALLPRIVATE va4a(0x173)

    Begin block 0x59
    prev=[0x0], succ=[0xa3d, 0x68]
    =================================
    ...
    prev=[0x59], succ=[]
    =================================
    0xa3d: va3d(0xa3f) = CONST 
    0xa3e: CALLPRIVATE va3d(0xa3f)
...
function fallback()() public {
    Begin block 0xa3f
    prev=[], succ=[0x2160xa3f]
    =================================
    0x5f: v5f(0x66) = CONST 
    0x62: v62(0x216) = CONST 
    0x65: JUMP v62(0x216)

    Begin block 0x2160xa3f
    prev=[0xa3f], succ=[0x7fcB0x2160xa3f]
    =================================
    0x2170xa3f: va3f217(0x21e) = CONST 
    0x21a0xa3f: va3f21a(0x7fc) = CONST 
    0x21d0xa3f: JUMP va3f21a(0x7fc)

    Begin block 0x7fcB0x2160xa3f
    prev=[0x2160xa3f], succ=[0x21e0xa3f]
    =================================
    0x7fdS0x2160xa3f: v7fdV216a3f(0x0) = CONST 
    0x7ffS0x2160xa3f: v7ffV216a3f(0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103) = CONST 
    0x820S0x2160xa3f: v820V216a3f = SLOAD v7ffV216a3f(0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103)
    0x824S0x2160xa3f: JUMP va3f217(0x21e)

    Begin block 0x21e0xa3f
    prev=[0x7fcB0x2160xa3f], succ=[0x2520xa3f, 0x2560xa3f]
    =================================
    0x21f0xa3f: va3f21f(0xffffffffffffffffffffffffffffffffffffffff) = CONST 
    0x2340xa3f: va3f234 = AND va3f21f(0xffffffffffffffffffffffffffffffffffffffff), v820V216a3f
    0x2350xa3f: va3f235 = CALLER 
    0x2360xa3f: va3f236(0xffffffffffffffffffffffffffffffffffffffff) = CONST 
    0x24b0xa3f: va3f24b = AND va3f236(0xffffffffffffffffffffffffffffffffffffffff), va3f235
    0x24c0xa3f: va3f24c = EQ va3f24b, va3f234
    0x24d0xa3f: va3f24d = ISZERO va3f24c
    0x24e0xa3f: va3f24e(0x256) = CONST 
    0x2510xa3f: JUMPI va3f24e(0x256), va3f24d

    Begin block 0x2520xa3f
    prev=[0x21e0xa3f], succ=[]
    =================================
    0x2520xa3f: va3f252(0x0) = CONST 
    0x2550xa3f: REVERT va3f252(0x0), va3f252(0x0)

    Begin block 0x2560xa3f
    prev=[0x21e0xa3f], succ=[0x825B0x2560xa3f]
    =================================
    0x2570xa3f: va3f257(0x266) = CONST 
    0x25a0xa3f: va3f25a(0x261) = CONST 
    0x25d0xa3f: va3f25d(0x825) = CONST 
    0x2600xa3f: JUMP va3f25d(0x825)

    Begin block 0x825B0x2560xa3f
    prev=[0x2560xa3f], succ=[0x2610xa3f]
    =================================
    0x826S0x2560xa3f: v826V256a3f(0x0) = CONST 
    0x828S0x2560xa3f: v828V256a3f(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc) = CONST 
    0x849S0x2560xa3f: v849V256a3f = SLOAD v828V256a3f(0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc)
    0x84dS0x2560xa3f: JUMP va3f25a(0x261)

    Begin block 0x2610xa3f
    prev=[0x825B0x2560xa3f], succ=[0x84e0xa3f]
    =================================
    0x2620xa3f: va3f262(0x84e) = CONST 
    0x2650xa3f: JUMP va3f262(0x84e)

    Begin block 0x84e0xa3f
    prev=[0x2610xa3f], succ=[0x86b0xa3f, 0x86f0xa3f]
    =================================
    0x84f0xa3f: va3f84f = CALLDATASIZE 
    0x8500xa3f: va3f850(0x0) = CONST 
    0x8530xa3f: CALLDATACOPY va3f850(0x0), va3f850(0x0), va3f84f
    0x8540xa3f: va3f854(0x0) = CONST 
    0x8570xa3f: va3f857 = CALLDATASIZE 
    0x8580xa3f: va3f858(0x0) = CONST 
    0x85b0xa3f: va3f85b = GAS 
    0x85c0xa3f: va3f85c = DELEGATECALL va3f85b, v849V256a3f, va3f858(0x0), va3f857, va3f854(0x0), va3f854(0x0)
    0x85d0xa3f: va3f85d = RETURNDATASIZE 
    0x85e0xa3f: va3f85e(0x0) = CONST 
    0x8610xa3f: RETURNDATACOPY va3f85e(0x0), va3f85e(0x0), va3f85d
    0x8630xa3f: va3f863(0x0) = CONST 
    0x8660xa3f: va3f866 = EQ va3f85c, va3f863(0x0)
    0x8670xa3f: va3f867(0x86f) = CONST 
    0x86a0xa3f: JUMPI va3f867(0x86f), va3f866

    Begin block 0x86b0xa3f
    prev=[0x84e0xa3f], succ=[]
    =================================
    0x86b0xa3f: va3f86b = RETURNDATASIZE 
    0x86c0xa3f: va3f86c(0x0) = CONST 
    0x86e0xa3f: RETURN va3f86c(0x0), va3f86b

    Begin block 0x86f0xa3f
    prev=[0x84e0xa3f], succ=[]
    =================================
    0x8700xa3f: va3f870 = RETURNDATASIZE 
    0x8710xa3f: va3f871(0x0) = CONST 
    0x8730xa3f: REVERT va3f871(0x0), va3f870
